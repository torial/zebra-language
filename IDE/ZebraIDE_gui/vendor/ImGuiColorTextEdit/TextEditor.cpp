...
void TextEditor::Render()
{
	...
	// GetWindowContentRegionMax() removed in ImGui 1.91+; cursor+avail is equivalent at render start.
	ImVec2 _cp = ImGui::GetCursorPos(); ImVec2 _ca = ImGui::GetContentRegionAvail();
	auto contentSize = ImVec2(_cp.x + _ca.x, _cp.y + _ca.y);
