...
// zbr:IDE/ZebraIDE.zbr:43
            if ((std.mem.trim(u8, ln, &std.ascii.whitespace).len == 0)) {
                continue;
            }
...
// zbr:IDE/ZebraIDE.zbr:78
            message = std.mem.trim(u8, message[@intCast((colonPos + 1))..@intCast(message.len)], &std.ascii.whitespace);
        }
