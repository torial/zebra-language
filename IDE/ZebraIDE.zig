...
pub const IDEDiagnostic = struct {
    ...
    message: []const u8 = "",
    is_error: bool = false,
    pub fn init() *IDEDiagnostic {
        const self = _allocator.create(IDEDiagnostic) catch @panic("OOM");
        self._type_tag = _ttag_IDEDiagnostic;
        self.line = 0;
        self.col = 0;
        self.end_col = 1;
        self.message = "";
...
const _ttag_IDEDiagnostic: u64 = _zbr_hash("IDEDiagnostic");
const _reflect_IDEDiagnostic_name: []const u8 = "IDEDiagnostic";
const _reflect_IDEDiagnostic_fields: []const []const u8 = &.{"line", "col", "end_col", "message", "is_error"};
const _reflect_IDEDiagnostic_field_types: []const []const u8 = &.{"int", "int", "int", "str", "bool"};

pub const CompilerBridge = struct {
    _type_tag: u64 = _ttag_CompilerBridge,
    pub fn check(filepath: []const u8) std.ArrayList(*IDEDiagnostic) {
// zbr:IDE/ZebraIDE.zbr:24
        var argv = std.ArrayList([]const u8){};
        argv.append(_allocator, "zebra") catch @panic("OOM");
        argv.append(_allocator, "-c") catch @panic("OOM");
        argv.append(_allocator, filepath) catch @panic("OOM");
...
// zbr:IDE/ZebraIDE.zbr:41
        var diags = std.ArrayList(*IDEDiagnostic){};
// zbr:IDE/ZebraIDE.zbr:42
        {
            var _it_ln = std.mem.splitSequence(u8, raw, "\n");
            while (_it_ln.next()) |ln| {
// zbr:IDE/ZebraIDE.zbr:43
                if ((@as(i64, @intCast(std.mem.trim(u8, ln, " \t\n\r").len)) == 0)) {
                    continue;
                }
// zbr:IDE/ZebraIDE.zbr:45
                const d = CompilerBridge.parseLine(ln);
// zbr:IDE/ZebraIDE.zbr:46
                if ((d != null)) {
                    diags.append(_allocator, d) catch @panic("OOM");
                }
            }
        }
// zbr:IDE/ZebraIDE.zbr:48
        return diags;
    }

    pub fn parseLine(ln: []const u8) ?*IDEDiagnostic {
// zbr:IDE/ZebraIDE.zbr:51
        var colon1 = blk: { const _idx = std.mem.indexOf(u8, ln, ":"); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:52
        if (_zebra_lt(colon1, 0)) {
// zbr:IDE/ZebraIDE.zbr:53
            return null;
        }
// zbr:IDE/ZebraIDE.zbr:54
        var searchFrom = (colon1 + 1);
// zbr:IDE/ZebraIDE.zbr:55
        if ((colon1 == 1)) {
// zbr:IDE/ZebraIDE.zbr:56
            const next = blk: { const _idx = std.mem.indexOf(u8, ln, ":"); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:57
            if (_zebra_lt(next, 0)) {
// zbr:IDE/ZebraIDE.zbr:58
                return null;
            }
// zbr:IDE/ZebraIDE.zbr:59
            searchFrom = (next + 1);
// zbr:IDE/ZebraIDE.zbr:60
            colon1 = next;
        }
// zbr:IDE/ZebraIDE.zbr:61
        const colon2 = blk: { const _idx = std.mem.indexOf(u8, ln, ":"); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:62
        if (_zebra_lt(colon2, 0)) {
// zbr:IDE/ZebraIDE.zbr:63
            return null;
        }
// zbr:IDE/ZebraIDE.zbr:64
        const colon3 = blk: { const _idx = std.mem.indexOf(u8, ln, ":"); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:65
        if (_zebra_lt(colon3, 0)) {
// zbr:IDE/ZebraIDE.zbr:66
            return null;
        }
// zbr:IDE/ZebraIDE.zbr:67
        var _mc_1 = ln[@intCast((colon1 + 1))..@intCast(colon2)];
        const lineStr = _mc_1.trim();
// zbr:IDE/ZebraIDE.zbr:68
        var _mc_2 = ln[@intCast((colon2 + 1))..@intCast(colon3)];
        const colStr = _mc_2.trim();
// zbr:IDE/ZebraIDE.zbr:69
        var _mc_3 = ln[@intCast((colon3 + 1))..@intCast(@as(i64, @intCast(ln.len)))];
        const rest = _mc_3.trim();
// zbr:IDE/ZebraIDE.zbr:70
        const lineNum = (std.fmt.parseInt(i64, lineStr, 10) catch 0);
// zbr:IDE/ZebraIDE.zbr:71
        const colNum = (std.fmt.parseInt(i64, colStr, 10) catch 0);
// zbr:IDE/ZebraIDE.zbr:72
        if (((lineNum == 0) or (colNum == 0))) {
// zbr:IDE/ZebraIDE.zbr:73
            return null;
        }
// zbr:IDE/ZebraIDE.zbr:74
        const isError = std.mem.startsWith(u8, rest, "error:");
// zbr:IDE/ZebraIDE.zbr:75
        var message = rest;
// zbr:IDE/ZebraIDE.zbr:76
        const colonPos = blk: { const _idx = std.mem.indexOf(u8, message, ":"); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:77
        if (_zebra_ge(colonPos, 0)) {
// zbr:IDE/ZebraIDE.zbr:78
            var _mc_4 = message[@intCast((colonPos + 1))..@intCast(@as(i64, @intCast(message.items.len)))];
            message = _mc_4.trim();
        }
// zbr:IDE/ZebraIDE.zbr:79
        var d = IDEDiagnostic.init();
// zbr:IDE/ZebraIDE.zbr:80
        d.line = lineNum;
// zbr:IDE/ZebraIDE.zbr:81
        d.col = colNum;
...
// zbr:IDE/ZebraIDE.zbr:85
    ...
    pub fn init() *CompilerBridge {
        const self = _allocator.create(CompilerBridge) catch @panic("OOM");
        self._type_tag = _ttag_CompilerBridge;
        return self;
    }

};
const _ttag_CompilerBridge: u64 = _zbr_hash("CompilerBridge");
const _reflect_CompilerBridge_name: []const u8 = "CompilerBridge";
const _reflect_CompilerBridge_fields: []const []const u8 = &.{};
const _reflect_CompilerBridge_field_types: []const []const u8 = &.{};

pub const IDEState = struct {
    _type_tag: u64 = _ttag_IDEState,
    filepath: []const u8 = "untitled.zbr",
    diags: std.ArrayList(*IDEDiagnostic) = std.ArrayList(*IDEDiagnostic){},
    output: []const u8 = "",
    dirty: bool = false,
    lastCheck: []const u8 = "",
    files: std.ArrayList([]const u8) = std.ArrayList([]const u8){},
    debugProc: ?*_SysProcess = null,
    debugPort: i64 = 0,
    buildOutput: []const u8 = "",
    buildRunning: bool = false,
    buildTargets: std.ArrayList([]const u8) = std.ArrayList([]const u8){},
    buildFile: []const u8 = "build.zbr",
...
// zbr:IDE/ZebraIDE.zbr:108
    ...
    pub fn init() *IDEState {
        ...
        self._type_tag = _ttag_IDEState;
        self.filepath = "untitled.zbr";
        self.diags = std.ArrayList(*IDEDiagnostic){};
        self.output = "";
        self.dirty = false;
        self.lastCheck = "";
        self.files = std.ArrayList([]const u8){};
        self.debugProc = null;
        self.debugPort = 0;
        self.buildOutput = "";
        self.buildRunning = false;
        self.buildTargets = std.ArrayList([]const u8){};
        self.buildFile = "build.zbr";
        return self;
    }

};
const _ttag_IDEState: u64 = _zbr_hash("IDEState");
const _reflect_IDEState_name: []const u8 = "IDEState";
const _reflect_IDEState_fields: []const []const u8 = &.{"filepath", "diags", "output", "dirty", "lastCheck", "files", "debugProc", "debugPort", "buildOutput", "buildRunning", "buildTargets", "buildFile"};
const _reflect_IDEState_field_types: []const []const u8 = &.{"str", "List(IDEDiagnostic)", "str", "bool", "str", "List(str)", "?SysProcess", "int", "str", "bool", "List(str)", "str"};

pub const DebugTask = struct {
    _type_tag: u64 = _ttag_DebugTask,
    state: *IDEState,
    proc: *_SysProcess,
    pub fn new(state: *IDEState, proc: *_SysProcess) *DebugTask {
// zbr:IDE/ZebraIDE.zbr:120
        var t = DebugTask.init();
...
// zbr:IDE/ZebraIDE.zbr:130
    ...
    pub fn cancel(self: *DebugTask) void {
        self.proc.kill();
...
// zbr:IDE/ZebraIDE.zbr:136
        self.state.output = "Debugger stopped.";
    }

    pub fn init() *DebugTask {
        const self = _allocator.create(DebugTask) catch @panic("OOM");
        self._type_tag = _ttag_DebugTask;
        return self;
    }

};
const _ttag_DebugTask: u64 = _zbr_hash("DebugTask");
const _reflect_DebugTask_name: []const u8 = "DebugTask";
const _reflect_DebugTask_fields: []const []const u8 = &.{"state", "proc"};
const _reflect_DebugTask_field_types: []const []const u8 = &.{"IDEState", "SysProcess"};

pub const BuildTask = struct {
    _type_tag: u64 = _ttag_BuildTask,
    state: *IDEState,
    proc: *_SysProcess,
    tmpFile: []const u8,
    lastPos: i64,
    pub fn new(state: *IDEState, proc: *_SysProcess, tmpFile: []const u8) *BuildTask {
// zbr:IDE/ZebraIDE.zbr:149
        var t = BuildTask.init();
// zbr:IDE/ZebraIDE.zbr:150
        t.state = state;
// zbr:IDE/ZebraIDE.zbr:151
        t.proc = proc;
// zbr:IDE/ZebraIDE.zbr:152
        t.tmpFile = _intern(tmpFile);
...
// zbr:IDE/ZebraIDE.zbr:154
    ...
    pub fn poll(self: *BuildTask) bool {
// zbr:IDE/ZebraIDE.zbr:157
        if ((blk_fex: { std.fs.cwd().access(self.tmpFile, .{}) catch break :blk_fex false; break :blk_fex true; })) {
// zbr:IDE/ZebraIDE.zbr:158
            const content = (std.fs.cwd().readFileAlloc(_allocator, self.tmpFile, std.math.maxInt(usize)) catch @panic("File.read error"));
// zbr:IDE/ZebraIDE.zbr:159
            if (_zebra_gt(@as(i64, @intCast(content.len)), self.lastPos)) {
// zbr:IDE/ZebraIDE.zbr:160
                self.state.buildOutput = _str_concat(self.state.buildOutput, content[@intCast(self.lastPos)..@intCast(@as(i64, @intCast(content.len)))], _allocator);
// zbr:IDE/ZebraIDE.zbr:161
                self.lastPos = @as(i64, @intCast(content.len));
            }
        }
// zbr:IDE/ZebraIDE.zbr:162
        if ((!self.proc.isRunning())) {
// zbr:IDE/ZebraIDE.zbr:163
            self.state.buildRunning = false;
...
// zbr:IDE/ZebraIDE.zbr:165
    ...
    pub fn cancel(self: *BuildTask) void {
        self.proc.kill();
// zbr:IDE/ZebraIDE.zbr:169
        self.state.buildRunning = false;
    }

    pub fn init() *BuildTask {
        const self = _allocator.create(BuildTask) catch @panic("OOM");
        self._type_tag = _ttag_BuildTask;
        return self;
    }

};
const _ttag_BuildTask: u64 = _zbr_hash("BuildTask");
const _reflect_BuildTask_name: []const u8 = "BuildTask";
const _reflect_BuildTask_fields: []const []const u8 = &.{"state", "proc", "tmpFile", "lastPos"};
const _reflect_BuildTask_field_types: []const []const u8 = &.{"IDEState", "SysProcess", "str", "int"};

pub const PollTask = union(enum) {
    debug_task: *DebugTask,
    build_task: *BuildTask,
};

pub const PollRegistry = struct {
    _type_tag: u64 = _ttag_PollRegistry,
    _tasks: std.ArrayList(PollTask) = std.ArrayList(PollTask){},
    pub fn register(self: *PollRegistry, task: PollTask) void {
        self._tasks.append(_allocator, task) catch @panic("OOM");
    }

    pub fn pollAll(self: *PollRegistry) void {
// zbr:IDE/ZebraIDE.zbr:185
        var next = std.ArrayList(PollTask){};
// zbr:IDE/ZebraIDE.zbr:186
        for (self._tasks.items) |task| {
// zbr:IDE/ZebraIDE.zbr:187
            var keep: bool = false;
// zbr:IDE/ZebraIDE.zbr:188
            switch (task) {
                .debug_task => |dt| {
...
// zbr:IDE/ZebraIDE.zbr:193
            if (keep) {
                next.append(_allocator, task) catch @panic("OOM");
            }
        }
// zbr:IDE/ZebraIDE.zbr:195
    ...
    pub fn cancelDebug(self: *PollRegistry) void {
...
// zbr:IDE/ZebraIDE.zbr:206
        self._tasks = next;
    }

    pub fn cancelBuilds(self: *PollRegistry) void {
...
// zbr:IDE/ZebraIDE.zbr:217
    ...
    pub fn init() *PollRegistry {
        const self = _allocator.create(PollRegistry) catch @panic("OOM");
        self._type_tag = _ttag_PollRegistry;
        self._tasks = std.ArrayList(PollTask){};
        return self;
    }

};
const _ttag_PollRegistry: u64 = _zbr_hash("PollRegistry");
const _reflect_PollRegistry_name: []const u8 = "PollRegistry";
const _reflect_PollRegistry_fields: []const []const u8 = &.{"_tasks"};
const _reflect_PollRegistry_field_types: []const []const u8 = &.{"List(PollTask)"};

pub fn renderToolbar(g: Gui, state: *IDEState, editor: CodeEditor, registry: *PollRegistry) void {
// zbr:IDE/ZebraIDE.zbr:224
    if (g.button("Open")) {
// zbr:IDE/ZebraIDE.zbr:225
        if ((blk_fex: { std.fs.cwd().access(state.filepath, .{}) catch break :blk_fex false; break :blk_fex true; })) {
            editor.setText((std.fs.cwd().readFileAlloc(_allocator, state.filepath, std.math.maxInt(usize)) catch @panic("File.read error")));
// zbr:IDE/ZebraIDE.zbr:227
            state.diags = std.ArrayList(*IDEDiagnostic){};
// zbr:IDE/ZebraIDE.zbr:228
            state.output = "";
// zbr:IDE/ZebraIDE.zbr:229
            state.dirty = false;
        }
    }
    g.sameLine();
// zbr:IDE/ZebraIDE.zbr:231
    if (g.button("Save")) {
// zbr:IDE/ZebraIDE.zbr:232
        const src = editor.getText();
        (std.fs.cwd().writeFile(.{ .sub_path = state.filepath, .data = src }) catch @panic("File.write error"));
// zbr:IDE/ZebraIDE.zbr:234
        state.dirty = false;
    }
    g.sameLine();
// zbr:IDE/ZebraIDE.zbr:236
    if (g.button("Check  (F5)")) {
        doCheck(state, editor);
    }
    g.sameLine();
// zbr:IDE/ZebraIDE.zbr:239
    if (g.button("Run  (F9)")) {
        doRun(state, editor);
    }
    g.sameLine();
// zbr:IDE/ZebraIDE.zbr:243
    var debugRunning: bool = false;
// zbr:IDE/ZebraIDE.zbr:244
    if ((state.debugProc != null)) {
// zbr:IDE/ZebraIDE.zbr:245
        debugRunning = state.debugProc.?.isRunning();
    }
// zbr:IDE/ZebraIDE.zbr:246
    if (debugRunning) {
// zbr:IDE/ZebraIDE.zbr:247
        if (g.button("Stop Debug")) {
            registry.cancelDebug();
        }
        g.sameLine();
        g.textColored(0.2, 0.9, 0.2, 1.0, (std.fmt.allocPrint(_allocator, "DAP :{}", .{state.debugPort}) catch @panic("OOM")));
    } else {
// zbr:IDE/ZebraIDE.zbr:252
        if ((state.debugProc != null)) {
// zbr:IDE/ZebraIDE.zbr:253
            state.debugProc = null;
        }
// zbr:IDE/ZebraIDE.zbr:254
        if (g.button("Debug  (F10)")) {
            doDebug(state, editor, registry);
        }
    }
    g.sameLine();
// zbr:IDE/ZebraIDE.zbr:258
    if (state.buildRunning) {
// zbr:IDE/ZebraIDE.zbr:259
...
// zbr:IDE/ZebraIDE.zbr:264
        if (g.button("Build  (F7)")) {
            doBuild(state, registry);
        }
    }
    g.sameLine();
// zbr:IDE/ZebraIDE.zbr:267
    state.filepath = g.input("##filepath", state.filepath);
// zbr:IDE/ZebraIDE.zbr:268
    if (state.dirty) {
        g.sameLine();
        g.text("*");
    }
    g.sameLine();
    g.text((std.fmt.allocPrint(_allocator, "  Ln {}  Col {}", .{editor.getCursorLine(), editor.getCursorCol()}) catch @panic("OOM")));
}

pub fn renderDiags(gc: Gui, state: *IDEState, editor: CodeEditor) void {
// zbr:IDE/ZebraIDE.zbr:275
    var errorCount: i64 = 0;
// zbr:IDE/ZebraIDE.zbr:276
    for (state.diags.items) |d| {
// zbr:IDE/ZebraIDE.zbr:277
        if (d.is_error) {
// zbr:IDE/ZebraIDE.zbr:278
            errorCount = (errorCount + 1);
        }
    }
    gc.text((std.fmt.allocPrint(_allocator, "Errors: {} / {}", .{errorCount, state.diagCount()}) catch @panic("OOM")));
    gc.separator();
// zbr:IDE/ZebraIDE.zbr:281
    if (gc.beginTable("##diagtbl", 3)) {
        gc.tableSetupColumn("T");
        gc.tableSetupColumn("Ln:Col");
        gc.tableSetupColumn("Message");
        gc.tableHeadersRow();
// zbr:IDE/ZebraIDE.zbr:286
        for (state.diags.items) |d| {
            gc.tableNextRow();
            gc.tableNextColumn();
// zbr:IDE/ZebraIDE.zbr:289
            if (d.is_error) {
...
pub fn renderFileBrowser(gc: Gui, state: *IDEState, editor: CodeEditor) void {
// zbr:IDE/ZebraIDE.zbr:301
    if (gc.button("Refresh")) {
// zbr:IDE/ZebraIDE.zbr:302
        state.files = (blk_dw: {
            const _dw_root = ".";
    ...
    gc.separator();
// zbr:IDE/ZebraIDE.zbr:304
    for (state.files.items) |f| {
// zbr:IDE/ZebraIDE.zbr:305
        if (std.mem.endsWith(u8, f, ".zbr")) {
// zbr:IDE/ZebraIDE.zbr:306
            if (gc.selectable(f)) {
// zbr:IDE/ZebraIDE.zbr:307
                state.filepath = f;
// zbr:IDE/ZebraIDE.zbr:308
                if ((blk_fex: { std.fs.cwd().access(f, .{}) catch break :blk_fex false; break :blk_fex true; })) {
                    editor.setText((std.fs.cwd().readFileAlloc(_allocator, f, std.math.maxInt(usize)) catch @panic("File.read error")));
// zbr:IDE/ZebraIDE.zbr:310
                    state.diags = std.ArrayList(*IDEDiagnostic){};
// zbr:IDE/ZebraIDE.zbr:311
                    state.output = "";
// zbr:IDE/ZebraIDE.zbr:312
                    state.dirty = false;
                }
            }
        }
...
pub fn renderBuildPanel(gc: Gui, state: *IDEState, registry: *PollRegistry) void {
    _ = registry;
    gc.text("Build file:");
    gc.sameLine();
// zbr:IDE/ZebraIDE.zbr:317
    state.buildFile = gc.input("##buildfile", state.buildFile);
// zbr:IDE/ZebraIDE.zbr:318
    if (gc.button("List Targets")) {
        refreshBuildTargets(state);
    }
// zbr:IDE/ZebraIDE.zbr:320
    if (_zebra_gt(@as(i64, @intCast(state.buildTargets.len)), 0)) {
        gc.separator();
        gc.text("Targets:");
// zbr:IDE/ZebraIDE.zbr:323
        for (state.buildTargets.items) |t| {
            gc.text(_str_concat("  ", t, _allocator));
        }
    }
}

pub fn renderBody(g: Gui, state: *IDEState, editor: CodeEditor, registry: *PollRegistry) void {
    _ = registry;
    editor.setErrorMarkers(state.diags);
    g.childWindow("##browser", 180, 520, struct { fn call(gc: Gui) void {
        renderFileBrowser(gc, state, editor);
     } }.call);
    g.sameLine();
    editor.render(g, "##code", 560, 520);
    g.sameLine();
    g.childWindow("##rightpanel", 0, 520, struct { fn call(gc: Gui) void {
        gc.text("Diagnostics");
        gc.separator();
...
pub fn renderOutput(g: Gui, state: *IDEState, outputEditor: CodeEditor) void {
    g.text("Output:");
    outputEditor.setText(state.output);
    outputEditor.render(g, "##output", 990, 80);
// zbr:IDE/ZebraIDE.zbr:348
    if (!std.mem.eql(u8, state.buildOutput, "")) {
        g.text("Build output:");
        g.text(state.buildOutput);
    }
}

pub fn doCheck(state: *IDEState, editor: CodeEditor) void {
// zbr:IDE/ZebraIDE.zbr:353
    const src = editor.getText();
// zbr:IDE/ZebraIDE.zbr:354
    const tmpFile: []const u8 = "_ide_tmp_check.zbr";
    (std.fs.cwd().writeFile(.{ .sub_path = tmpFile, .data = src }) catch @panic("File.write error"));
// zbr:IDE/ZebraIDE.zbr:356
    state.diags = CompilerBridge.check(tmpFile);
// zbr:IDE/ZebraIDE.zbr:357
    state.lastCheck = src;
// zbr:IDE/ZebraIDE.zbr:358
    state.dirty = true;
}

pub fn doRun(state: *IDEState, editor: CodeEditor) void {
// zbr:IDE/ZebraIDE.zbr:361
    state.buildOutput = "";
// zbr:IDE/ZebraIDE.zbr:362
    const src = editor.getText();
    (std.fs.cwd().writeFile(.{ .sub_path = state.filepath, .data = src }) catch @panic("File.write error"));
// zbr:IDE/ZebraIDE.zbr:364
    state.dirty = false;
// zbr:IDE/ZebraIDE.zbr:365
    state.output = CompilerBridge.runFile(state.filepath);
}

pub fn doDebug(state: *IDEState, editor: CodeEditor, registry: *PollRegistry) void {
// zbr:IDE/ZebraIDE.zbr:368
    if ((state.debugProc != null)) {
// zbr:IDE/ZebraIDE.zbr:369
        if (state.debugProc.?.isRunning()) {
// zbr:IDE/ZebraIDE.zbr:370
            return;
        }
    }
// zbr:IDE/ZebraIDE.zbr:371
    const src = editor.getText();
    (std.fs.cwd().writeFile(.{ .sub_path = state.filepath, .data = src }) catch @panic("File.write error"));
// zbr:IDE/ZebraIDE.zbr:373
    state.dirty = false;
// zbr:IDE/ZebraIDE.zbr:374
    state.debugPort = 7777;
// zbr:IDE/ZebraIDE.zbr:375
    var argv = std.ArrayList([]const u8){};
    argv.append(_allocator, "zebra") catch @panic("OOM");
    argv.append(_allocator, "debug") catch @panic("OOM");
    argv.append(_allocator, "--listen") catch @panic("OOM");
    argv.append(_allocator, (std.fmt.allocPrint(_allocator, "{}", .{state.debugPort}) catch unreachable)) catch @panic("OOM");
    argv.append(_allocator, state.filepath) catch @panic("OOM");
// zbr:IDE/ZebraIDE.zbr:381
    const proc = _sys_spawn(argv);
// zbr:IDE/ZebraIDE.zbr:382
    state.debugProc = proc;
// zbr:IDE/ZebraIDE.zbr:383
    state.output = _str_concat(_str_concat("Debug proxy listening on 127.0.0.1:", (std.fmt.allocPrint(_allocator, "{}", .{state.debugPort}) catch unreachable), _allocator), " — connect with CodeLLDB or VS Code DAP client.", _allocator);
    registry.register(PollTask{ .debug_task = DebugTask.new(state, proc) });
}

pub fn doBuild(state: *IDEState, registry: *PollRegistry) void {
// zbr:IDE/ZebraIDE.zbr:387
    if (state.buildRunning) {
// zbr:IDE/ZebraIDE.zbr:388
        return;
    }
// zbr:IDE/ZebraIDE.zbr:389
    const tmpFile: []const u8 = ".ide_build.tmp";
    (std.fs.cwd().writeFile(.{ .sub_path = tmpFile, .data = "" }) catch @panic("File.write error"));
// zbr:IDE/ZebraIDE.zbr:391
    state.buildOutput = "";
// zbr:IDE/ZebraIDE.zbr:392
    state.buildRunning = true;
// zbr:IDE/ZebraIDE.zbr:393
    var cmd: []const u8 = "zebra build";
// zbr:IDE/ZebraIDE.zbr:394
    if (!std.mem.eql(u8, state.buildFile, "build.zbr")) {
// zbr:IDE/ZebraIDE.zbr:395
        cmd = _str_concat(_str_concat(cmd, " --build-file=", _allocator), state.buildFile, _allocator);
    }
// zbr:IDE/ZebraIDE.zbr:396
    var argv = std.ArrayList([]const u8){};
    argv.append(_allocator, "cmd") catch @panic("OOM");
    argv.append(_allocator, "/C") catch @panic("OOM");
    argv.append(_allocator, _str_concat(_str_concat(_str_concat(cmd, " > ", _allocator), tmpFile, _allocator), " 2>&1", _allocator)) catch @panic("OOM");
// zbr:IDE/ZebraIDE.zbr:400
    const proc = _sys_spawn(argv);
    registry.register(PollTask{ .build_task = BuildTask.new(state, proc, tmpFile) });
}

pub fn refreshBuildTargets(state: *IDEState) void {
// zbr:IDE/ZebraIDE.zbr:404
    var argv = std.ArrayList([]const u8){};
    argv.append(_allocator, "zebra") catch @panic("OOM");
    argv.append(_allocator, "build") catch @panic("OOM");
    argv.append(_allocator, "--list-targets") catch @panic("OOM");
// zbr:IDE/ZebraIDE.zbr:408
    const out = _sys_run(argv);
// zbr:IDE/ZebraIDE.zbr:409
    if ((out.exit_code == 0)) {
// zbr:IDE/ZebraIDE.zbr:410
        state.buildTargets = parseBuildTargetNames(out.stdout);
    } else {
// zbr:IDE/ZebraIDE.zbr:412
        state.buildTargets = std.ArrayList([]const u8){};
    }
}

pub fn parseBuildTargetNames(json: []const u8) std.ArrayList([]const u8) {
// zbr:IDE/ZebraIDE.zbr:416
    var names = std.ArrayList([]const u8){};
// zbr:IDE/ZebraIDE.zbr:417
    const marker: []const u8 = "\"name\":\"";
// zbr:IDE/ZebraIDE.zbr:418
    var pos: i64 = 0;
// zbr:IDE/ZebraIDE.zbr:419
    while (_zebra_lt(pos, @as(i64, @intCast(json.len)))) {
// zbr:IDE/ZebraIDE.zbr:420
        const idx = blk: { const _idx = std.mem.indexOf(u8, json, marker); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:421
        if (_zebra_lt(idx, 0)) {
            break;
        }
// zbr:IDE/ZebraIDE.zbr:423
        const nameStart = (idx + @as(i64, @intCast(marker.len)));
// zbr:IDE/ZebraIDE.zbr:424
        const endIdx = blk: { const _idx = std.mem.indexOf(u8, json, "\""); break :blk if (_idx) |_i| @as(i64, @intCast(_i)) else null; };
// zbr:IDE/ZebraIDE.zbr:425
        if (_zebra_lt(endIdx, 0)) {
            break;
        }
        names.append(_allocator, json[@intCast(nameStart)..@intCast(endIdx)]) catch @panic("OOM");
// zbr:IDE/ZebraIDE.zbr:428
        pos = (endIdx + 1);
    }
// zbr:IDE/ZebraIDE.zbr:429
    return names;
}

pub fn main() void {
// zbr:IDE/ZebraIDE.zbr:432
    const frame = (struct {
        state: *IDEState,
...
// zbr:IDE/ZebraIDE.zbr:439
        if ((!self.inited)) {
// zbr:IDE/ZebraIDE.zbr:440
            if ((blk_fex: { std.fs.cwd().access(self.state.filepath, .{}) catch break :blk_fex false; break :blk_fex true; })) {
// zbr:IDE/ZebraIDE.zbr:441
...
// zbr:IDE/ZebraIDE.zbr:446
            self.inited = true;
        }
        self.registry.pollAll();
        renderToolbar(g, self.state, self.editor, self.registry);
        g.separator();
        renderBody(g, self.state, self.editor, self.registry);
        g.separator();
        renderOutput(g, self.state, self.outputEditor);
     } }{ .state = state, .registry = registry, .editor = editor, .outputEditor = outputEditor, .inited = inited, });
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_IDEDiagnostic) return _reflect_IDEDiagnostic_name;
    if (tag == _ttag_CompilerBridge) return _reflect_CompilerBridge_name;
    if (tag == _ttag_IDEState) return _reflect_IDEState_name;
    if (tag == _ttag_DebugTask) return _reflect_DebugTask_name;
    if (tag == _ttag_BuildTask) return _reflect_BuildTask_name;
    if (tag == _ttag_PollRegistry) return _reflect_PollRegistry_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_IDEDiagnostic) return .{ .items = _reflect_IDEDiagnostic_fields };
    if (tag == _ttag_CompilerBridge) return .{ .items = _reflect_CompilerBridge_fields };
    if (tag == _ttag_IDEState) return .{ .items = _reflect_IDEState_fields };
    if (tag == _ttag_DebugTask) return .{ .items = _reflect_DebugTask_fields };
    if (tag == _ttag_BuildTask) return .{ .items = _reflect_BuildTask_fields };
    if (tag == _ttag_PollRegistry) return .{ .items = _reflect_PollRegistry_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_IDEDiagnostic) return .{ .items = _reflect_IDEDiagnostic_field_types };
    if (tag == _ttag_CompilerBridge) return .{ .items = _reflect_CompilerBridge_field_types };
    if (tag == _ttag_IDEState) return .{ .items = _reflect_IDEState_field_types };
    if (tag == _ttag_DebugTask) return .{ .items = _reflect_DebugTask_field_types };
    if (tag == _ttag_BuildTask) return .{ .items = _reflect_BuildTask_field_types };
    if (tag == _ttag_PollRegistry) return .{ .items = _reflect_PollRegistry_field_types };
    return .{ .items = &.{} };
}
