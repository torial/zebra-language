...
pub fn init() Counter {
// zbr:examples/counter.zbr:16
    return Counter{ .count = 0 };
}

pub fn update(model: Counter, msg: Msg) Counter {
// zbr:examples/counter.zbr:19
    switch (msg) {
        .inc => {
// zbr:examples/counter.zbr:20
            return Counter{ .count = (model.count + 1) };
        },
        .dec => {
// zbr:examples/counter.zbr:21
            return Counter{ .count = (model.count - 1) };
        },
        .reset => {
// zbr:examples/counter.zbr:22
            return Counter{ .count = 0 };
        },
    }
}

pub fn view(g: GuiContext, model: Counter) void {
// zbr:examples/counter.zbr:25
    g.text(_str_concat("Count: ", (std.fmt.allocPrint(_allocator, "{}", .{model.count}) catch unreachable), _allocator));
// zbr:examples/counter.zbr:26
    g.separator();
// zbr:examples/counter.zbr:27
    if (g.button("+")) {
// zbr:examples/counter.zbr:28
        g.send(Msg.inc);
    }
// zbr:examples/counter.zbr:29
    g.sameLine();
// zbr:examples/counter.zbr:30
    if (g.button("-")) {
// zbr:examples/counter.zbr:31
        g.send(Msg.dec);
    }
// zbr:examples/counter.zbr:32
    g.sameLine();
// zbr:examples/counter.zbr:33
    if (g.button("Reset")) {
// zbr:examples/counter.zbr:34
        g.send(Msg.reset);
    }
}
...
// zbr:examples/counter.zbr:37
    _gui_mvu_run("Counter", 400, 200, init, update, view);
}
