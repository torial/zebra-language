...
| [docs/FINDINGS.md](docs/FINDINGS.md) | **what do we already know?** | you measured something, so nobody re-derives it |
| [NEXT_STEPS_to_0.9.md](NEXT_STEPS_to_0.9.md) | **what is next before public release?** | work that gates 0.9 |
| [NEXT_STEPS_to_1.0.md](NEXT_STEPS_to_1.0.md) | **what is next before the freeze?** | work that gates 1.0 |
| [NEXT_STEPS_post_1.0.md](NEXT_STEPS_post_1.0.md) | **what is deliberately deferred?** | something is parked past 1.0 ON PURPOSE |
...
`SELFHOST_JOURNAL.md` and `CHANGELOG.md`; cross-project concepts in the wiki.**
