...
pub const Holder = struct {
    ...
    pub fn init(pt: Point) *Holder {
        const self = _allocator.create(Holder) catch @panic("OOM");
        self._type_tag = _ttag_Holder;
// zbr:test/ref_struct_test.zbr:13
...
const _ttag_Holder: u64 = 458631599;
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/ref_struct_test.zbr:17
        const pt = Point{ .x = 3, .y = 4 };
// zbr:test/ref_struct_test.zbr:18
        const h = Holder.init(pt);
// zbr:test/ref_struct_test.zbr:19
        std.debug.assert((h.p.*.x == 3));
// zbr:test/ref_struct_test.zbr:20
        std.debug.assert((h.p.*.y == 4));
// zbr:test/ref_struct_test.zbr:21
        std.debug.print("{s}\n", .{"ref_struct_test OK"});
    }
