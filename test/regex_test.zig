...
pub const Main = struct {
    ...
    pub fn main() void {
        var re1: Regex = _regex_compile("hello", "");
        std.debug.print("{}\n", .{re1.match("hello")});
        std.debug.print("{}\n", .{re1.match("world")});
        var re2: Regex = _regex_compile("h.*o", "");
        std.debug.print("{}\n", .{re2.match("hello")});
        std.debug.print("{}\n", .{re2.match("ho")});
        std.debug.print("{}\n", .{re2.match("hi")});
        var re3: Regex = _regex_compile("\\d+", "");
        std.debug.print("{}\n", .{re3.match("42")});
        std.debug.print("{}\n", .{re3.match("abc")});
        var re4: Regex = _regex_compile("cat|dog", "");
        std.debug.print("{}\n", .{re4.match("cat")});
        std.debug.print("{}\n", .{re4.match("dog")});
        std.debug.print("{}\n", .{re4.match("fish")});
        var re5: Regex = _regex_compile("\\d+", "");
        std.debug.print("{}\n", .{re5.find("abc 42 def")});
        std.debug.print("{}\n", .{re5.find("no digits")});
        var re6: Regex = _regex_compile("\\d+\\.\\d+", "");
        std.debug.print("{}\n", .{re6.match("3.14")});
        std.debug.print("{}\n", .{re6.match("3")});
