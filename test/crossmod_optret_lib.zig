...
// Source: test\crossmod_optret_lib.zbr
...
pub fn _initAllocator(a: std.mem.Allocator) void {
    _allocator = a;
    @import("crossmod_optret_geom.zig")._initAllocator(a);
}
pub fn _initIo(io: std.Io) void {
    _io = io;
    @import("crossmod_optret_geom.zig")._initIo(io);
}
...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("crossmod_optret_geom.zig")._zbr_error_msg().len > 0) return @import("crossmod_optret_geom.zig")._zbr_error_msg();
    return "";
}
...
pub const World = struct {
    _type_tag: u64 = _ttag_World,
    w: i64 = undefined,
    pub fn init(width: i64) *World {
        const self = _allocator.create(World) catch @panic("OOM");
        self._type_tag = _ttag_World;
// zbr:test\crossmod_optret_lib.zbr:6
        self.w = width;
        return self;
    }

    pub fn getSize(self: *World, found: bool) ?*Vec3 {
        _ = self;
// zbr:test\crossmod_optret_lib.zbr:10
        if (found) {
// zbr:test\crossmod_optret_lib.zbr:11
            return Vec3.init(1, 2, 3);
        }
// zbr:test\crossmod_optret_lib.zbr:12
        return null;
    }

};

const _ttag_World: u64 = 3714116915;
const _reflect_World_name: []const u8 = "World";
const _reflect_World_fields: []const []const u8 = &.{"w"};
const _reflect_World_field_types: []const []const u8 = &.{"int"};
