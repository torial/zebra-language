...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("tc_smoke_types.zig")._zbr_error_msg().len > 0) return @import("tc_smoke_types.zig")._zbr_error_msg();
    return "";
}
...
// zbr:test/tc_smoke_main.zbr:10
    const _try_err_1: ?anyerror = null;
    _try_blk_1: {
// zbr:test/tc_smoke_main.zbr:6
        const opt = TcType{ .optional = _box_2: { const _bp_2 = _allocator.create(tc_smoke_types.TcType) catch @panic("OOM"); _bp_2.* = TcType{ .str_ = {} }; break :_box_2 _bp_2; } };
// zbr:test/tc_smoke_main.zbr:7
        std.debug.assert(std.mem.eql(u8, TcTypes.describe(opt), "?str"));
// zbr:test/tc_smoke_main.zbr:8
        const nested = TcType{ .optional = _box_3: { const _bp_3 = _allocator.create(tc_smoke_types.TcType) catch @panic("OOM"); _bp_3.* = TcType{ .optional = _box_4: { const _bp_4 = _allocator.create(tc_smoke_types.TcType) catch @panic("OOM"); _bp_4.* = TcType{ .int_ = {} }; break :_box_4 _bp_4; } }; break :_box_3 _bp_3; } };
...
// zbr:test/tc_smoke_main.zbr:18
        testOptionalTypes();
// zbr:test/tc_smoke_main.zbr:19
