...
// Source: C:/Projects/zebra-language/test/string_methods_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        words.append(_allocator, "one") catch @panic("OOM");
        words.append(_allocator, "two") catch @panic("OOM");
        words.append(_allocator, "three") catch @panic("OOM");
