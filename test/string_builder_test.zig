...
// Source: C:/Projects/zebra-language/test/string_builder_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        std.debug.print("{any}\n", .{(sb.toOwnedSlice(_allocator) catch "")});
        std.debug.print("{any}\n", .{sb.items.len});
        ...
        std.debug.print("{any}\n", .{(sb2.toOwnedSlice(_allocator) catch "")});
        ...
        std.debug.print("{any}\n", .{(sb3.toOwnedSlice(_allocator) catch "")});
    }
