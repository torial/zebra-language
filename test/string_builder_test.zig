...
// zbr:test/string_builder_test.zbr:9
        std.debug.print("{s}\n", .{sb.toOwnedSlice(_allocator) catch @panic("OOM")});
...
// zbr:test/string_builder_test.zbr:20
        words.append(_allocator, _intern("one")) catch unreachable;
// zbr:test/string_builder_test.zbr:21
        words.append(_allocator, _intern("two")) catch unreachable;
// zbr:test/string_builder_test.zbr:22
        words.append(_allocator, _intern("three")) catch unreachable;
...
// zbr:test/string_builder_test.zbr:30
        std.debug.print("{s}\n", .{sb2.toOwnedSlice(_allocator) catch @panic("OOM")});
...
// zbr:test/string_builder_test.zbr:36
        std.debug.print("{s}\n", .{sb3.toOwnedSlice(_allocator) catch @panic("OOM")});
    }
