...
// Source: test/visibility_test.zbr
...
pub const BankAccount = struct {
    _type_tag: u64 = _ttag_BankAccount,
    balance: i64 = undefined,
    owner: []const u8 = undefined,
    pub fn init(balance: i64, owner: []const u8) *BankAccount {
        const self = _allocator.create(BankAccount) catch @panic("OOM");
        self._type_tag = _ttag_BankAccount;
// zbr:test/visibility_test.zbr:6
        self.balance = balance;
// zbr:test/visibility_test.zbr:7
        self.owner = _intern(owner);
        return self;
    }

    pub fn deposit(self: *BankAccount, n: i64) void {
// zbr:test/visibility_test.zbr:10
        self.balance = (self.balance + n);
    }

    pub fn getBalance(self: *BankAccount) i64 {
// zbr:test/visibility_test.zbr:13
        return self.balance;
    }

    pub fn transfer(self: *BankAccount, other: *BankAccount, n: i64) void {
// zbr:test/visibility_test.zbr:16
        self.balance = (self.balance - n);
// zbr:test/visibility_test.zbr:17
        other.balance = (other.balance + n);
    }

};

const _ttag_BankAccount: u64 = 572770034;
const _reflect_BankAccount_name: []const u8 = "BankAccount";
const _reflect_BankAccount_fields: []const []const u8 = &.{"balance", "owner"};
const _reflect_BankAccount_field_types: []const []const u8 = &.{"int", "str"};

pub const Counter = struct {
    _type_tag: u64 = _ttag_Counter,
    count: i64 = undefined,
    pub fn init() *Counter {
        const self = _allocator.create(Counter) catch @panic("OOM");
        self._type_tag = _ttag_Counter;
// zbr:test/visibility_test.zbr:23
        self.count = 0;
        return self;
    }

    pub fn inc(self: *Counter) void {
// zbr:test/visibility_test.zbr:26
        self.count = (self.count + 1);
    }

    pub fn value(self: *Counter) i64 {
// zbr:test/visibility_test.zbr:29
        return self.count;
    }
...
pub fn main() void {
// zbr:test/visibility_test.zbr:32
    const acc = BankAccount.init(100, "Alice");
// zbr:test/visibility_test.zbr:33
    acc.deposit(50);
// zbr:test/visibility_test.zbr:34
    std.debug.print("{}\n", .{acc.getBalance()});
// zbr:test/visibility_test.zbr:35
    std.debug.print("{s}\n", .{acc.owner});
// zbr:test/visibility_test.zbr:37
    const a = BankAccount.init(200, "Bob");
// zbr:test/visibility_test.zbr:38
    const b = BankAccount.init(0, "Carol");
// zbr:test/visibility_test.zbr:39
    a.transfer(b, 75);
// zbr:test/visibility_test.zbr:40
    std.debug.print("{}\n", .{a.getBalance()});
// zbr:test/visibility_test.zbr:41
    std.debug.print("{}\n", .{b.getBalance()});
// zbr:test/visibility_test.zbr:43
    const c = Counter.init();
// zbr:test/visibility_test.zbr:44
    c.inc();
// zbr:test/visibility_test.zbr:45
    c.inc();
// zbr:test/visibility_test.zbr:46
    c.inc();
// zbr:test/visibility_test.zbr:47
    std.debug.print("{}\n", .{c.value()});
}
