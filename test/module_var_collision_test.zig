...
// Source: test/module_var_collision_test.zbr
...
pub var _zbr_mv_total: i64 = 0;
pub const _zbr_mv_count: i64 = 100;
pub fn addLocal() void {
// zbr:test/module_var_collision_test.zbr:14
    const total: i64 = 5;
    std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "local={}", .{total}) catch @panic("OOM"))});
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
    addLocal();
// zbr:test/module_var_collision_test.zbr:19
    _zbr_mv_total = 7;
    std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "module={} count={}", .{_zbr_mv_total, _zbr_mv_count}) catch @panic("OOM"))});
// zbr:test/module_var_collision_test.zbr:21
    if ((_zbr_mv_total == 7)) {
        std.debug.print("{s}\n", .{"module_var_collision_test: OK"});
    }
}
