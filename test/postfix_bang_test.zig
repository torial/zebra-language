...
// Source: test/postfix_bang_test.zbr
...
pub fn maybeInt(x: i64) ?i64 {
// zbr:test/postfix_bang_test.zbr:4
    if (_zebra_gt(x, 0)) {
// zbr:test/postfix_bang_test.zbr:5
        return x;
    }
// zbr:test/postfix_bang_test.zbr:6
    return null;
}
...
// zbr:test/postfix_bang_test.zbr:12
            _self.count = start;
        return _self;
    }

    pub fn doubled(self: *Counter) i64 {
// zbr:test/postfix_bang_test.zbr:15
        return (self.count * 2);
    }
...
pub fn maybeCounter(x: i64) ?*Counter {
// zbr:test/postfix_bang_test.zbr:18
    if (_zebra_gt(x, 0)) {
// zbr:test/postfix_bang_test.zbr:19
        return Counter.init(x);
    }
// zbr:test/postfix_bang_test.zbr:20
    return null;
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/postfix_bang_test.zbr:24
    const a: ?i64 = 42;
// zbr:test/postfix_bang_test.zbr:25
    const v1: i64 = a.?;
    std.debug.print("{}\n", .{v1});
// zbr:test/postfix_bang_test.zbr:29
    const v2: i64 = maybeInt(7).?;
    std.debug.print("{}\n", .{v2});
// zbr:test/postfix_bang_test.zbr:33
    const v3: i64 = maybeCounter(5).?.doubled();
    std.debug.print("{}\n", .{v3});
// zbr:test/postfix_bang_test.zbr:37
    const b: ?i64 = 99;
// zbr:test/postfix_bang_test.zbr:38
    const v4: i64 = b.?;
    std.debug.print("{}\n", .{v4});
    std.debug.print("{s}\n", .{"postfix_bang_test PASS"});
}
