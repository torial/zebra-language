...
pub const Account = struct {
    ...
    pub fn init(starting: i64) *Account {
        const self = _allocator.create(Account) catch @panic("OOM");
        self._type_tag = _ttag_Account;
...
const _ttag_Account: u64 = 1509466876;
...
// zbr:test/contract_invariant.zbr:40
    const a = Account.init(10);
// zbr:test/contract_invariant.zbr:41
    a.deposit(5);
// zbr:test/contract_invariant.zbr:42
    a.withdraw(3);
// zbr:test/contract_invariant.zbr:43
    var g = Gauge.init(50, 100);
// zbr:test/contract_invariant.zbr:44
    g.set(75);
// zbr:test/contract_invariant.zbr:45
    std.debug.print("{s}\n", .{"ok"});
}
