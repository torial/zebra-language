...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("MathUtils.zig")._zbr_error_msg().len > 0) return @import("MathUtils.zig")._zbr_error_msg();
    if (@import("StringHelper.zig")._zbr_error_msg().len > 0) return @import("StringHelper.zig")._zbr_error_msg();
    return "";
}
