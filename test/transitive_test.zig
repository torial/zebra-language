...
// Source: C:/Projects/zebra-language/test/transitive_test.zbr
...
fn _zbr_error_msg() []const u8 {
    ...
    if (@import("MathUtils.zig")._error_ctx.message.len > 0) return @import("MathUtils.zig")._error_ctx.message;
    if (@import("StringHelper.zig")._error_ctx.message.len > 0) return @import("StringHelper.zig")._error_ctx.message;
    return "";
}
