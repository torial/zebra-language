...
// zbr:test/tc_infer_test.zbr:28
        const opt_resp_sym = TcSymbol.init("maybe_resp", TcSymKind.local, TcType{ .optional = blk_box_1: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .http_response = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_1 _bp; } });
// zbr:test/tc_infer_test.zbr:29
        std.debug.assert(sc.define("maybe_resp", opt_resp_sym));
// zbr:test/tc_infer_test.zbr:32
        var inf = TcInfer.init(sc);
...
// zbr:test/tc_infer_test.zbr:41
        std.debug.assert(TcTypes.eql(nil_t, TcType{ .optional = blk_box_2: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .void_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_2 _bp; } }));
...
// zbr:test/tc_infer_test.zbr:52
        const t_status = inf.inferExpr(TcExpr{ .member = blk_box_3: { const _bv: std.meta.Child(@FieldType(TcExpr, "member")) = mem_status; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_3 _bp; } });
...
// zbr:test/tc_infer_test.zbr:55
        const t_text = inf.inferExpr(TcExpr{ .member = blk_box_4: { const _bv: std.meta.Child(@FieldType(TcExpr, "member")) = mem_text; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_4 _bp; } });
...
// zbr:test/tc_infer_test.zbr:62
        const t_get = inf.inferExpr(TcExpr{ .member = blk_box_5: { const _bv: std.meta.Child(@FieldType(TcExpr, "member")) = mem_get; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_5 _bp; } });
...
// zbr:test/tc_infer_test.zbr:69
        ...
        http_args.append(_allocator, TcExpr{ .string_lit = {} }) catch @panic("OOM");
// zbr:test/tc_infer_test.zbr:71
        const http_call = TcExprCall.init(TcExpr{ .member = blk_box_6: { const _bv: std.meta.Child(@FieldType(TcExpr, "member")) = http_mem; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_6 _bp; } }, http_args);
// zbr:test/tc_infer_test.zbr:72
        const t_http_get = inf.inferExpr(TcExpr{ .call = blk_box_7: { const _bv: std.meta.Child(@FieldType(TcExpr, "call")) = http_call; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_7 _bp; } });
// zbr:test/tc_infer_test.zbr:73
        std.debug.assert(TcTypes.eql(t_http_get, TcType{ .optional = blk_box_8: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .http_response = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_8 _bp; } }));
...
// zbr:test/tc_infer_test.zbr:80
        const tm_call = TcExprCall.init(TcExpr{ .member = blk_box_9: { const _bv: std.meta.Child(@FieldType(TcExpr, "member")) = tm_mem; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_9 _bp; } }, tm_args);
// zbr:test/tc_infer_test.zbr:81
        const t_timer = inf.inferExpr(TcExpr{ .call = blk_box_10: { const _bv: std.meta.Child(@FieldType(TcExpr, "call")) = tm_call; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_10 _bp; } });
...
// zbr:test/tc_infer_test.zbr:87
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = blk_box_11: { const _bv: std.meta.Child(@FieldType(TcExpr, "binary")) = bi_arith; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_11 _bp; } }), TcType{ .int_ = {} }));
// zbr:test/tc_infer_test.zbr:88
        const bi_cmp = TcExprBinary.init("==", TcExpr{ .int_lit = {} }, TcExpr{ .int_lit = {} });
// zbr:test/tc_infer_test.zbr:89
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = blk_box_12: { const _bv: std.meta.Child(@FieldType(TcExpr, "binary")) = bi_cmp; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_12 _bp; } }), TcType{ .bool_ = {} }));
...
// zbr:test/tc_infer_test.zbr:91
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = blk_box_13: { const _bv: std.meta.Child(@FieldType(TcExpr, "binary")) = bi_str; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_13 _bp; } }), TcType{ .string_ = {} }));
...
// zbr:test/tc_infer_test.zbr:93
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = blk_box_14: { const _bv: std.meta.Child(@FieldType(TcExpr, "binary")) = bi_lt; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_14 _bp; } }), TcType{ .bool_ = {} }));
...
// zbr:test/tc_infer_test.zbr:98
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .unary = blk_box_15: { const _bv: std.meta.Child(@FieldType(TcExpr, "unary")) = un_neg; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_15 _bp; } }), TcType{ .int_ = {} }));
// zbr:test/tc_infer_test.zbr:99
        const un_not = TcExprUnary.init("not", TcExpr{ .bool_lit = {} });
// zbr:test/tc_infer_test.zbr:100
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .unary = blk_box_16: { const _bv: std.meta.Child(@FieldType(TcExpr, "unary")) = un_not; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_16 _bp; } }), TcType{ .bool_ = {} }));
...
// zbr:test/tc_infer_test.zbr:110
        const chain_expr = TcExpr{ .optional_chain = blk_box_17: { const _bv: std.meta.Child(@FieldType(TcExpr, "optional_chain")) = opt_chain; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_17 _bp; } };
...
fn _zbr_error_msg() []const u8 {
    ...
    if (@import("tc_types.zig")._error_ctx.message.len > 0) return @import("tc_types.zig")._error_ctx.message;
    if (@import("tc_scope.zig")._error_ctx.message.len > 0) return @import("tc_scope.zig")._error_ctx.message;
    if (@import("tc_infer.zig")._error_ctx.message.len > 0) return @import("tc_infer.zig")._error_ctx.message;
    if (@import("tc_stdlib.zig")._error_ctx.message.len > 0) return @import("tc_stdlib.zig")._error_ctx.message;
    return "";
}
