...
// Source: C:/Projects/zebra-language/test/result_test.zbr
...
pub const Main = struct {
    ...
    pub fn testMultipleResults() void {
        ...
        results.append(_allocator, Math.divide(10, 2)) catch @panic("OOM");
        results.append(_allocator, Math.divide(20, 4)) catch @panic("OOM");
        results.append(_allocator, Math.divide(30, 0)) catch @panic("OOM");
    ...
    pub fn testCustomError() void {
        const error_msg: []const u8 = "Invalid operation";
