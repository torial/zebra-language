...
// Source: test/bug119_once_method_test.zbr
...
pub const Counter = struct {
    ...
    count: i64 = 0,
    _once_expensive_val: ?i64 = null,
    pub fn expensive(self: *Counter) i64 {
        if (self._once_expensive_val) |_zbr_v| return _zbr_v;
        const _zbr_r = self._zbr_once_expensive_impl();
        self._once_expensive_val = _zbr_r;
        return _zbr_r;
    }

    fn _zbr_once_expensive_impl(self: *Counter) i64 {
// zbr:test/bug119_once_method_test.zbr:6
        self.count = (self.count + 1);
// zbr:test/bug119_once_method_test.zbr:7
        return 42;
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/bug119_once_method_test.zbr:11
        var c = Counter.init();
// zbr:test/bug119_once_method_test.zbr:12
        const r1 = c.expensive();
// zbr:test/bug119_once_method_test.zbr:13
        const r2 = c.expensive();
// zbr:test/bug119_once_method_test.zbr:14
        const r3 = c.expensive();
// zbr:test/bug119_once_method_test.zbr:15
        std.debug.assert((r1 == 42));
// zbr:test/bug119_once_method_test.zbr:16
        std.debug.assert((r2 == 42));
// zbr:test/bug119_once_method_test.zbr:17
        std.debug.assert((r3 == 42));
// zbr:test/bug119_once_method_test.zbr:19
        std.debug.assert((c.count == 1));
        std.debug.print("{s}\n", .{"BUG-119 @once: OK"});
    }
