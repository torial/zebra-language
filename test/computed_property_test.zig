...
// Source: C:/Projects/zebra-language/test/computed_property_test.zbr
...
pub const Rectangle = struct {
    ...
    pub fn init(w: f64, h: f64) *Rectangle {
        const _self = _allocator.create(Rectangle) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Rectangle");
            _self.width = w;
            _self.height = h;
        return _self;
    }
...
const _ttag_Rectangle: u64 = _zbr_hash("Rectangle");
