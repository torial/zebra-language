...
// Source: test/named_default_test.zbr
...
pub fn greet(name: []const u8, times: i64) void {
// zbr:test/named_default_test.zbr:2
    var i: i64 = 0;
// zbr:test/named_default_test.zbr:3
    while (_zebra_lt(i, times)) {
// zbr:test/named_default_test.zbr:4
        std.debug.print("{s}\n", .{_str_concat(_str_concat("Hello, ", name, _allocator), "!", _allocator)});
// zbr:test/named_default_test.zbr:5
        i += 1;
    }
}

pub fn add(a: i64, b: i64) i64 {
// zbr:test/named_default_test.zbr:8
    return (a + b);
}

pub fn main() void {
// zbr:test/named_default_test.zbr:11
    greet();
// zbr:test/named_default_test.zbr:12
    greet("Alice");
// zbr:test/named_default_test.zbr:13
    greet("Bob", 2);
// zbr:test/named_default_test.zbr:14
    greet("Carol", 3);
// zbr:test/named_default_test.zbr:15
    std.debug.print("{}\n", .{add(5)});
// zbr:test/named_default_test.zbr:16
    std.debug.print("{}\n", .{add(5, 20)});
// zbr:test/named_default_test.zbr:17
    std.debug.print("{}\n", .{add(3, 7)});
// zbr:test/named_default_test.zbr:18
    std.debug.print("{s}\n", .{"ok"});
}
