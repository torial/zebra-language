...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/udp_test.zbr:3
    var recv_sock: UdpSocket = _udp_bind(19878);
// zbr:test/udp_test.zbr:4
    var send_sock: UdpSocket = _udp_socket();
    send_sock.send_("127.0.0.1", 19878, "hello udp");
    send_sock.close_();
// zbr:test/udp_test.zbr:7
    const data: []const u8 = recv_sock.recv_(1024);
    recv_sock.close_();
    std.debug.print("{s}\n", .{data});
    std.debug.print("{s}\n", .{"udp_test OK"});
}
