...
// Source: test/tc_iface_generic_match_test.zbr
...
// zbr:test/tc_iface_generic_match_test.zbr:10
                _self.value = v;
            return _self;
        }
        ...
        pub fn label(self: *@This()) []const u8 {
            _ = self;
// zbr:test/tc_iface_generic_match_test.zbr:13
            return "Box";
        }
        ...
        fn _shim_Printable_label(ptr: *anyopaque) []const u8 { return @as(*@This(), @alignCast(@ptrCast(ptr))).label(); }
        const _vtable_Printable = Printable.VTable{ .label = &_shim_Printable_label, };
    };
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/tc_iface_generic_match_test.zbr:16
    var b: Printable = .{ .ptr = Box(i64).init(42), .vtable = &Box(i64)._vtable_Printable };
    std.debug.print("{s}\n", .{b.label()});
}
