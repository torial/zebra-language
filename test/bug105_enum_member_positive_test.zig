...
// Source: test/bug105_enum_member_positive_test.zbr
...
pub fn main() void {
// zbr:test/bug105_enum_member_positive_test.zbr:10
    const c: Color = Color.red;
// zbr:test/bug105_enum_member_positive_test.zbr:11
    switch (c) {
        .red => {
// zbr:test/bug105_enum_member_positive_test.zbr:13
            std.debug.print("{s}\n", .{"red"});
        },
        .green => {
// zbr:test/bug105_enum_member_positive_test.zbr:15
            std.debug.print("{s}\n", .{"green"});
        },
        .blue => {
// zbr:test/bug105_enum_member_positive_test.zbr:17
            std.debug.print("{s}\n", .{"blue"});
        },
    }
}
