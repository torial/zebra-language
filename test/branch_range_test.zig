...
// Source: C:/Projects/zebra-language/test/branch_range_test.zbr
...
pub const BranchRangeTest = struct {
    ...
    pub fn init() *BranchRangeTest {
        const self = _allocator.create(BranchRangeTest) catch @panic("OOM");
        self._type_tag = _ttag_BranchRangeTest;
        return self;
    }

};
const _ttag_BranchRangeTest: u64 = _zbr_hash("BranchRangeTest");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_BranchRangeTest) return _reflect_BranchRangeTest_name;
    if (tag == _ttag_Main) return _reflect_Main_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_BranchRangeTest) return .{ .items = _reflect_BranchRangeTest_fields };
    if (tag == _ttag_Main) return .{ .items = _reflect_Main_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_BranchRangeTest) return .{ .items = _reflect_BranchRangeTest_field_types };
