...
// Source: C:/Projects/zebra-language/test\tc_infer.zbr
...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("tc_scope.zig")._zbr_error_msg().len > 0) return @import("tc_scope.zig")._zbr_error_msg();
    if (@import("tc_stdlib.zig")._zbr_error_msg().len > 0) return @import("tc_stdlib.zig")._zbr_error_msg();
    return "";
}
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:29
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = o; self.obj = _rp; }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:30
        self.member = m;
        return self;
    }
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:38
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = c; self.callee = _rp; }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:39
        self.args = a;
        return self;
    }
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:47
        self.op = op;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:48
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = l; self.left = _rp; }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:49
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:56
        self.op = op;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:57
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:63
        self.target = t;
        return self;
    }
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:104
        self._scope = scope;
        return self;
    }
    ...
    pub fn inferExpr(self: *TcInfer, _p_e: TcExpr) TcType {
        var e = _p_e;
        while (true) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:109
            switch (e) {
                .int_lit => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:111
                    return TcType{ .int_ = {} };
                },
                .float_lit => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:112
                    return TcType{ .float_ = {} };
                },
                .bool_lit => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:113
                    return TcType{ .bool_ = {} };
                },
                .string_lit => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:114
                    return TcType{ .string_ = {} };
                },
                .char_lit => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:115
                    return TcType{ .char_ = {} };
                },
                .nil_ => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:117
                    return TcType{ .optional = _box_1: { const _bp_1 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1.* = TcType{ .void_ = {} }; break :_box_1 _bp_1; } };
                },
                .this_ => {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:119
                    return TcType{ .unknown_ = {} };
                },
                .ident => |name| {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:123
                    if (self._scope.hasSymbol(name)) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:124
                        return self._scope.lookup(name).type_;
                    }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:125
                    return TcType{ .unknown_ = {} };
                },
                .member => |m_ptr| {
                    const m = m_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:129
                    const obj_t = self.inferExpr(m.obj.*);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:130
                    return self.inferMember(obj_t, m.member);
                },
                .call => |c_ptr| {
                    const c = c_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:134
                    return self.inferCall(c);
                },
                .binary => |b_ptr| {
                    const b = b_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:138
                    const lt = self.inferExpr(b.left.*);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:139
                    const rt = self.inferExpr(b.right.*);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:140
                    return self.inferBinary(b.op, lt, rt);
                },
                .unary => |u_ptr| {
                    const u = u_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:144
                    if (std.mem.eql(u8, u.op, "not")) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:145
                        return TcType{ .bool_ = {} };
                    }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:147
                    { const _tco0 = u.operand.*; e = _tco0; }
                    continue;
                },
                .cast => |c| {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:151
                    return c.target;
                },
                .optional_chain => |inner_ptr| {
                    const inner = inner_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:155
                    const t = self.inferExpr(inner);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:156
    ...
    pub fn inferMember(self: *TcInfer, obj_t: TcType, member: []const u8) TcType {
        _ = self;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:161
        const stdlib_t = TcStdlib.memberType(obj_t, member);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:162
        if ((!TcTypes.eql(stdlib_t, TcType{ .unknown_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:163
            return stdlib_t;
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:166
        return TcType{ .unknown_ = {} };
    }

    pub fn inferCall(self: *TcInfer, c: TcExprCall) TcType {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:172
        switch (c.callee.*) {
            .member => |m_ptr| {
                const m = m_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:174
                switch (m.obj.*) {
                    .ident => |class_name| {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:176
                        const sc_t = TcStdlib.staticCall(class_name, m.member);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:177
                        if ((!TcTypes.eql(sc_t, TcType{ .unknown_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:178
                            return sc_t;
                        }
                    },
                    else => {
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:184
        switch (c.callee.*) {
            .member => |m_ptr| {
                const m = m_ptr.*;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:186
                const obj_t = self.inferExpr(m.obj.*);
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:187
                return self.inferMember(obj_t, m.member);
            },
            else => {
                // pass
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:192
        return TcType{ .unknown_ = {} };
    }

    pub fn inferBinary(self: *TcInfer, op: []const u8, lt: TcType, rt: TcType) TcType {
        _ = self;
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:197
...
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:198
            return TcType{ .bool_ = {} };
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:200
        if ((std.mem.eql(u8, op, "and") or std.mem.eql(u8, op, "or"))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:201
            return TcType{ .bool_ = {} };
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:203
        if (std.mem.eql(u8, op, "+")) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:204
            if ((TcTypes.eql(lt, TcType{ .string_ = {} }) or TcTypes.eql(rt, TcType{ .string_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:205
                return TcType{ .string_ = {} };
            }
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:207
        if ((TcTypes.isNumeric(lt) and TcTypes.isNumeric(rt))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:208
            return lt;
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:210
        if ((TcTypes.isFloatFamily(lt) or TcTypes.isFloatFamily(rt))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:211
            return TcType{ .float_ = {} };
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:213
        if ((TcTypes.eql(lt, TcType{ .unknown_ = {} }) or TcTypes.eql(rt, TcType{ .unknown_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:214
            return TcType{ .unknown_ = {} };
        }
// zbr:C:/Projects/zebra-language/test\tc_infer.zbr:215
        return TcType{ .unknown_ = {} };
    }
