...
// zbr:test/tc_infer.zbr:117
                return TcType{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .void_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .this_ => |_| {
