...
// Source: C:/Projects/zebra-language/test\MathUtils.zbr
...
// zbr:C:/Projects/zebra-language/test\MathUtils.zbr:4
        return (x * 2);
    }

    pub fn square(x: i64) i64 {
// zbr:C:/Projects/zebra-language/test\MathUtils.zbr:7
        return (x * x);
    }

    pub fn cube(x: i64) i64 {
// zbr:C:/Projects/zebra-language/test\MathUtils.zbr:10
        return ((x * x) * x);
    }

    pub fn max(a: i64, b: i64) i64 {
// zbr:C:/Projects/zebra-language/test\MathUtils.zbr:13
        if (_zebra_gt(a, b)) {
// zbr:C:/Projects/zebra-language/test\MathUtils.zbr:14
            return a;
        }
// zbr:C:/Projects/zebra-language/test\MathUtils.zbr:15
        return b;
    }

    pub fn init() *MathUtils {
        const self = _allocator.create(MathUtils) catch @panic("OOM");
