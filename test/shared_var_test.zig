...
// Source: test/shared_var_test.zbr
...
pub const Counter = struct {
    ...
    pub var count: i64 = 0;
    pub var label: []const u8 = "default";
    pub fn increment() void {
// zbr:test/shared_var_test.zbr:9
        Counter.count = (Counter.count + 1);
    }

    pub fn reset() void {
// zbr:test/shared_var_test.zbr:12
        Counter.count = 0;
    }

    pub fn getCount(self: *Counter) i64 {
        _ = self;
// zbr:test/shared_var_test.zbr:15
...
pub fn main() void {
// zbr:test/shared_var_test.zbr:18
    std.debug.assert((Counter.count == 0));
// zbr:test/shared_var_test.zbr:20
    Counter.increment();
// zbr:test/shared_var_test.zbr:21
    Counter.increment();
// zbr:test/shared_var_test.zbr:22
    Counter.increment();
// zbr:test/shared_var_test.zbr:23
    std.debug.assert((Counter.count == 3));
// zbr:test/shared_var_test.zbr:25
    Counter.reset();
// zbr:test/shared_var_test.zbr:26
    std.debug.assert((Counter.count == 0));
// zbr:test/shared_var_test.zbr:29
    const c = Counter.init();
// zbr:test/shared_var_test.zbr:30
    std.debug.assert((c.getCount() == 0));
// zbr:test/shared_var_test.zbr:33
    Counter.count = 7;
// zbr:test/shared_var_test.zbr:34
    std.debug.assert((Counter.count == 7));
// zbr:test/shared_var_test.zbr:37
    std.debug.assert(std.mem.eql(u8, Counter.label, "default"));
// zbr:test/shared_var_test.zbr:38
    Counter.label = _intern("updated");
// zbr:test/shared_var_test.zbr:39
    std.debug.assert(std.mem.eql(u8, Counter.label, "updated"));
// zbr:test/shared_var_test.zbr:41
    std.debug.print("{s}\n", .{"shared_var: OK"});
}
