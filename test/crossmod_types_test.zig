...
// Source: C:/Projects/zebra-language/test/crossmod_types_test.zbr
...
pub const Segment = struct {
    ...
    start: *crossmod_types_lib.Point,
    end_: *crossmod_types_lib.Point,
...
const _ttag_Segment: u64 = _zbr_hash("Segment");
