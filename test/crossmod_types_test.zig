...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("crossmod_types_lib.zig")._zbr_error_msg().len > 0) return @import("crossmod_types_lib.zig")._zbr_error_msg();
    return "";
}
...
pub const Segment = struct {
    ...
    pub fn init(sx: i64, sy: i64, ex: i64, ey: i64) *Segment {
        const self = _allocator.create(Segment) catch @panic("OOM");
