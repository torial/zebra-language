...
// Source: test/chained_cmp_test.zbr
...
pub fn main() void {
// zbr:test/chained_cmp_test.zbr:3
    const x: i64 = 5;
// zbr:test/chained_cmp_test.zbr:4
    if (!((_cchain_1: {const _cm0_1 = x; break :_cchain_1 (_zebra_lt(0, _cm0_1) and _zebra_lt(_cm0_1, 10)); }))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:5
    if (!((!(_cchain_2: {const _cm0_2 = x; break :_cchain_2 (_zebra_lt(0, _cm0_2) and _zebra_lt(_cm0_2, 4)); })))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:8
    const a: i64 = 3;
// zbr:test/chained_cmp_test.zbr:9
    const b: i64 = 3;
// zbr:test/chained_cmp_test.zbr:10
    const c: i64 = 7;
// zbr:test/chained_cmp_test.zbr:11
    if (!((_cchain_3: {const _cm0_3 = b; break :_cchain_3 (_zebra_le(a, _cm0_3) and _zebra_le(_cm0_3, c)); }))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:12
    if (!((!(_cchain_4: {const _cm0_4 = b; break :_cchain_4 (_zebra_le(a, _cm0_4) and _zebra_le(_cm0_4, 2)); })))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:15
    if (!((_cchain_5: {const _cm0_5 = 2; const _cm1_5 = 5; break :_cchain_5 (_zebra_lt(1, _cm0_5) and _zebra_le(_cm0_5, _cm1_5) and _zebra_lt(_cm1_5, 10)); }))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:18
    const n: i64 = 4;
// zbr:test/chained_cmp_test.zbr:19
    if (!((_cchain_6: {const _cm0_6 = 2; const _cm1_6 = n; break :_cchain_6 (_zebra_lt(1, _cm0_6) and _zebra_lt(_cm0_6, _cm1_6) and _zebra_lt(_cm1_6, 100)); }))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:22
    if (!(_zebra_lt(x, 10))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:23
    if (!((!_zebra_lt(x, 3)))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/chained_cmp_test.zbr:25
    std.debug.print("{s}\n", .{"chained_cmp tests passed"});
}
