...
pub const Pair = struct {
    ...
    pub fn init(pa: i64, pb: i64) *Pair {
        const self = _allocator.create(Pair) catch @panic("OOM");
...
pub const PairHolder = struct {
    ...
    pub fn init(pair: *Pair) *PairHolder {
        const self = _allocator.create(PairHolder) catch @panic("OOM");
...
pub const Tree = struct {
    ...
    pub fn init(v: i64) *Tree {
        const self = _allocator.create(Tree) catch @panic("OOM");
