...
// Source: C:/Projects/zebra-language/test/random_test.zbr
...
pub const RandomTest = struct {
    ...
    pub fn main() void {
        ...
        fruits.append(_allocator, "apple") catch @panic("OOM");
        fruits.append(_allocator, "banana") catch @panic("OOM");
        fruits.append(_allocator, "cherry") catch @panic("OOM");
    ...
    pub fn init() *RandomTest {
        const self = _allocator.create(RandomTest) catch @panic("OOM");
        self._type_tag = _ttag_RandomTest;
        return self;
    }

};
const _ttag_RandomTest: u64 = _zbr_hash("RandomTest");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_RandomTest) return _reflect_RandomTest_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_RandomTest) return .{ .items = _reflect_RandomTest_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_RandomTest) return .{ .items = _reflect_RandomTest_field_types };
    return .{ .items = &.{} };
}
