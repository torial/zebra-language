...
// zbr:test/random_test.zbr:29
        fruits.append(_allocator, _intern("apple")) catch unreachable;
// zbr:test/random_test.zbr:30
        fruits.append(_allocator, _intern("banana")) catch unreachable;
// zbr:test/random_test.zbr:31
        fruits.append(_allocator, _intern("cherry")) catch unreachable;
