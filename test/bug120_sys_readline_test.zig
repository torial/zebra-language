...
// Source: test/bug120_sys_readline_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/bug120_sys_readline_test.zbr:4
        const line = _sys_readline();
// zbr:test/bug120_sys_readline_test.zbr:5
        if ((line == null)) {
            std.debug.print("{s}\n", .{"BUG-120 sys.readLine: OK"});
        } else {
            std.debug.print("{s}\n", .{"BUG-120 sys.readLine: OK (with data)"});
        }
    }
