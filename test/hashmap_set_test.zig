...
// Source: test/hashmap_set_test.zbr
...
pub const Gauge = struct {
    _type_tag: u64 = _ttag_Gauge,
    value: i64 = undefined,
    pub fn init(v: i64) *Gauge {
        const self = _allocator.create(Gauge) catch @panic("OOM");
        self._type_tag = _ttag_Gauge;
// zbr:test/hashmap_set_test.zbr:7
        self.value = v;
        return self;
    }

    pub fn set(self: *Gauge, v: i64) void {
// zbr:test/hashmap_set_test.zbr:9
        self.value = v;
    }

    pub fn get(self: *Gauge) i64 {
// zbr:test/hashmap_set_test.zbr:11
        return self.value;
    }

};

const _ttag_Gauge: u64 = 3876551184;
const _reflect_Gauge_name: []const u8 = "Gauge";
const _reflect_Gauge_fields: []const []const u8 = &.{"value"};
const _reflect_Gauge_field_types: []const []const u8 = &.{"int"};

pub fn main() void {
// zbr:test/hashmap_set_test.zbr:15
    const g = Gauge.init(10);
// zbr:test/hashmap_set_test.zbr:16
    g.set(42);
// zbr:test/hashmap_set_test.zbr:17
    std.debug.print("{}\n", .{g.get()});
// zbr:test/hashmap_set_test.zbr:20
    var scores = HashMap([]const u8, i64).init();
// zbr:test/hashmap_set_test.zbr:21
    scores.set("alice", 95);
// zbr:test/hashmap_set_test.zbr:22
    scores.set("bob", 87);
// zbr:test/hashmap_set_test.zbr:23
    std.debug.print("{any}\n", .{scores.fetch("alice")});
// zbr:test/hashmap_set_test.zbr:24
    std.debug.print("{any}\n", .{scores.fetch("bob")});
// zbr:test/hashmap_set_test.zbr:25
    std.debug.print("{s}\n", .{"ok"});
}
