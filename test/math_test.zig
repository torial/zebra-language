...
// Source: C:/Projects/zebra-language/test/math_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        std.debug.print("{}\n", .{(_zebra_gt(Math.PI, 3.14) and _zebra_lt(Math.PI, 3.15))});
        std.debug.print("{}\n", .{(_zebra_gt(Math.E, 2.71) and _zebra_lt(Math.E, 2.72))});
        std.debug.print("{}\n", .{(_zebra_gt(Math.TAU, 6.28) and _zebra_lt(Math.TAU, 6.29))});
        const sin90: f64 = std.math.sin(@divTrunc(Math.PI, 2.0));
        std.debug.print("{}\n", .{_zebra_gt(sin90, 0.999)});
        const cos0: f64 = std.math.cos(0.0);
        std.debug.print("{}\n", .{_zebra_gt(cos0, 0.999)});
        const atan2_val: f64 = std.math.atan2(1.0, 1.0);
        std.debug.print("{}\n", .{(_zebra_gt(atan2_val, 0.785) and _zebra_lt(atan2_val, 0.786))});
        std.debug.print("{}\n", .{_zebra_gt(std.math.sqrt(9.0), 2.999)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.pow(f64, 2.0, 10.0), 1023.9)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.log(Math.E), 0.999)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.log2(8.0), 2.999)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.log10(1000.0), 2.999)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.exp(0.0), 0.999)});
        std.debug.print("{}\n", .{_zebra_gt(@floor(3.9), 2.999)});
        std.debug.print("{}\n", .{_zebra_gt(@ceil(3.1), 3.999)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.round(3.5), 3.999)});
        std.debug.print("{}\n", .{_zebra_gt(std.math.trunc(3.9), 2.999)});
        ...
        std.debug.print("{any}\n", .{std.math.isNaN(Math.NAN)});
        std.debug.print("{any}\n", .{std.math.isInf(Math.INF)});
        std.debug.print("{}\n", .{(std.math.isNaN(1.0) == false)});
    }
