...
// zbr:test/math_test.zbr:8
    const sin90: f64 = std.math.sin(@divTrunc(std.math.pi, 2.0));
...
// zbr:test/math_test.zbr:12
    ...
    std.debug.print("{}\n", .{_zebra_gt(std.math.log(std.math.e), 0.999)});
    ...
    std.debug.print("{any}\n", .{std.math.isNaN(std.math.nan(f64))});
    std.debug.print("{any}\n", .{std.math.isInf(std.math.inf(f64))});
