...
pub fn _initAllocator(a: std.mem.Allocator) void {
    _allocator = a;
    @import("bug082_lib.zig")._initAllocator(a);
}
...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("bug082_lib.zig")._zbr_error_msg().len > 0) return @import("bug082_lib.zig")._zbr_error_msg();
    return "";
}
...
const bug082_lib = @import("bug082_lib.zig");
pub fn main() void {
// zbr:test/bug082_test.zbr:4
    var b = bug082_lib.Builder.init(5, "initial");
// zbr:test/bug082_test.zbr:5
    var c = b.withVal(10);
// zbr:test/bug082_test.zbr:6
    var d = c.withName("updated");
// zbr:test/bug082_test.zbr:7
    std.debug.print("{s}\n", .{d.show()});
// zbr:test/bug082_test.zbr:9
    var e = bug082_lib.Builder.init(1, "start");
// zbr:test/bug082_test.zbr:10
    var f = e.withVal(99);
// zbr:test/bug082_test.zbr:11
    std.debug.print("{s}\n", .{f.show()});
// zbr:test/bug082_test.zbr:12
    std.debug.print("{s}\n", .{"bug082 OK"});
}
