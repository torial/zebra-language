...
// Source: test/crossmod_hatopt_test.zbr
...
pub fn _initAllocator(a: std.mem.Allocator) void {
    _allocator = a;
    @import("crossmod_hatopt_lib.zig")._initAllocator(a);
}
...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("crossmod_hatopt_lib.zig")._zbr_error_msg().len > 0) return @import("crossmod_hatopt_lib.zig")._zbr_error_msg();
    return "";
}
...
const crossmod_hatopt_lib = @import("crossmod_hatopt_lib.zig");
pub fn sumChain(c: *crossmod_hatopt_lib.Chain) i64 {
// zbr:test/crossmod_hatopt_test.zbr:4
    var total: i64 = c.value;
// zbr:test/crossmod_hatopt_test.zbr:5
    if (c.next) |nxt| {
// zbr:test/crossmod_hatopt_test.zbr:6
        total = (total + sumChain(nxt));
    }
// zbr:test/crossmod_hatopt_test.zbr:7
    return total;
}

pub fn main() void {
// zbr:test/crossmod_hatopt_test.zbr:10
    const c3: *crossmod_hatopt_lib.Chain = crossmod_hatopt_lib.Chain.init(30, null);
// zbr:test/crossmod_hatopt_test.zbr:11
    const c2: *crossmod_hatopt_lib.Chain = crossmod_hatopt_lib.Chain.init(20, c3);
// zbr:test/crossmod_hatopt_test.zbr:12
    const c1: *crossmod_hatopt_lib.Chain = crossmod_hatopt_lib.Chain.init(10, c2);
// zbr:test/crossmod_hatopt_test.zbr:13
    std.debug.assert((sumChain(c1) == 60));
// zbr:test/crossmod_hatopt_test.zbr:14
    std.debug.print("{s}\n", .{"crossmod_hatopt: OK"});
}
