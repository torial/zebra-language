...
// zbr:test/contract_require.zbr:25
    c.push(5);
// zbr:test/contract_require.zbr:26
    c.push(3);
// zbr:test/contract_require.zbr:27
    c.reset(2);
// zbr:test/contract_require.zbr:28
    var b = Box{};
// zbr:test/contract_require.zbr:29
    b.set(10);
// zbr:test/contract_require.zbr:30
    std.debug.print("{s}\n", .{"ok"});
}
