...
// Source: test/dynlib_export_class_test.zbr
...
pub const HelloGreeter = struct {
    ...
    pub fn greet(self: *HelloGreeter, name: []const u8) []const u8 {
        _ = self;
// zbr:test/dynlib_export_class_test.zbr:7
...
var _zbr_export_greeter_iface: ?IGreeter = null;
pub export fn greeter() *IGreeter {
    if (_zbr_export_greeter_iface == null) {
        _zbr_export_greeter_iface = .{ .ptr = HelloGreeter.init(), .vtable = &_vtable_HelloGreeter_IGreeter };
    }
    return &_zbr_export_greeter_iface.?;
}
