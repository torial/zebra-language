...
// Source: test/inline_if_test.zbr
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/inline_if_test.zbr:3
    const x: i64 = 5;
// zbr:test/inline_if_test.zbr:4
    if (_zebra_gt(x, 3)) {
        std.debug.print("{s}\n", .{"big"});
    }
// zbr:test/inline_if_test.zbr:7
    var label: []const u8 = "";
// zbr:test/inline_if_test.zbr:8
    if (_zebra_gt(x, 3)) {
// zbr:test/inline_if_test.zbr:8
        label = "big";
    } else {
// zbr:test/inline_if_test.zbr:8
    ...
    std.debug.print("{s}\n", .{label});
// zbr:test/inline_if_test.zbr:12
    var label2: []const u8 = "";
// zbr:test/inline_if_test.zbr:13
    if (_zebra_gt(x, 3)) {
// zbr:test/inline_if_test.zbr:13
        label2 = "yes";
    } else {
// zbr:test/inline_if_test.zbr:14
        label2 = "no";
    }
    std.debug.print("{s}\n", .{label2});
// zbr:test/inline_if_test.zbr:18
    const grade: i64 = 85;
// zbr:test/inline_if_test.zbr:19
    var letter: []const u8 = "";
// zbr:test/inline_if_test.zbr:20
    if (_zebra_ge(grade, 90)) {
// zbr:test/inline_if_test.zbr:20
        letter = "A";
    } else {
// zbr:test/inline_if_test.zbr:20
        if (_zebra_ge(grade, 80)) {
// zbr:test/inline_if_test.zbr:20
            letter = "B";
        } else {
// zbr:test/inline_if_test.zbr:20
            if (_zebra_ge(grade, 70)) {
// zbr:test/inline_if_test.zbr:20
                letter = "C";
            } else {
// zbr:test/inline_if_test.zbr:20
    ...
    std.debug.print("{s}\n", .{sign((-3))});
    std.debug.print("{s}\n", .{sign(0)});
// zbr:test/inline_if_test.zbr:29
    if (_zebra_gt(x, 0)) {
        std.debug.print("{s}\n", .{"positive"});
    } else {
        std.debug.print("{s}\n", .{"nonpositive"});
...
pub fn sign(n: i64) []const u8 {
// zbr:test/inline_if_test.zbr:37
    if (_zebra_gt(n, 0)) {
// zbr:test/inline_if_test.zbr:37
        return "pos";
    } else {
// zbr:test/inline_if_test.zbr:38
        if (_zebra_lt(n, 0)) {
// zbr:test/inline_if_test.zbr:38
            return "neg";
        } else {
// zbr:test/inline_if_test.zbr:39
            return "zero";
        }
    }
}
