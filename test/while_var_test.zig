...
// Source: C:/Projects/zebra-language/test/while_var_test.zbr
...
pub const WhileVarTest = struct {
    ...
    pub fn testScanAlpha(self: *WhileVarTest) []const u8 {
        _ = self;
        const src: []const u8 = "hello123";
        var pos: i64 = 0;
        var word: []const u8 = "";
        while (true) {
            const c = src[@as(usize, @intCast(pos))];
            if ((!(_zebra_ge(c, 'a') and _zebra_le(c, 'z')))) {
                break;
            }
            word = _str_concat(word, src[@as(usize, @intCast(pos))..@as(usize, @intCast((pos + 1)))], _allocator);
            pos = (pos + 1);
        }
        return word;
    }
    ...
    pub fn testScanDigits(self: *WhileVarTest) []const u8 {
        ...
        while (true) {
            ...
            digits = _str_concat(digits, src[@as(usize, @intCast(pos))..@as(usize, @intCast((pos + 1)))], _allocator);
            pos = (pos + 1);
        }
        return digits;
    }
    ...
    pub fn init() *WhileVarTest {
        const self = _allocator.create(WhileVarTest) catch @panic("OOM");
        self._type_tag = _ttag_WhileVarTest;
        return self;
    }

};
const _ttag_WhileVarTest: u64 = _zbr_hash("WhileVarTest");
