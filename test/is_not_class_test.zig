...
// Source: test/is_not_class_test.zbr
...
pub const Cat = struct {
    ...
    pub fn init(n: []const u8) *Cat {
        const _self = _allocator.create(Cat) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Cat");
// zbr:test/is_not_class_test.zbr:7
            _self.name = _intern(n);
        return _self;
    }

};
const _ttag_Cat: u64 = _zbr_hash("Cat");
...
pub const Dog = struct {
    ...
    name: []const u8,
    pub fn init(n: []const u8) *Dog {
        const _self = _allocator.create(Dog) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Dog");
// zbr:test/is_not_class_test.zbr:12
            _self.name = _intern(n);
        return _self;
    }
...
// zbr:test/is_not_class_test.zbr:16
    const d = Dog.init("Rex");
    std.debug.print("{any}\n", .{(!(c._type_tag == _ttag_Dog))});
    std.debug.print("{any}\n", .{(!(c._type_tag == _ttag_Cat))});
    std.debug.print("{any}\n", .{(!(d._type_tag == _ttag_Cat))});
    std.debug.print("{any}\n", .{(!(d._type_tag == _ttag_Dog))});
// zbr:test/is_not_class_test.zbr:31
    if ((!(c._type_tag == _ttag_Dog))) {
        std.debug.print("{s}\n", .{"cat is not a dog"});
    }
// zbr:test/is_not_class_test.zbr:35
    const r: bool = (!(d._type_tag == _ttag_Cat));
    std.debug.print("{}\n", .{r});
    std.debug.print("{s}\n", .{"is_not_class: OK"});
}
