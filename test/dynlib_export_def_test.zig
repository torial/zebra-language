...
// Source: test/dynlib_export_def_test.zbr
...
pub export fn addTwo(x: i64) i64 {
// zbr:test/dynlib_export_def_test.zbr:2
    return (x + 2);
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
    std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "{}", .{addTwo(40)}) catch unreachable)});
}
