...
pub const CrossModuleRef = struct {
    ...
    pub fn init(mod: []const u8, tname: []const u8) CrossModuleRef {
        var _self: CrossModuleRef = undefined;
            _self.module = mod;
            _self.type_name = tname;
        return _self;
    }
...
pub const Types = struct {
    ...
    pub fn init() *Types {
        const self = _allocator.create(Types) catch @panic("OOM");
        self._type_tag = _ttag_Types;
        return self;
    }

};
const _ttag_Types: u64 = _zbr_hash("Types");
...
pub const TypeEnv = struct {
    ...
    pub fn init() *TypeEnv {
        const _self = _allocator.create(TypeEnv) catch @panic("OOM");
        _self._type_tag = _zbr_hash("TypeEnv");
            _self.types = std.StringHashMap(Type).init(_allocator);
        return _self;
    }

    pub fn define(self: *TypeEnv, name: []const u8, t: Type) void {
        self.types.put(name, t) catch @panic("OOM");
    }
...
const _ttag_TypeEnv: u64 = _zbr_hash("TypeEnv");
...
pub const Checker = struct {
    ...
    pub fn init() *Checker {
        const _self = _allocator.create(Checker) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Checker");
            _self.errors = std.ArrayList([]const u8){};
        return _self;
    }
    ...
    pub fn checkExpr(self: *Checker, e: Expr, expected: Type) anyerror!void {
        ...
        if ((!Types.eql(actual, expected))) {
            { _error_ctx = .{ .message = "type mismatch" }; return error.ZebraError; }
        }
    }

};
const _ttag_Checker: u64 = _zbr_hash("Checker");
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        const opt_int = Type{ .optional = blk_box: { const _bv = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        const list_str = Type{ .list_ = blk_box: { const _bv = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        ...
        std.debug.print("{s}\n", .{"3. recursive ^T OK"});
        const opt_list = Type{ .optional = blk_box: { const _bv = Type{ .list_ = blk_box: { const _bv = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        const list_opt = Type{ .list_ = blk_box: { const _bv = Type{ .optional = blk_box: { const _bv = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        ...
        elems.append(_allocator, Type{ .int_ = {} }) catch @panic("OOM");
        elems.append(_allocator, Type{ .str_ = {} }) catch @panic("OOM");
        ...
        env.define("y", Type{ .optional = blk_box: { const _bv = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } });
        env.define("z", Type{ .list_ = blk_box: { const _bv = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } });
        ...
        std.debug.assert(Types.eql(Type{ .optional = blk_box: { const _bv = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }, Type{ .optional = blk_box: { const _bv = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }));
        std.debug.assert((!Types.eql(Type{ .optional = blk_box: { const _bv = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }, Type{ .optional = blk_box: { const _bv = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } })));
        std.debug.assert(Types.eql(Type{ .list_ = blk_box: { const _bv = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }, Type{ .list_ = blk_box: { const _bv = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }));
        std.debug.print("{s}\n", .{"8. Type.eql OK"});
        var ch = Checker.init();
        const lit = Expr{ .int_lit = 42 };
        const slit = Expr{ .str_lit = "hi" };
        const neg = Expr{ .neg = blk_box: { const _bv = Expr{ .int_lit = 5 }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_Types) return _reflect_Types_name;
    if (tag == _ttag_TypeEnv) return _reflect_TypeEnv_name;
    if (tag == _ttag_Checker) return _reflect_Checker_name;
    if (tag == _ttag_Main) return _reflect_Main_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_Types) return .{ .items = _reflect_Types_fields };
    if (tag == _ttag_TypeEnv) return .{ .items = _reflect_TypeEnv_fields };
    if (tag == _ttag_Checker) return .{ .items = _reflect_Checker_fields };
    if (tag == _ttag_Main) return .{ .items = _reflect_Main_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_Types) return .{ .items = _reflect_Types_field_types };
    if (tag == _ttag_TypeEnv) return .{ .items = _reflect_TypeEnv_field_types };
    if (tag == _ttag_Checker) return .{ .items = _reflect_Checker_field_types };
