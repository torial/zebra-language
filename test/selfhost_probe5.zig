...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        const opt_int = Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        const list_str = Type{ .list_ = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "list_")) = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        ...
        std.debug.print("{s}\n", .{"3. recursive ^T OK"});
        const opt_list = Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .list_ = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "list_")) = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        const list_opt = Type{ .list_ = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "list_")) = Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        ...
        env.define("y", Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } });
        env.define("z", Type{ .list_ = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "list_")) = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } });
        ...
        std.debug.assert(Types.eql(Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }, Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }));
        std.debug.assert((!Types.eql(Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }, Type{ .optional = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "optional")) = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } })));
        std.debug.assert(Types.eql(Type{ .list_ = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "list_")) = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }, Type{ .list_ = blk_box: { const _bv: std.meta.Child(@FieldType(Type, "list_")) = Type{ .str_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }));
        std.debug.print("{s}\n", .{"8. Type.eql OK"});
        var ch = Checker.init();
        const lit = Expr{ .int_lit = 42 };
        const slit = Expr{ .str_lit = "hi" };
        const neg = Expr{ .neg = blk_box: { const _bv: std.meta.Child(@FieldType(Expr, "neg")) = Expr{ .int_lit = 5 }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
