...
// Source: test/ctor_arg_ref_test.zbr
...
pub const Node = struct {
    ...
    pub fn init(v: i64, nxt: ?*Node) *Node {
        const self = _allocator.create(Node) catch @panic("OOM");
        self._type_tag = _ttag_Node;
// zbr:test/ctor_arg_ref_test.zbr:10
        self.value = v;
// zbr:test/ctor_arg_ref_test.zbr:11
        self.next = nxt;
        return self;
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/ctor_arg_ref_test.zbr:15
        const c = Node.init(3, null);
// zbr:test/ctor_arg_ref_test.zbr:16
        const b = Node.init(2, c);
// zbr:test/ctor_arg_ref_test.zbr:17
        const a = Node.init(1, b);
// zbr:test/ctor_arg_ref_test.zbr:18
        std.debug.assert((a.value == 1));
// zbr:test/ctor_arg_ref_test.zbr:19
        std.debug.assert((b.value == 2));
// zbr:test/ctor_arg_ref_test.zbr:20
        std.debug.assert((c.value == 3));
// zbr:test/ctor_arg_ref_test.zbr:21
        std.debug.print("{s}\n", .{"ctor_arg_ref_test OK"});
    }
