...
pub const App = struct {
    ...
    pub fn main() void {
// zbr:test/progress_test.zbr:4
        const pb = _progress_bar(5, "counting");
// zbr:test/progress_test.zbr:5
        var n: i64 = 0;
        while (n < 5) : (n += 1) {
// zbr:test/progress_test.zbr:6
            pb.tick();
        }
// zbr:test/progress_test.zbr:7
        pb.done();
// zbr:test/progress_test.zbr:8
        std.debug.print("{s}\n", .{"done"});
    }
