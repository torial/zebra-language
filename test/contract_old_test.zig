...
// Source: test/contract_old_test.zbr
...
pub const BankAccount = struct {
    ...
    balance: i64 = 0,
    pub fn deposit(self: *BankAccount, amount: i64) void {
        const _old_0 = self.balance;
        defer {
            if (!((self.balance == (_old_0 + amount)))) std.debug.panic("ensure failed in 'deposit'\n", .{});
        }
// zbr:test/contract_old_test.zbr:7
        self.balance = (self.balance + amount);
    }

    pub fn init() *BankAccount {
...
const _ttag_BankAccount: u64 = _zbr_hash("BankAccount");
const _reflect_BankAccount_name: []const u8 = "BankAccount";
const _reflect_BankAccount_fields: []const []const u8 = &.{"balance"};
const _reflect_BankAccount_field_types: []const []const u8 = &.{"int"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/contract_old_test.zbr:12
        var acc = BankAccount.init();
        acc.deposit(100);
        std.debug.print("{}\n", .{acc.balance});
    }
