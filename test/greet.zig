...
// Source: C:/Projects/zebra-language/test/greet.zbr
...
pub const Greeter = struct {
    ...
    pub fn init() *Greeter {
        const self = _allocator.create(Greeter) catch @panic("OOM");
        self._type_tag = _ttag_Greeter;
        return self;
    }

};
const _ttag_Greeter: u64 = _zbr_hash("Greeter");
