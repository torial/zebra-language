...
// Source: test/bug121_arena_copyout_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/bug121_arena_copyout_test.zbr:4
        var result: []const u8 = "";
// zbr:test/bug121_arena_copyout_test.zbr:5
        { // allocate
...
// zbr:test/bug121_arena_copyout_test.zbr:6
            const tmp = _str_concat(_str_concat("hello", " ", _allocator), "world", _allocator);
// zbr:test/bug121_arena_copyout_test.zbr:7
            const _co_1: []const u8 = tmp;
            result = _parent_alloc_1.dupe(u8, _co_1) catch _co_1;
        }
// zbr:test/bug121_arena_copyout_test.zbr:8
        if (std.mem.eql(u8, result, "hello world")) {
// zbr:test/bug121_arena_copyout_test.zbr:9
            std.debug.print("{s}\n", .{"BUG-121 <- arena copy-out: OK"});
        } else {
// zbr:test/bug121_arena_copyout_test.zbr:11
            std.debug.print("{s}\n", .{_str_concat("BUG-121 <- arena copy-out: FAIL got: ", result, _allocator)});
        }
// zbr:test/bug121_arena_copyout_test.zbr:14
        var x: []const u8 = "";
// zbr:test/bug121_arena_copyout_test.zbr:15
        x = "plain";
// zbr:test/bug121_arena_copyout_test.zbr:16
        if (std.mem.eql(u8, x, "plain")) {
// zbr:test/bug121_arena_copyout_test.zbr:17
            std.debug.print("{s}\n", .{"BUG-121 <- outside arena: OK"});
        } else {
// zbr:test/bug121_arena_copyout_test.zbr:19
            std.debug.print("{s}\n", .{"BUG-121 <- outside arena: FAIL"});
        }
    }
