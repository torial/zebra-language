...
// Source: test/test_module_test.zbr
...
pub fn test_assert_eq_int() anyerror!void {
// zbr:test/test_module_test.zbr:2
    try _zebra_assert_cmp((1 + 1), 2, true);
// zbr:test/test_module_test.zbr:3
    try _zebra_assert_cmp((10 - 3), 7, true);
}

pub fn test_assert_ne_int() anyerror!void {
// zbr:test/test_module_test.zbr:6
    try _zebra_assert_cmp(1, 2, false);
// zbr:test/test_module_test.zbr:7
    try _zebra_assert_cmp(42, 0, false);
}

pub fn test_assert_eq_str() anyerror!void {
// zbr:test/test_module_test.zbr:10
    try _zebra_assert_cmp("hello", "hello", true);
}

pub fn test_assert_ne_str() anyerror!void {
// zbr:test/test_module_test.zbr:13
    try _zebra_assert_cmp("hello", "world", false);
}

pub fn test_assert_true_false() anyerror!void {
// zbr:test/test_module_test.zbr:16
    try _zebra_assert_bool(_zebra_gt(5, 3), true);
// zbr:test/test_module_test.zbr:17
    try _zebra_assert_bool(_zebra_gt(1, 2), false);
// zbr:test/test_module_test.zbr:18
    try _zebra_assert_bool((!false), true);
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    if (test_assert_eq_int()) |_| {
        _test_pass += 1;
        std.debug.print("PASS: test_assert_eq_int\n", .{});
    } else |_terr| {
        _test_fail += 1;
        if (_terr == error.ZebraError) {
            std.debug.print("FAIL: test_assert_eq_int: {s}\n", .{_zbr_error_msg()});
        } else {
            std.debug.print("FAIL: test_assert_eq_int: {}\n", .{_terr});
        }
    }
    if (test_assert_ne_int()) |_| {
        _test_pass += 1;
        std.debug.print("PASS: test_assert_ne_int\n", .{});
    } else |_terr| {
        _test_fail += 1;
        if (_terr == error.ZebraError) {
            std.debug.print("FAIL: test_assert_ne_int: {s}\n", .{_zbr_error_msg()});
        } else {
            std.debug.print("FAIL: test_assert_ne_int: {}\n", .{_terr});
        }
    }
    if (test_assert_eq_str()) |_| {
        _test_pass += 1;
        std.debug.print("PASS: test_assert_eq_str\n", .{});
    } else |_terr| {
        _test_fail += 1;
        if (_terr == error.ZebraError) {
            std.debug.print("FAIL: test_assert_eq_str: {s}\n", .{_zbr_error_msg()});
        } else {
            std.debug.print("FAIL: test_assert_eq_str: {}\n", .{_terr});
        }
    }
    if (test_assert_ne_str()) |_| {
        _test_pass += 1;
        std.debug.print("PASS: test_assert_ne_str\n", .{});
    } else |_terr| {
        _test_fail += 1;
        if (_terr == error.ZebraError) {
            std.debug.print("FAIL: test_assert_ne_str: {s}\n", .{_zbr_error_msg()});
        } else {
            std.debug.print("FAIL: test_assert_ne_str: {}\n", .{_terr});
        }
    }
    if (test_assert_true_false()) |_| {
        _test_pass += 1;
        std.debug.print("PASS: test_assert_true_false\n", .{});
    } else |_terr| {
        _test_fail += 1;
        if (_terr == error.ZebraError) {
            std.debug.print("FAIL: test_assert_true_false: {s}\n", .{_zbr_error_msg()});
        } else {
            std.debug.print("FAIL: test_assert_true_false: {}\n", .{_terr});
        }
    }
