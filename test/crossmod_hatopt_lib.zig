...
// Source: test\crossmod_hatopt_lib.zbr
...
pub const Chain = struct {
    _type_tag: u64 = _ttag_Chain,
    value: i64 = undefined,
    next: ?*Chain = undefined,
    pub fn init(value: i64, next: ?*Chain) *Chain {
        const self = _allocator.create(Chain) catch @panic("OOM");
        self._type_tag = _ttag_Chain;
// zbr:test\crossmod_hatopt_lib.zbr:5
        self.value = value;
// zbr:test\crossmod_hatopt_lib.zbr:6
        self.next = next;
        return self;
    }
...
const _ttag_Chain: u64 = 149688694;
const _reflect_Chain_name: []const u8 = "Chain";
const _reflect_Chain_fields: []const []const u8 = &.{"value", "next"};
const _reflect_Chain_field_types: []const []const u8 = &.{"int", "^?Chain"};
