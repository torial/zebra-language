...
pub const Comparable = struct {
    ...
    pub const VTable = struct {
        compareTo: *const fn (ptr: *anyopaque, other: @This()) i64,
    };

    pub fn compareTo(self: @This(), other: @This()) i64 {
        return self.vtable.compareTo(self.ptr, other);
    }
...
pub const Score = struct {
    ...
    pub fn init(v: i64) *Score {
        const self = _allocator.create(Score) catch @panic("OOM");
