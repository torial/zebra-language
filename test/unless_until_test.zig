...
// zbr:test/unless_until_test.zbr:7
        if ((!_zebra_gt(x, 10))) {
// zbr:test/unless_until_test.zbr:8
            x = (x + 1);
        }
// zbr:test/unless_until_test.zbr:9
        std.debug.assert((x == 6));
// zbr:test/unless_until_test.zbr:12
        if ((!_zebra_lt(x, 10))) {
// zbr:test/unless_until_test.zbr:13
            x = 99;
        }
// zbr:test/unless_until_test.zbr:14
        std.debug.assert((x == 6));
// zbr:test/unless_until_test.zbr:17
        var n: i64 = 0;
// zbr:test/unless_until_test.zbr:18
        while ((!_zebra_ge(n, 3))) {
// zbr:test/unless_until_test.zbr:19
            n = (n + 1);
        }
// zbr:test/unless_until_test.zbr:20
        std.debug.assert((n == 3));
// zbr:test/unless_until_test.zbr:22
        std.debug.print("{s}\n", .{"if-not/while-not OK"});
    }
...
const _ttag_UnlessUntilTest: u64 = 2726389077;
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/unless_until_test.zbr:25
