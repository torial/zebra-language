...
// Source: C:/Projects/zebra-language/test/implicit_capture_test.zbr
...
pub const Program = struct {
    ...
    pub fn main() void {
        const base: i64 = 10;
        const adder = struct { fn call(x: i64) i64 {
            return (x + base);
         } }.call;
        std.debug.print("{any}\n", .{adder(5)});
        const scale: i64 = 3;
        const triple = struct { fn call(n: i64) @TypeOf((n * scale)) { return (n * scale); } }.call;
        std.debug.print("{any}\n", .{triple(4)});
        const a: i64 = 100;
        const b: i64 = 7;
        const combine = struct { fn call(x: i64) i64 {
            return ((x + a) - b);
         } }.call;
        std.debug.print("{any}\n", .{combine(0)});
        const offset: i64 = 20;
