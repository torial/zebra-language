...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("expose_dotted/lib.zig")._zbr_error_msg().len > 0) return @import("expose_dotted/lib.zig")._zbr_error_msg();
    return "";
}
...
// zbr:test/expose_dotted_test.zbr:28
        const sum = DottedLib.append(_allocator, 7) catch unreachable;
