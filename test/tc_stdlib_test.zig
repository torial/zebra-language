...
// zbr:test/tc_stdlib_test.zbr:81
        std.debug.assert(TcTypes.eql(http_get, TcType{ .optional = blk_box_1: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .http_response = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_1 _bp; } }));
// zbr:test/tc_stdlib_test.zbr:82
        const http_json = TcStdlib.staticCall("Http", "json");
// zbr:test/tc_stdlib_test.zbr:83
        std.debug.assert(TcTypes.eql(http_json, TcType{ .optional = blk_box_2: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .json_value = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_2 _bp; } }));
...
// zbr:test/tc_stdlib_test.zbr:93
        std.debug.assert(TcTypes.eql(json_parse, TcType{ .optional = blk_box_3: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .json_value = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_3 _bp; } }));
...
// zbr:test/tc_stdlib_test.zbr:133
        std.debug.assert(TcTypes.eql(compress_ung, TcType{ .optional = blk_box_4: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .string_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_4 _bp; } }));
