...
// zbr:test/tc_stdlib_test.zbr:81
        std.debug.assert(TcTypes.eql(http_get, TcType{ .optional = _box_1: { const _bp_1 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1.* = TcType{ .http_response = {} }; break :_box_1 _bp_1; } }));
// zbr:test/tc_stdlib_test.zbr:82
        const http_json = TcStdlib.staticCall("Http", "json");
// zbr:test/tc_stdlib_test.zbr:83
        std.debug.assert(TcTypes.eql(http_json, TcType{ .optional = _box_2: { const _bp_2 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_2.* = TcType{ .json_value = {} }; break :_box_2 _bp_2; } }));
...
// zbr:test/tc_stdlib_test.zbr:93
        std.debug.assert(TcTypes.eql(json_parse, TcType{ .optional = _box_3: { const _bp_3 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_3.* = TcType{ .json_value = {} }; break :_box_3 _bp_3; } }));
...
// zbr:test/tc_stdlib_test.zbr:133
        std.debug.assert(TcTypes.eql(compress_ung, TcType{ .optional = _box_4: { const _bp_4 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_4.* = TcType{ .string_ = {} }; break :_box_4 _bp_4; } }));
