...
// Source: C:/Projects/zebra-language/test/tc_stdlib_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        std.debug.assert(TcTypes.eql(http_get, TcType{ .optional = TcType{ .http_response = {} } }));
        const http_json = TcStdlib.staticCall("Http", "json");
        std.debug.assert(TcTypes.eql(http_json, TcType{ .optional = TcType{ .json_value = {} } }));
        ...
        std.debug.assert(TcTypes.eql(json_parse, TcType{ .optional = TcType{ .json_value = {} } }));
        ...
        std.debug.assert(TcTypes.eql(compress_ung, TcType{ .optional = TcType{ .string_ = {} } }));
