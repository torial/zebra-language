...
// Source: test/opt_chain_test.zbr
...
pub const Config = struct {
    port: i64,
    pub fn init(port: i64) Config {
        var _self: Config = undefined;
// zbr:test/opt_chain_test.zbr:4
            _self.port = port;
        return _self;
    }

    pub fn doubled(self: *Config) i64 {
// zbr:test/opt_chain_test.zbr:6
        return (self.port * 2);
    }

};

pub fn getPort(c: ?Config) ?i64 {
// zbr:test/opt_chain_test.zbr:9
...
// zbr:test/opt_chain_test.zbr:12
    const cfg: ?Config = Config.init(8080);
// zbr:test/opt_chain_test.zbr:13
    const none: ?Config = null;
// zbr:test/opt_chain_test.zbr:16
    if ((if (cfg) |_oc_2| _oc_2.port else null)) |p| {
// zbr:test/opt_chain_test.zbr:17
        std.debug.assert((p == 8080));
    }
// zbr:test/opt_chain_test.zbr:20
    const nil_port: ?i64 = (if (none) |_oc_3| _oc_3.port else null);
// zbr:test/opt_chain_test.zbr:21
    std.debug.assert((nil_port == null));
// zbr:test/opt_chain_test.zbr:24
    if ((if (cfg) |_oc_val_4| _oc_blk_4: { var _oc_4 = _oc_val_4; break :_oc_blk_4 _oc_4.doubled(); } else null)) |d| {
// zbr:test/opt_chain_test.zbr:25
        std.debug.assert((d == 16160));
    }
// zbr:test/opt_chain_test.zbr:28
    const nil_doubled: ?i64 = (if (none) |_oc_val_5| _oc_blk_5: { var _oc_5 = _oc_val_5; break :_oc_blk_5 _oc_5.doubled(); } else null);
// zbr:test/opt_chain_test.zbr:29
    std.debug.assert((nil_doubled == null));
// zbr:test/opt_chain_test.zbr:32
    if (getPort(cfg)) |v| {
// zbr:test/opt_chain_test.zbr:33
        std.debug.assert((v == 8080));
    }
// zbr:test/opt_chain_test.zbr:34
    const nil_r: ?i64 = getPort(none);
// zbr:test/opt_chain_test.zbr:35
    std.debug.assert((nil_r == null));
    std.debug.print("{s}\n", .{"opt_chain: OK"});
}
