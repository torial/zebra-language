...
// Source: C:/Projects/zebra-language/test/escape_field_test.zbr
...
pub const Container = struct {
    ...
    pub fn init() *Container {
        const self = _allocator.create(Container) catch @panic("OOM");
...
pub const Builder = struct {
    ...
    pub fn build(label: []const u8) *Container {
        ...
        items.append(_allocator, "alpha") catch @panic("OOM");
        items.append(_allocator, "beta") catch @panic("OOM");
        c.items = items;
        c.label = label;
        return c;
    }
    ...
    pub fn init() *Builder {
        const self = _allocator.create(Builder) catch @panic("OOM");
        self._type_tag = _ttag_Builder;
        return self;
    }

};
const _ttag_Builder: u64 = _zbr_hash("Builder");
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        if (!((@as(i64, @intCast(c.items.items.len)) == 2))) @panic("item count");
        std.debug.print("{any}\n", .{c.items.items[@intCast(0)]});
        std.debug.print("{s}\n", .{c.label});
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    ...
    if (tag == _ttag_Builder) return _reflect_Builder_name;
...
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    ...
    if (tag == _ttag_Builder) return .{ .items = _reflect_Builder_fields };
...
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    ...
    if (tag == _ttag_Builder) return .{ .items = _reflect_Builder_field_types };
