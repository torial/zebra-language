...
// Source: C:/Projects/zebra-language/test/arg_test.zbr
...
pub const ArgTest = struct {
    ...
    pub fn init() *ArgTest {
        const self = _allocator.create(ArgTest) catch @panic("OOM");
        self._type_tag = _ttag_ArgTest;
        return self;
    }

};
const _ttag_ArgTest: u64 = _zbr_hash("ArgTest");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_ArgTest) return _reflect_ArgTest_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_ArgTest) return .{ .items = _reflect_ArgTest_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_ArgTest) return .{ .items = _reflect_ArgTest_field_types };
    return .{ .items = &.{} };
}
