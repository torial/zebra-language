...
// zbr:test/try_outer_vars.zbr:6
    ...
    pub fn testRiskyCalc(base: i64, multiplier: i64) void {
// zbr:test/try_outer_vars.zbr:12
        var _try_err_2: ?anyerror = null;
        _try_blk_2: {
// zbr:test/try_outer_vars.zbr:9
            const result: i64 = App.risky(base) catch |_tc_3| { _try_err_2 = _tc_3; break :_try_blk_2; };
...
// zbr:test/try_outer_vars.zbr:18
        App.testRiskyCalc(base, multiplier);
// zbr:test/try_outer_vars.zbr:19
        std.debug.print("{}\n", .{base});
    }
