...
// Source: test/in_operator_test.zbr
...
pub fn main(init: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/in_operator_test.zbr:14
    if (!((std.mem.indexOf(u8, "hello", "ell") != null))) @panic("substring in: expected true");
// zbr:test/in_operator_test.zbr:16
    if (!((!(std.mem.indexOf(u8, "hello", "xyz") != null)))) @panic("substring not-in: expected false");
// zbr:test/in_operator_test.zbr:18
    if (!((std.mem.indexOf(u8, "hello", "") != null))) @panic("empty substring: expected true");
// zbr:test/in_operator_test.zbr:20
    if (!((std.mem.indexOf(u8, "hello", "hello") != null))) @panic("whole string in: expected true");
// zbr:test/in_operator_test.zbr:23
...
// zbr:test/in_operator_test.zbr:27
    if (!(_zebra_in(20, nums))) @panic("List int in: expected true");
// zbr:test/in_operator_test.zbr:28
    if (!((!_zebra_in(99, nums)))) @panic("List int not-in: expected false");
// zbr:test/in_operator_test.zbr:31
    var fruits = std.ArrayList([]const u8).empty;
    fruits.append(_allocator, _intern("apple")) catch @panic("OOM");
    fruits.append(_allocator, _intern("banana")) catch @panic("OOM");
// zbr:test/in_operator_test.zbr:34
    if (!(_zebra_in("banana", fruits))) @panic("List str in: expected true");
// zbr:test/in_operator_test.zbr:35
    if (!((!_zebra_in("cherry", fruits)))) @panic("List str not-in: expected false");
// zbr:test/in_operator_test.zbr:38
    if (!(_zebra_in(3, .{1, 2, 3, 4, 5}))) @panic("array literal in: expected true");
// zbr:test/in_operator_test.zbr:39
    if (!((!_zebra_in(7, .{1, 2, 3})))) @panic("array literal not-in: expected false");
// zbr:test/in_operator_test.zbr:42
    if (!(_zebra_in("cat", .{"dog", "cat", "bird"}))) @panic("array str in: expected true");
// zbr:test/in_operator_test.zbr:43
    if (!((!_zebra_in("fish", .{"dog", "cat"})))) @panic("array str not-in: expected false");
    std.debug.print("{s}\n", .{"in_operator: OK"});
}
