...
// Source: C:/Projects/zebra-language/test\tc_scope.zbr
...
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:58
        self.name = n;
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:59
        self.kind = k;
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:60
        self.type_ = t;
        return self;
    }
...
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:102
        const frame_start = self._limits.items[@as(usize, @intCast((@as(i64, @intCast(self._limits.items.len)) - 1)))];
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:103
        var i: i64 = (@as(i64, @intCast(self._names.items.len)) - 1);
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:104
        while (_zebra_ge(i, frame_start)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:105
            if (std.mem.eql(u8, self._names.items[@as(usize, @intCast(i))], name)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:106
                return false;
            }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:107
            i = (i - 1);
        }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:108
        self._names.append(_allocator, name) catch unreachable;
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:109
        self._syms.append(_allocator, sym) catch unreachable;
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:110
        return true;
    }

    pub fn hasLocal(self: *TcScope, name: []const u8) bool {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:114
        const frame_start = self._limits.items[@as(usize, @intCast((@as(i64, @intCast(self._limits.items.len)) - 1)))];
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:115
        var i: i64 = (@as(i64, @intCast(self._names.items.len)) - 1);
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:116
        while (_zebra_ge(i, frame_start)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:117
            if (std.mem.eql(u8, self._names.items[@as(usize, @intCast(i))], name)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:118
                return true;
            }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:119
            i = (i - 1);
        }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:120
        return false;
    }

    pub fn getLocal(self: *TcScope, name: []const u8) TcSymbol {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:125
        const frame_start = self._limits.items[@as(usize, @intCast((@as(i64, @intCast(self._limits.items.len)) - 1)))];
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:126
        var i: i64 = (@as(i64, @intCast(self._names.items.len)) - 1);
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:127
        while (_zebra_ge(i, frame_start)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:128
            if (std.mem.eql(u8, self._names.items[@as(usize, @intCast(i))], name)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:129
                return self._syms.items[@as(usize, @intCast(i))];
            }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:130
            i = (i - 1);
        }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:131
        return TcSymbol.init("", TcSymKind.local, TcType{ .unknown_ = {} });
    }

    pub fn hasSymbol(self: *TcScope, name: []const u8) bool {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:135
        var i: i64 = (@as(i64, @intCast(self._names.items.len)) - 1);
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:136
        while (_zebra_ge(i, 0)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:137
            if (std.mem.eql(u8, self._names.items[@as(usize, @intCast(i))], name)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:138
                return true;
            }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:139
            i = (i - 1);
        }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:140
        return false;
    }

    pub fn lookup(self: *TcScope, name: []const u8) TcSymbol {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:145
        var i: i64 = (@as(i64, @intCast(self._names.items.len)) - 1);
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:146
        while (_zebra_ge(i, 0)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:147
            if (std.mem.eql(u8, self._names.items[@as(usize, @intCast(i))], name)) {
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:148
                return self._syms.items[@as(usize, @intCast(i))];
            }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:149
            i = (i - 1);
        }
// zbr:C:/Projects/zebra-language/test\tc_scope.zbr:150
        return TcSymbol.init("", TcSymKind.local, TcType{ .unknown_ = {} });
    }
