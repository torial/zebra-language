...
pub fn testGuardSuccess() void {
// zbr:test/guard_test.zbr:17
    var _try_err_1: ?anyerror = null;
    _try_blk_1: {
// zbr:test/guard_test.zbr:15
        const x = Validator.checkPositive(42) catch |_tc_2| { _try_err_1 = _tc_2; break :_try_blk_1; };
// zbr:test/guard_test.zbr:16
        std.debug.print("{}\n", .{x});
        break :_try_blk_1;
    }
    if (_try_err_1 != null) {
// zbr:test/guard_test.zbr:18
        {
            const _pt0 = (std.mem.concat(_allocator, u8, &.{ "unexpected error: ", _zbr_error_msg() }) catch unreachable);
            std.debug.print("{s}\n", .{_pt0});
        }
    }
}

pub fn testGuardFail() void {
// zbr:test/guard_test.zbr:23
    var _try_err_3: ?anyerror = null;
    _try_blk_3: {
// zbr:test/guard_test.zbr:21
        const bad = Validator.checkPositive((-5)) catch |_tc_4| { _try_err_3 = _tc_4; break :_try_blk_3; };
// zbr:test/guard_test.zbr:22
        std.debug.print("{}\n", .{bad});
        break :_try_blk_3;
    }
    if (_try_err_3 != null) {
// zbr:test/guard_test.zbr:24
        {
            const _pt0 = (std.mem.concat(_allocator, u8, &.{ "guard raised: ", _zbr_error_msg() }) catch unreachable);
            std.debug.print("{s}\n", .{_pt0});
        }
    }
}
...
// zbr:test/guard_test.zbr:34
        std.debug.print("{s}\n", .{c});
// zbr:test/guard_test.zbr:36
        const empty = Validator.firstChar("");
// zbr:test/guard_test.zbr:37
        std.debug.print("{s}\n", .{empty});
// zbr:test/guard_test.zbr:40
        testGuardFail();
// zbr:test/guard_test.zbr:42
        std.debug.print("{s}\n", .{"ok"});
    }
