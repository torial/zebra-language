...
// Source: test/opt_ptr_local_var_test.zbr
...
pub const Node = struct {
    ...
    value: i64,
    next: ?*Node,
    pub fn init(v: i64, nxt: ?*Node) *Node {
        const _self = _allocator.create(Node) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Node");
// zbr:test/opt_ptr_local_var_test.zbr:9
            _self.value = v;
// zbr:test/opt_ptr_local_var_test.zbr:10
            _self.next = nxt;
        return _self;
    }
...
pub fn makeNode(v: i64) *Node {
// zbr:test/opt_ptr_local_var_test.zbr:13
    return Node.init(v, null);
}

pub fn head(n: *Node) *Node {
// zbr:test/opt_ptr_local_var_test.zbr:16
    return n.next.?;
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/opt_ptr_local_var_test.zbr:20
    const n1: *Node = Node.init(1, makeNode(99));
// zbr:test/opt_ptr_local_var_test.zbr:22
    std.debug.assert((head(n1).value == 99));
// zbr:test/opt_ptr_local_var_test.zbr:25
    const n2: *Node = Node.init(2, makeNode(77));
// zbr:test/opt_ptr_local_var_test.zbr:26
    const tail2: *Node = n2.next.?;
// zbr:test/opt_ptr_local_var_test.zbr:27
    std.debug.assert((tail2.value == 77));
// zbr:test/opt_ptr_local_var_test.zbr:30
    const n3 = Node.init(3, makeNode(55));
// zbr:test/opt_ptr_local_var_test.zbr:31
    const tail3: *Node = n3.next.?;
// zbr:test/opt_ptr_local_var_test.zbr:32
    std.debug.assert((tail3.value == 55));
// zbr:test/opt_ptr_local_var_test.zbr:35
    const n4: *Node = Node.init(4, makeNode(33));
// zbr:test/opt_ptr_local_var_test.zbr:36
    if (n4.next) |t4| {
// zbr:test/opt_ptr_local_var_test.zbr:37
        std.debug.assert((t4.value == 33));
    }
// zbr:test/opt_ptr_local_var_test.zbr:40
    const n5 = Node.init(5, makeNode(11));
// zbr:test/opt_ptr_local_var_test.zbr:41
    if (n5.next) |t5| {
// zbr:test/opt_ptr_local_var_test.zbr:42
        std.debug.assert((t5.value == 11));
    }
    std.debug.print("{s}\n", .{"opt_ptr_local_var: OK"});
}
