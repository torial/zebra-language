...
pub fn main() void {
// zbr:test/arena_scope_test.zbr:14
    const x: i64 = 0;
// zbr:test/arena_scope_test.zbr:17
    { // allocate
...
// zbr:test/arena_scope_test.zbr:18
        var c = Counter.init();
        c.inc();
        c.inc();
        c.inc();
...
// zbr:test/arena_scope_test.zbr:25
    std.debug.assert((x == 3));
// zbr:test/arena_scope_test.zbr:28
    const y: i64 = 0;
// zbr:test/arena_scope_test.zbr:29
    { // allocate
