...
// Source: test/hashmap_remove_test.zbr
...
pub fn main() void {
// zbr:test/hashmap_remove_test.zbr:5
    var m = HashMap([]const u8, i64).init();
// zbr:test/hashmap_remove_test.zbr:6
    m.put("a", 1);
// zbr:test/hashmap_remove_test.zbr:7
    m.put("b", 2);
// zbr:test/hashmap_remove_test.zbr:8
    m.put("c", 3);
// zbr:test/hashmap_remove_test.zbr:9
    if (!((@as(i64, @intCast(m.items.len)) == 3))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:11
    _ = m.orderedRemove(@as(usize, @intCast("b")));
// zbr:test/hashmap_remove_test.zbr:12
    if (!((@as(i64, @intCast(m.items.len)) == 2))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:13
    if (!((!(std.mem.indexOfScalar(@TypeOf(m.items[0]), m.items, "b") != null)))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:14
    if (!((std.mem.indexOfScalar(@TypeOf(m.items[0]), m.items, "a") != null))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:15
    if (!((std.mem.indexOfScalar(@TypeOf(m.items[0]), m.items, "c") != null))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:18
    _ = m.orderedRemove(@as(usize, @intCast("z")));
// zbr:test/hashmap_remove_test.zbr:19
    if (!((@as(i64, @intCast(m.items.len)) == 2))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:22
    var tags = HashMap([]const u8, []const u8).init();
// zbr:test/hashmap_remove_test.zbr:23
    tags.put("lang", "zebra");
// zbr:test/hashmap_remove_test.zbr:24
    tags.put("tier", "alpha");
// zbr:test/hashmap_remove_test.zbr:25
    if (!((@as(i64, @intCast(tags.items.len)) == 2))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:26
    _ = tags.orderedRemove(@as(usize, @intCast("tier")));
// zbr:test/hashmap_remove_test.zbr:27
    if (!((@as(i64, @intCast(tags.items.len)) == 1))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:28
    if (!((std.mem.indexOfScalar(@TypeOf(tags.items[0]), tags.items, "lang") != null))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/hashmap_remove_test.zbr:30
    std.debug.print("{s}\n", .{"ok"});
}
