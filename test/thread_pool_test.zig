...
// Source: test/thread_pool_test.zbr
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
// zbr:test/thread_pool_test.zbr:2
    var pool: *_ThreadPool = _thread_pool_create(4);
// zbr:test/thread_pool_test.zbr:3
    var counter: *_Atomic(i64) = _atomic_create(i64, 0);
// zbr:test/thread_pool_test.zbr:4
    var i: i64 = 0;
// zbr:test/thread_pool_test.zbr:5
    while (_zebra_lt(i, 8)) {
        pool.submit((struct {
            counter: *_Atomic(i64),
...
// zbr:test/thread_pool_test.zbr:11
        i = (i + 1);
    }
    pool.wait();
    std.debug.print("{any}\n", .{counter.load()});
