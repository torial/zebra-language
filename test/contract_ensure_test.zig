...
// Source: test/contract_ensure_test.zbr
...
pub const BankAccount = struct {
    ...
    pub fn deposit(self: *BankAccount, amount: i64) void {
        defer {
            if (!(_zebra_ge(self.balance, 0))) std.debug.panic("ensure failed in 'deposit'\n", .{});
        }
// zbr:test/contract_ensure_test.zbr:7
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/contract_ensure_test.zbr:12
