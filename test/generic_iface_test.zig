...
pub const Num = struct {
    ...
    pub fn init(n: i64) *Num {
        const self = _allocator.create(Num) catch @panic("OOM");
        self._type_tag = _ttag_Num;
...
const _ttag_Num: u64 = 1895626067;
...
// zbr:test/generic_iface_test.zbr:26
        var b = Box(*Num).init(Num.init(42));
// zbr:test/generic_iface_test.zbr:29
        std.debug.print("{}\n", .{b.get().val});
// zbr:test/generic_iface_test.zbr:30
        std.debug.print("{s}\n", .{"generic_iface OK"});
    }
