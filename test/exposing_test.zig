...
// Source: C:/Projects/zebra-language/test/exposing_test.zbr
...
fn _zbr_error_msg() []const u8 {
    ...
    if (@import("expose_lib.zig")._error_ctx.message.len > 0) return @import("expose_lib.zig")._error_ctx.message;
    return "";
}
