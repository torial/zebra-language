...
// Source: C:/Projects/zebra-language/test\tc_check.zbr
...
pub fn _zbr_error_msg() []const u8 {
    ...
    if (@import("tc_infer.zig")._zbr_error_msg().len > 0) return @import("tc_infer.zig")._zbr_error_msg();
    return "";
}
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:25
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:33
        self.name = n;
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:34
        self.decl_type = t;
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:35
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:42
        self.target_name = name;
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:43
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:49
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:55
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = c; self.cond = _rp; }
        return self;
    }
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:82
        self.errors = std.ArrayList([]const u8){};
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:83
        self._infer = infer;
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:84
        self._ret_type = ret_type;
        return self;
    }

    pub fn ok(self: *TcCheck) bool {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:88
        return (@as(i64, @intCast(self.errors.items.len)) == 0);
    }

    pub fn report(self: *TcCheck, msg: []const u8) void {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:92
        self.errors.append(_allocator, msg) catch unreachable;
    }

    pub fn checkStmt(self: *TcCheck, s: TcStmt) void {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:96
        switch (s) {
            .return_ => |r| {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:98
                const actual = self._infer.inferExpr(r.value.*);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:99
                if ((!TcTypes.isAssignable(actual, self._ret_type))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:100
            ...
            .return_void => {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:103
                if ((!TcTypes.eql(self._ret_type, TcType{ .void_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:104
                    if ((!TcTypes.eql(self._ret_type, TcType{ .unknown_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:105
            ...
            .var_decl => |d| {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:108
                const actual = self._infer.inferExpr(d.init_expr.*);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:109
                if ((!TcTypes.isAssignable(actual, d.decl_type))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:110
            ...
            .assign => |a| {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:113
                const rhs = self._infer.inferExpr(a.rhs_expr.*);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:114
                const lhs = self._infer.inferMember(TcType{ .unknown_ = {} }, a.target_name);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:115
                if (TcTypes.eql(lhs, TcType{ .unknown_ = {} })) {
                    // pass
                } else {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:118
                    if ((!TcTypes.isAssignable(rhs, lhs))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:119
            ...
            .if_ => |i| {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:122
                const cond_t = self._infer.inferExpr(i.cond.*);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:123
                if ((!TcTypes.eql(cond_t, TcType{ .bool_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:124
                    if ((!TcTypes.eql(cond_t, TcType{ .unknown_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:125
                        self.report(_str_concat("if condition must be bool, got ", TcTypes.typeName(cond_t), _allocator));
                    }
                }
            },
            .assert_ => |a| {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:128
                const cond_t = self._infer.inferExpr(a.cond.*);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:129
                if ((!TcTypes.eql(cond_t, TcType{ .bool_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:130
                    if ((!TcTypes.eql(cond_t, TcType{ .unknown_ = {} }))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:131
...
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:138
        var i: i64 = 0;
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:139
        while (_zebra_lt(i, @as(i64, @intCast(stmts.items.len)))) {
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:140
            self.checkStmt(stmts.items[@as(usize, @intCast(i))]);
// zbr:C:/Projects/zebra-language/test\tc_check.zbr:141
            i = (i + 1);
        }
    }
