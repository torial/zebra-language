...
// Source: C:/Projects/zebra-language/test/bench_zebra.zbr
...
pub const Bench = struct {
    ...
    pub fn init() *Bench {
        const self = _allocator.create(Bench) catch @panic("OOM");
        self._type_tag = _ttag_Bench;
        return self;
    }

};
const _ttag_Bench: u64 = _zbr_hash("Bench");
