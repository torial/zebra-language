...
pub fn main() void {
// zbr:test/datetime_test.zbr:3
    var epoch = _DateTime{ .epoch_ms = 0 };
// zbr:test/datetime_test.zbr:4
    var dt = _dt_from_gregorian(2024, 3, 15, 0, 0, 0);
// zbr:test/datetime_test.zbr:5
    var dt2 = _dt_from_gregorian(2024, 3, 15, 14, 30, 45);
    std.debug.print("{any}\n", .{epoch.year});
    std.debug.print("{any}\n", .{epoch.month});
    std.debug.print("{any}\n", .{epoch.day});
    std.debug.print("{any}\n", .{epoch.weekday});
    ...
    std.debug.print("{any}\n", .{epoch.toIso8601()});
    std.debug.print("{any}\n", .{dt2.toIso8601()});
    std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, dt2, .{ "yyyy-MM-dd HH:mm:ss" }) catch unreachable)});
    std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, dt2, .{ "d MMMM yyyy" }) catch unreachable)});
    std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, dt2, .{ "EEE, d MMM yyyy" }) catch unreachable)});
// zbr:test/datetime_test.zbr:36
    var _mc_1 = _dt_from_gregorian(2024, 3, 15, 0, 0, 0);
    const d_plus = _mc_1.addDays(10);
    std.debug.print("{any}\n", .{d_plus.day});
// zbr:test/datetime_test.zbr:40
    var jan31 = _dt_from_gregorian(2024, 1, 31, 0, 0, 0);
// zbr:test/datetime_test.zbr:41
    const feb_dt = jan31.addMonths(1);
    std.debug.print("{any}\n", .{feb_dt.month});
    std.debug.print("{any}\n", .{feb_dt.day});
// zbr:test/datetime_test.zbr:45
    var jan31_23 = _dt_from_gregorian(2023, 1, 31, 0, 0, 0);
// zbr:test/datetime_test.zbr:46
    const feb23_dt = jan31_23.addMonths(1);
    std.debug.print("{any}\n", .{feb23_dt.day});
// zbr:test/datetime_test.zbr:50
    var feb29_24 = _dt_from_gregorian(2024, 2, 29, 0, 0, 0);
// zbr:test/datetime_test.zbr:51
    const next_yr = feb29_24.addYears(1);
    std.debug.print("{any}\n", .{next_yr.year});
    std.debug.print("{any}\n", .{next_yr.day});
// zbr:test/datetime_test.zbr:56
    var t = _dt_from_gregorian(2024, 1, 1, 23, 59, 0);
// zbr:test/datetime_test.zbr:57
    const t2 = t.addHours(1);
    std.debug.print("{any}\n", .{t2.day});
    std.debug.print("{any}\n", .{t2.hour});
// zbr:test/datetime_test.zbr:62
    var a = _dt_from_gregorian(2020, 1, 1, 0, 0, 0);
// zbr:test/datetime_test.zbr:63
    var b = _dt_from_gregorian(2021, 1, 1, 0, 0, 0);
    std.debug.print("{any}\n", .{a.before(b)});
    std.debug.print("{any}\n", .{b.before(a)});
    std.debug.print("{any}\n", .{b.after(a)});
    std.debug.print("{any}\n", .{a.equals(a)});
    ...
    std.debug.print("{any}\n", .{a.daysBetween(b)});
    std.debug.print("{any}\n", .{b.daysBetween(a)});
// zbr:test/datetime_test.zbr:75
    var s1 = _dt_from_gregorian(2024, 1, 1, 0, 0, 0);
// zbr:test/datetime_test.zbr:76
    const s2 = _dt_from_gregorian(2024, 1, 1, 0, 0, 30);
    std.debug.print("{any}\n", .{s1.secondsBetween(s2)});
// zbr:test/datetime_test.zbr:80
    const view = dt.inCalendar(Calendar.Gregorian);
    std.debug.print("{any}\n", .{view.year});
    std.debug.print("{any}\n", .{view.month});
    std.debug.print("{any}\n", .{view.day});
    std.debug.print("{any}\n", .{view.weekday});
    std.debug.print("{any}\n", .{view.monthName});
    std.debug.print("{any}\n", .{view.era});
// zbr:test/datetime_test.zbr:89
    const now = _dt_now();
    std.debug.print("{}\n", .{_zebra_ge(now.year, 2024)});
}
