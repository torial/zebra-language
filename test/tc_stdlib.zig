    ...
    pub fn staticCall(class_: []const u8, method: []const u8) TcType {
        if (std.mem.eql(u8, class_, "Http")) {
            if ((std.mem.eql(u8, method, "get") or std.mem.eql(u8, method, "post"))) {
                return TcType{ .optional = TcType{ .http_response = {} } };
            }
            if ((std.mem.eql(u8, method, "json") or std.mem.eql(u8, method, "postJson"))) {
                return TcType{ .optional = TcType{ .json_value = {} } };
            }
            return TcType{ .void_ = {} };
        }
        ...
        if (std.mem.eql(u8, class_, "Tcp")) {
            if (std.mem.eql(u8, method, "connect")) {
                return TcType{ .optional = TcType{ .tcp_conn = {} } };
            }
            return TcType{ .void_ = {} };
        }
        ...
        if (std.mem.eql(u8, class_, "Compress")) {
            ...
            if (std.mem.eql(u8, method, "gunzip")) {
                return TcType{ .optional = TcType{ .string_ = {} } };
            }
            return TcType{ .unknown_ = {} };
        }
