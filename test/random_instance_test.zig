...
// Source: test/random_instance_test.zbr
...
pub fn test_deterministic_same_seed() anyerror!void {
// zbr:test/random_instance_test.zbr:8
    var a = _Random.init(12345);
// zbr:test/random_instance_test.zbr:9
    var b = _Random.init(12345);
// zbr:test/random_instance_test.zbr:10
    try _zebra_assert_cmp(a.nextInt(1, 1000000), b.nextInt(1, 1000000), true);
// zbr:test/random_instance_test.zbr:11
    try _zebra_assert_cmp(a.nextInt(1, 1000000), b.nextInt(1, 1000000), true);
// zbr:test/random_instance_test.zbr:12
    try _zebra_assert_cmp(a.nextInt(1, 1000000), b.nextInt(1, 1000000), true);
}

pub fn test_int_in_range() anyerror!void {
// zbr:test/random_instance_test.zbr:15
    var rng = _Random.init(7);
// zbr:test/random_instance_test.zbr:16
    var i: i64 = 0;
// zbr:test/random_instance_test.zbr:17
    while (_zebra_lt(i, 50)) {
// zbr:test/random_instance_test.zbr:18
        const n = rng.nextInt(1, 6);
// zbr:test/random_instance_test.zbr:19
        try _zebra_assert_bool(_zebra_ge(n, 1), true);
// zbr:test/random_instance_test.zbr:20
        try _zebra_assert_bool(_zebra_le(n, 6), true);
// zbr:test/random_instance_test.zbr:21
        i = (i + 1);
    }
}

pub fn test_float_in_range() anyerror!void {
// zbr:test/random_instance_test.zbr:24
    var rng = _Random.init(99);
// zbr:test/random_instance_test.zbr:25
    var i: i64 = 0;
// zbr:test/random_instance_test.zbr:26
    while (_zebra_lt(i, 20)) {
// zbr:test/random_instance_test.zbr:27
        const f = rng.nextFloat();
// zbr:test/random_instance_test.zbr:28
        try _zebra_assert_bool(_zebra_ge(f, 0.0), true);
// zbr:test/random_instance_test.zbr:29
        try _zebra_assert_bool(_zebra_lt(f, 1.0), true);
// zbr:test/random_instance_test.zbr:30
        i = (i + 1);
    }
}

pub fn test_bool_is_usable() anyerror!void {
// zbr:test/random_instance_test.zbr:33
    var rng = _Random.init(5);
// zbr:test/random_instance_test.zbr:34
    const t = rng.nextBool();
// zbr:test/random_instance_test.zbr:36
    try _zebra_assert_bool(((t == true) or (t == false)), true);
}

pub fn test_bytes_deterministic() anyerror!void {
// zbr:test/random_instance_test.zbr:39
    var a = _Random.init(2024);
// zbr:test/random_instance_test.zbr:40
    var b = _Random.init(2024);
// zbr:test/random_instance_test.zbr:42
    try _zebra_assert_cmp(a.bytes(8), b.bytes(8), true);
}
...
pub fn main(_zinit: std.process.Init) void {
    ...
    defer _arena.deinit();
    std.debug.print("{s}\n", .{"random_instance_test: run with 'zebra test'"});
}
