...
// Source: test/bug116_char_methods_test.zbr
...
pub fn main() void {
// zbr:test/bug116_char_methods_test.zbr:6
    const text: []const u8 = "Hello World 123";
// zbr:test/bug116_char_methods_test.zbr:7
    var alpha_count: i64 = 0;
// zbr:test/bug116_char_methods_test.zbr:8
    var digit_count: i64 = 0;
// zbr:test/bug116_char_methods_test.zbr:9
    var space_count: i64 = 0;
// zbr:test/bug116_char_methods_test.zbr:10
    {
        var _cp_it_c = std.unicode.Utf8View.initUnchecked(text).iterator();
        while (_cp_it_c.nextCodepoint()) |c| {
// zbr:test/bug116_char_methods_test.zbr:11
            if (std.ascii.isAlphabetic(@as(u8, @truncate(c)))) {
// zbr:test/bug116_char_methods_test.zbr:12
                alpha_count = (alpha_count + 1);
            }
// zbr:test/bug116_char_methods_test.zbr:13
            if (std.ascii.isDigit(@as(u8, @truncate(c)))) {
// zbr:test/bug116_char_methods_test.zbr:14
                digit_count = (digit_count + 1);
            }
// zbr:test/bug116_char_methods_test.zbr:15
            if (std.ascii.isWhitespace(@as(u8, @truncate(c)))) {
// zbr:test/bug116_char_methods_test.zbr:16
                space_count = (space_count + 1);
            }
        }
    }
// zbr:test/bug116_char_methods_test.zbr:17
    if (!((alpha_count == 10))) @panic(_str_concat("expected 10 alpha, got ", (std.fmt.allocPrint(_allocator, "{}", .{alpha_count}) catch unreachable), _allocator));
// zbr:test/bug116_char_methods_test.zbr:18
    if (!((digit_count == 3))) @panic(_str_concat("expected 3 digits, got ", (std.fmt.allocPrint(_allocator, "{}", .{digit_count}) catch unreachable), _allocator));
// zbr:test/bug116_char_methods_test.zbr:19
    if (!((space_count == 2))) @panic(_str_concat("expected 2 spaces, got ", (std.fmt.allocPrint(_allocator, "{}", .{space_count}) catch unreachable), _allocator));
// zbr:test/bug116_char_methods_test.zbr:22
    var upper_count: i64 = 0;
// zbr:test/bug116_char_methods_test.zbr:23
    var lower_count: i64 = 0;
// zbr:test/bug116_char_methods_test.zbr:24
    {
        var _cp_it_c = std.unicode.Utf8View.initUnchecked(text).iterator();
        while (_cp_it_c.nextCodepoint()) |c| {
// zbr:test/bug116_char_methods_test.zbr:25
            if (std.ascii.isUpper(@as(u8, @truncate(c)))) {
// zbr:test/bug116_char_methods_test.zbr:26
                upper_count = (upper_count + 1);
            }
// zbr:test/bug116_char_methods_test.zbr:27
            if (std.ascii.isLower(@as(u8, @truncate(c)))) {
// zbr:test/bug116_char_methods_test.zbr:28
                lower_count = (lower_count + 1);
            }
        }
    }
// zbr:test/bug116_char_methods_test.zbr:29
    if (!((upper_count == 2))) @panic(_str_concat("expected 2 upper, got ", (std.fmt.allocPrint(_allocator, "{}", .{upper_count}) catch unreachable), _allocator));
// zbr:test/bug116_char_methods_test.zbr:30
    if (!((lower_count == 8))) @panic(_str_concat("expected 8 lower, got ", (std.fmt.allocPrint(_allocator, "{}", .{lower_count}) catch unreachable), _allocator));
// zbr:test/bug116_char_methods_test.zbr:33
    var sb = std.ArrayList(u8){};
// zbr:test/bug116_char_methods_test.zbr:34
    {
        var _cp_it_c = std.unicode.Utf8View.initUnchecked("hello").iterator();
        while (_cp_it_c.nextCodepoint()) |c| {
            sb.append(_allocator, @as(u8, @intCast(@as(u21, std.ascii.toUpper(@as(u8, @truncate(c))))))) catch @panic("OOM");
        }
    }
// zbr:test/bug116_char_methods_test.zbr:36
    const up = (sb.toOwnedSlice(_allocator) catch "");
// zbr:test/bug116_char_methods_test.zbr:37
    if (!(std.mem.eql(u8, up, "HELLO"))) @panic(_str_concat("expected HELLO, got ", up, _allocator));
    std.debug.print("{s}\n", .{"bug116_char_methods_test: ok"});
}
