...
// Source: test/allocate_slice5_test.zbr
...
pub fn main() void {
// zbr:test/allocate_slice5_test.zbr:9
    var r1: []const u8 = "";
// zbr:test/allocate_slice5_test.zbr:10
    { // allocate
        ...
        defer { _allocator = _parent_alloc_1; _alloc_src_1.deinit(); }
// zbr:test/allocate_slice5_test.zbr:11
        const tmp1 = "hello from arena";
// zbr:test/allocate_slice5_test.zbr:12
        const _co_1: []const u8 = tmp1;
        r1 = _parent_alloc_1.dupe(u8, _co_1) catch _co_1;
    }
// zbr:test/allocate_slice5_test.zbr:13
    if (!(std.mem.eql(u8, r1, "hello from arena"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/allocate_slice5_test.zbr:16
    var r2: []const u8 = "";
// zbr:test/allocate_slice5_test.zbr:17
    { // allocate
        var _alloc_src_1 = std.heap.DebugAllocator(.{}){};
        const _parent_alloc_1 = _allocator;
        _allocator = _alloc_src_1.allocator();
        defer { _allocator = _parent_alloc_1; std.debug.assert(_alloc_src_1.deinit() == .ok); }
// zbr:test/allocate_slice5_test.zbr:18
        const tmp2 = "hello from debug";
// zbr:test/allocate_slice5_test.zbr:19
        const _co_2: []const u8 = tmp2;
        r2 = _parent_alloc_1.dupe(u8, _co_2) catch _co_2;
    }
// zbr:test/allocate_slice5_test.zbr:20
    if (!(std.mem.eql(u8, r2, "hello from debug"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/allocate_slice5_test.zbr:23
    var r3: []const u8 = "";
// zbr:test/allocate_slice5_test.zbr:24
    { // allocate
        var _fba_backing_1: [256]u8 = undefined;
        var _alloc_src_1 = std.heap.FixedBufferAllocator.init(&_fba_backing_1);
        const _parent_alloc_1 = _allocator;
        _allocator = _alloc_src_1.allocator();
        defer _allocator = _parent_alloc_1;
// zbr:test/allocate_slice5_test.zbr:25
        const tmp3 = "hello from fixed";
// zbr:test/allocate_slice5_test.zbr:26
        const _co_3: []const u8 = tmp3;
        r3 = _parent_alloc_1.dupe(u8, _co_3) catch _co_3;
    }
// zbr:test/allocate_slice5_test.zbr:27
    if (!(std.mem.eql(u8, r3, "hello from fixed"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/allocate_slice5_test.zbr:30
    var r4: []const u8 = "";
// zbr:test/allocate_slice5_test.zbr:31
    { // allocate
        const _parent_alloc_1 = _allocator;
        _allocator = std.heap.page_allocator;
        defer _allocator = _parent_alloc_1;
// zbr:test/allocate_slice5_test.zbr:32
        r4 = "hello from page";
    }
// zbr:test/allocate_slice5_test.zbr:33
    if (!(std.mem.eql(u8, r4, "hello from page"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/allocate_slice5_test.zbr:36
    var r5: []const u8 = "";
// zbr:test/allocate_slice5_test.zbr:37
    { // allocate
        var _alloc_src_1 = std.heap.ArenaAllocator.init(_allocator);
        const _parent_alloc_1 = _allocator;
        _allocator = _alloc_src_1.allocator();
        defer { _allocator = _parent_alloc_1; _alloc_src_1.deinit(); }
// zbr:test/allocate_slice5_test.zbr:38
        var inner: []const u8 = "";
// zbr:test/allocate_slice5_test.zbr:39
        { // allocate
            ...
            defer { _allocator = _parent_alloc_2; _alloc_src_2.deinit(); }
// zbr:test/allocate_slice5_test.zbr:40
            const tmp5 = "nested inner";
// zbr:test/allocate_slice5_test.zbr:41
            const _co_4: []const u8 = tmp5;
            inner = _parent_alloc_2.dupe(u8, _co_4) catch _co_4;
        }
// zbr:test/allocate_slice5_test.zbr:42
        const _co_5: []const u8 = inner;
        r5 = _parent_alloc_1.dupe(u8, _co_5) catch _co_5;
    }
// zbr:test/allocate_slice5_test.zbr:43
    if (!(std.mem.eql(u8, r5, "nested inner"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/allocate_slice5_test.zbr:45
    std.debug.print("{s}\n", .{"allocate Slice 5: all OK"});
}
