...
// Source: test/stdlib_hash_test.zbr
...
pub fn main() void {
// zbr:test/stdlib_hash_test.zbr:3
    const crc = _hash_crc32("hello");
// zbr:test/stdlib_hash_test.zbr:4
    std.debug.assert((crc != 0));
// zbr:test/stdlib_hash_test.zbr:7
    const fnv = _hash_fnv64("hello");
// zbr:test/stdlib_hash_test.zbr:8
    std.debug.assert((fnv != 0));
// zbr:test/stdlib_hash_test.zbr:11
    const xx = _hash_xxhash64("hello");
// zbr:test/stdlib_hash_test.zbr:12
    std.debug.assert((xx != 0));
// zbr:test/stdlib_hash_test.zbr:15
    std.debug.assert((_hash_crc32("hello") != _hash_crc32("world")));
// zbr:test/stdlib_hash_test.zbr:16
    std.debug.assert((_hash_fnv64("hello") != _hash_fnv64("world")));
// zbr:test/stdlib_hash_test.zbr:17
    std.debug.assert((_hash_xxhash64("hello") != _hash_xxhash64("world")));
// zbr:test/stdlib_hash_test.zbr:20
    const hmac = _hash_hmac512("key", "message");
// zbr:test/stdlib_hash_test.zbr:21
    std.debug.assert((hmac.len == 128));
// zbr:test/stdlib_hash_test.zbr:23
    std.debug.print("{s}\n", .{"stdlib_hash OK"});
}
