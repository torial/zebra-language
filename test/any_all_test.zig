...
pub const Program = struct {
    ...
    pub fn main() void {
// zbr:test/any_all_test.zbr:5
        var nums = std.ArrayList(i64){};
// zbr:test/any_all_test.zbr:6
        nums.append(_allocator, 1) catch unreachable;
// zbr:test/any_all_test.zbr:7
        nums.append(_allocator, 2) catch unreachable;
// zbr:test/any_all_test.zbr:8
        nums.append(_allocator, 3) catch unreachable;
// zbr:test/any_all_test.zbr:11
        const has_big = _zebra_list_any(std.meta.Child(@TypeOf(nums.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 2)) { return _zebra_gt(x, 2); } }.call, nums);
// zbr:test/any_all_test.zbr:12
        std.debug.print("{any}\n", .{has_big});
// zbr:test/any_all_test.zbr:15
        const has_huge = _zebra_list_any(std.meta.Child(@TypeOf(nums.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 10)) { return _zebra_gt(x, 10); } }.call, nums);
// zbr:test/any_all_test.zbr:16
        std.debug.print("{any}\n", .{has_huge});
// zbr:test/any_all_test.zbr:19
        const all_pos = _zebra_list_all(std.meta.Child(@TypeOf(nums.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 0)) { return _zebra_gt(x, 0); } }.call, nums);
// zbr:test/any_all_test.zbr:20
        std.debug.print("{any}\n", .{all_pos});
// zbr:test/any_all_test.zbr:23
        const all_big = _zebra_list_all(std.meta.Child(@TypeOf(nums.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 2)) { return _zebra_gt(x, 2); } }.call, nums);
// zbr:test/any_all_test.zbr:24
        std.debug.print("{any}\n", .{all_big});
// zbr:test/any_all_test.zbr:27
        const empty = std.ArrayList(i64){};
// zbr:test/any_all_test.zbr:30
        const empty_any = _zebra_list_any(std.meta.Child(@TypeOf(empty.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 0)) { return _zebra_gt(x, 0); } }.call, empty);
// zbr:test/any_all_test.zbr:31
        std.debug.print("{any}\n", .{empty_any});
// zbr:test/any_all_test.zbr:34
        const empty_all = _zebra_list_all(std.meta.Child(@TypeOf(empty.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 0)) { return _zebra_gt(x, 0); } }.call, empty);
// zbr:test/any_all_test.zbr:35
        std.debug.print("{any}\n", .{empty_all});
// zbr:test/any_all_test.zbr:38
        var one = std.ArrayList(i64){};
// zbr:test/any_all_test.zbr:39
        one.append(_allocator, 5) catch unreachable;
// zbr:test/any_all_test.zbr:41
        const one_any_t = _zebra_list_any(std.meta.Child(@TypeOf(one.items)), struct { fn call(x: anytype) @TypeOf((x == 5)) { return (x == 5); } }.call, one);
// zbr:test/any_all_test.zbr:42
        std.debug.print("{any}\n", .{one_any_t});
// zbr:test/any_all_test.zbr:44
        const one_any_f = _zebra_list_any(std.meta.Child(@TypeOf(one.items)), struct { fn call(x: anytype) @TypeOf((x == 0)) { return (x == 0); } }.call, one);
// zbr:test/any_all_test.zbr:45
        std.debug.print("{any}\n", .{one_any_f});
// zbr:test/any_all_test.zbr:47
        const one_all_t = _zebra_list_all(std.meta.Child(@TypeOf(one.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 0)) { return _zebra_gt(x, 0); } }.call, one);
// zbr:test/any_all_test.zbr:48
        std.debug.print("{any}\n", .{one_all_t});
// zbr:test/any_all_test.zbr:50
        const one_all_f = _zebra_list_all(std.meta.Child(@TypeOf(one.items)), struct { fn call(x: anytype) @TypeOf(_zebra_gt(x, 10)) { return _zebra_gt(x, 10); } }.call, one);
// zbr:test/any_all_test.zbr:51
        std.debug.print("{any}\n", .{one_all_f});
// zbr:test/any_all_test.zbr:55
        var words = std.ArrayList([]const u8){};
// zbr:test/any_all_test.zbr:56
        words.append(_allocator, _intern("hello")) catch unreachable;
// zbr:test/any_all_test.zbr:57
        words.append(_allocator, _intern("world")) catch unreachable;
// zbr:test/any_all_test.zbr:58
        words.append(_allocator, _intern("hi")) catch unreachable;
// zbr:test/any_all_test.zbr:61
        const has_hello = _zebra_list_any(std.meta.Child(@TypeOf(words.items)), struct { fn call(s: anytype) @TypeOf(std.mem.eql(u8, s, "hello")) { return std.mem.eql(u8, s, "hello"); } }.call, words);
// zbr:test/any_all_test.zbr:62
        std.debug.print("{any}\n", .{has_hello});
// zbr:test/any_all_test.zbr:65
        const has_xyz = _zebra_list_any(std.meta.Child(@TypeOf(words.items)), struct { fn call(s: anytype) @TypeOf(std.mem.eql(u8, s, "xyz")) { return std.mem.eql(u8, s, "xyz"); } }.call, words);
// zbr:test/any_all_test.zbr:66
        std.debug.print("{any}\n", .{has_xyz});
// zbr:test/any_all_test.zbr:69
        const all_hello = _zebra_list_all(std.meta.Child(@TypeOf(words.items)), struct { fn call(s: anytype) @TypeOf(std.mem.eql(u8, s, "hello")) { return std.mem.eql(u8, s, "hello"); } }.call, words);
// zbr:test/any_all_test.zbr:70
        std.debug.print("{any}\n", .{all_hello});
// zbr:test/any_all_test.zbr:73
        const all_nonempty = _zebra_list_all(std.meta.Child(@TypeOf(words.items)), struct { fn call(s: anytype) @TypeOf(!std.mem.eql(u8, s, "")) { return !std.mem.eql(u8, s, ""); } }.call, words);
// zbr:test/any_all_test.zbr:74
        std.debug.print("{any}\n", .{all_nonempty});
    }
