...
// Source: test/chan_thread_test.zbr
...
pub fn main() void {
// zbr:test/chan_thread_test.zbr:4
    var ch: *_Chan(i64) = _chan_create(i64, 4);
    _sys_go((struct {
        ch: *_Chan(i64),
...
// zbr:test/chan_thread_test.zbr:19
    var sum: i64 = 0;
// zbr:test/chan_thread_test.zbr:20
    var done: bool = false;
// zbr:test/chan_thread_test.zbr:21
    while ((!done)) {
// zbr:test/chan_thread_test.zbr:22
        const v: ?i64 = ch.recv();
// zbr:test/chan_thread_test.zbr:23
        if (v) |n| {
// zbr:test/chan_thread_test.zbr:24
            sum = (sum + n);
        } else {
// zbr:test/chan_thread_test.zbr:26
            done = true;
        }
    }
// zbr:test/chan_thread_test.zbr:28
    std.debug.assert((sum == 10));
    std.debug.print("{s}\n", .{"chan_thread: OK"});
}
