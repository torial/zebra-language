...
// Source: test/hashmap_param_field_test.zbr
...
pub const Scope = struct {
    _type_tag: u64 = _ttag_Scope,
    vars: std.StringHashMap(i64) = undefined,
    pub fn init() *Scope {
        const self = _allocator.create(Scope) catch @panic("OOM");
        self._type_tag = _ttag_Scope;
// zbr:test/hashmap_param_field_test.zbr:8
        self.vars = std.StringHashMap(i64).init(_allocator);
        return self;
    }

    pub fn define(self: *Scope, k: []const u8, v: i64) void {
// zbr:test/hashmap_param_field_test.zbr:11
        self.vars.put((_allocator.dupe(u8, k) catch @panic("OOM")), v) catch unreachable;
    }

};

const _ttag_Scope: u64 = 1676043659;
const _reflect_Scope_name: []const u8 = "Scope";
const _reflect_Scope_fields: []const []const u8 = &.{"vars"};
const _reflect_Scope_field_types: []const []const u8 = &.{"HashMap(str, int)"};

pub const Checker = struct {
    _type_tag: u64 = _ttag_Checker,
    pub fn hasVar(self: *Checker, sc: *Scope, name: []const u8) bool {
        _ = self;
// zbr:test/hashmap_param_field_test.zbr:15
        return (std.mem.indexOfScalar(@TypeOf(sc.vars.items[0]), sc.vars.items, name) != null);
    }
...
const _reflect_Checker_fields: []const []const u8 = &.{};
const _reflect_Checker_field_types: []const []const u8 = &.{};

pub fn main() void {
// zbr:test/hashmap_param_field_test.zbr:18
    const sc = Scope.init();
// zbr:test/hashmap_param_field_test.zbr:19
    sc.define("x", 1);
// zbr:test/hashmap_param_field_test.zbr:20
    const chk = Checker.init();
// zbr:test/hashmap_param_field_test.zbr:21
    std.debug.print("{}\n", .{chk.hasVar(sc, "x")});
// zbr:test/hashmap_param_field_test.zbr:22
    std.debug.print("{}\n", .{chk.hasVar(sc, "y")});
// zbr:test/hashmap_param_field_test.zbr:23
    std.debug.print("{s}\n", .{"ok"});
}
