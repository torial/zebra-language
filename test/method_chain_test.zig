...
// Source: test/method_chain_test.zbr
...
// zbr:test/method_chain_test.zbr:5
        self.value = v;
        return self;
    }

    pub fn withVal(self: *Builder, n: i64) Builder {
// zbr:test/method_chain_test.zbr:8
        const r = blk: {
            var _tmp = self.*;
            _tmp.value = n;
            break :blk _tmp;
        };
// zbr:test/method_chain_test.zbr:10
        return r;
    }

    pub fn doubled(self: *Builder) Builder {
// zbr:test/method_chain_test.zbr:13
        const r = blk: {
            var _tmp = self.*;
            _tmp.value = (self.value * 2);
            break :blk _tmp;
        };
// zbr:test/method_chain_test.zbr:15
        return r;
    }

    pub fn result(self: *Builder) i64 {
// zbr:test/method_chain_test.zbr:18
        return self.value;
    }

};

pub fn makeBuilder(n: i64) Builder {
// zbr:test/method_chain_test.zbr:21
