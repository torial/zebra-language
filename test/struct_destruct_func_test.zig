...
// Source: test/struct_destruct_func_test.zbr
...
pub fn makePerson() *Person {
// zbr:test/struct_destruct_func_test.zbr:6
    var p = Person.init();
// zbr:test/struct_destruct_func_test.zbr:7
    p.name = _intern("Bob");
// zbr:test/struct_destruct_func_test.zbr:8
    p.age = 25;
// zbr:test/struct_destruct_func_test.zbr:9
    return p;
}
...
pub const Program = struct {
    ...
    pub fn main() void {
// zbr:test/struct_destruct_func_test.zbr:17
        const _dt_1 = makePerson();
        const name = _dt_1.name;
        const age = _dt_1.age;
// zbr:test/struct_destruct_func_test.zbr:18
        std.debug.print("{s}\n", .{name});
// zbr:test/struct_destruct_func_test.zbr:19
        std.debug.print("{}\n", .{age});
    }
