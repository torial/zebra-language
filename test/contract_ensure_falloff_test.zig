...
// Source: test/contract_ensure_falloff_test.zbr
...
pub const Counter = struct {
    ...
    pub fn bump(self: *Counter) void {
        ...
        defer {
            if (_ensure_armed and !(_zebra_gt(self.value, 0))) std.debug.panic("ensure failed in 'bump'\n", .{});
        }
// zbr:test/contract_ensure_falloff_test.zbr:11
...
const _reflect_Counter_fields: []const []const u8 = &.{"value"};
const _reflect_Counter_field_types: []const []const u8 = &.{"int"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/contract_ensure_falloff_test.zbr:17
        var c = Counter.init();
        c.bump();
        c.bump();
// zbr:test/contract_ensure_falloff_test.zbr:20
        std.debug.assert((c.value == 2));
        std.debug.print("{s}\n", .{"contract_ensure_falloff_test OK"});
    }
