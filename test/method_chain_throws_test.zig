...
// Source: test/method_chain_throws_test.zbr
...
pub const Widget = struct {
    ...
    pub fn init(lbl: []const u8) Widget {
        var self: Widget = undefined;
// zbr:test/method_chain_throws_test.zbr:5
        self.label = lbl;
        return self;
    }

    pub fn withLabel(self: *Widget, s: []const u8) Widget {
// zbr:test/method_chain_throws_test.zbr:8
        const r = blk: {
            var _tmp = self.*;
            _tmp.label = s;
            break :blk _tmp;
        };
// zbr:test/method_chain_throws_test.zbr:10
        return r;
    }

    pub fn name(self: *Widget) anyerror![]const u8 {
// zbr:test/method_chain_throws_test.zbr:13
        if (std.mem.eql(u8, self.label, "bad")) {
// zbr:test/method_chain_throws_test.zbr:14
            _error_ctx = .{ .message = "invalid label", .details = null };
            return error.ZebraError;
        }
// zbr:test/method_chain_throws_test.zbr:15
        return self.label;
    }

};

pub fn makeWidget(lbl: []const u8) Widget {
// zbr:test/method_chain_throws_test.zbr:18
    return Widget.init(lbl);
}

pub fn acceptStr(s: []const u8) []const u8 {
// zbr:test/method_chain_throws_test.zbr:21
    return s;
}

pub fn testCallArgChain() anyerror![]const u8 {
// zbr:test/method_chain_throws_test.zbr:26
    return acceptStr((blk_1: { var _mc_1 = makeWidget("hello"); break :blk_1 try _mc_1.name(); }));
}

pub fn testVarInitChain() anyerror![]const u8 {
// zbr:test/method_chain_throws_test.zbr:31
    const n = (blk_2: { var _mc_2 = makeWidget("ok"); break :blk_2 try _mc_2.name(); });
// zbr:test/method_chain_throws_test.zbr:32
    return n;
}

pub fn testNestedChain() anyerror![]const u8 {
// zbr:test/method_chain_throws_test.zbr:37
    return acceptStr((blk_3: { var _mc_3 = (blk_4: { var _mc_4 = makeWidget("hi"); break :blk_4 _mc_4.withLabel("world"); }); break :blk_3 try _mc_3.name(); }));
}

pub fn main() void {
// zbr:test/method_chain_throws_test.zbr:47
    var _try_err_5: ?anyerror = null;
    _try_blk_5: {
// zbr:test/method_chain_throws_test.zbr:40
        const a = testCallArgChain() catch |_e| { _try_err_5 = _e; break :_try_blk_5; };
// zbr:test/method_chain_throws_test.zbr:41
        std.debug.print("{s}\n", .{a});
// zbr:test/method_chain_throws_test.zbr:42
        const b = testVarInitChain() catch |_e| { _try_err_5 = _e; break :_try_blk_5; };
// zbr:test/method_chain_throws_test.zbr:43
        std.debug.print("{s}\n", .{b});
// zbr:test/method_chain_throws_test.zbr:44
        const c = testNestedChain() catch |_e| { _try_err_5 = _e; break :_try_blk_5; };
// zbr:test/method_chain_throws_test.zbr:45
        std.debug.print("{s}\n", .{c});
// zbr:test/method_chain_throws_test.zbr:46
        std.debug.print("{s}\n", .{"ok"});
        break :_try_blk_5;
    }
    if (_try_err_5 != null) {
// zbr:test/method_chain_throws_test.zbr:48
        std.debug.print("{s}\n", .{_str_concat("ERROR: ", _zbr_error_msg(), _allocator)});
    }
}
