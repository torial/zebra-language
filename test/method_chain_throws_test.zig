...
// zbr:test/method_chain_throws_test.zbr:14
            { _error_ctx = .{ .message = "invalid label" }; return error.ZebraError; }
        }
...
// zbr:test/method_chain_throws_test.zbr:31
    var _mc_2 = makeWidget("ok");
    const n = try _mc_2.name();
...
// zbr:test/method_chain_throws_test.zbr:41
            const a = testCallArgChain() catch |_tc_e| { _try_err = _tc_e; break :_try_blk; };
            std.debug.print("{s}\n", .{a});
// zbr:test/method_chain_throws_test.zbr:43
            const b = testVarInitChain() catch |_tc_e| { _try_err = _tc_e; break :_try_blk; };
            std.debug.print("{s}\n", .{b});
// zbr:test/method_chain_throws_test.zbr:45
            const c = testNestedChain() catch |_tc_e| { _try_err = _tc_e; break :_try_blk; };
            std.debug.print("{s}\n", .{c});
            std.debug.print("{s}\n", .{"ok"});
            break :_try_blk;
        }
