...
// Source: test/stdlib_misc_test.zbr
...
pub fn main() void {
// zbr:test/stdlib_misc_test.zbr:3
    const cwd = (std.fs.cwd().realpathAlloc(_allocator, ".") catch "");
// zbr:test/stdlib_misc_test.zbr:4
    std.debug.assert(_zebra_gt(cwd.len, 0));
// zbr:test/stdlib_misc_test.zbr:7
    _sys_setenv("ZEBRA_TEST_VAR", "hello_zebra");
// zbr:test/stdlib_misc_test.zbr:8
    const val = _sys_getenv("ZEBRA_TEST_VAR");
// zbr:test/stdlib_misc_test.zbr:9
    std.debug.assert((val != null));
// zbr:test/stdlib_misc_test.zbr:10
    std.debug.assert(std.mem.eql(u8, val.?, "hello_zebra"));
// zbr:test/stdlib_misc_test.zbr:13
    const g = _random_gaussian(0.0, 1.0);
// zbr:test/stdlib_misc_test.zbr:15
    std.debug.assert((_zebra_gt(g, (-10.0)) and _zebra_lt(g, 10.0)));
// zbr:test/stdlib_misc_test.zbr:18
    var keys = std.ArrayList([]const u8){};
// zbr:test/stdlib_misc_test.zbr:19
    keys.append(_allocator, _intern("a")) catch unreachable;
// zbr:test/stdlib_misc_test.zbr:20
    keys.append(_allocator, _intern("b")) catch unreachable;
// zbr:test/stdlib_misc_test.zbr:21
    keys.append(_allocator, _intern("c")) catch unreachable;
// zbr:test/stdlib_misc_test.zbr:22
    var weights = std.ArrayList(f64){};
// zbr:test/stdlib_misc_test.zbr:23
    weights.append(_allocator, 1.0) catch unreachable;
// zbr:test/stdlib_misc_test.zbr:24
    weights.append(_allocator, 0.0) catch unreachable;
// zbr:test/stdlib_misc_test.zbr:25
    weights.append(_allocator, 0.0) catch unreachable;
// zbr:test/stdlib_misc_test.zbr:27
    const choice = _random_weighted(keys, weights);
// zbr:test/stdlib_misc_test.zbr:28
    std.debug.assert(std.mem.eql(u8, choice, "a"));
// zbr:test/stdlib_misc_test.zbr:31
    const abs = (blk: { const _pp = "."; break :blk std.fs.cwd().realpathAlloc(_allocator, _pp) catch _pp; });
// zbr:test/stdlib_misc_test.zbr:32
    std.debug.assert(_zebra_gt(abs.len, 0));
// zbr:test/stdlib_misc_test.zbr:33
    std.debug.assert((!std.mem.startsWith(u8, abs, ".")));
// zbr:test/stdlib_misc_test.zbr:35
    std.debug.print("{s}\n", .{"stdlib_misc OK"});
}
