...
// Source: C:/Projects/zebra-language/test/sort_test.zbr
...
pub const Program = struct {
    ...
    pub fn main() void {
        ...
        words.append(_allocator, "banana") catch @panic("OOM");
        words.append(_allocator, "apple") catch @panic("OOM");
        words.append(_allocator, "cherry") catch @panic("OOM");
        ...
        reverse_sort.append(_allocator, "cat") catch @panic("OOM");
        reverse_sort.append(_allocator, "ant") catch @panic("OOM");
        reverse_sort.append(_allocator, "bat") catch @panic("OOM");
        ...
        mixed_case.append(_allocator, "Apple") catch @panic("OOM");
        mixed_case.append(_allocator, "apple") catch @panic("OOM");
        mixed_case.append(_allocator, "Banana") catch @panic("OOM");
