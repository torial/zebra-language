...
pub const Program = struct {
    ...
    pub fn main() void {
        ...
        _zebra_sort_by(@TypeOf(desc.items[0]), struct { fn call(a: anytype, b: anytype) @TypeOf((a > b)) { return (a > b); } }.call, desc.items);
        for (desc.items) |n| {
            std.debug.print("{}\n", .{n});
        }
        ...
        _zebra_sort_by(@TypeOf(people.items[0]), struct { fn call(a: anytype, b: anytype) @TypeOf((a.score > b.score)) { return (a.score > b.score); } }.call, people.items);
        for (people.items) |p| {
            std.debug.print("{}\n", .{p.name});
        }
        ...
        _zebra_sort_by(@TypeOf(reverse_sort.items[0]), struct { fn call(a: anytype, b: anytype) @TypeOf((a > b)) { return (a > b); } }.call, reverse_sort.items);
        ...
        _zebra_sort_by(@TypeOf(people2.items[0]), struct { fn call(a: anytype, b: anytype) void {
            if ((a.score != b.score)) {
