...
// zbr:test/sort_test.zbr:5
        ...
        nums.append(_allocator, 5) catch @panic("OOM");
        nums.append(_allocator, 2) catch @panic("OOM");
        nums.append(_allocator, 8) catch @panic("OOM");
        nums.append(_allocator, 1) catch @panic("OOM");
        nums.append(_allocator, 9) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(nums.items)), nums.items);
...
// zbr:test/sort_test.zbr:16
        ...
        words.append(_allocator, _intern("banana")) catch @panic("OOM");
        words.append(_allocator, _intern("apple")) catch @panic("OOM");
        words.append(_allocator, _intern("cherry")) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(words.items)), words.items);
...
// zbr:test/sort_test.zbr:25
        ...
        desc.append(_allocator, 3) catch @panic("OOM");
        desc.append(_allocator, 1) catch @panic("OOM");
        desc.append(_allocator, 4) catch @panic("OOM");
        desc.append(_allocator, 1) catch @panic("OOM");
        desc.append(_allocator, 5) catch @panic("OOM");
        _zebra_sort_by(std.meta.Child(@TypeOf(desc.items)), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a, b)) { return _zebra_gt(a, b); } }.call, desc.items);
...
// zbr:test/sort_test.zbr:45
        ...
        people.append(_allocator, alice) catch @panic("OOM");
        people.append(_allocator, bob) catch @panic("OOM");
        people.append(_allocator, carol) catch @panic("OOM");
        _zebra_sort_by(std.meta.Child(@TypeOf(people.items)), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a.score, b.score)) { return _zebra_gt(a.score, b.score); } }.call, people.items);
...
// zbr:test/sort_test.zbr:54
        ...
        stable.append(_allocator, 3) catch @panic("OOM");
        stable.append(_allocator, 1) catch @panic("OOM");
        stable.append(_allocator, 3) catch @panic("OOM");
        stable.append(_allocator, 2) catch @panic("OOM");
        stable.append(_allocator, 1) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(stable.items)), stable.items);
...
// zbr:test/sort_test.zbr:65
        ...
        reverse_sort.append(_allocator, _intern("cat")) catch @panic("OOM");
        reverse_sort.append(_allocator, _intern("ant")) catch @panic("OOM");
        reverse_sort.append(_allocator, _intern("bat")) catch @panic("OOM");
        _zebra_sort_by(std.meta.Child(@TypeOf(reverse_sort.items)), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a, b)) { return _zebra_gt(a, b); } }.call, reverse_sort.items);
...
// zbr:test/sort_test.zbr:74
        ...
        _zebra_sort_natural(std.meta.Child(@TypeOf(empty.items)), empty.items);
        std.debug.print("{any}\n", .{@as(i64, @intCast(empty.items.len))});
// zbr:test/sort_test.zbr:79
        var single = std.ArrayList(i64){};
        single.append(_allocator, 42) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(single.items)), single.items);
        std.debug.print("{any}\n", .{single.items[@intCast(0)]});
// zbr:test/sort_test.zbr:85
        var already = std.ArrayList(i64){};
        already.append(_allocator, 1) catch @panic("OOM");
        already.append(_allocator, 2) catch @panic("OOM");
        already.append(_allocator, 3) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(already.items)), already.items);
...
// zbr:test/sort_test.zbr:94
        ...
        rev_input.append(_allocator, 3) catch @panic("OOM");
        rev_input.append(_allocator, 2) catch @panic("OOM");
        rev_input.append(_allocator, 1) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(rev_input.items)), rev_input.items);
...
// zbr:test/sort_test.zbr:103
        ...
        dupes.append(_allocator, 1) catch @panic("OOM");
        dupes.append(_allocator, 5) catch @panic("OOM");
        dupes.append(_allocator, 1) catch @panic("OOM");
        dupes.append(_allocator, 5) catch @panic("OOM");
        dupes.append(_allocator, 1) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(dupes.items)), dupes.items);
        std.debug.print("{any}\n", .{@as(i64, @intCast(dupes.items.len))});
// zbr:test/sort_test.zbr:113
        var floats = std.ArrayList(f64){};
        floats.append(_allocator, 3.14) catch @panic("OOM");
        floats.append(_allocator, 2.71) catch @panic("OOM");
        floats.append(_allocator, 1.41) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(floats.items)), floats.items);
...
// zbr:test/sort_test.zbr:122
        ...
        mixed_case.append(_allocator, _intern("Apple")) catch @panic("OOM");
        mixed_case.append(_allocator, _intern("apple")) catch @panic("OOM");
        mixed_case.append(_allocator, _intern("Banana")) catch @panic("OOM");
        _zebra_sort_natural(std.meta.Child(@TypeOf(mixed_case.items)), mixed_case.items);
...
// zbr:test/sort_test.zbr:134
        p1.score = 90;
        people2.append(_allocator, p1) catch @panic("OOM");
...
// zbr:test/sort_test.zbr:138
        p2.score = 90;
        people2.append(_allocator, p2) catch @panic("OOM");
...
// zbr:test/sort_test.zbr:142
        p3.score = 85;
        people2.append(_allocator, p3) catch @panic("OOM");
        _zebra_sort_by(std.meta.Child(@TypeOf(people2.items)), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a.name, b.name)) {
...
pub const Person = struct {
    ...
    score: i64 = 0,
    pub fn init() *Person {
        const self = _allocator.create(Person) catch @panic("OOM");
...
const _ttag_Person: u64 = _zbr_hash("Person");
