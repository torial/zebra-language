...
// Source: test/float_suffix_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/float_suffix_test.zbr:4
        const a: f64 = @as(f32, 1.5);
// zbr:test/float_suffix_test.zbr:5
        const b: f64 = @as(f64, 2.5);
// zbr:test/float_suffix_test.zbr:6
        const c: f64 = @as(f32, 0.5);
// zbr:test/float_suffix_test.zbr:7
        const d: f64 = @as(f64, 3.0);
// zbr:test/float_suffix_test.zbr:8
        std.debug.print("{d}\n", .{a});
// zbr:test/float_suffix_test.zbr:9
        std.debug.print("{d}\n", .{b});
// zbr:test/float_suffix_test.zbr:10
        std.debug.print("{d}\n", .{c});
// zbr:test/float_suffix_test.zbr:11
        std.debug.print("{d}\n", .{d});
    }
