...
pub const Builder = struct {
    val: i64,
    name: []const u8,
    pub fn init(v: i64, n: []const u8) Builder {
        var _self: Builder = undefined;
// zbr:test/bug082_lib.zbr:6
            _self.val = v;
// zbr:test/bug082_lib.zbr:7
            _self.name = _intern(n);
        return _self;
    }

    pub fn withVal(self: *Builder, v: i64) Builder {
// zbr:test/bug082_lib.zbr:10
        const r = blk: { var _except_tmp = self.*; _except_tmp.val = v; break :blk _except_tmp; };
// zbr:test/bug082_lib.zbr:12
        return r;
    }

    pub fn withName(self: *Builder, n: []const u8) Builder {
// zbr:test/bug082_lib.zbr:15
        const r = blk: { var _except_tmp = self.*; _except_tmp.name = n; break :blk _except_tmp; };
// zbr:test/bug082_lib.zbr:17
        return r;
    }

    pub fn show(self: *Builder) []const u8 {
// zbr:test/bug082_lib.zbr:20
        return (std.fmt.allocPrint(_allocator, "Builder({}, {s})", .{self.val, self.name}) catch @panic("OOM"));
    }
