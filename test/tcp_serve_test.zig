...
// Source: test/tcp_serve_test.zbr
...
pub fn handleConn(conn: TcpConn) void {
// zbr:test/tcp_serve_test.zbr:2
    const data = _tcp_read(conn);
    _tcp_write(conn, _str_concat("ECHO:", data, _allocator));
    _tcp_close(conn);
}

pub fn startServer() void {
    _tcp_serve(19876, handleConn);
}
