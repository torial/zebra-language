...
// Source: C:/Projects/zebra-language/test/tc_types_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        std.debug.print("{s}\n", .{"3. named eql OK"});
        const opt_int = TcType{ .optional = TcType{ .int_ = {} } };
        const opt_int2 = TcType{ .optional = TcType{ .int_ = {} } };
        const opt_str = TcType{ .optional = TcType{ .string_ = {} } };
        ...
        const opt_opt_int = TcType{ .optional = TcType{ .optional = TcType{ .int_ = {} } } };
        const opt_opt_int2 = TcType{ .optional = TcType{ .optional = TcType{ .int_ = {} } } };
        ...
        std.debug.assert(TcTypes.isAssignable(TcType{ .int_ = {} }, TcType{ .optional = TcType{ .int_ = {} } }));
        std.debug.assert(TcTypes.isAssignable(opt_int, opt_int2));
        const nil_t = TcType{ .optional = TcType{ .void_ = {} } };
        std.debug.assert(TcTypes.isAssignable(nil_t, TcType{ .optional = TcType{ .string_ = {} } }));
        ...
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .optional = TcType{ .int_ = {} } }), "?int"));
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .optional = TcType{ .optional = TcType{ .string_ = {} } } }), "??String"));
