...
// zbr:test/tc_types_test.zbr:38
        const opt_int = TcType{ .optional = blk_box_1: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_1 _bp; } };
// zbr:test/tc_types_test.zbr:39
        const opt_int2 = TcType{ .optional = blk_box_2: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_2 _bp; } };
// zbr:test/tc_types_test.zbr:40
        const opt_str = TcType{ .optional = blk_box_3: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .string_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_3 _bp; } };
...
// zbr:test/tc_types_test.zbr:45
        const opt_opt_int = TcType{ .optional = blk_box_4: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .optional = blk_box_5: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_5 _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_4 _bp; } };
// zbr:test/tc_types_test.zbr:46
        const opt_opt_int2 = TcType{ .optional = blk_box_6: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .optional = blk_box_7: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_7 _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_6 _bp; } };
...
// zbr:test/tc_types_test.zbr:51
        ...
        ta.append(_allocator, TcType{ .int_ = {} }) catch @panic("OOM");
        ta.append(_allocator, TcType{ .string_ = {} }) catch @panic("OOM");
// zbr:test/tc_types_test.zbr:54
        var tb = std.ArrayList(TcType){};
        tb.append(_allocator, TcType{ .int_ = {} }) catch @panic("OOM");
        tb.append(_allocator, TcType{ .string_ = {} }) catch @panic("OOM");
// zbr:test/tc_types_test.zbr:57
        var tc = std.ArrayList(TcType){};
        tc.append(_allocator, TcType{ .int_ = {} }) catch @panic("OOM");
        tc.append(_allocator, TcType{ .int_ = {} }) catch @panic("OOM");
...
// zbr:test/tc_types_test.zbr:82
        std.debug.assert((blk_in: { if (TcTypes.len == 0) break :blk_in false; for (TcTypes) |_nc| { if (!std.ascii.isDigit(_nc)) break :blk_in false; } break :blk_in true; }));
...
// zbr:test/tc_types_test.zbr:97
        std.debug.assert(TcTypes.isAssignable(TcType{ .int_ = {} }, TcType{ .optional = blk_box_8: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_8 _bp; } }));
// zbr:test/tc_types_test.zbr:99
        std.debug.assert(TcTypes.isAssignable(opt_int, opt_int2));
// zbr:test/tc_types_test.zbr:101
        const nil_t = TcType{ .optional = blk_box_9: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .void_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_9 _bp; } };
// zbr:test/tc_types_test.zbr:102
        std.debug.assert(TcTypes.isAssignable(nil_t, TcType{ .optional = blk_box_10: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .string_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_10 _bp; } }));
...
// zbr:test/tc_types_test.zbr:114
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .optional = blk_box_11: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .int_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_11 _bp; } }), "?int"));
// zbr:test/tc_types_test.zbr:115
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .optional = blk_box_12: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .optional = blk_box_13: { const _bv: std.meta.Child(@FieldType(TcType, "optional")) = TcType{ .string_ = {} }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_13 _bp; } }; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_12 _bp; } }), "??String"));
...
// zbr:test/tc_types_test.zbr:125
        ...
        ga_args.append(_allocator, TcType{ .int_ = {} }) catch @panic("OOM");
// zbr:test/tc_types_test.zbr:127
        var gb_args = std.ArrayList(TcType){};
        gb_args.append(_allocator, TcType{ .int_ = {} }) catch @panic("OOM");
// zbr:test/tc_types_test.zbr:129
        var gc_args = std.ArrayList(TcType){};
        gc_args.append(_allocator, TcType{ .string_ = {} }) catch @panic("OOM");
