...
// zbr:test/tc_types_test.zbr:38
        const opt_int = TcType{ .optional = _box_1: { const _bp_1 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1.* = TcType{ .int_ = {} }; break :_box_1 _bp_1; } };
// zbr:test/tc_types_test.zbr:39
        const opt_int2 = TcType{ .optional = _box_2: { const _bp_2 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_2.* = TcType{ .int_ = {} }; break :_box_2 _bp_2; } };
// zbr:test/tc_types_test.zbr:40
        const opt_str = TcType{ .optional = _box_3: { const _bp_3 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_3.* = TcType{ .string_ = {} }; break :_box_3 _bp_3; } };
...
// zbr:test/tc_types_test.zbr:45
        const opt_opt_int = TcType{ .optional = _box_4: { const _bp_4 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_4.* = TcType{ .optional = _box_5: { const _bp_5 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_5.* = TcType{ .int_ = {} }; break :_box_5 _bp_5; } }; break :_box_4 _bp_4; } };
// zbr:test/tc_types_test.zbr:46
        const opt_opt_int2 = TcType{ .optional = _box_6: { const _bp_6 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_6.* = TcType{ .optional = _box_7: { const _bp_7 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_7.* = TcType{ .int_ = {} }; break :_box_7 _bp_7; } }; break :_box_6 _bp_6; } };
...
// zbr:test/tc_types_test.zbr:97
        std.debug.assert(TcTypes.isAssignable(TcType{ .int_ = {} }, TcType{ .optional = _box_8: { const _bp_8 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_8.* = TcType{ .int_ = {} }; break :_box_8 _bp_8; } }));
// zbr:test/tc_types_test.zbr:99
        std.debug.assert(TcTypes.isAssignable(opt_int, opt_int2));
// zbr:test/tc_types_test.zbr:101
        const nil_t = TcType{ .optional = _box_9: { const _bp_9 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_9.* = TcType{ .void_ = {} }; break :_box_9 _bp_9; } };
// zbr:test/tc_types_test.zbr:102
        std.debug.assert(TcTypes.isAssignable(nil_t, TcType{ .optional = _box_a: { const _bp_a = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_a.* = TcType{ .string_ = {} }; break :_box_a _bp_a; } }));
...
// zbr:test/tc_types_test.zbr:114
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .optional = _box_b: { const _bp_b = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_b.* = TcType{ .int_ = {} }; break :_box_b _bp_b; } }), "?int"));
// zbr:test/tc_types_test.zbr:115
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .optional = _box_c: { const _bp_c = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_c.* = TcType{ .optional = _box_d: { const _bp_d = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_d.* = TcType{ .string_ = {} }; break :_box_d _bp_d; } }; break :_box_c _bp_c; } }), "??String"));
