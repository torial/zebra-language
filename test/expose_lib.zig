...
// Source: C:/Projects/zebra-language/test\expose_lib.zbr
...
pub const Palette = struct {
    ...
    pub fn init(n: []const u8) *Palette {
        const self = _allocator.create(Palette) catch @panic("OOM");
        self._type_tag = _ttag_Palette;
// zbr:C:/Projects/zebra-language/test\expose_lib.zbr:10
        self.name = n;
        return self;
    }

    pub fn describe(self: *Palette) []const u8 {
// zbr:C:/Projects/zebra-language/test\expose_lib.zbr:13
...
// zbr:C:/Projects/zebra-language/test\expose_lib.zbr:16
    return Color{ .red = {} };
}
