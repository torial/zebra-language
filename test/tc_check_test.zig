...
// zbr:test/tc_check_test.zbr:21
        var chk1 = TcCheck.init(inf, TcType{ .int_ = {} });
...
// zbr:test/tc_check_test.zbr:24
        if (!(chk1.ok())) @panic("valid return should produce no errors");
        std.debug.print("{s}\n", .{"1. valid return OK"});
// zbr:test/tc_check_test.zbr:28
        var chk2 = TcCheck.init(inf, TcType{ .int_ = {} });
...
// zbr:test/tc_check_test.zbr:31
        if (!((!chk2.ok()))) @panic("return type mismatch should be reported");
...
// zbr:test/tc_check_test.zbr:36
        var chk3 = TcCheck.init(inf, TcType{ .void_ = {} });
...
// zbr:test/tc_check_test.zbr:42
        var chk4 = TcCheck.init(inf, TcType{ .int_ = {} });
...
// zbr:test/tc_check_test.zbr:48
        var chk5 = TcCheck.init(inf, TcType{ .void_ = {} });
...
// zbr:test/tc_check_test.zbr:55
        var chk6 = TcCheck.init(inf, TcType{ .void_ = {} });
...
// zbr:test/tc_check_test.zbr:63
        var chk7 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:64
        const bi_cmp = TcExprBinary.init("==", TcExpr{ .int_lit = {} }, TcExpr{ .int_lit = {} });
// zbr:test/tc_check_test.zbr:65
        const if_ok = TcStmtIf.init(TcExpr{ .binary = blk_box_1: { const _bv: std.meta.Child(@FieldType(TcExpr, "binary")) = bi_cmp; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_1 _bp; } });
...
// zbr:test/tc_check_test.zbr:71
        var chk8 = TcCheck.init(inf, TcType{ .void_ = {} });
...
// zbr:test/tc_check_test.zbr:78
        var chk9 = TcCheck.init(inf, TcType{ .void_ = {} });
...
// zbr:test/tc_check_test.zbr:85
        var chk10 = TcCheck.init(inf, TcType{ .void_ = {} });
...
// zbr:test/tc_check_test.zbr:92
        var chk11 = TcCheck.init(inf, TcType{ .void_ = {} });
        chk11.checkStmt(TcStmt{ .pass_ = {} });
// zbr:test/tc_check_test.zbr:94
        std.debug.assert(chk11.ok());
        std.debug.print("{s}\n", .{"11. pass_ OK"});
// zbr:test/tc_check_test.zbr:98
        var chk12 = TcCheck.init(inf, TcType{ .int_ = {} });
// zbr:test/tc_check_test.zbr:99
        var stmts = std.ArrayList(TcStmt){};
        stmts.append(_allocator, TcStmt{ .var_decl = TcStmtVarDecl.init("a", TcType{ .int_ = {} }, TcExpr{ .string_lit = {} }) }) catch @panic("OOM");
        stmts.append(_allocator, TcStmt{ .var_decl = TcStmtVarDecl.init("b", TcType{ .string_ = {} }, TcExpr{ .int_lit = {} }) }) catch @panic("OOM");
        stmts.append(_allocator, TcStmt{ .pass_ = {} }) catch @panic("OOM");
        chk12.checkStmts(stmts);
// zbr:test/tc_check_test.zbr:104
        if (!((@as(i64, @intCast(chk12.errors.items.len)) == 2))) @panic("two type mismatches in three stmts");
