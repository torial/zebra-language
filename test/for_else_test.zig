...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/for_else_test.zbr:6
        var nums = std.ArrayList(i64){};
// zbr:test/for_else_test.zbr:7
        nums.append(_allocator, 1) catch unreachable;
// zbr:test/for_else_test.zbr:8
        nums.append(_allocator, 2) catch unreachable;
// zbr:test/for_else_test.zbr:9
        nums.append(_allocator, 3) catch unreachable;
// zbr:test/for_else_test.zbr:10
        var found: i64 = (-1);
// zbr:test/for_else_test.zbr:11
        for (nums) |x| {
// zbr:test/for_else_test.zbr:12
            if ((x == 99)) {
// zbr:test/for_else_test.zbr:13
                found = x;
                break;
            }
        } else {
// zbr:test/for_else_test.zbr:16
            found = 0;
        }
// zbr:test/for_else_test.zbr:17
        std.debug.print("{}\n", .{found});
// zbr:test/for_else_test.zbr:20
        var found2: i64 = (-1);
// zbr:test/for_else_test.zbr:21
        for (nums) |x| {
// zbr:test/for_else_test.zbr:22
            if ((x == 2)) {
// zbr:test/for_else_test.zbr:23
                found2 = x;
                break;
            }
        } else {
// zbr:test/for_else_test.zbr:26
            found2 = 0;
        }
// zbr:test/for_else_test.zbr:27
        std.debug.print("{}\n", .{found2});
// zbr:test/for_else_test.zbr:30
        var found3: i64 = (-1);
// zbr:test/for_else_test.zbr:31
        const empty = std.ArrayList(i64){};
// zbr:test/for_else_test.zbr:32
        for (empty) |x| {
// zbr:test/for_else_test.zbr:33
            found3 = x;
        } else {
// zbr:test/for_else_test.zbr:35
            found3 = 42;
        }
// zbr:test/for_else_test.zbr:36
        std.debug.print("{}\n", .{found3});
// zbr:test/for_else_test.zbr:40
        var found_n: i64 = (-1);
// zbr:test/for_else_test.zbr:41
        const _fels_1 = _fels_1: {
            var i: i64 = 0;
            while (i < 5) : (i += 1) {
// zbr:test/for_else_test.zbr:42
                if ((i == 99)) {
// zbr:test/for_else_test.zbr:43
                    found_n = i;
                    break :_fels_1 false;
                }
            }
        ...
        if (_fels_1) {
// zbr:test/for_else_test.zbr:46
            found_n = 0;
        }
// zbr:test/for_else_test.zbr:47
        std.debug.print("{}\n", .{found_n});
// zbr:test/for_else_test.zbr:50
        var found_n2: i64 = (-1);
// zbr:test/for_else_test.zbr:51
        const _fels_2 = _fels_2: {
            var i: i64 = 0;
            while (i < 5) : (i += 1) {
// zbr:test/for_else_test.zbr:52
                if ((i == 3)) {
// zbr:test/for_else_test.zbr:53
                    found_n2 = i;
                    break :_fels_2 false;
                }
            }
        ...
        if (_fels_2) {
// zbr:test/for_else_test.zbr:56
            found_n2 = 0;
        }
// zbr:test/for_else_test.zbr:57
        std.debug.print("{}\n", .{found_n2});
// zbr:test/for_else_test.zbr:61
        const text = "hello world foo";
// zbr:test/for_else_test.zbr:62
        var found_s: []const u8 = "not found";
// zbr:test/for_else_test.zbr:63
        const _fels_3 = _fels_3: {
            var _it_word = std.mem.splitSequence(u8, text, " ");
            while (_it_word.next()) |word| {
// zbr:test/for_else_test.zbr:64
                if (std.mem.eql(u8, word, "bar")) {
// zbr:test/for_else_test.zbr:65
                    found_s = word;
                    break :_fels_3 false;
                }
            }
        ...
        if (_fels_3) {
// zbr:test/for_else_test.zbr:68
            found_s = "default";
        }
// zbr:test/for_else_test.zbr:69
        std.debug.print("{s}\n", .{found_s});
// zbr:test/for_else_test.zbr:72
        var found_s2: []const u8 = "not found";
// zbr:test/for_else_test.zbr:73
        const _fels_4 = _fels_4: {
            var _it_word2 = std.mem.splitSequence(u8, text, " ");
            while (_it_word2.next()) |word2| {
// zbr:test/for_else_test.zbr:74
                if (std.mem.eql(u8, word2, "world")) {
// zbr:test/for_else_test.zbr:75
                    found_s2 = word2;
                    break :_fels_4 false;
                }
            }
        ...
        if (_fels_4) {
// zbr:test/for_else_test.zbr:78
            found_s2 = "default";
        }
// zbr:test/for_else_test.zbr:79
        std.debug.print("{s}\n", .{found_s2});
// zbr:test/for_else_test.zbr:83
        var found_c: i64 = (-1);
// zbr:test/for_else_test.zbr:84
        const cs = "hello";
// zbr:test/for_else_test.zbr:85
        const _fels_6 = _fels_6: {
            var _cp_it_5 = std.unicode.Utf8View.initUnchecked(cs).iterator();
            while (_cp_it_5.nextCodepoint()) |cp| {
// zbr:test/for_else_test.zbr:86
                if ((cp == 120)) {
// zbr:test/for_else_test.zbr:87
                    found_c = cp;
                    break :_fels_6 false;
                }
            }
        ...
        if (_fels_6) {
// zbr:test/for_else_test.zbr:90
            found_c = 42;
        }
// zbr:test/for_else_test.zbr:91
        std.debug.print("{}\n", .{found_c});
// zbr:test/for_else_test.zbr:94
        var found_c2: i64 = (-1);
// zbr:test/for_else_test.zbr:95
        const _fels_8 = _fels_8: {
            var _cp_it_7 = std.unicode.Utf8View.initUnchecked(cs).iterator();
            while (_cp_it_7.nextCodepoint()) |cp2| {
// zbr:test/for_else_test.zbr:96
                if ((cp2 == 104)) {
// zbr:test/for_else_test.zbr:97
                    found_c2 = cp2;
                    break :_fels_8 false;
                }
            }
        ...
        if (_fels_8) {
// zbr:test/for_else_test.zbr:100
            found_c2 = 42;
        }
// zbr:test/for_else_test.zbr:101
        std.debug.print("{}\n", .{found_c2});
// zbr:test/for_else_test.zbr:103
        std.debug.print("{s}\n", .{"ok"});
    }
