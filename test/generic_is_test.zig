...
// Source: C:/Projects/zebra-language/test/generic_is_test.zbr
...
const _reflect_Box_fields: []const []const u8 = &.{"value"};
const _reflect_Box_field_types: []const []const u8 = &.{"T"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
        const b = Box.init(int)(42);
        std.debug.print("{any}\n", .{b._type_tag == _ttag_Box});
        std.debug.print("{any}\n", .{(!b._type_tag == _ttag_Box)});
        const s = Box.init(str)("hi");
