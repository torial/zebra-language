...
// Source: C:/Projects/zebra-language/test/tco_test.zbr
...
pub const Acc = struct {
    ...
    pub fn sumTo(n: i64, acc: i64) i64 {
        if (_zebra_le(n, 0)) {
            return acc;
        }
    ...
    pub fn init() *Acc {
        const self = _allocator.create(Acc) catch @panic("OOM");
        self._type_tag = _ttag_Acc;
        return self;
    }

};
const _ttag_Acc: u64 = _zbr_hash("Acc");
...
pub const Counter = struct {
    ...
    count: i64 = 0,
    pub fn countDown(self: *Counter, n: i64) i64 {
        if (_zebra_le(n, 0)) {
            return self.count;
        }
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_Acc) return _reflect_Acc_name;
...
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_Acc) return .{ .items = _reflect_Acc_fields };
...
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_Acc) return .{ .items = _reflect_Acc_field_types };
