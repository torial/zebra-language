...
// Source: C:/Projects/zebra-language/test/fn_ref_test.zbr
...
pub const FnRefTest = struct {
    ...
    pub fn init() *FnRefTest {
        const self = _allocator.create(FnRefTest) catch @panic("OOM");
        self._type_tag = _ttag_FnRefTest;
        return self;
    }

};
const _ttag_FnRefTest: u64 = _zbr_hash("FnRefTest");
