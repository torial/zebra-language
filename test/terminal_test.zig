...
// Source: C:/Projects/zebra-language/test/terminal_test.zbr
...
pub const TerminalTest = struct {
    ...
    pub fn init() *TerminalTest {
        const self = _allocator.create(TerminalTest) catch @panic("OOM");
        self._type_tag = _ttag_TerminalTest;
        return self;
    }

};
const _ttag_TerminalTest: u64 = _zbr_hash("TerminalTest");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_TerminalTest) return _reflect_TerminalTest_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_TerminalTest) return .{ .items = _reflect_TerminalTest_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_TerminalTest) return .{ .items = _reflect_TerminalTest_field_types };
    return .{ .items = &.{} };
}
