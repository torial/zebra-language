...
const _ttag_Ratchet: u64 = 790236698;
...
// zbr:test/contract_old_compound_test.zbr:14
    const r = Ratchet.init();
// zbr:test/contract_old_compound_test.zbr:15
    r.advance(3);
// zbr:test/contract_old_compound_test.zbr:16
    std.debug.assert((r.val == 3));
// zbr:test/contract_old_compound_test.zbr:17
    r.advance(7);
// zbr:test/contract_old_compound_test.zbr:18
    std.debug.assert((r.val == 7));
// zbr:test/contract_old_compound_test.zbr:19
