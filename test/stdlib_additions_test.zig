...
// Source: test/stdlib_additions_test.zbr
...
pub fn main() void {
// zbr:test/stdlib_additions_test.zbr:4
    std.debug.assert((_zebra_gt(std.math.phi, 1.6) and _zebra_lt(std.math.phi, 1.7)));
// zbr:test/stdlib_additions_test.zbr:5
    std.debug.assert((_zebra_gt(std.math.sqrt2, 1.41) and _zebra_lt(std.math.sqrt2, 1.42)));
// zbr:test/stdlib_additions_test.zbr:6
    std.debug.assert((_zebra_gt(std.math.ln2, 0.69) and _zebra_lt(std.math.ln2, 0.70)));
// zbr:test/stdlib_additions_test.zbr:7
    std.debug.assert((_zebra_gt(std.math.ln10, 2.30) and _zebra_lt(std.math.ln10, 2.31)));
// zbr:test/stdlib_additions_test.zbr:10
    std.debug.assert((std.math.sinh(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_additions_test.zbr:11
    std.debug.assert((std.math.cosh(@as(f64, 0.0)) == 1.0));
// zbr:test/stdlib_additions_test.zbr:12
    std.debug.assert((std.math.tanh(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_additions_test.zbr:13
    std.debug.assert((_zebra_gt(std.math.cbrt(@as(f64, 8.0)), 1.99) and _zebra_lt(std.math.cbrt(@as(f64, 8.0)), 2.01)));
// zbr:test/stdlib_additions_test.zbr:14
    std.debug.assert((_zebra_gt(std.math.hypot(@as(f64, 3.0), @as(f64, 4.0)), 4.99) and _zebra_lt(std.math.hypot(@as(f64, 3.0), @as(f64, 4.0)), 5.01)));
// zbr:test/stdlib_additions_test.zbr:15
    std.debug.assert((_zebra_gt(std.math.lerp(@as(f64, 0.0), @as(f64, 10.0), @as(f64, 0.5)), 4.99) and _zebra_lt(std.math.lerp(@as(f64, 0.0), @as(f64, 10.0), @as(f64, 0.5)), 5.01)));
// zbr:test/stdlib_additions_test.zbr:16
    std.debug.assert(((blk: { var _ga = @as(i64, @intCast(@abs(12))); var _gb = @as(i64, @intCast(@abs(8))); while (_gb != 0) { const _gt = _gb; _gb = @mod(_ga, _gb); _ga = _gt; } break :blk _ga; }) == 4));
// zbr:test/stdlib_additions_test.zbr:17
    std.debug.assert(((blk: { const _la = @as(i64, @intCast(@abs(4))); const _lb = @as(i64, @intCast(@abs(6))); var _lg = _la; var _lh = _lb; while (_lh != 0) { const _lt = _lh; _lh = @mod(_lg, _lh); _lg = _lt; } break :blk if (_lg == 0) @as(i64, 0) else @divExact(_la, _lg) * _lb; }) == 12));
// zbr:test/stdlib_additions_test.zbr:18
    std.debug.assert((_zebra_gt(std.math.degreesToRadians(@as(f64, 180.0)), 3.14) and _zebra_lt(std.math.degreesToRadians(@as(f64, 180.0)), 3.15)));
// zbr:test/stdlib_additions_test.zbr:19
    std.debug.assert((_zebra_gt(std.math.radiansToDegrees(@as(f64, std.math.pi)), 179.9) and _zebra_lt(std.math.radiansToDegrees(@as(f64, std.math.pi)), 180.1)));
// zbr:test/stdlib_additions_test.zbr:20
    std.debug.assert((blk: { const _po2 = 8; break :blk _po2 > 0 and (_po2 & (_po2 - 1)) == 0; }));
// zbr:test/stdlib_additions_test.zbr:21
    std.debug.assert((!(blk: { const _po2 = 7; break :blk _po2 > 0 and (_po2 & (_po2 - 1)) == 0; })));
// zbr:test/stdlib_additions_test.zbr:22
    std.debug.assert((@mod((-1), 5) == 4));
// zbr:test/stdlib_additions_test.zbr:23
    std.debug.assert((@as(i64, @intCast(@popCount(@as(u64, @intCast(7))))) == 3));
// zbr:test/stdlib_additions_test.zbr:24
    std.debug.assert((@as(i64, @intCast(@clz(@as(u64, @intCast(1))))) == 63));
// zbr:test/stdlib_additions_test.zbr:25
    std.debug.assert((@as(i64, @intCast(@ctz(@as(u64, @intCast(8))))) == 3));
// zbr:test/stdlib_additions_test.zbr:26
    std.debug.assert((std.math.log1p(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_additions_test.zbr:27
    std.debug.assert((std.math.expm1(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_additions_test.zbr:30
    std.debug.assert(((if (std.mem.lastIndexOf(u8, "hello world", "o")) |_li| @as(i64, @intCast(_li)) else @as(i64, -1)) == 7));
// zbr:test/stdlib_additions_test.zbr:31
    std.debug.assert(((if (std.mem.lastIndexOf(u8, "hello world", "z")) |_li| @as(i64, @intCast(_li)) else @as(i64, -1)) == (-1)));
// zbr:test/stdlib_additions_test.zbr:32
    std.debug.assert(std.ascii.eqlIgnoreCase("Hello", "hello"));
// zbr:test/stdlib_additions_test.zbr:33
    std.debug.assert((blk: { if ("abc123".len == 0) break :blk false; for ("abc123") |_an| { if (!std.ascii.isAlphanumeric(_an)) break :blk false; } break :blk true; }));
// zbr:test/stdlib_additions_test.zbr:34
    std.debug.assert((!(blk: { if ("abc 123".len == 0) break :blk false; for ("abc 123") |_an| { if (!std.ascii.isAlphanumeric(_an)) break :blk false; } break :blk true; })));
// zbr:test/stdlib_additions_test.zbr:35
    std.debug.assert((blk: { if ("hello".len == 0) break :blk false; for ("hello") |_pr| { if (!std.ascii.isPrint(_pr)) break :blk false; } break :blk true; }));
// zbr:test/stdlib_additions_test.zbr:36
    std.debug.assert(std.ascii.startsWithIgnoreCase("Hello", "he"));
// zbr:test/stdlib_additions_test.zbr:37
    std.debug.assert(std.ascii.endsWithIgnoreCase("Hello World", "WORLD"));
// zbr:test/stdlib_additions_test.zbr:38
    std.debug.assert((std.ascii.indexOfIgnoreCase("Hello World", "HELLO") != null));
// zbr:test/stdlib_additions_test.zbr:39
    std.debug.assert(((if (std.ascii.indexOfIgnoreCase("Hello World", "world")) |_ii| @as(i64, @intCast(_ii)) else @as(i64, -1)) == 6));
// zbr:test/stdlib_additions_test.zbr:40
    std.debug.assert(((if (std.mem.indexOfPos(u8, "hello world", @intCast(5), "o")) |_if| @as(i64, @intCast(_if)) else @as(i64, -1)) == 7));
// zbr:test/stdlib_additions_test.zbr:41
    std.debug.assert(((std.fmt.parseInt(i64, "FF", @intCast(16)) catch 0) == 255));
// zbr:test/stdlib_additions_test.zbr:42
    std.debug.assert(((std.fmt.parseInt(i64, "1010", @intCast(2)) catch 0) == 10));
// zbr:test/stdlib_additions_test.zbr:43
    const parts = (blk_tok: { var _tok_it = std.mem.tokenizeSequence(u8, "  hello   world  ", " "); var _tok_list = std.ArrayList([]const u8){}; while (_tok_it.next()) |_tok_t| { _tok_list.append(_allocator, _tok_t) catch unreachable; } break :blk_tok _tok_list; });
// zbr:test/stdlib_additions_test.zbr:44
    std.debug.assert((@as(i64, @intCast(parts.items.len)) == 2));
// zbr:test/stdlib_additions_test.zbr:47
    const enc = _base64_encode("hello");
// zbr:test/stdlib_additions_test.zbr:48
    std.debug.assert(std.mem.eql(u8, enc, "aGVsbG8="));
// zbr:test/stdlib_additions_test.zbr:49
    const dec = _base64_decode("aGVsbG8=");
// zbr:test/stdlib_additions_test.zbr:50
    if (dec) |s| {
// zbr:test/stdlib_additions_test.zbr:51
        std.debug.assert(std.mem.eql(u8, s, "hello"));
    }
// zbr:test/stdlib_additions_test.zbr:52
    const enc_url = _base64_encode_url("hello");
// zbr:test/stdlib_additions_test.zbr:53
    std.debug.assert(std.mem.eql(u8, enc_url, "aGVsbG8"));
// zbr:test/stdlib_additions_test.zbr:55
    const enc2 = _base64_encode("hello");
// zbr:test/stdlib_additions_test.zbr:56
    std.debug.assert(std.mem.eql(u8, enc2, "aGVsbG8="));
// zbr:test/stdlib_additions_test.zbr:57
    const dec2 = _base64_decode_str("aGVsbG8=");
// zbr:test/stdlib_additions_test.zbr:58
    std.debug.assert(std.mem.eql(u8, dec2, "hello"));
// zbr:test/stdlib_additions_test.zbr:61
    const crc = _hash_crc32("hello");
// zbr:test/stdlib_additions_test.zbr:62
    std.debug.assert((crc != 0));
// zbr:test/stdlib_additions_test.zbr:63
    const fnv = _hash_fnv64("hello");
// zbr:test/stdlib_additions_test.zbr:64
    std.debug.assert((fnv != 0));
// zbr:test/stdlib_additions_test.zbr:65
    const xx = _hash_xxhash64("hello");
// zbr:test/stdlib_additions_test.zbr:66
    std.debug.assert((xx != 0));
// zbr:test/stdlib_additions_test.zbr:67
    const hmac = _hash_hmac512("key", "data");
// zbr:test/stdlib_additions_test.zbr:68
    std.debug.assert(_zebra_gt(hmac.len, 0));
// zbr:test/stdlib_additions_test.zbr:71
    const g = _random_gaussian(0.0, 1.0);
// zbr:test/stdlib_additions_test.zbr:73
    std.debug.assert((_zebra_gt(g, (-100.0)) and _zebra_lt(g, 100.0)));
// zbr:test/stdlib_additions_test.zbr:76
    (std.fs.cwd().writeFile(.{ .sub_path = "_test_stdlib_tmp.txt", .data = "hello\nworld" }) catch @panic("File.write error"));
// zbr:test/stdlib_additions_test.zbr:77
    std.debug.assert((blk: { std.fs.cwd().access("_test_stdlib_tmp.txt", .{}) catch break :blk false; break :blk true; }));
// zbr:test/stdlib_additions_test.zbr:78
    std.debug.assert((blk: { const _fi_stat = std.fs.cwd().statFile("_test_stdlib_tmp.txt") catch break :blk false; break :blk _fi_stat.kind == .file; }));
// zbr:test/stdlib_additions_test.zbr:79
    std.debug.assert((!(blk: { var _fd_dir = std.fs.cwd().openDir("_test_stdlib_tmp.txt", .{}) catch break :blk false; _fd_dir.close(); break :blk true; })));
// zbr:test/stdlib_additions_test.zbr:80
    const sz = (blk: { const _fs_stat = std.fs.cwd().statFile("_test_stdlib_tmp.txt") catch break :blk @as(i64, -1); break :blk @as(i64, @intCast(_fs_stat.size)); });
// zbr:test/stdlib_additions_test.zbr:81
    std.debug.assert((sz == 11));
// zbr:test/stdlib_additions_test.zbr:82
    _file_write_lines("_test_stdlib_lines.txt", (blk_1: { var _ll_1: std.ArrayList([]const u8) = std.ArrayList([]const u8){}; _ll_1.append(_allocator, "line1") catch @panic("OOM"); _ll_1.append(_allocator, "line2") catch @panic("OOM"); break :blk_1 _ll_1; }));
// zbr:test/stdlib_additions_test.zbr:83
    const lines = (blk: {
        const _fl_content = std.fs.cwd().readFileAlloc(_allocator, "_test_stdlib_lines.txt", std.math.maxInt(usize)) catch @panic("File.readLines error");
...
// zbr:test/stdlib_additions_test.zbr:84
    std.debug.assert(_zebra_ge(@as(i64, @intCast(lines.items.len)), 2));
// zbr:test/stdlib_additions_test.zbr:85
    (std.fs.cwd().deleteFile("_test_stdlib_tmp.txt") catch |_fd_err| { if (_fd_err != error.FileNotFound) @panic("File.delete error"); });
// zbr:test/stdlib_additions_test.zbr:86
    (std.fs.cwd().deleteFile("_test_stdlib_lines.txt") catch |_fd_err| { if (_fd_err != error.FileNotFound) @panic("File.delete error"); });
// zbr:test/stdlib_additions_test.zbr:89
    const cwd = (std.fs.cwd().realpathAlloc(_allocator, ".") catch "");
// zbr:test/stdlib_additions_test.zbr:90
    std.debug.assert(_zebra_gt(cwd.len, 0));
// zbr:test/stdlib_additions_test.zbr:93
    const abs = (blk: { const _pp = "."; break :blk std.fs.cwd().realpathAlloc(_allocator, _pp) catch _pp; });
// zbr:test/stdlib_additions_test.zbr:94
    std.debug.assert(_zebra_gt(abs.len, 0));
// zbr:test/stdlib_additions_test.zbr:97
    const now = _dt_now();
// zbr:test/stdlib_additions_test.zbr:98
    const ts = @divFloor(now.epoch_ms, 1000);
// zbr:test/stdlib_additions_test.zbr:99
    std.debug.assert(_zebra_gt(ts, 1000000000));
// zbr:test/stdlib_additions_test.zbr:101
    std.debug.print("{s}\n", .{"stdlib_additions OK"});
}
