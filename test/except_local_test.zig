...
// Source: test/except_local_test.zbr
...
pub const Box = struct {
    ...
    pub fn init(v: i64) Box {
        var self: Box = undefined;
// zbr:test/except_local_test.zbr:14
        self.v = v;
        return self;
    }

    pub fn bumped(self: *Box, delta: i64) Box {
// zbr:test/except_local_test.zbr:18
        const b = blk: {
            var _tmp = self.*;
            _tmp.v = (self.v + delta);
            break :blk _tmp;
        };
// zbr:test/except_local_test.zbr:20
        return b;
    }

    pub fn viaLocal(self: *Box, delta: i64) Box {
// zbr:test/except_local_test.zbr:24
        const tmp: Box = blk: {
            var _tmp = self.*;
            _tmp.v = (self.v + 0);
            break :blk _tmp;
        };
// zbr:test/except_local_test.zbr:26
        const out = blk: {
            var _tmp = tmp;
            _tmp.v = (tmp.v + delta);
            break :blk _tmp;
        };
// zbr:test/except_local_test.zbr:28
        return out;
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/except_local_test.zbr:33
        var b = Box.init(10);
// zbr:test/except_local_test.zbr:34
        const b2 = b.bumped(5);
// zbr:test/except_local_test.zbr:35
        std.debug.assert((b.v == 10));
// zbr:test/except_local_test.zbr:36
        std.debug.assert((b2.v == 15));
// zbr:test/except_local_test.zbr:38
        const b3 = b.viaLocal(7);
// zbr:test/except_local_test.zbr:39
        std.debug.assert((b.v == 10));
// zbr:test/except_local_test.zbr:40
        std.debug.assert((b3.v == 17));
// zbr:test/except_local_test.zbr:42
        std.debug.print("{s}\n", .{"BUG-031 verification: OK"});
    }
