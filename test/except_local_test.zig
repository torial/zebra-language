...
// Source: C:/Projects/zebra-language/test/except_local_test.zbr
...
pub const Box = struct {
    ...
    pub fn init(v: i64) Box {
        var _self: Box = undefined;
            _self.v = v;
        return _self;
    }

    pub fn bumped(self: *Box, delta: i64) Box {
        const b = blk: { var _except_tmp = self.*; _except_tmp.v = (self.v + delta); break :blk _except_tmp; };
        return b;
    }

    pub fn viaLocal(self: *Box, delta: i64) Box {
        const tmp: Box = blk: { var _except_tmp = self.*; _except_tmp.v = (self.v + 0); break :blk _except_tmp; };
        const out = blk: { var _except_tmp = tmp; _except_tmp.v = (tmp.v + delta); break :blk _except_tmp; };
        return out;
    }
