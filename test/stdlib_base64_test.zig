...
// Source: test/stdlib_base64_test.zbr
...
pub fn main() void {
// zbr:test/stdlib_base64_test.zbr:3
    const encoded = _base64_encode("hello world");
// zbr:test/stdlib_base64_test.zbr:4
    std.debug.assert(std.mem.eql(u8, encoded, "aGVsbG8gd29ybGQ="));
// zbr:test/stdlib_base64_test.zbr:5
    const decoded = _base64_decode("aGVsbG8gd29ybGQ=");
// zbr:test/stdlib_base64_test.zbr:6
    std.debug.assert((decoded != null));
// zbr:test/stdlib_base64_test.zbr:7
    std.debug.assert(std.mem.eql(u8, decoded.?, "hello world"));
// zbr:test/stdlib_base64_test.zbr:10
    const enc_url = _base64_encode_url("hello world");
// zbr:test/stdlib_base64_test.zbr:11
    std.debug.assert(std.mem.eql(u8, enc_url, "aGVsbG8gd29ybGQ"));
// zbr:test/stdlib_base64_test.zbr:12
    const dec_url = _base64_decode_url("aGVsbG8gd29ybGQ");
// zbr:test/stdlib_base64_test.zbr:13
    std.debug.assert((dec_url != null));
// zbr:test/stdlib_base64_test.zbr:14
    std.debug.assert(std.mem.eql(u8, dec_url.?, "hello world"));
// zbr:test/stdlib_base64_test.zbr:17
    const bad = _base64_decode("!!!invalid!!!");
// zbr:test/stdlib_base64_test.zbr:18
    std.debug.assert((bad == null));
// zbr:test/stdlib_base64_test.zbr:21
    const s = "hello";
// zbr:test/stdlib_base64_test.zbr:22
    const s_enc = _base64_encode(s);
// zbr:test/stdlib_base64_test.zbr:23
    std.debug.assert(std.mem.eql(u8, s_enc, "aGVsbG8="));
// zbr:test/stdlib_base64_test.zbr:24
    const s_dec = _base64_decode_str(s_enc);
// zbr:test/stdlib_base64_test.zbr:25
    std.debug.assert(std.mem.eql(u8, s_dec, "hello"));
// zbr:test/stdlib_base64_test.zbr:27
    std.debug.print("{s}\n", .{"stdlib_base64 OK"});
}
