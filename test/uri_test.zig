...
// Source: C:/Projects/zebra-language/test/uri_test.zbr
...
pub const UriTest = struct {
    ...
    pub fn init() *UriTest {
        const self = _allocator.create(UriTest) catch @panic("OOM");
        self._type_tag = _ttag_UriTest;
        return self;
    }

};
const _ttag_UriTest: u64 = _zbr_hash("UriTest");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_UriTest) return _reflect_UriTest_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_UriTest) return .{ .items = _reflect_UriTest_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_UriTest) return .{ .items = _reflect_UriTest_field_types };
    return .{ .items = &.{} };
}
