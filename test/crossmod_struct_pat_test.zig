...
// Source: test/crossmod_struct_pat_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/crossmod_struct_pat_test.zbr:6
        const p = crossmod_types_lib.Point.init(3, 4);
// zbr:test/crossmod_struct_pat_test.zbr:7
        var label: []const u8 = "none";
// zbr:test/crossmod_struct_pat_test.zbr:8
        {
            const _bsp_1 = p;
            if (_bsp_1.x == 0 and _bsp_1.y == 0) {
// zbr:test/crossmod_struct_pat_test.zbr:10
                label = "origin";
            } else if (_bsp_1.x == 3) {
// zbr:test/crossmod_struct_pat_test.zbr:12
                label = "x is 3";
            } else {
// zbr:test/crossmod_struct_pat_test.zbr:14
                label = "other";
            }
        }
// zbr:test/crossmod_struct_pat_test.zbr:15
        std.debug.assert(std.mem.eql(u8, label, "x is 3"));
// zbr:test/crossmod_struct_pat_test.zbr:17
        const p2 = crossmod_types_lib.Point.init(0, 0);
// zbr:test/crossmod_struct_pat_test.zbr:18
        {
            const _bsp_2 = p2;
            if (_bsp_2.x == 0 and _bsp_2.y == 0) {
// zbr:test/crossmod_struct_pat_test.zbr:20
                label = "origin";
            } else {
// zbr:test/crossmod_struct_pat_test.zbr:22
                label = "other";
            }
        }
// zbr:test/crossmod_struct_pat_test.zbr:23
        std.debug.assert(std.mem.eql(u8, label, "origin"));
        std.debug.print("{s}\n", .{"crossmod_struct_pat_test OK"});
    }
...
fn _zbr_error_msg() []const u8 {
    ...
    if (@import("crossmod_types_lib.zig")._error_ctx.message.len > 0) return @import("crossmod_types_lib.zig")._error_ctx.message;
    return "";
}
