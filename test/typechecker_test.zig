...
// Source: C:/Projects/zebra-language/test/typechecker_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        stmts_assert.append(_allocator, TcStmt{ .assert_ = TcStmtAssert.init(TcExpr{ .binary = bi_cmp }) }) catch @panic("OOM");
        ...
        std.debug.assert(std.mem.eql(u8, tc.typeName(TcType{ .optional = TcType{ .int_ = {} } }), "?int"));
