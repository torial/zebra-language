...
// Source: test/http_serve_test.zbr
...
pub fn handleRequest(req: HttpRequest) HttpResponse {
// zbr:test/http_serve_test.zbr:2
    if ((std.mem.eql(u8, req.method, "GET") and std.mem.eql(u8, req.path, "/hello"))) {
// zbr:test/http_serve_test.zbr:3
        return HttpResponse(200, "Hello, World!");
    }
// zbr:test/http_serve_test.zbr:4
    return HttpResponse(404, "Not Found");
}

pub fn startServer() void {
    _http_serve(8080, handleRequest);
}
