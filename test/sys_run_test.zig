...
// zbr:test/sys_run_test.zbr:6
        argv.append(_allocator, _intern("cmd")) catch unreachable;
// zbr:test/sys_run_test.zbr:7
        argv.append(_allocator, _intern("/c")) catch unreachable;
// zbr:test/sys_run_test.zbr:8
        argv.append(_allocator, _intern("echo hello")) catch unreachable;
...
// zbr:test/sys_run_test.zbr:16
        bad.append(_allocator, _intern("cmd")) catch unreachable;
// zbr:test/sys_run_test.zbr:17
        bad.append(_allocator, _intern("/c")) catch unreachable;
// zbr:test/sys_run_test.zbr:18
        bad.append(_allocator, _intern("exit 42")) catch unreachable;
