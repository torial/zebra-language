...
pub const Container = struct {
    opt_val: ?*Val,
    pub fn init(opt_val: ?*Val) Container {
        var _self: Container = undefined;
// zbr:test/val_lib.zbr:8
            _self.opt_val = opt_val;
        return _self;
    }

};

pub fn makeContainer(n: i64) Container {
// zbr:test/val_lib.zbr:11
    const v = Val{ .int_val = n };
// zbr:test/val_lib.zbr:12
    return Container.init(_bx0: { const _bv = v; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; });
}
