...
pub const Engine = struct {
    ...
    pub fn init() *Engine {
        const self = _allocator.create(Engine) catch @panic("OOM");
...
// zbr:test/throws_nested_test.zbr:39
        const e = Engine.init();
// zbr:test/throws_nested_test.zbr:40
        e.run() catch |_tc_2| { _try_err_1 = _tc_2; break :_try_blk_1; };
        break :_try_blk_1;
    }
    if (_try_err_1 != null) {
        // pass
...
// zbr:test/throws_nested_test.zbr:47
    var _try_err_3: ?anyerror = null;
    _try_blk_3: {
// zbr:test/throws_nested_test.zbr:45
        const e = Engine.init();
// zbr:test/throws_nested_test.zbr:46
        e.helper.compute() catch |_tc_4| { _try_err_3 = _tc_4; break :_try_blk_3; };
        break :_try_blk_3;
    }
    if (_try_err_3 != null) {
        // pass
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/throws_nested_test.zbr:53
        testCase1();
// zbr:test/throws_nested_test.zbr:54
        testCase3();
