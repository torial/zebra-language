...
// Source: test/list_ref_autobox_test.zbr
...
pub fn main() void {
// zbr:test/list_ref_autobox_test.zbr:12
    var rects: std.ArrayList(*Rect) = std.ArrayList(*Rect){};
// zbr:test/list_ref_autobox_test.zbr:13
    const r1 = Rect{ .w = 3, .h = 4 };
// zbr:test/list_ref_autobox_test.zbr:14
    const r2 = Rect{ .w = 5, .h = 6 };
    rects.append(_allocator, _box_1: { const _bp_1 = _allocator.create(Rect) catch @panic("OOM"); _bp_1.* = r1; break :_box_1 _bp_1; }) catch @panic("OOM");
    rects.append(_allocator, _box_2: { const _bp_2 = _allocator.create(Rect) catch @panic("OOM"); _bp_2.* = r2; break :_box_2 _bp_2; }) catch @panic("OOM");
// zbr:test/list_ref_autobox_test.zbr:17
    std.debug.assert((@as(i64, @intCast(rects.items.len)) == 2));
// zbr:test/list_ref_autobox_test.zbr:19
    for (rects.items) |r| {
// zbr:test/list_ref_autobox_test.zbr:20
        std.debug.assert(_zebra_gt(r.w, 0));
// zbr:test/list_ref_autobox_test.zbr:21
        std.debug.assert(_zebra_gt(r.h, 0));
    }
// zbr:test/list_ref_autobox_test.zbr:23
    std.debug.assert((rects.items[@intCast(0)].w == 3));
// zbr:test/list_ref_autobox_test.zbr:24
    std.debug.assert((rects.items[@intCast(0)].h == 4));
// zbr:test/list_ref_autobox_test.zbr:25
    std.debug.assert((rects.items[@intCast(1)].w == 5));
// zbr:test/list_ref_autobox_test.zbr:26
    std.debug.assert((rects.items[@intCast(1)].h == 6));
    std.debug.print("{s}\n", .{"list_ref_autobox_test OK"});
}
