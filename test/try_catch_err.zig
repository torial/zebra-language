...
// zbr:test/try_catch_err.zbr:6
    ...
    pub fn testRiskyFail() void {
// zbr:test/try_catch_err.zbr:11
        var _try_err_2: ?anyerror = null;
        _try_blk_2: {
// zbr:test/try_catch_err.zbr:9
            const result: i64 = App.risky((-3)) catch |_tc_3| { _try_err_2 = _tc_3; break :_try_blk_2; };
// zbr:test/try_catch_err.zbr:10
            std.debug.print("{}\n", .{result});
            break :_try_blk_2;
        }
        if (_try_err_2 != null) {
// zbr:test/try_catch_err.zbr:12
            std.debug.print("{s}\n", .{"caught an error"});
        }
    }
