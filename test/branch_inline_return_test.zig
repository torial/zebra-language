...
// Source: C:/Projects/zebra-language/test/branch_inline_return_test.zbr
...
pub const Calc = struct {
    ...
    pub fn init(s: i64) *Calc {
        const _self = _allocator.create(Calc) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Calc");
            _self.scale = s;
        return _self;
    }
...
const _ttag_Calc: u64 = _zbr_hash("Calc");
