...
// zbr:test/string_branch_test.zbr:4
        {
            const _bs_1 = cmd;
            if (std.mem.eql(u8, _bs_1, "start") or std.mem.eql(u8, _bs_1, "begin")) {
// zbr:test/string_branch_test.zbr:6
                return "start command";
            } else if (std.mem.eql(u8, _bs_1, "stop") or std.mem.eql(u8, _bs_1, "end") or std.mem.eql(u8, _bs_1, "quit")) {
// zbr:test/string_branch_test.zbr:8
                return "stop command";
            } else if (std.mem.eql(u8, _bs_1, "help")) {
...
// zbr:test/string_branch_test.zbr:24
        {
            const _bs_2 = lang;
            if (std.mem.eql(u8, _bs_2, "Zebra")) {
// zbr:test/string_branch_test.zbr:26
                std.debug.print("{s}\n", .{"Zebra is the best"});
            } else if (std.mem.eql(u8, _bs_2, "Python")) {
