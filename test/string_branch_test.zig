...
// Source: C:/Projects/zebra-language/test/string_branch_test.zbr
...
pub const Main = struct {
    ...
    pub fn classify(cmd: []const u8) []const u8 {
        if (std.mem.eql(u8, cmd, "start") or std.mem.eql(u8, cmd, "begin")) {
            return "start command";
        } else if (std.mem.eql(u8, cmd, "stop") or std.mem.eql(u8, cmd, "end") or std.mem.eql(u8, cmd, "quit")) {
            return "stop command";
    ...
    pub fn main() void {
        ...
        std.debug.print("{any}\n", .{Main.classify("help")});
        std.debug.print("{any}\n", .{Main.classify("foo")});
        const lang: []const u8 = "Zebra";
        if (std.mem.eql(u8, lang, "Zebra")) {
            std.debug.print("{s}\n", .{"Zebra is the best"});
