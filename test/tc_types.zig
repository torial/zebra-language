...
pub const TcTypes = struct {
    ...
    pub fn eql(a: TcType, b: TcType) bool {
        switch (a) {
            .int_ => |_| {
                return (b == TcType{ .int_ = {} });
            },
            .uint_ => |_| {
                return (b == TcType{ .uint_ = {} });
            },
            .float_ => |_| {
                return (b == TcType{ .float_ = {} });
            },
            .bool_ => |_| {
                return (b == TcType{ .bool_ = {} });
            },
            .char_ => |_| {
                return (b == TcType{ .char_ = {} });
            },
            .string_ => |_| {
                return (b == TcType{ .string_ = {} });
            },
            .void_ => |_| {
                return (b == TcType{ .void_ = {} });
            },
            .int_n => |wa| {
                switch (b) {
                    .int_n => |wb| {
            ...
            .generic_named => |ga| {
                switch (b) {
                    .generic_named => |gb| {
                        ...
                        var i: i64 = 0;
                        while ((i < @as(i64, @intCast(ga.args.items.len)))) {
            ...
            .tuple => |ea| {
                switch (b) {
                    .tuple => |eb| {
                        ...
                        var i: i64 = 0;
                        while ((i < @as(i64, @intCast(ea.items.len)))) {
            ...
            .string_builder => |_| {
                return (b == TcType{ .string_builder = {} });
            },
            .http_request => |_| {
                return (b == TcType{ .http_request = {} });
            },
            .http_response => |_| {
                return (b == TcType{ .http_response = {} });
            },
            .tcp_conn => |_| {
                return (b == TcType{ .tcp_conn = {} });
            },
            .udp_socket => |_| {
                return (b == TcType{ .udp_socket = {} });
            },
            .regex => |_| {
                return (b == TcType{ .regex = {} });
            },
            .gui_context => |_| {
                return (b == TcType{ .gui_context = {} });
            },
            .shell => |_| {
                return (b == TcType{ .shell = {} });
            },
            .file_ => |_| {
                return (b == TcType{ .file_ = {} });
            },
            .str_slice => |_| {
                return (b == TcType{ .str_slice = {} });
            },
            .sys_run_result => |_| {
                return (b == TcType{ .sys_run_result = {} });
            },
            .json_value => |_| {
                return (b == TcType{ .json_value = {} });
            },
            .json_array => |_| {
                return (b == TcType{ .json_array = {} });
            },
            .date_time => |_| {
                return (b == TcType{ .date_time = {} });
            },
            .calendar_view => |_| {
                return (b == TcType{ .calendar_view = {} });
            },
            .csv_table => |_| {
                return (b == TcType{ .csv_table = {} });
            },
            .csv_writer => |_| {
                return (b == TcType{ .csv_writer = {} });
            },
            .csv_row => |_| {
                return (b == TcType{ .csv_row = {} });
            },
            .arg_result => |_| {
                return (b == TcType{ .arg_result = {} });
            },
            .uri_result => |_| {
                return (b == TcType{ .uri_result = {} });
            },
            .timer_handle => |_| {
                return (b == TcType{ .timer_handle = {} });
            },
            .unknown_ => |_| {
                return (b == TcType{ .unknown_ = {} });
            },
        }
    }
    ...
    pub fn isAssignable(a: TcType, b: TcType) bool {
        ...
        if (((b == TcType{ .char_ = {} }) and ((blk_in: { if (TcTypes.len == 0) break :blk_in false; for (TcTypes) |_nc| { if (!std.ascii.isDigit(_nc)) break :blk_in false; } break :blk_in true; }) or (a == TcType{ .char_ = {} })))) {
            return true;
        }
        if (((a == TcType{ .char_ = {} }) and (blk_in: { if (TcTypes.len == 0) break :blk_in false; for (TcTypes) |_nc| { if (!std.ascii.isDigit(_nc)) break :blk_in false; } break :blk_in true; }))) {
            return true;
        }
        switch (a) {
            .fn_ref => {
        ...
        switch (a) {
            .optional => |_ptr_a_inner| {
                const a_inner = _ptr_a_inner.*;
                switch (b) {
