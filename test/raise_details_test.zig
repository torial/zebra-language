...
pub const FileInfo = struct {
    ...
    pub fn init(p: []const u8, c: i64) *FileInfo {
        const self = _allocator.create(FileInfo) catch @panic("OOM");
...
// zbr:test/raise_details_test.zbr:15
        { const _rdet_1 = _allocator.create(FileInfo) catch @panic("OOM");
          _rdet_1.* = FileInfo.init(path, 404);
    ...
    pub fn testRaiseWithDetails() void {
// zbr:test/raise_details_test.zbr:19
        var _try_err_2: ?anyerror = null;
        _try_blk_2: {
// zbr:test/raise_details_test.zbr:18
            Main.tryRead("data.txt") catch |_e| { _try_err_2 = _e; break :_try_blk_2; };
            break :_try_blk_2;
        }
        if (_try_err_2 != null) {
// zbr:test/raise_details_test.zbr:20
            std.debug.print("{s}\n", .{_zbr_error_msg()});
...
// zbr:test/raise_details_test.zbr:26
    ...
    pub fn main() void {
// zbr:test/raise_details_test.zbr:29
        Main.testRaiseWithDetails();
// zbr:test/raise_details_test.zbr:30
        Main.testSimpleRaise();
    }
