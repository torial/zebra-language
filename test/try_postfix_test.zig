...
// zbr:test/try_postfix_test.zbr:11
    var _try_err_1: ?anyerror = null;
    _try_blk_1: {
// zbr:test/try_postfix_test.zbr:9
        const result = Math.safeDiv(10, 2) catch |_tc_2| { _try_err_1 = _tc_2; break :_try_blk_1; };
// zbr:test/try_postfix_test.zbr:10
        std.debug.print("{d}\n", .{result});
        break :_try_blk_1;
    }
    if (_try_err_1 != null) {
...
// zbr:test/try_postfix_test.zbr:17
    var _try_err_3: ?anyerror = null;
    _try_blk_3: {
// zbr:test/try_postfix_test.zbr:15
        const result2 = Math.safeDiv(10, 0) catch |_tc_4| { _try_err_3 = _tc_4; break :_try_blk_3; };
// zbr:test/try_postfix_test.zbr:16
        std.debug.print("{d}\n", .{result2});
        break :_try_blk_3;
    }
    if (_try_err_3 != null) {
// zbr:test/try_postfix_test.zbr:18
        {
            const _pt0 = (std.mem.concat(_allocator, u8, &.{ "caught: ", _zbr_error_msg() }) catch unreachable);
            std.debug.print("{s}\n", .{_pt0});
        }
    }
}
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/try_postfix_test.zbr:24
        testSafeDiv();
// zbr:test/try_postfix_test.zbr:27
        testSafeDivFail();
// zbr:test/try_postfix_test.zbr:29
        std.debug.print("{s}\n", .{"ok"});
    }
