...
// Source: C:/Projects/zebra-language/test/server_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:C:/Projects/zebra-language/test/server_test.zbr:4
        const handler = struct { fn call(req: HttpRequest) HttpResponse {
// zbr:C:/Projects/zebra-language/test/server_test.zbr:5
            if (std.mem.eql(u8, req.path, "/")) {
// zbr:C:/Projects/zebra-language/test/server_test.zbr:6
                return HttpResponse{ .status = 200, .text = "<h1>Hello from Zebra!</h1>" };
            }
// zbr:C:/Projects/zebra-language/test/server_test.zbr:7
            if (std.mem.eql(u8, req.path, "/greet")) {
// zbr:C:/Projects/zebra-language/test/server_test.zbr:8
                const msg: []const u8 = (std.fmt.allocPrint(_allocator, "Hello, {s} {s}", .{req.method, req.path}) catch @panic("OOM"));
// zbr:C:/Projects/zebra-language/test/server_test.zbr:9
                return HttpResponse{ .status = 200, .text = msg };
            }
// zbr:C:/Projects/zebra-language/test/server_test.zbr:10
            if (std.mem.eql(u8, req.path, "/echo")) {
// zbr:C:/Projects/zebra-language/test/server_test.zbr:11
                return HttpResponse{ .status = 200, .text = req.content };
            }
// zbr:C:/Projects/zebra-language/test/server_test.zbr:12
            return HttpResponse{ .status = 404, .text = "<h1>404 Not Found</h1>" };
         } }.call;
// zbr:C:/Projects/zebra-language/test/server_test.zbr:13
        std.debug.print("{s}\n", .{"Listening on http://localhost:8080"});
// zbr:C:/Projects/zebra-language/test/server_test.zbr:14
