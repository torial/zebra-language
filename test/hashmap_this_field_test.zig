...
// Source: test/hashmap_this_field_test.zbr
...
pub const Sym = struct {
    _type_tag: u64 = _ttag_Sym,
    name: []const u8 = undefined,
    pub fn init(n: []const u8) *Sym {
        const self = _allocator.create(Sym) catch @panic("OOM");
        self._type_tag = _ttag_Sym;
// zbr:test/hashmap_this_field_test.zbr:8
        self.name = n;
        return self;
    }
...
const _ttag_Sym: u64 = 534981956;
const _reflect_Sym_name: []const u8 = "Sym";
const _reflect_Sym_fields: []const []const u8 = &.{"name"};
const _reflect_Sym_field_types: []const []const u8 = &.{"str"};

pub const Env = struct {
    _type_tag: u64 = _ttag_Env,
    vars: std.StringHashMap(*Sym) = undefined,
    pub fn init() *Env {
        const self = _allocator.create(Env) catch @panic("OOM");
        self._type_tag = _ttag_Env;
// zbr:test/hashmap_this_field_test.zbr:14
        self.vars = std.StringHashMap(*Sym).init(_allocator);
        return self;
    }

    pub fn define(self: *Env, k: []const u8, v: *Sym) void {
// zbr:test/hashmap_this_field_test.zbr:17
        self.vars.put((_allocator.dupe(u8, k) catch @panic("OOM")), v) catch unreachable;
    }

    pub fn lookup(self: *Env, k: []const u8) *Sym {
// zbr:test/hashmap_this_field_test.zbr:20
        return self.vars.get(k).?;
    }

};

const _ttag_Env: u64 = 3717434452;
const _reflect_Env_name: []const u8 = "Env";
const _reflect_Env_fields: []const []const u8 = &.{"vars"};
const _reflect_Env_field_types: []const []const u8 = &.{"HashMap(str, Sym)"};

pub fn main() void {
// zbr:test/hashmap_this_field_test.zbr:23
    const e = Env.init();
// zbr:test/hashmap_this_field_test.zbr:24
    e.define("hello", Sym.init("world"));
// zbr:test/hashmap_this_field_test.zbr:25
    const s = e.lookup("hello");
// zbr:test/hashmap_this_field_test.zbr:26
    std.debug.print("{s}\n", .{s.name});
// zbr:test/hashmap_this_field_test.zbr:27
    std.debug.print("{s}\n", .{"ok"});
}
