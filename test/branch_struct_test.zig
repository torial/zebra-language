...
pub fn main() void {
// zbr:test/branch_struct_test.zbr:11
    const p = Point.init(0, 0);
// zbr:test/branch_struct_test.zbr:12
    {
        const _bsp_1 = p;
...
// zbr:test/branch_struct_test.zbr:21
    const q = Point.init(0, 5);
// zbr:test/branch_struct_test.zbr:22
    {
        const _bsp_2 = q;
...
// zbr:test/branch_struct_test.zbr:31
    const person = Person.init("alice", 30);
// zbr:test/branch_struct_test.zbr:32
    {
        const _bsp_3 = person;
...
// zbr:test/branch_struct_test.zbr:39
    const r = Point.init(5, 3);
// zbr:test/branch_struct_test.zbr:40
    {
        const _bsp_4 = r;
        if (_bsp_4.x == 5) {
            const pt = _bsp_4;
