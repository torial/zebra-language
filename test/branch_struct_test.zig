...
// Source: test/branch_struct_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/branch_struct_test.zbr:13
        const p = Point{ .x = 0, .y = 0 };
// zbr:test/branch_struct_test.zbr:14
        {
            const _bsp_1 = p;
            if (_bsp_1.x == 0 and _bsp_1.y == 0) {
// zbr:test/branch_struct_test.zbr:16
                std.debug.print("{s}\n", .{"origin"});
            } else if (_bsp_1.x == 0) {
// zbr:test/branch_struct_test.zbr:18
                std.debug.print("{s}\n", .{"y-axis"});
            } else {
// zbr:test/branch_struct_test.zbr:20
                std.debug.print("{s}\n", .{"elsewhere"});
            }
        }
// zbr:test/branch_struct_test.zbr:23
        const q = Point{ .x = 0, .y = 5 };
// zbr:test/branch_struct_test.zbr:24
        {
            const _bsp_2 = q;
            if (_bsp_2.x == 0 and _bsp_2.y == 0) {
// zbr:test/branch_struct_test.zbr:26
                std.debug.print("{s}\n", .{"bad"});
            } else if (_bsp_2.x == 0) {
// zbr:test/branch_struct_test.zbr:28
                std.debug.print("{s}\n", .{"on y-axis"});
            } else {
// zbr:test/branch_struct_test.zbr:30
                std.debug.print("{s}\n", .{"nope"});
            }
        }
// zbr:test/branch_struct_test.zbr:33
        const person = Person{ .name = "alice", .age = 30 };
// zbr:test/branch_struct_test.zbr:34
        {
            const _bsp_3 = person;
            if (std.mem.eql(u8, _bsp_3.name, "alice")) {
// zbr:test/branch_struct_test.zbr:36
                std.debug.print("{s}\n", .{"hello alice"});
            } else {
// zbr:test/branch_struct_test.zbr:38
                std.debug.print("{s}\n", .{"unknown"});
            }
        }
// zbr:test/branch_struct_test.zbr:41
        const r = Point{ .x = 5, .y = 3 };
// zbr:test/branch_struct_test.zbr:42
        {
            const _bsp_4 = r;
            if (_bsp_4.x == 5) {
                const pt = _bsp_4;
// zbr:test/branch_struct_test.zbr:44
                std.debug.print("{}\n", .{pt.y});
            } else {
// zbr:test/branch_struct_test.zbr:46
                std.debug.print("{s}\n", .{"no match"});
            }
        }
    }
