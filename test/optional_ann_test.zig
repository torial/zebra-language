...
// Source: C:/Projects/zebra-language/test/optional_ann_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        items.append(_allocator, "apple") catch @panic("OOM");
        items.append(_allocator, "banana") catch @panic("OOM");
        items.append(_allocator, "cherry") catch @panic("OOM");
