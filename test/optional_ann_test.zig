...
// zbr:test/optional_ann_test.zbr:15
        items.append(_allocator, _intern("apple")) catch unreachable;
// zbr:test/optional_ann_test.zbr:16
        items.append(_allocator, _intern("banana")) catch unreachable;
// zbr:test/optional_ann_test.zbr:17
        items.append(_allocator, _intern("cherry")) catch unreachable;
