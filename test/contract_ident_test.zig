...
// Source: test/contract_ident_test.zbr
...
pub fn compute() i64 {
// zbr:test/contract_ident_test.zbr:5
    const result: i64 = 10;
// zbr:test/contract_ident_test.zbr:6
    const old: i64 = 3;
// zbr:test/contract_ident_test.zbr:7
    return (result + old);
}

pub fn main() void {
// zbr:test/contract_ident_test.zbr:10
    const v = compute();
    std.debug.print("{}\n", .{v});
}
