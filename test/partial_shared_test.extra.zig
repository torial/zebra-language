...
// Source: C:/Projects/zebra-language/test/partial_shared_test.extra.zbr
...
pub const PartialSharedTest = struct {
    ...
    pub fn init() *PartialSharedTest {
        const self = _allocator.create(PartialSharedTest) catch @panic("OOM");
        self._type_tag = _ttag_PartialSharedTest;
        return self;
    }

};
const _ttag_PartialSharedTest: u64 = _zbr_hash("PartialSharedTest");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_PartialSharedTest) return _reflect_PartialSharedTest_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_PartialSharedTest) return .{ .items = _reflect_PartialSharedTest_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_PartialSharedTest) return .{ .items = _reflect_PartialSharedTest_field_types };
    return .{ .items = &.{} };
}
