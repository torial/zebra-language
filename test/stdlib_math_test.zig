...
// Source: test/stdlib_math_test.zbr
...
fn _sys_setenv(key: []const u8, val: []const u8) void {
    if (comptime builtin.os.tag == .windows) {
        // Windows: convert to null-terminated and call SetEnvironmentVariableA
        const key_z = _allocator.dupeZ(u8, key) catch return;
        const val_z = _allocator.dupeZ(u8, val) catch return;
        _ = std.os.windows.kernel32.SetEnvironmentVariableA(key_z.ptr, val_z.ptr);
    } else {
        std.posix.setenv(key, val) catch {};
    }
}
pub fn main() void {
// zbr:test/stdlib_math_test.zbr:3
    std.debug.assert((_zebra_gt(std.math.pi, 3.14) and _zebra_lt(std.math.pi, 3.15)));
// zbr:test/stdlib_math_test.zbr:4
    std.debug.assert((_zebra_gt(std.math.e, 2.71) and _zebra_lt(std.math.e, 2.72)));
// zbr:test/stdlib_math_test.zbr:5
    std.debug.assert((_zebra_gt(std.math.tau, 6.28) and _zebra_lt(std.math.tau, 6.29)));
// zbr:test/stdlib_math_test.zbr:6
    std.debug.assert((_zebra_gt(std.math.phi, 1.61) and _zebra_lt(std.math.phi, 1.62)));
// zbr:test/stdlib_math_test.zbr:7
    std.debug.assert((_zebra_gt(std.math.sqrt2, 1.41) and _zebra_lt(std.math.sqrt2, 1.42)));
// zbr:test/stdlib_math_test.zbr:8
    std.debug.assert((_zebra_gt(std.math.ln2, 0.69) and _zebra_lt(std.math.ln2, 0.70)));
// zbr:test/stdlib_math_test.zbr:9
    std.debug.assert((_zebra_gt(std.math.ln10, 2.30) and _zebra_lt(std.math.ln10, 2.31)));
// zbr:test/stdlib_math_test.zbr:12
    std.debug.assert((std.math.sinh(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:13
    std.debug.assert((std.math.cosh(@as(f64, 0.0)) == 1.0));
// zbr:test/stdlib_math_test.zbr:14
    std.debug.assert((std.math.tanh(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:15
    std.debug.assert((std.math.asinh(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:16
    std.debug.assert((std.math.acosh(@as(f64, 1.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:17
    std.debug.assert((std.math.atanh(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:20
    const cbrt8 = std.math.cbrt(@as(f64, 8.0));
// zbr:test/stdlib_math_test.zbr:21
    std.debug.assert((_zebra_gt(cbrt8, 1.99) and _zebra_lt(cbrt8, 2.01)));
// zbr:test/stdlib_math_test.zbr:24
    std.debug.assert((std.math.log1p(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:25
    std.debug.assert((std.math.expm1(@as(f64, 0.0)) == 0.0));
// zbr:test/stdlib_math_test.zbr:28
    const h = std.math.hypot(@as(f64, 3.0), @as(f64, 4.0));
// zbr:test/stdlib_math_test.zbr:29
    std.debug.assert((_zebra_gt(h, 4.99) and _zebra_lt(h, 5.01)));
// zbr:test/stdlib_math_test.zbr:32
    const l = std.math.lerp(@as(f64, 0.0), @as(f64, 10.0), @as(f64, 0.5));
// zbr:test/stdlib_math_test.zbr:33
    std.debug.assert((_zebra_gt(l, 4.99) and _zebra_lt(l, 5.01)));
// zbr:test/stdlib_math_test.zbr:36
...
// zbr:test/stdlib_math_test.zbr:37
...
// zbr:test/stdlib_math_test.zbr:40
    const rad = std.math.degreesToRadians(@as(f64, 180.0));
// zbr:test/stdlib_math_test.zbr:41
    std.debug.assert((_zebra_gt(rad, 3.14) and _zebra_lt(rad, 3.15)));
// zbr:test/stdlib_math_test.zbr:42
    const deg = std.math.radiansToDegrees(@as(f64, std.math.pi));
// zbr:test/stdlib_math_test.zbr:43
    std.debug.assert((_zebra_gt(deg, 179.9) and _zebra_lt(deg, 180.1)));
// zbr:test/stdlib_math_test.zbr:46
    std.debug.assert((blk: { const _po2 = 8; break :blk _po2 > 0 and (_po2 & (_po2 - 1)) == 0; }));
// zbr:test/stdlib_math_test.zbr:47
    std.debug.assert((!(blk: { const _po2 = 7; break :blk _po2 > 0 and (_po2 & (_po2 - 1)) == 0; })));
// zbr:test/stdlib_math_test.zbr:50
    const w = @mod(10, 8);
// zbr:test/stdlib_math_test.zbr:51
    std.debug.assert((w == 2));
// zbr:test/stdlib_math_test.zbr:54
    std.debug.assert((@as(i64, @intCast(@popCount(@as(u64, @intCast(255))))) == 8));
// zbr:test/stdlib_math_test.zbr:55
    std.debug.assert((@as(i64, @intCast(@popCount(@as(u64, @intCast(0))))) == 0));
// zbr:test/stdlib_math_test.zbr:56
    std.debug.assert((@as(i64, @intCast(@clz(@as(u64, @intCast(1))))) == 63));
// zbr:test/stdlib_math_test.zbr:57
    std.debug.assert((@as(i64, @intCast(@ctz(@as(u64, @intCast(8))))) == 3));
// zbr:test/stdlib_math_test.zbr:59
    std.debug.print("{s}\n", .{"stdlib_math OK"});
}
