...
// Source: test\crossmod_optret_geom.zbr
...
pub const Vec3 = struct {
    _type_tag: u64 = _ttag_Vec3,
    x: i64 = undefined,
    y: i64 = undefined,
    z: i64 = undefined,
    pub fn init(px: i64, py: i64, pz: i64) *Vec3 {
        const self = _allocator.create(Vec3) catch @panic("OOM");
        self._type_tag = _ttag_Vec3;
// zbr:test\crossmod_optret_geom.zbr:8
        self.x = px;
// zbr:test\crossmod_optret_geom.zbr:9
        self.y = py;
// zbr:test\crossmod_optret_geom.zbr:10
        self.z = pz;
        return self;
    }
...
const _ttag_Vec3: u64 = 725374594;
const _reflect_Vec3_name: []const u8 = "Vec3";
const _reflect_Vec3_fields: []const []const u8 = &.{"x", "y", "z"};
const _reflect_Vec3_field_types: []const []const u8 = &.{"int", "int", "int"};
