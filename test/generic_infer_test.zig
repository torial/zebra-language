...
// Source: C:/Projects/zebra-language/test/generic_infer_test.zbr
...
pub const Container = struct {
    ...
    pub fn init() *Container {
        ...
        _self._type_tag = _zbr_hash("Container");
            _self.items = std.ArrayList([]const u8){};
            _self.flags = std.ArrayList(bool){};
        return _self;
    }

    pub fn add(self: *Container, s: []const u8, flag: bool) void {
        self.items.append(_allocator, s) catch @panic("OOM");
        self.flags.append(_allocator, flag) catch @panic("OOM");
    }

    pub fn first(self: *Container) []const u8 {
        return self.items.items[@intCast(0)];
    }

    pub fn firstFlag(self: *Container) bool {
        return self.flags.items[@intCast(0)];
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        c.append(_allocator, "hello") catch @panic("OOM");
        c.append(_allocator, "world") catch @panic("OOM");
