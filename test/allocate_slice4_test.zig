...
// Source: test/allocate_slice4_test.zbr
...
pub fn main() void {
// zbr:test/allocate_slice4_test.zbr:6
    { // allocate
        var _alloc_src_0 = std.heap.DebugAllocator(.{}){};
        const _saved_alloc_0 = _allocator;
        _allocator = _alloc_src_0.allocator();
        defer { _allocator = _saved_alloc_0; std.debug.assert(_alloc_src_0.deinit() == .ok); }
// zbr:test/allocate_slice4_test.zbr:7
        const s: []const u8 = "debug block";
// zbr:test/allocate_slice4_test.zbr:8
        std.debug.assert(std.mem.eql(u8, s, "debug block"));
    }
    std.debug.print("{s}\n", .{"Debug: OK"});
// zbr:test/allocate_slice4_test.zbr:12
    { // allocate
        ...
        defer _allocator = _saved_alloc_1;
// zbr:test/allocate_slice4_test.zbr:13
        const msg: []const u8 = "fixed buf";
// zbr:test/allocate_slice4_test.zbr:14
        std.debug.assert(std.mem.eql(u8, msg, "fixed buf"));
    }
    std.debug.print("{s}\n", .{"FixedBuffer: OK"});
// zbr:test/allocate_slice4_test.zbr:18
    { // allocate
        var _alloc_src_2 = std.heap.stackFallback(128, _allocator);
        const _saved_alloc_2 = _allocator;
        _allocator = _alloc_src_2.get();
        defer _allocator = _saved_alloc_2;
// zbr:test/allocate_slice4_test.zbr:19
        const t: []const u8 = "stack fallback";
// zbr:test/allocate_slice4_test.zbr:20
        std.debug.assert(std.mem.eql(u8, t, "stack fallback"));
    }
    std.debug.print("{s}\n", .{"StackFallback: OK"});
// zbr:test/allocate_slice4_test.zbr:24
    { // allocate
        const _saved_alloc_3 = _allocator;
        _allocator = std.heap.page_allocator;
        defer _allocator = _saved_alloc_3;
// zbr:test/allocate_slice4_test.zbr:25
        const p: []const u8 = "page alloc";
// zbr:test/allocate_slice4_test.zbr:26
        std.debug.assert(std.mem.eql(u8, p, "page alloc"));
    }
    std.debug.print("{s}\n", .{"Page: OK"});
// zbr:test/allocate_slice4_test.zbr:30
    { // allocate
        const _saved_alloc_4 = _allocator;
        _allocator = std.heap.smp_allocator;
        defer _allocator = _saved_alloc_4;
// zbr:test/allocate_slice4_test.zbr:31
        const q: []const u8 = "smp alloc";
// zbr:test/allocate_slice4_test.zbr:32
        std.debug.assert(std.mem.eql(u8, q, "smp alloc"));
    }
    std.debug.print("{s}\n", .{"Smp: OK"});
// zbr:test/allocate_slice4_test.zbr:36
    { // allocate
        const _saved_alloc_5 = _allocator;
        _allocator = std.heap.c_allocator;
        defer _allocator = _saved_alloc_5;
// zbr:test/allocate_slice4_test.zbr:37
        const r: []const u8 = "c alloc";
// zbr:test/allocate_slice4_test.zbr:38
        std.debug.assert(std.mem.eql(u8, r, "c alloc"));
    }
    std.debug.print("{s}\n", .{"C: OK"});
    std.debug.print("{s}\n", .{"allocate Slice 4: all OK"});
}
