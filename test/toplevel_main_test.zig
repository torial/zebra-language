...
// Source: test/toplevel_main_test.zbr
...
// zbr:test/toplevel_main_test.zbr:2
    return (a + b);
}

pub fn main() void {
// zbr:test/toplevel_main_test.zbr:5
    const result = add(3, 4);
// zbr:test/toplevel_main_test.zbr:6
    if (!((result == 7))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:test/toplevel_main_test.zbr:7
    std.debug.print("{s}\n", .{"toplevel_main: OK"});
}
