...
// Source: test/interp_tostring_test.zbr
...
pub const Point = struct {
    ...
    x: i64 = 0,
    y: i64 = 0,
    pub fn toString(self: *Point) []const u8 {
// zbr:test/interp_tostring_test.zbr:6
...
pub const Color = struct {
    _type_tag: u64 = _ttag_Color,
    r: i64 = 0,
    g: i64 = 0,
    b: i64 = 0,
    pub fn toString(self: *Color) []const u8 {
// zbr:test/interp_tostring_test.zbr:14
        return (std.fmt.allocPrint(_allocator, "rgb({}, {}, {})", .{self.r, self.g, self.b}) catch @panic("OOM"));
    }

    pub fn init() *Color {
        const self = _allocator.create(Color) catch @panic("OOM");
        self.* = .{};
        self._type_tag = _ttag_Color;
        return self;
    }

};

const _ttag_Color: u64 = 3853794552;
const _reflect_Color_name: []const u8 = "Color";
const _reflect_Color_fields: []const []const u8 = &.{"r", "g", "b"};
const _reflect_Color_field_types: []const []const u8 = &.{"int", "int", "int"};

pub const NoToString = struct {
    _type_tag: u64 = _ttag_NoToString,
    val: i64 = 0,
    pub fn init() *NoToString {
        const self = _allocator.create(NoToString) catch @panic("OOM");
        self.* = .{};
        self._type_tag = _ttag_NoToString;
        return self;
    }

};

const _ttag_NoToString: u64 = 405199562;
const _reflect_NoToString_name: []const u8 = "NoToString";
const _reflect_NoToString_fields: []const []const u8 = &.{"val"};
const _reflect_NoToString_field_types: []const []const u8 = &.{"int"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/interp_tostring_test.zbr:22
        var p = Point.init();
// zbr:test/interp_tostring_test.zbr:23
        p.x = 3;
// zbr:test/interp_tostring_test.zbr:24
        p.y = 4;
// zbr:test/interp_tostring_test.zbr:25
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "point: {s}", .{p.toString()}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/interp_tostring_test.zbr:26
        const msg: []const u8 = (std.fmt.allocPrint(_allocator, "location is {s}", .{p.toString()}) catch @panic("OOM"));
// zbr:test/interp_tostring_test.zbr:27
        std.debug.print("{s}\n", .{msg});
// zbr:test/interp_tostring_test.zbr:29
        var c = Color.init();
// zbr:test/interp_tostring_test.zbr:30
        c.r = 255;
// zbr:test/interp_tostring_test.zbr:31
        c.g = 128;
// zbr:test/interp_tostring_test.zbr:32
        c.b = 0;
// zbr:test/interp_tostring_test.zbr:33
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "color: {s}", .{c.toString()}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/interp_tostring_test.zbr:35
        const n = 42;
// zbr:test/interp_tostring_test.zbr:36
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "n = {}", .{n}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/interp_tostring_test.zbr:37
        const s: []const u8 = "hi";
// zbr:test/interp_tostring_test.zbr:38
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "s = {s}", .{s}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
    }
