...
// Source: C:/Projects/zebra-language/test/interface_test.zbr
...
pub const English = struct {
    ...
    pub fn init() *English {
        const self = _allocator.create(English) catch @panic("OOM");
...
pub const Spanish = struct {
    ...
    pub fn init() *Spanish {
        const self = _allocator.create(Spanish) catch @panic("OOM");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_English) return _reflect_English_name;
    if (tag == _ttag_Spanish) return _reflect_Spanish_name;
...
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_English) return .{ .items = _reflect_English_fields };
    if (tag == _ttag_Spanish) return .{ .items = _reflect_Spanish_fields };
...
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_English) return .{ .items = _reflect_English_field_types };
    if (tag == _ttag_Spanish) return .{ .items = _reflect_Spanish_field_types };
