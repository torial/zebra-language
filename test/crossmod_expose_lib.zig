...
// Source: test\crossmod_expose_lib.zbr
...
pub const Tag = struct {
    ...
    weight: i64 = undefined,
    pub fn init(n: []const u8, w: i64) Tag {
        var self: Tag = undefined;
// zbr:test\crossmod_expose_lib.zbr:9
        self.name = n;
// zbr:test\crossmod_expose_lib.zbr:10
        self.weight = w;
        return self;
    }
...
pub const Bag = struct {
    _type_tag: u64 = _ttag_Bag,
    label: []const u8 = undefined,
    items: std.ArrayList(Tag) = undefined,
    pub fn init(lbl: []const u8) *Bag {
        const self = _allocator.create(Bag) catch @panic("OOM");
        self._type_tag = _ttag_Bag;
// zbr:test\crossmod_expose_lib.zbr:16
        self.label = lbl;
// zbr:test\crossmod_expose_lib.zbr:17
        self.items = std.ArrayList(Tag){};
        return self;
    }

    pub fn add(self: *Bag, t: Tag) void {
// zbr:test\crossmod_expose_lib.zbr:19
        self.items.append(_allocator, t) catch unreachable;
    }

};

const _ttag_Bag: u64 = 3367788497;
const _reflect_Bag_name: []const u8 = "Bag";
const _reflect_Bag_fields: []const []const u8 = &.{"label", "items"};
const _reflect_Bag_field_types: []const []const u8 = &.{"str", "List(Tag)"};
