...
| **…and it is the RIGHT thing, per the reference** | **`boundary_check`** (intent-authored, not recorded) | 31 probes / 295 assertions | <!-- doc-gen: 31 = bash tools/corpus_ls.sh test/boundary | wc -l | tr -d ' ' --> <!-- doc-gen: 295 = cat test/boundary/*.expected | grep -c . -->
