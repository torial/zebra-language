...
| **…and it is the RIGHT thing, per the reference** | **`boundary_check`** (intent-authored, not recorded) | 30 probes / 295 assertions | <!-- doc-gen: 30 = bash tools/corpus_ls.sh test/boundary | wc -l | tr -d ' ' --> <!-- doc-gen: 295 = cat test/boundary/*.expected | grep -c . -->
