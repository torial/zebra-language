...
#   bash tools/gates.sh --fast       # ~2min  — everything except smoke + round-trip
#   bash tools/gates.sh              # ~14min — QUICK, the default. After any .zbr edit
#   bash tools/gates.sh --full       # ~40min — before committing a codegen change
#   bash tools/gates.sh --daily      # 57min  — ONCE A DAY: full + the excluded set
