...
// zbr:selfhost/typechecker_test.zbr:11
    if (ok) {
// zbr:selfhost/typechecker_test.zbr:12
        std.debug.print("{s}\n", .{_str_concat("PASS ", label, _allocator)});
    } else {
// zbr:selfhost/typechecker_test.zbr:14
...
// zbr:selfhost/typechecker_test.zbr:70
    if ((ft2 != null)) {
// zbr:selfhost/typechecker_test.zbr:71
...
// zbr:selfhost/typechecker_test.zbr:74
...
// zbr:selfhost/typechecker_test.zbr:86
    ct.addCtorParam(Type_.int_);
// zbr:selfhost/typechecker_test.zbr:87
    ct.addCtorParam(Type_.string_);
// zbr:selfhost/typechecker_test.zbr:88
...
// zbr:selfhost/typechecker_test.zbr:91
    if ((p0 != null)) {
// zbr:selfhost/typechecker_test.zbr:92
...
// zbr:selfhost/typechecker_test.zbr:108
    var ct: *ClassTypes = ClassTypes.init("Foo");
// zbr:selfhost/typechecker_test.zbr:109
    ct.setField("name", Type_.string_);
// zbr:selfhost/typechecker_test.zbr:110
    mt.addClass(ct);
// zbr:selfhost/typechecker_test.zbr:112
    check(mt.hasClass("Foo"), "ModuleTypes.hasClass(Foo)");
// zbr:selfhost/typechecker_test.zbr:113
...
// zbr:selfhost/typechecker_test.zbr:121
...
// zbr:selfhost/typechecker_test.zbr:124
...
// zbr:selfhost/typechecker_test.zbr:138
...
// zbr:selfhost/typechecker_test.zbr:142
    var ct: *ClassTypes = ClassTypes.init("Baz");
// zbr:selfhost/typechecker_test.zbr:143
    ct.addCtorParam(Type_.string_);
// zbr:selfhost/typechecker_test.zbr:144
    ct.addCtorParam(Type_.int_);
// zbr:selfhost/typechecker_test.zbr:145
    mt.addClass(ct);
// zbr:selfhost/typechecker_test.zbr:147
    const p0: ?Type_ = mt.ctorParamAt("Baz", 0);
// zbr:selfhost/typechecker_test.zbr:148
    if ((p0 != null)) {
// zbr:selfhost/typechecker_test.zbr:149
...
// zbr:selfhost/typechecker_test.zbr:152
    if ((p1 != null)) {
// zbr:selfhost/typechecker_test.zbr:153
...
// zbr:selfhost/typechecker_test.zbr:156
...
// zbr:selfhost/typechecker_test.zbr:163
    check(std.mem.eql(u8, cm.module, "parser"), "CrossModuleType.module");
// zbr:selfhost/typechecker_test.zbr:164
...
// zbr:selfhost/typechecker_test.zbr:197
    check(typeIsInt(typeFromRef(namedRef("int"))), "typeFromRef(named int)");
// zbr:selfhost/typechecker_test.zbr:198
    check(typeIsString(typeFromRef(namedRef("str"))), "typeFromRef(named str)");
// zbr:selfhost/typechecker_test.zbr:199
    check(typeIsNamed(typeFromRef(namedRef("Foo"))), "typeFromRef(named Foo)");
// zbr:selfhost/typechecker_test.zbr:202
    check(isOptional(typeFromRef(TypeRef{ .nilable = _box_1: { const _bp_1 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1.* = namedRef("int"); break :_box_1 _bp_1; } })), "typeFromRef(nilable) → optional");
// zbr:selfhost/typechecker_test.zbr:205
    const t_void: Type_ = typeFromRef(TypeRef.void_);
// zbr:selfhost/typechecker_test.zbr:206
    switch (t_void) {
        .void_ => {
// zbr:selfhost/typechecker_test.zbr:208
            check(true, "typeFromRef(void_) → void_");
        },
        else => {
// zbr:selfhost/typechecker_test.zbr:210
            check(false, "typeFromRef(void_) → void_");
        },
    }
// zbr:selfhost/typechecker_test.zbr:213
    check(isRefTo(typeFromRef(TypeRef{ .ref_to = _box_2: { const _bp_2 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_2.* = namedRef("Foo"); break :_box_2 _bp_2; } })), "typeFromRef(ref_to) → ref_to");
// zbr:selfhost/typechecker_test.zbr:216
...
// zbr:selfhost/typechecker_test.zbr:225
    return Decl{ .var_ = _box_3: { const _bp_3 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_3.* = DeclVar.init(mkSpan(), emptyMods(), name, t, null, false); break :_box_3 _bp_3; } };
}

pub fn classDecl(name: []const u8, members: std.ArrayList(Decl)) Decl {
// zbr:selfhost/typechecker_test.zbr:228
    return Decl{ .class_ = _box_4: { const _bp_4 = _allocator.create(ast.DeclClass) catch @panic("OOM"); _bp_4.* = DeclClass.init(mkSpan(), emptyMods(), name, std.ArrayList(ast.TypeParam).empty, std.ArrayList(TypeRef).empty, std.ArrayList(TypeRef).empty, members); break :_box_4 _bp_4; } };
}

pub fn testBuildModuleTypesClass() void {
// zbr:selfhost/typechecker_test.zbr:231
    var members = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:232
    members.append(_allocator, varDecl("name", namedRef("str"))) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:233
    members.append(_allocator, varDecl("count", namedRef("int"))) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:234
    var decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:235
    decls.append(_allocator, classDecl("Foo", members)) catch unreachable;
...
// zbr:selfhost/typechecker_test.zbr:245
    if ((ft2 != null)) {
// zbr:selfhost/typechecker_test.zbr:246
...
// zbr:selfhost/typechecker_test.zbr:251
    params.append(_allocator, Param.init(mkSpan(), ParamMode.normal, "x", namedRef("int"), null)) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:252
    params.append(_allocator, Param.init(mkSpan(), ParamMode.normal, "y", namedRef("str"), null)) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:253
    var members = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:254
    members.append(_allocator, Decl{ .init = _box_5: { const _bp_5 = _allocator.create(ast.DeclInit) catch @panic("OOM"); _bp_5.* = DeclInit.init(mkSpan(), emptyMods(), params, null); break :_box_5 _bp_5; } }) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:255
    var decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:256
    decls.append(_allocator, classDecl("Bar", members)) catch unreachable;
...
// zbr:selfhost/typechecker_test.zbr:261
    if ((p0 != null)) {
// zbr:selfhost/typechecker_test.zbr:262
...
// zbr:selfhost/typechecker_test.zbr:264
    if ((p1 != null)) {
// zbr:selfhost/typechecker_test.zbr:265
...
// zbr:selfhost/typechecker_test.zbr:288
    check(typeIsInt(inferExpr(mkInt("42"), ctx)), "inferExpr(int_lit) → int");
// zbr:selfhost/typechecker_test.zbr:289
...
// zbr:selfhost/typechecker_test.zbr:291
    switch (inferExpr(mkBool(true), ctx)) {
        .bool_ => {
// zbr:selfhost/typechecker_test.zbr:293
            check(true, "inferExpr(bool_lit) → bool");
        },
        else => {
// zbr:selfhost/typechecker_test.zbr:295
...
// zbr:selfhost/typechecker_test.zbr:297
    switch (inferExpr(mkFloat("3.14"), ctx)) {
        .float_ => {
// zbr:selfhost/typechecker_test.zbr:299
            check(true, "inferExpr(float_lit) → float");
        },
        else => {
// zbr:selfhost/typechecker_test.zbr:301
...
// zbr:selfhost/typechecker_test.zbr:303
    switch (inferExpr(mkChar("a"), ctx)) {
        .char_ => {
// zbr:selfhost/typechecker_test.zbr:305
            check(true, "inferExpr(char_lit) → char");
        },
        else => {
// zbr:selfhost/typechecker_test.zbr:307
...
// zbr:selfhost/typechecker_test.zbr:313
    const e: Expr = Expr{ .binary = _box_6: { const _bp_6 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_6.* = ExprBinary.init(mkSpan(), BinaryOp.add, _box_7: { const _bp_7 = blk2: { break :blk2 _allocator.create(@TypeOf(mkStr("foo"))) catch @panic("OOM"); }; _bp_7.* = mkStr("foo"); break :_box_7 _bp_7; }, _box_8: { const _bp_8 = blk2: { break :blk2 _allocator.create(@TypeOf(mkStr("bar"))) catch @panic("OOM"); }; _bp_8.* = mkStr("bar"); break :_box_8 _bp_8; }); break :_box_6 _bp_6; } };
// zbr:selfhost/typechecker_test.zbr:314
    check(typeIsString(inferExpr(e, ctx)), "inferExpr(str + str) → string");
// zbr:selfhost/typechecker_test.zbr:316
    const e2: Expr = Expr{ .binary = _box_9: { const _bp_9 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_9.* = ExprBinary.init(mkSpan(), BinaryOp.add, _box_a: { const _bp_a = blk2: { break :blk2 _allocator.create(@TypeOf(mkInt("1"))) catch @panic("OOM"); }; _bp_a.* = mkInt("1"); break :_box_a _bp_a; }, _box_b: { const _bp_b = blk2: { break :blk2 _allocator.create(@TypeOf(mkInt("2"))) catch @panic("OOM"); }; _bp_b.* = mkInt("2"); break :_box_b _bp_b; }); break :_box_9 _bp_9; } };
// zbr:selfhost/typechecker_test.zbr:317
    check(typeIsInt(inferExpr(e2, ctx)), "inferExpr(int + int) → int");
// zbr:selfhost/typechecker_test.zbr:319
    const e3: Expr = Expr{ .binary = _box_c: { const _bp_c = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_c.* = ExprBinary.init(mkSpan(), BinaryOp.add, _box_d: { const _bp_d = blk2: { break :blk2 _allocator.create(@TypeOf(mkStr("x"))) catch @panic("OOM"); }; _bp_d.* = mkStr("x"); break :_box_d _bp_d; }, _box_e: { const _bp_e = blk2: { break :blk2 _allocator.create(@TypeOf(mkInt("1"))) catch @panic("OOM"); }; _bp_e.* = mkInt("1"); break :_box_e _bp_e; }); break :_box_c _bp_c; } };
// zbr:selfhost/typechecker_test.zbr:320
...
// zbr:selfhost/typechecker_test.zbr:325
    const e: Expr = Expr{ .binary = _box_f: { const _bp_f = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_f.* = ExprBinary.init(mkSpan(), BinaryOp.eq, _box_10: { const _bp_10 = blk2: { break :blk2 _allocator.create(@TypeOf(mkInt("1"))) catch @panic("OOM"); }; _bp_10.* = mkInt("1"); break :_box_10 _bp_10; }, _box_11: { const _bp_11 = blk2: { break :blk2 _allocator.create(@TypeOf(mkInt("2"))) catch @panic("OOM"); }; _bp_11.* = mkInt("2"); break :_box_11 _bp_11; }); break :_box_f _bp_f; } };
// zbr:selfhost/typechecker_test.zbr:326
    switch (inferExpr(e, ctx)) {
        .bool_ => {
// zbr:selfhost/typechecker_test.zbr:328
            check(true, "inferExpr(int == int) → bool");
        },
        else => {
// zbr:selfhost/typechecker_test.zbr:330
...
// zbr:selfhost/typechecker_test.zbr:335
    var ct: *ClassTypes = ClassTypes.init("Foo");
// zbr:selfhost/typechecker_test.zbr:336
    ct.setField("name", Type_.string_);
// zbr:selfhost/typechecker_test.zbr:337
    mt.addClass(ct);
...
// zbr:selfhost/typechecker_test.zbr:341
    const mem: Expr = Expr{ .member = _box_12: { const _bp_12 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_12.* = ExprMember.init(mkSpan(), _box_13: { const _bp_13 = blk2: { break :blk2 _allocator.create(@TypeOf(this_expr)) catch @panic("OOM"); }; _bp_13.* = this_expr; break :_box_13 _bp_13; }, "name"); break :_box_12 _bp_12; } };
// zbr:selfhost/typechecker_test.zbr:342
    check(typeIsString(inferExpr(mem, ctx)), "inferExpr(this.name) → string");
// zbr:selfhost/typechecker_test.zbr:344
    const mem2: Expr = Expr{ .member = _box_14: { const _bp_14 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_14.* = ExprMember.init(mkSpan(), _box_15: { const _bp_15 = blk2: { break :blk2 _allocator.create(@TypeOf(this_expr)) catch @panic("OOM"); }; _bp_15.* = this_expr; break :_box_15 _bp_15; }, "missing"); break :_box_14 _bp_14; } };
// zbr:selfhost/typechecker_test.zbr:345
...
// zbr:selfhost/typechecker_test.zbr:349
    var mt: *ModuleTypes = ModuleTypes.init();
// zbr:selfhost/typechecker_test.zbr:350
...
// zbr:selfhost/typechecker_test.zbr:353
    const call: Expr = Expr{ .call = _box_16: { const _bp_16 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_16.* = ExprCall.init(mkSpan(), callee, std.ArrayList(Arg).empty); break :_box_16 _bp_16; } };
// zbr:selfhost/typechecker_test.zbr:354
...
// zbr:selfhost/typechecker_test.zbr:357
    const call_int: Expr = Expr{ .call = _box_17: { const _bp_17 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_17.* = ExprCall.init(mkSpan(), callee_int, std.ArrayList(Arg).empty); break :_box_17 _bp_17; } };
// zbr:selfhost/typechecker_test.zbr:358
...
// zbr:selfhost/typechecker_test.zbr:367
...
// zbr:selfhost/typechecker_test.zbr:372
    var ct: *ClassTypes = ClassTypes.init("Bar");
// zbr:selfhost/typechecker_test.zbr:373
    ct.setMethodReturn("go", Type_.int_);
// zbr:selfhost/typechecker_test.zbr:374
    mt.addClass(ct);
// zbr:selfhost/typechecker_test.zbr:375
    var ctx: *InferCtx = InferCtx.init(mt, "");
// zbr:selfhost/typechecker_test.zbr:376
...
// zbr:selfhost/typechecker_test.zbr:378
    const mem: Expr = Expr{ .member = _box_18: { const _bp_18 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_18.* = ExprMember.init(mkSpan(), _box_19: { const _bp_19 = blk2: { break :blk2 _allocator.create(@TypeOf(recv)) catch @panic("OOM"); }; _bp_19.* = recv; break :_box_19 _bp_19; }, "go"); break :_box_18 _bp_18; } };
// zbr:selfhost/typechecker_test.zbr:379
    const call: Expr = Expr{ .call = _box_1a: { const _bp_1a = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_1a.* = ExprCall.init(mkSpan(), mem, std.ArrayList(Arg).empty); break :_box_1a _bp_1a; } };
// zbr:selfhost/typechecker_test.zbr:380
...
// zbr:selfhost/typechecker_test.zbr:387
    return Decl{ .union_ = _box_1b: { const _bp_1b = _allocator.create(ast.DeclUnion) catch @panic("OOM"); _bp_1b.* = DeclUnion.init(mkSpan(), emptyMods(), name, variants); break :_box_1b _bp_1b; } };
}

pub fn testUnionVariantIndex() void {
// zbr:selfhost/typechecker_test.zbr:390
    var variants = std.ArrayList(UnionVariant).empty;
// zbr:selfhost/typechecker_test.zbr:391
    variants.append(_allocator, UnionVariant.init(mkSpan(), "circle", namedRef("int"))) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:392
    variants.append(_allocator, UnionVariant.init(mkSpan(), "square", namedRef("str"))) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:393
    variants.append(_allocator, UnionVariant.init(mkSpan(), "dot", null)) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:394
    var decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:395
    decls.append(_allocator, unionDecl("Shape", variants)) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:396
    const m: Module = Module.init(_str_concat("", "<test>", _allocator), decls);
// zbr:selfhost/typechecker_test.zbr:397
    var mt: *ModuleTypes = buildModuleTypes(m);
// zbr:selfhost/typechecker_test.zbr:399
    check(mt.hasUnion("Shape"), "buildModuleTypes: hasUnion(Shape)");
// zbr:selfhost/typechecker_test.zbr:400
...
// zbr:selfhost/typechecker_test.zbr:408
    if ((p_square != null)) {
// zbr:selfhost/typechecker_test.zbr:409
...
// zbr:selfhost/typechecker_test.zbr:417
...
// zbr:selfhost/typechecker_test.zbr:426
    var variants = std.ArrayList(UnionVariant).empty;
// zbr:selfhost/typechecker_test.zbr:427
    variants.append(_allocator, UnionVariant.init(mkSpan(), "circle", namedRef("int"))) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:428
    variants.append(_allocator, UnionVariant.init(mkSpan(), "dot", null)) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:429
    var decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:430
    decls.append(_allocator, unionDecl("Shape", variants)) catch unreachable;
...
// zbr:selfhost/typechecker_test.zbr:436
    const circle_val: Expr = Expr{ .member = _box_1c: { const _bp_1c = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_1c.* = ExprMember.init(mkSpan(), _box_1d: { const _bp_1d = blk2: { break :blk2 _allocator.create(@TypeOf(shape_ident)) catch @panic("OOM"); }; _bp_1d.* = shape_ident; break :_box_1d _bp_1d; }, "circle"); break :_box_1c _bp_1c; } };
// zbr:selfhost/typechecker_test.zbr:437
    const nt: ?Type_ = narrowPayloadFromOnValue(mt, circle_val);
// zbr:selfhost/typechecker_test.zbr:438
    check((nt != null), "narrowPayloadFromOnValue(Shape.circle) is not nil");
// zbr:selfhost/typechecker_test.zbr:439
    if ((nt != null)) {
// zbr:selfhost/typechecker_test.zbr:440
...
// zbr:selfhost/typechecker_test.zbr:444
    const dot_val: Expr = Expr{ .member = _box_1e: { const _bp_1e = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_1e.* = ExprMember.init(mkSpan(), _box_1f: { const _bp_1f = blk2: { break :blk2 _allocator.create(@TypeOf(shape_ident2)) catch @panic("OOM"); }; _bp_1f.* = shape_ident2; break :_box_1f _bp_1f; }, "dot"); break :_box_1e _bp_1e; } };
// zbr:selfhost/typechecker_test.zbr:445
    const nt_dot: ?Type_ = narrowPayloadFromOnValue(mt, dot_val);
// zbr:selfhost/typechecker_test.zbr:446
...
// zbr:selfhost/typechecker_test.zbr:450
    const miss_val: Expr = Expr{ .member = _box_20: { const _bp_20 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_20.* = ExprMember.init(mkSpan(), _box_21: { const _bp_21 = blk2: { break :blk2 _allocator.create(@TypeOf(shape_ident3)) catch @panic("OOM"); }; _bp_21.* = shape_ident3; break :_box_21 _bp_21; }, "missing"); break :_box_20 _bp_20; } };
// zbr:selfhost/typechecker_test.zbr:451
...
// zbr:selfhost/typechecker_test.zbr:455
...
// zbr:selfhost/typechecker_test.zbr:462
    return Decl{ .method = _box_22: { const _bp_22 = _allocator.create(ast.DeclMethod) catch @panic("OOM"); _bp_22.* = DeclMethod.init(mkSpan(), emptyMods(), name, std.ArrayList(Param).empty, ret, null, false, false, std.ArrayList(Expr).empty, std.ArrayList(Expr).empty, std.ArrayList([]const u8).empty); break :_box_22 _bp_22; } };
}

pub fn testInferModuleFuncCall() void {
// zbr:selfhost/typechecker_test.zbr:466
    var point_members = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:467
    point_members.append(_allocator, varDecl("x", namedRef("int"))) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:468
    var decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:469
    decls.append(_allocator, classDecl("Point", point_members)) catch unreachable;
// zbr:selfhost/typechecker_test.zbr:470
    decls.append(_allocator, moduleFuncDecl("makePoint", namedRef("Point"))) catch unreachable;
...
// zbr:selfhost/typechecker_test.zbr:476
...
// zbr:selfhost/typechecker_test.zbr:481
    const call: Expr = Expr{ .call = _box_23: { const _bp_23 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_23.* = ExprCall.init(mkSpan(), callee, std.ArrayList(Arg).empty); break :_box_23 _bp_23; } };
// zbr:selfhost/typechecker_test.zbr:482
...
// zbr:selfhost/typechecker_test.zbr:486
...
// zbr:selfhost/typechecker_test.zbr:492
    var dep_decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:493
    dep_decls.append(_allocator, moduleFuncDecl("helper", namedRef("str"))) catch unreachable;
...
// zbr:selfhost/typechecker_test.zbr:499
    check((dep_mr != null), "dep buildModuleTypes: helper registered under sentinel");
// zbr:selfhost/typechecker_test.zbr:502
    var caller_decls = std.ArrayList(Decl).empty;
// zbr:selfhost/typechecker_test.zbr:503
    caller_decls.append(_allocator, classDecl("Caller", std.ArrayList(Decl).empty)) catch unreachable;
...
// zbr:selfhost/typechecker_test.zbr:509
...
// zbr:selfhost/typechecker_test.zbr:513
    const call: Expr = Expr{ .call = _box_24: { const _bp_24 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_24.* = ExprCall.init(mkSpan(), callee, std.ArrayList(Arg).empty); break :_box_24 _bp_24; } };
// zbr:selfhost/typechecker_test.zbr:514
...
// zbr:selfhost/typechecker_test.zbr:518
...
// zbr:selfhost/typechecker_test.zbr:523
    testTypeFromName();
// zbr:selfhost/typechecker_test.zbr:524
    testClassTypesFields();
// zbr:selfhost/typechecker_test.zbr:525
    testClassTypesMethods();
// zbr:selfhost/typechecker_test.zbr:526
    testClassTypesCtorParams();
// zbr:selfhost/typechecker_test.zbr:527
    testModuleTypesFields();
// zbr:selfhost/typechecker_test.zbr:528
    testModuleTypesMethods();
// zbr:selfhost/typechecker_test.zbr:529
    testModuleTypesCtorParams();
// zbr:selfhost/typechecker_test.zbr:530
    testCrossModuleType();
// zbr:selfhost/typechecker_test.zbr:531
    testTypeFromRef();
// zbr:selfhost/typechecker_test.zbr:532
    testBuildModuleTypesClass();
// zbr:selfhost/typechecker_test.zbr:533
    testBuildModuleTypesInit();
// zbr:selfhost/typechecker_test.zbr:534
    testInferLiterals();
// zbr:selfhost/typechecker_test.zbr:535
    testInferBinaryAdd();
// zbr:selfhost/typechecker_test.zbr:536
    testInferBinaryCompare();
// zbr:selfhost/typechecker_test.zbr:537
    testInferThisField();
// zbr:selfhost/typechecker_test.zbr:538
    testInferCtorCall();
// zbr:selfhost/typechecker_test.zbr:539
    testInferIdentScope();
// zbr:selfhost/typechecker_test.zbr:540
    testInferMethodCall();
// zbr:selfhost/typechecker_test.zbr:541
    testUnionVariantIndex();
// zbr:selfhost/typechecker_test.zbr:542
    testNarrowPayloadFromOnValue();
// zbr:selfhost/typechecker_test.zbr:543
    testInferModuleFuncCall();
// zbr:selfhost/typechecker_test.zbr:544
    testInferDepModuleFuncCall();
// zbr:selfhost/typechecker_test.zbr:545
