...
pub const ResolverTest = struct {
    ...
    pub fn testEmptyClass(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic("empty class: expected no errors");
        if (!((r.symbolCount() >= 1))) @panic("empty class: expected at least 1 symbol");
        std.debug.print("{s}\n", .{"testEmptyClass: OK"});
    }
    ...
    pub fn testFieldInScope(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("field in scope: expected no errors, got: ", r.firstError(), _allocator));
        std.debug.print("{s}\n", .{"testFieldInScope: OK"});
    }
    ...
    pub fn testMethodInScope(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("method in scope: expected no errors, got: ", r.firstError(), _allocator));
    ...
    pub fn testLocalDeclaredBeforeUse(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("local before use: expected no errors, got: ", r.firstError(), _allocator));
    ...
    pub fn testUndefinedName(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 1))) @panic(_str_concat("undefined name: expected 1 error, got ", (blk: { var _cpbuf: [4]u8 = undefined; const _cplen = std.unicode.utf8Encode(@intCast(r.errorCount()), &_cpbuf) catch 1; break :blk _allocator.dupe(u8, _cpbuf[0.._cplen]) catch @panic("OOM"); }), _allocator));
        const msg = r.firstError();
        if (!(msg.contains("undeclared"))) @panic(_str_concat("undefined name: error should mention 'undeclared', got: ", msg, _allocator));
    ...
    pub fn testLocalNotVisibleBeforeDecl(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 1))) @panic(_str_concat("pre-decl: expected 1 error, got ", (blk: { var _cpbuf: [4]u8 = undefined; const _cplen = std.unicode.utf8Encode(@intCast(r.errorCount()), &_cpbuf) catch 1; break :blk _allocator.dupe(u8, _cpbuf[0.._cplen]) catch @panic("OOM"); }), _allocator));
        const msg = r.firstError();
        if (!(msg.contains("'x'"))) @panic(_str_concat("pre-decl: error should mention 'x', got: ", msg, _allocator));
    ...
    pub fn testArithExpr(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("arith: expected no errors, got: ", r.firstError(), _allocator));
        std.debug.print("{s}\n", .{"testArithExpr: OK"});
    }
    ...
    pub fn testIfCond(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("if: expected no errors, got: ", r.firstError(), _allocator));
        std.debug.print("{s}\n", .{"testIfCond: OK"});
    }
    ...
    pub fn testWhileLoop(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("while: expected no errors, got: ", r.firstError(), _allocator));
        std.debug.print("{s}\n", .{"testWhileLoop: OK"});
    }
    ...
    pub fn testTryCatch(self: *ResolverTest) anyerror!void {
        ...
        var r = Resolver.init();
        try r.resolve(root);
        if (!((r.errorCount() == 0))) @panic(_str_concat("try/catch: expected no errors, got: ", r.firstError(), _allocator));
        std.debug.print("{s}\n", .{"testTryCatch: OK"});
    }
...
const _ttag_ResolverTest: u64 = _zbr_hash("ResolverTest");
