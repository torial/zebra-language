...
// zbr:selfhost/Resolver.zbr:82
                result = _str_concat(result, "\n", _allocator);
            }
// zbr:selfhost/Resolver.zbr:83
            result = _str_concat(result, e.message, _allocator);
        }
// zbr:selfhost/Resolver.zbr:84
        return result;
    }
