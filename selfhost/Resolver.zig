...
// zbr:selfhost\Resolver.zbr:212
                    self.method_scope.put(_intern(i.is_capture.?), 4) catch unreachable;
...
// zbr:selfhost\Resolver.zbr:370
        ...
        { var _split_iter_1 = std.mem.splitSequence(u8, name, "x"); while (_split_iter_1.next()) |_se_1| { parts.append(_allocator, _se_1) catch @panic("OOM"); } }
