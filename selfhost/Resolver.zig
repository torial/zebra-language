...
// zbr:selfhost\Resolver.zbr:100
                self.module_scope.put((_allocator.dupe(u8, e.name) catch @panic("OOM")), 0) catch unreachable;
...
// zbr:selfhost\Resolver.zbr:139
            self.class_scope.put((_allocator.dupe(u8, tp) catch @panic("OOM")), 6) catch unreachable;
...
// zbr:selfhost\Resolver.zbr:194
                    self.method_scope.put((_allocator.dupe(u8, nm) catch @panic("OOM")), 4) catch unreachable;
...
// zbr:selfhost\Resolver.zbr:203
                    self.method_scope.put((_allocator.dupe(u8, i.is_capture.?) catch @panic("OOM")), 4) catch unreachable;
