...
pub const Resolver = struct {
    ...
    pub fn init(file_name: []const u8) *Resolver {
...
// zbr:selfhost\Resolver.zbr:289
                    self.errors.append(_allocator, ResolveError.init(_str_concat(_str_concat(_str_concat(_str_concat(_str_concat(_str_concat(_str_concat(self.file_name, ":", _allocator), (std.fmt.allocPrint(_allocator, "{}", .{id.line}) catch unreachable), _allocator), ":", _allocator), (std.fmt.allocPrint(_allocator, "{}", .{id.col}) catch unreachable), _allocator), ": error: undefined name: '", _allocator), id.name, _allocator), "'", _allocator))) catch unreachable;
                }
            },
            .expr_binary => |b_ptr| {
                const b = b_ptr.*;
