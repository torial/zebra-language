...
pub fn zspan() Span {
// zbr:selfhost/codegen_test.zbr:21
    return Span.init(0, 0, 0, 0);
}

pub fn zmods() Modifiers {
// zbr:selfhost/codegen_test.zbr:24
    return Modifiers.init(false, false, false, false, false, false, false, false);
}

pub fn zstatic() Modifiers {
// zbr:selfhost/codegen_test.zbr:27
    return Modifiers.init(false, false, false, true, false, false, false, false);
}

pub fn namedTr(name: []const u8) TypeRef {
// zbr:selfhost/codegen_test.zbr:30
    return TypeRef{ .named = NamedTypeRef.init(zspan(), name) };
}

pub fn nilableTr(inner: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:33
    return TypeRef{ .nilable = _box_1: { const _bp_1 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_1.* = inner; break :_box_1 _bp_1; } };
}

pub fn refToTr(inner: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:36
    return TypeRef{ .ref_to = _box_2: { const _bp_2 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_2.* = inner; break :_box_2 _bp_2; } };
}

pub fn errUnionTr(inner: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:39
    return TypeRef{ .error_union = _box_3: { const _bp_3 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_3.* = inner; break :_box_3 _bp_3; } };
}
...
// zbr:selfhost/codegen_test.zbr:44
...
// zbr:selfhost/codegen_test.zbr:50
...
// zbr:selfhost/codegen_test.zbr:55
    return Generator.init(w, 0, "", false, false, false, false, null, "", "", cn, ModuleTypes.init(), ModuleTypes.init());
}
...
// zbr:selfhost/codegen_test.zbr:63
    if (!(std.mem.eql(u8, w.output(), "hello world"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:64
    std.debug.print("{s}\n", .{"1. Writer: OK"});
}
...
// zbr:selfhost/codegen_test.zbr:72
...
// zbr:selfhost/codegen_test.zbr:84
    std.debug.assert((!g3.in_method));
// zbr:selfhost/codegen_test.zbr:86
    std.debug.print("{s}\n", .{"2. Generator context-forking: OK"});
}

pub fn testGenTypePrimitive() void {
// zbr:selfhost/codegen_test.zbr:91
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:93
    g.genType(namedTr("int"));
// zbr:selfhost/codegen_test.zbr:94
    if (!(std.mem.eql(u8, g.w.output(), "i64"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:98
    if (!(std.mem.eql(u8, g2.w.output(), "[]const u8"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:102
    if (!(std.mem.eql(u8, g3.w.output(), "f64"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:106
    if (!(std.mem.eql(u8, g4.w.output(), "bool"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:110
    if (!(std.mem.eql(u8, g5.w.output(), "u21"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:114
    if (!(std.mem.eql(u8, g6.w.output(), "void"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:118
    if (!(std.mem.eql(u8, g7.w.output(), "MyStruct"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:124
    var g8 = Generator.init(w8, 0, "", false, false, false, false, null, "", "", cn, ModuleTypes.init(), ModuleTypes.init());
// zbr:selfhost/codegen_test.zbr:125
    g8.genType(namedTr("MyClass"));
// zbr:selfhost/codegen_test.zbr:126
    if (!(std.mem.eql(u8, g8.w.output(), "*MyClass"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:128
...
// zbr:selfhost/codegen_test.zbr:135
    if (!(std.mem.eql(u8, g.w.output(), "std.ArrayList(i64)"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:139
    if (!(std.mem.eql(u8, g2.w.output(), "std.StringHashMap(i64)"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:146
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:147
    g.genType(nilableTr(namedTr("int")));
// zbr:selfhost/codegen_test.zbr:148
    if (!(std.mem.eql(u8, g.w.output(), "?i64"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:150
    var g2 = makeGen();
// zbr:selfhost/codegen_test.zbr:151
    g2.genType(errUnionTr(namedTr("str")));
// zbr:selfhost/codegen_test.zbr:152
    if (!(std.mem.eql(u8, g2.w.output(), "anyerror![]const u8"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:154
    var g3 = makeGen();
// zbr:selfhost/codegen_test.zbr:155
    g3.genType(refToTr(namedTr("Node")));
// zbr:selfhost/codegen_test.zbr:156
    if (!(std.mem.eql(u8, g3.w.output(), "*Node"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
...
// zbr:selfhost/codegen_test.zbr:163
...
// zbr:selfhost/codegen_test.zbr:195
    const fld2 = DeclVar.init(zspan(), zmods(), "name", namedTr("str"), null, false);
// zbr:selfhost/codegen_test.zbr:196
    members.append(_allocator, Decl{ .var_ = _box_4: { const _bp_4 = _allocator.create(Ast.DeclVar) catch @panic("OOM"); _bp_4.* = fld1; break :_box_4 _bp_4; } }) catch unreachable;
// zbr:selfhost/codegen_test.zbr:197
    members.append(_allocator, Decl{ .var_ = _box_5: { const _bp_5 = _allocator.create(Ast.DeclVar) catch @panic("OOM"); _bp_5.* = fld2; break :_box_5 _bp_5; } }) catch unreachable;
// zbr:selfhost/codegen_test.zbr:198
    const n = DeclStruct.init(zspan(), zmods(), "Point", std.ArrayList(TypeRef).empty, members);
...
// zbr:selfhost/codegen_test.zbr:205
...
// zbr:selfhost/codegen_test.zbr:214
    members.append(_allocator, Decl{ .var_ = _box_6: { const _bp_6 = _allocator.create(Ast.DeclVar) catch @panic("OOM"); _bp_6.* = fld; break :_box_6 _bp_6; } }) catch unreachable;
// zbr:selfhost/codegen_test.zbr:215
    const cls = DeclClass.init(zspan(), zmods(), "Counter", std.ArrayList(TypeParam).empty, std.ArrayList(TypeRef).empty, std.ArrayList(TypeRef).empty, members);
// zbr:selfhost/codegen_test.zbr:217
    var g = makeGen();
...
// zbr:selfhost/codegen_test.zbr:222
...
// zbr:selfhost/codegen_test.zbr:232
    var ig = g.indented();
// zbr:selfhost/codegen_test.zbr:233
    const fld = DeclVar.init(zspan(), zmods(), "buf", namedTr("StringBuilder"), null, false);
// zbr:selfhost/codegen_test.zbr:234
    ig.genFieldDecl(fld);
// zbr:selfhost/codegen_test.zbr:235
    const out = g.w.output();
// zbr:selfhost/codegen_test.zbr:236
...
// zbr:selfhost/codegen_test.zbr:243
    testGenerator();
// zbr:selfhost/codegen_test.zbr:244
    testGenTypePrimitive();
// zbr:selfhost/codegen_test.zbr:245
    testGenTypeGenerics();
// zbr:selfhost/codegen_test.zbr:246
    testGenTypeCompound();
// zbr:selfhost/codegen_test.zbr:247
    testGenEnum();
// zbr:selfhost/codegen_test.zbr:248
    testGenUnion();
// zbr:selfhost/codegen_test.zbr:249
    testGenStruct();
