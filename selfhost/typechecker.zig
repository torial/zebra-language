...
// zbr:selfhost/typechecker.zbr:1367
                                return Type_{ .optional = blk_box_11: { const _bv: std.meta.Child(@FieldType(Type_, "optional")) = list_elem; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_11 _bp; } };
                            }
...
// zbr:selfhost/typechecker.zbr:1373
                                return Type_{ .optional = blk_box_12: { const _bv: std.meta.Child(@FieldType(Type_, "optional")) = chan_elem; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_12 _bp; } };
                            }
...
// zbr:selfhost/typechecker.zbr:1381
                                return Type_{ .optional = blk_box_13: { const _bv: std.meta.Child(@FieldType(Type_, "optional")) = hmt.val_t; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_13 _bp; } };
                            }
...
// zbr:selfhost/typechecker.zbr:1387
                                return Type_{ .list_ = blk_box_14: { const _bv: std.meta.Child(@FieldType(Type_, "list_")) = hmt.key_t; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_14 _bp; } };
                            }
// zbr:selfhost/typechecker.zbr:1388
                            if (std.mem.eql(u8, hmname, "values")) {
// zbr:selfhost/typechecker.zbr:1389
                                return Type_{ .list_ = blk_box_15: { const _bv: std.meta.Child(@FieldType(Type_, "list_")) = hmt.val_t; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_15 _bp; } };
                            }
                        },
                        else => |_| {
                            // pass
...
// zbr:selfhost/typechecker.zbr:1416
                                return Type_{ .list_ = blk_box_16: { const _bv: std.meta.Child(@FieldType(Type_, "list_")) = typeFromName(tn.name); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_16 _bp; } };
                            }
                        }
                    }
...
// zbr:selfhost/typechecker.zbr:1435
            return Type_{ .optional = blk_box_17: { const _bv: std.meta.Child(@FieldType(Type_, "optional")) = inner_t; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_17 _bp; } };
        },
        .orelse_ => |_ptr_eo| {
            const eo = _ptr_eo.*;
...
// zbr:selfhost/typechecker.zbr:1562
            return Type_{ .optional = blk_box_18: { const _bv: std.meta.Child(@FieldType(Type_, "optional")) = flat_t; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_18 _bp; } };
        },
        .list_lit => |_ptr_ll| {
            const ll = _ptr_ll.*;
...
// zbr:selfhost/typechecker.zbr:1565
                return Type_{ .list_ = blk_box_19: { const _bv: std.meta.Child(@FieldType(Type_, "list_")) = typeFromRef(ll.elem_type.?); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_19 _bp; } };
            }
...
// zbr:selfhost/typechecker.zbr:1568
                return Type_{ .list_ = blk_box_20: { const _bv: std.meta.Child(@FieldType(Type_, "list_")) = elem_t; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_20 _bp; } };
            }
// zbr:selfhost/typechecker.zbr:1569
            return Type_{ .list_ = blk_box_21: { const _bv: std.meta.Child(@FieldType(Type_, "list_")) = Type_.unknown_; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_21 _bp; } };
        },
        .tuple_lit => |_ptr_tl| {
            const tl = _ptr_tl.*;
