...
pub const _zbr_ty_Modifiers = struct {
    ...
    pub fn init(is_public: bool, is_private: bool, is_static: bool, is_extern: bool, is_reflectable: bool, is_profile: bool, is_once: bool, is_export: bool, is_derive_debug: bool, is_derive_eq: bool, is_derive_hash: bool, is_pure: bool, is_node_export: bool) _zbr_ty_Modifiers {
...
// zbr:selfhost/Ast.zbr:142
            _self.mods = mods;
// zbr:selfhost/Ast.zbr:143
            _self.name = _intern(name);
// zbr:selfhost/Ast.zbr:144
...
// zbr:selfhost/Ast.zbr:273
            _self.span = span;
// zbr:selfhost/Ast.zbr:274
            _self.name = _intern(name);
...
// zbr:selfhost/Ast.zbr:288
            _self.span = span;
// zbr:selfhost/Ast.zbr:289
            _self.name = _intern(name);
...
// zbr:selfhost/Ast.zbr:352
            _self.span = span;
// zbr:selfhost/Ast.zbr:353
            _self.mods = mods;
...
// zbr:selfhost/Ast.zbr:401
            _self.span = span;
// zbr:selfhost/Ast.zbr:402
            _self.params = params;
// zbr:selfhost/Ast.zbr:403
            _self.ret = ret;
        return _self;
    }
...
// zbr:selfhost/Ast.zbr:410
            _self.span = span;
// zbr:selfhost/Ast.zbr:411
            _self.name = _intern(name);
        return _self;
    }
...
// zbr:selfhost/Ast.zbr:419
            _self.span = span;
// zbr:selfhost/Ast.zbr:420
            _self.name = _intern(name);
// zbr:selfhost/Ast.zbr:421
            _self.args = args;
        return _self;
    }
...
// zbr:selfhost/Ast.zbr:437
            _self.span = span;
// zbr:selfhost/Ast.zbr:438
            _self.name = _intern(name);
// zbr:selfhost/Ast.zbr:439
            _self.args = args;
        return _self;
    }
...
// zbr:selfhost/Ast.zbr:507
            _self.cond = cond;
// zbr:selfhost/Ast.zbr:508
            _self.is_capture = null;
// zbr:selfhost/Ast.zbr:509
            _self.then_stmts = then_stmts;
// zbr:selfhost/Ast.zbr:510
...
// zbr:selfhost/Ast.zbr:549
            _self.span = span;
// zbr:selfhost/Ast.zbr:550
            _self.var_ = _intern(var_);
// zbr:selfhost/Ast.zbr:551
            _self.start = start;
// zbr:selfhost/Ast.zbr:552
            _self.stop_ = stop_;
...
// zbr:selfhost/Ast.zbr:1060
            _self.span = span;
// zbr:selfhost/Ast.zbr:1061
            _self.ops = ops;
// zbr:selfhost/Ast.zbr:1062
...
// zbr:selfhost/Ast.zbr:1115
            _self.span = span;
// zbr:selfhost/Ast.zbr:1116
            _self.expr = expr;
// zbr:selfhost/Ast.zbr:1117
            _self.err_var = err_var;
// zbr:selfhost/Ast.zbr:1118
            _self.fallback = fallback;
        return _self;
    }
...
// zbr:selfhost/Ast.zbr:1184
            _self.key = key;
// zbr:selfhost/Ast.zbr:1185
            _self.value = value;
        return _self;
    }
...
// zbr:selfhost/Ast.zbr:1218
            _self.span = span;
// zbr:selfhost/Ast.zbr:1219
            _self.expr = expr;
        return _self;
    }
