...
// zbr:selfhost/pipeline_test.zbr:14
    const pm_node = try Parser.Parser.parse(src, "<test>");
...
// zbr:selfhost/pipeline_test.zbr:27
            return try generateFull(module, "<test>", preamble_path, false);
        },
        else => {
...
// zbr:selfhost/pipeline_test.zbr:132
        var resolver = Resolver.Resolver.init("<test>");
...
// zbr:selfhost/pipeline_test.zbr:170
    ...
    _try_blk_1: {
// zbr:selfhost/pipeline_test.zbr:168
        const t = PipelineTest.init();
// zbr:selfhost/pipeline_test.zbr:169
