...
const exprHasTry = CgHelpers.exprHasTry;
const bodyHasRaise = CgHelpers.bodyHasRaise;
const nilNarrowVar = CgHelpers.nilNarrowVar;
const nameUsedInExpr = CgHelpers.nameUsedInExpr;
const nameUsedInStmts = CgHelpers.nameUsedInStmts;
const collectAllIdents = CgHelpers.collectAllIdents;
...
// zbr:selfhost/cg_helpers_test.zbr:97
    var args1 = std.ArrayList(TypeRef).empty;
...
// zbr:selfhost/cg_helpers_test.zbr:100
    var args2 = std.ArrayList(TypeRef).empty;
...
// zbr:selfhost/cg_helpers_test.zbr:119
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .nilable = _box_1: { const _bp_1 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_1.* = inner; break :_box_1 _bp_1; } }), "?str"));
// zbr:selfhost/cg_helpers_test.zbr:120
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .stream = _box_2: { const _bp_2 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_2.* = inner; break :_box_2 _bp_2; } }), "str*"));
// zbr:selfhost/cg_helpers_test.zbr:121
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .error_union = _box_3: { const _bp_3 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_3.* = inner; break :_box_3 _bp_3; } }), "!str"));
// zbr:selfhost/cg_helpers_test.zbr:122
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .ref_to = _box_4: { const _bp_4 = _allocator.create(Ast.TypeRef) catch @panic("OOM"); _bp_4.* = inner; break :_box_4 _bp_4; } }), "^str"));
...
// zbr:selfhost/cg_helpers_test.zbr:140
    const ne = Expr{ .binary = _box_5: { const _bp_5 = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_5.* = ExprBinary.init(sp, BinaryOp.ne, _box_6: { const _bp_6 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_6.* = id_x; break :_box_6 _bp_6; }, _box_7: { const _bp_7 = blk2: { break :blk2 _allocator.create(@TypeOf(nil_)) catch @panic("OOM"); }; _bp_7.* = nil_; break :_box_7 _bp_7; }); break :_box_5 _bp_5; } };
...
// zbr:selfhost/cg_helpers_test.zbr:144
    const eq = Expr{ .binary = _box_8: { const _bp_8 = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_8.* = ExprBinary.init(sp, BinaryOp.eq, _box_9: { const _bp_9 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_9.* = id_x; break :_box_9 _bp_9; }, _box_a: { const _bp_a = blk2: { break :blk2 _allocator.create(@TypeOf(nil_)) catch @panic("OOM"); }; _bp_a.* = nil_; break :_box_a _bp_a; }); break :_box_8 _bp_8; } };
...
// zbr:selfhost/cg_helpers_test.zbr:148
    const ne2 = Expr{ .binary = _box_b: { const _bp_b = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_b.* = ExprBinary.init(sp, BinaryOp.ne, _box_c: { const _bp_c = blk2: { break :blk2 _allocator.create(@TypeOf(nil_)) catch @panic("OOM"); }; _bp_c.* = nil_; break :_box_c _bp_c; }, _box_d: { const _bp_d = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_d.* = id_x; break :_box_d _bp_d; }); break :_box_b _bp_b; } };
...
// zbr:selfhost/cg_helpers_test.zbr:152
    const add = Expr{ .binary = _box_e: { const _bp_e = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_e.* = ExprBinary.init(sp, BinaryOp.add, _box_f: { const _bp_f = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_f.* = id_x; break :_box_f _bp_f; }, _box_10: { const _bp_10 = blk2: { break :blk2 _allocator.create(@TypeOf(lit)) catch @panic("OOM"); }; _bp_10.* = lit; break :_box_10 _bp_10; }); break :_box_e _bp_e; } };
...
// zbr:selfhost/cg_helpers_test.zbr:167
    const try_e = Expr{ .try_ = _box_11: { const _bp_11 = _allocator.create(Ast.ExprTry) catch @panic("OOM"); _bp_11.* = ExprTry.init(sp, _box_12: { const _bp_12 = blk2: { break :blk2 _allocator.create(@TypeOf(inner)) catch @panic("OOM"); }; _bp_12.* = inner; break :_box_12 _bp_12; }); break :_box_11 _bp_11; } };
...
// zbr:selfhost/cg_helpers_test.zbr:171
    std.debug.assert(exprHasTry(Expr{ .binary = _box_13: { const _bp_13 = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_13.* = ExprBinary.init(sp, BinaryOp.add, _box_14: { const _bp_14 = blk2: { break :blk2 _allocator.create(@TypeOf(lhs)) catch @panic("OOM"); }; _bp_14.* = lhs; break :_box_14 _bp_14; }, _box_15: { const _bp_15 = blk2: { break :blk2 _allocator.create(@TypeOf(try_e)) catch @panic("OOM"); }; _bp_15.* = try_e; break :_box_15 _bp_15; }); break :_box_13 _bp_13; } }));
...
// zbr:selfhost/cg_helpers_test.zbr:174
    std.debug.assert((!exprHasTry(Expr{ .binary = _box_16: { const _bp_16 = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_16.* = ExprBinary.init(sp, BinaryOp.add, _box_17: { const _bp_17 = blk2: { break :blk2 _allocator.create(@TypeOf(lhs)) catch @panic("OOM"); }; _bp_17.* = lhs; break :_box_17 _bp_17; }, _box_18: { const _bp_18 = blk2: { break :blk2 _allocator.create(@TypeOf(rhs)) catch @panic("OOM"); }; _bp_18.* = rhs; break :_box_18 _bp_18; }); break :_box_16 _bp_16; } })));
...
// zbr:selfhost/cg_helpers_test.zbr:182
    std.debug.assert((!bodyHasRaise(std.ArrayList(Stmt).empty)));
// zbr:selfhost/cg_helpers_test.zbr:184
    var with_raise = std.ArrayList(Stmt).empty;
// zbr:selfhost/cg_helpers_test.zbr:185
    with_raise.append(_allocator, Stmt{ .raise_ = _box_19: { const _bp_19 = _allocator.create(Ast.StmtRaise) catch @panic("OOM"); _bp_19.* = StmtRaise.init(sp, null, null); break :_box_19 _bp_19; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:186
    std.debug.assert(bodyHasRaise(with_raise));
// zbr:selfhost/cg_helpers_test.zbr:188
    var with_pass = std.ArrayList(Stmt).empty;
...
// zbr:selfhost/cg_helpers_test.zbr:192
    const try_e = Expr{ .try_ = _box_1a: { const _bp_1a = _allocator.create(Ast.ExprTry) catch @panic("OOM"); _bp_1a.* = ExprTry.init(sp, _box_1b: { const _bp_1b = blk2: { break :blk2 _allocator.create(@TypeOf(Expr{ .ident = ExprIdent.init(sp, "f") })) catch @panic("OOM"); }; _bp_1b.* = Expr{ .ident = ExprIdent.init(sp, "f") }; break :_box_1b _bp_1b; }); break :_box_1a _bp_1a; } };
// zbr:selfhost/cg_helpers_test.zbr:193
    const dv = DeclVar.init(sp, zmods(), "x", null, _box_1c: { const _bp_1c = blk2: { break :blk2 _allocator.create(@TypeOf(try_e)) catch @panic("OOM"); }; _bp_1c.* = try_e; break :_box_1c _bp_1c; }, false);
// zbr:selfhost/cg_helpers_test.zbr:194
    var with_try_var = std.ArrayList(Stmt).empty;
// zbr:selfhost/cg_helpers_test.zbr:195
    with_try_var.append(_allocator, Stmt{ .var_ = _box_1d: { const _bp_1d = _allocator.create(Ast.DeclVar) catch @panic("OOM"); _bp_1d.* = dv; break :_box_1d _bp_1d; } }) catch unreachable;
...
// zbr:selfhost/cg_helpers_test.zbr:199
    var with_return = std.ArrayList(Stmt).empty;
// zbr:selfhost/cg_helpers_test.zbr:200
    with_return.append(_allocator, Stmt{ .return_ = _box_1e: { const _bp_1e = _allocator.create(Ast.StmtReturn) catch @panic("OOM"); _bp_1e.* = StmtReturn.init(sp, _box_1f: { const _bp_1f = blk2: { break :blk2 _allocator.create(@TypeOf(ret_lit)) catch @panic("OOM"); }; _bp_1f.* = ret_lit; break :_box_1f _bp_1f; }); break :_box_1e _bp_1e; } }) catch unreachable;
...
// zbr:selfhost/cg_helpers_test.zbr:220
    const bin = Expr{ .binary = _box_20: { const _bp_20 = _allocator.create(Ast.ExprBinary) catch @panic("OOM"); _bp_20.* = ExprBinary.init(sp, BinaryOp.add, _box_21: { const _bp_21 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_21.* = id_x; break :_box_21 _bp_21; }, _box_22: { const _bp_22 = blk2: { break :blk2 _allocator.create(@TypeOf(id_y)) catch @panic("OOM"); }; _bp_22.* = id_y; break :_box_22 _bp_22; }); break :_box_20 _bp_20; } };
...
// zbr:selfhost/cg_helpers_test.zbr:230
    stmts.append(_allocator, Stmt{ .return_ = _box_23: { const _bp_23 = _allocator.create(Ast.StmtReturn) catch @panic("OOM"); _bp_23.* = StmtReturn.init(sp, _box_24: { const _bp_24 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_24.* = id_x; break :_box_24 _bp_24; }); break :_box_23 _bp_23; } }) catch unreachable;
...
// zbr:selfhost/cg_helpers_test.zbr:233
    std.debug.assert((!nameUsedInStmts("x", std.ArrayList(Stmt).empty)));
...
// zbr:selfhost/cg_helpers_test.zbr:243
    stmts.append(_allocator, Stmt{ .return_ = _box_25: { const _bp_25 = _allocator.create(Ast.StmtReturn) catch @panic("OOM"); _bp_25.* = StmtReturn.init(sp, _box_26: { const _bp_26 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_26.* = id_x; break :_box_26 _bp_26; }); break :_box_25 _bp_25; } }) catch unreachable;
...
// zbr:selfhost/cg_helpers_test.zbr:248
    std.debug.assert(((blk_27: { var _mc_27 = analyzeEscapes(std.ArrayList(Stmt).empty); break :blk_27 _mc_27.count(); }) == 0));
...
// zbr:selfhost/cg_helpers_test.zbr:259
    stmts.append(_allocator, Stmt{ .assign = _box_28: { const _bp_28 = _allocator.create(Ast.StmtAssign) catch @panic("OOM"); _bp_28.* = StmtAssign.init(sp, _box_29: { const _bp_29 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_29.* = id_x; break :_box_29 _bp_29; }, AssignOp.assign, _box_2a: { const _bp_2a = blk2: { break :blk2 _allocator.create(@TypeOf(lit)) catch @panic("OOM"); }; _bp_2a.* = lit; break :_box_2a _bp_2a; }); break :_box_28 _bp_28; } }) catch unreachable;
...
// zbr:selfhost/cg_helpers_test.zbr:264
    std.debug.assert(((blk_2b: { var _mc_2b = scanMutations(std.ArrayList(Stmt).empty); break :blk_2b _mc_2b.count(); }) == 0));
...
// zbr:selfhost/cg_helpers_test.zbr:287
    var _try_err_2c: ?anyerror = null;
    _try_blk_2c: {
// zbr:selfhost/cg_helpers_test.zbr:270
        testStrSet();
// zbr:selfhost/cg_helpers_test.zbr:271
        testAssignOpStr();
...
// zbr:selfhost/cg_helpers_test.zbr:276
        testTypeRefStrBoxed() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:277
        testNilNarrowVarSimple();
// zbr:selfhost/cg_helpers_test.zbr:278
        testNilNarrowVar() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:279
        testExprHasTry() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:280
        testBodyHasRaise() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:281
        testNameUsedInExprSimple();
// zbr:selfhost/cg_helpers_test.zbr:282
        testNameUsedInExprBinary() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:283
        testNameUsedInStmts() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:284
        testAnalyzeEscapes() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
// zbr:selfhost/cg_helpers_test.zbr:285
        testScanMutations() catch |_e| { _try_err_2c = _e; break :_try_blk_2c; };
