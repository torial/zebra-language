...
pub fn testStrSet() void {
    var s = StrSet.init();
    std.debug.assert((@as(i64, @intCast(s.count())) == 0));
    std.debug.assert((!s.contains_("a")));
    s.add("alpha");
    std.debug.assert((@as(i64, @intCast(s.count())) == 1));
    std.debug.assert(s.contains_("alpha"));
    std.debug.assert((!s.contains_("beta")));
    s.add("beta");
    s.add("alpha");
    std.debug.assert((@as(i64, @intCast(s.count())) == 2));
    std.debug.assert(s.contains_("beta"));
    std.debug.print("{s}\n", .{"1. StrSet: OK"});
}
...
pub fn testTypeRefStrGeneric() void {
    ...
    args1.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "str") }) catch @panic("OOM");
    ...
    args2.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "str") }) catch @panic("OOM");
    args2.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "int") }) catch @panic("OOM");
...
pub fn testTypeRefStrTuple() void {
    ...
    elems.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "int") }) catch @panic("OOM");
    elems.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "bool") }) catch @panic("OOM");
...
pub fn testTypeRefStrBoxed() anyerror!void {
    ...
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .nilable = blk_box: { const _bv = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }), "?str"));
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .stream = blk_box: { const _bv = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }), "str*"));
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .error_union = blk_box: { const _bv = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }), "!str"));
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .ref_to = blk_box: { const _bv = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }), "^str"));
...
pub fn testBodyHasRaise() anyerror!void {
    ...
    with_raise.append(_allocator, Stmt{ .raise_ = blk_box: { const _bv = StmtRaise.init(sp, null, null); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }) catch @panic("OOM");
...
pub fn testAnalyzeEscapes() anyerror!void {
    ...
    std.debug.assert((@as(i64, @intCast(analyzeEscapes(std.ArrayList(Stmt){}).items.len)) == 0));
    std.debug.print("{s}\n", .{"9. analyzeEscapes: OK"});
}
...
pub fn testScanMutations() anyerror!void {
    ...
    std.debug.assert((@as(i64, @intCast(scanMutations(std.ArrayList(Stmt){}).items.len)) == 0));
    std.debug.print("{s}\n", .{"10. scanMutations: OK"});
}
...
pub const Main = struct {
    ...
    pub fn main() void {
        ...
        testTypeRefStrTuple();
        {
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testTypeRefStrBoxed raised");
            }
        }
        testNilNarrowVarSimple();
        {
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testNilNarrowVar raised");
            }
        }
        {
            var _try_err: ?anyerror = null;
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testExprHasTry raised");
            }
        }
        {
            var _try_err: ?anyerror = null;
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testBodyHasRaise raised");
            }
        }
        testNameUsedInExprSimple();
        {
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testNameUsedInExprBinary raised");
            }
        }
        {
            var _try_err: ?anyerror = null;
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testNameUsedInStmts raised");
            }
        }
        {
            var _try_err: ?anyerror = null;
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testAnalyzeEscapes raised");
            }
        }
        {
            var _try_err: ?anyerror = null;
            ...
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testScanMutations raised");
            }
        }
