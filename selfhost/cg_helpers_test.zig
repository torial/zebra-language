...
// zbr:selfhost/cg_helpers_test.zbr:259
    stmts.append(_allocator, Stmt{ .assign = _box_27: { const _bp_27 = _allocator.create(ast.StmtAssign) catch @panic("OOM"); _bp_27.* = StmtAssign.init(sp, _box_28: { const _bp_28 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_28.* = id_x; break :_box_28 _bp_28; }, AssignOp.assign, _box_29: { const _bp_29 = blk2: { break :blk2 _allocator.create(@TypeOf(lit)) catch @panic("OOM"); }; _bp_29.* = lit; break :_box_29 _bp_29; }); break :_box_27 _bp_27; } }) catch unreachable;
...
// zbr:selfhost/cg_helpers_test.zbr:278
        var _try_err_2a: ?anyerror = null;
        _try_blk_2a: {
// zbr:selfhost/cg_helpers_test.zbr:279
            testTypeRefStrBoxed() catch |_e| { _try_err_2a = _e; break :_try_blk_2a; };
            break :_try_blk_2a;
        }
        if (_try_err_2a != null) {
...
// zbr:selfhost/cg_helpers_test.zbr:283
        var _try_err_2b: ?anyerror = null;
        _try_blk_2b: {
// zbr:selfhost/cg_helpers_test.zbr:284
            testNilNarrowVar() catch |_e| { _try_err_2b = _e; break :_try_blk_2b; };
            break :_try_blk_2b;
        }
        if (_try_err_2b != null) {
...
// zbr:selfhost/cg_helpers_test.zbr:291
        var _try_err_2d: ?anyerror = null;
        _try_blk_2d: {
// zbr:selfhost/cg_helpers_test.zbr:292
            testBodyHasRaise() catch |_e| { _try_err_2d = _e; break :_try_blk_2d; };
            break :_try_blk_2d;
        }
        if (_try_err_2d != null) {
...
// zbr:selfhost/cg_helpers_test.zbr:296
        var _try_err_2e: ?anyerror = null;
        _try_blk_2e: {
// zbr:selfhost/cg_helpers_test.zbr:297
            testNameUsedInExprBinary() catch |_e| { _try_err_2e = _e; break :_try_blk_2e; };
            break :_try_blk_2e;
        }
        if (_try_err_2e != null) {
...
// zbr:selfhost/cg_helpers_test.zbr:300
        var _try_err_2f: ?anyerror = null;
        _try_blk_2f: {
// zbr:selfhost/cg_helpers_test.zbr:301
            testNameUsedInStmts() catch |_e| { _try_err_2f = _e; break :_try_blk_2f; };
            break :_try_blk_2f;
        }
        if (_try_err_2f != null) {
...
// zbr:selfhost/cg_helpers_test.zbr:304
        var _try_err_30: ?anyerror = null;
        _try_blk_30: {
// zbr:selfhost/cg_helpers_test.zbr:305
            testAnalyzeEscapes() catch |_e| { _try_err_30 = _e; break :_try_blk_30; };
            break :_try_blk_30;
        }
        if (_try_err_30 != null) {
...
// zbr:selfhost/cg_helpers_test.zbr:308
        var _try_err_31: ?anyerror = null;
        _try_blk_31: {
// zbr:selfhost/cg_helpers_test.zbr:309
            testScanMutations() catch |_e| { _try_err_31 = _e; break :_try_blk_31; };
            break :_try_blk_31;
        }
        if (_try_err_31 != null) {
