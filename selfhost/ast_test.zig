...
pub const AstTest = struct {
    ...
    pub fn run(self: *AstTest) void {
        ...
        self.testUnionTypeRef();
        {
            ...
            _try_blk: {
                self.testNilableTypeRef() catch |_tc_e| { _try_err = _tc_e; break :_try_blk; };
                break :_try_blk;
            }
            if (_try_err != null) {
                _ = _try_err;
                if (!(false)) @panic("testNilableTypeRef raised unexpectedly");
            }
        }
    ...
    pub fn testDeclVar(self: *AstTest) void {
        ...
        const dv = ast.DeclVar(s, mods, "x", null, null, false);
    ...
    pub fn testNilableTypeRef(self: *AstTest) anyerror!void {
        ...
        switch (tr) {
            .TypeRef => {
                ...
                if (!(false)) @panic("expected nilable variant");
            },
        }
    }
...
const _ttag_AstTest: u64 = _zbr_hash("AstTest");
