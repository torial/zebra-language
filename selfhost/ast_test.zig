...
// zbr:selfhost/ast_test.zbr:19
            self.testNilableTypeRef() catch |_e| { _try_err_1 = _e; break :_try_blk_1; };
...
// zbr:selfhost/ast_test.zbr:49
    ...
    pub fn testDeclVar(self: *AstTest) void {
        _ = self;
// zbr:selfhost/ast_test.zbr:52
        const s = ast.Span.init(5, 1, 5, 10);
// zbr:selfhost/ast_test.zbr:53
        const mods = ast.Modifiers.init(false, false, false, false, false, false, false, false);
...
// zbr:selfhost/ast_test.zbr:78
        const tr = ast.TypeRef{ .nilable = _box_2: { const _bp_2 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_2.* = inner; break :_box_2 _bp_2; } };
...
// zbr:selfhost/ast_test.zbr:86
    const t = AstTest.init();
// zbr:selfhost/ast_test.zbr:87
    t.run();
}
