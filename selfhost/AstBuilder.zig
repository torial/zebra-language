...
// zbr:selfhost/AstBuilder.zbr:744
                const yval = (try self.buildExpr(_zbr_at(py.value.items, 0)));
// zbr:selfhost/AstBuilder.zbr:745
                return _zbr_ty_Stmt{ .yield_ = blk_box_41: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "yield_")) = _zbr_ty_StmtYield.init(_zbr_ty_Span.init(py.line, py.col, py.line, py.col), _bx0: { const _bv = yval; const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_41 _bp; } };
            },
            .stmt_raise => |_ptr_pr| {
                const pr = _ptr_pr.*;
...
// zbr:selfhost/AstBuilder.zbr:755
                return _zbr_ty_Stmt{ .raise_ = blk_box_44: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "raise_")) = _zbr_ty_StmtRaise.init(_zbr_ty_Span.init(pr.line, pr.col, pr.line, pr.col), null, null); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_44 _bp; } };
            },
...
// zbr:selfhost/AstBuilder.zbr:766
                return _zbr_ty_Stmt{ .try_catch = blk_box_45: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "try_catch")) = _zbr_ty_StmtTryCatch.init(_zbr_ty_Span.init(ptc.line, ptc.col, ptc.line, ptc.col), body_stmts, clauses); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_45 _bp; } };
            },
            .stmt_branch => |_ptr_pb| {
                const pb = _ptr_pb.*;
...
// zbr:selfhost/AstBuilder.zbr:775
                return _zbr_ty_Stmt{ .allocate_ = blk_box_46: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "allocate_")) = _zbr_ty_StmtAllocate.init(_zbr_ty_Span.init(pa.line, pa.col, pa.line, pa.col), source_expr, is_scoped, stmts); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_46 _bp; } };
            },
...
// zbr:selfhost/AstBuilder.zbr:780
                return _zbr_ty_Stmt{ .copy_out = blk_box_47: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "copy_out")) = _zbr_ty_StmtCopyOut.init(_zbr_ty_Span.init(pco.line, pco.col, pco.line, pco.col), target_expr, value_expr, pco.deep); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_47 _bp; } };
            },
            .stmt_with => |_ptr_pw| {
                const pw = _ptr_pw.*;
...
// zbr:selfhost/AstBuilder.zbr:803
                return _zbr_ty_Stmt{ .expr = blk_box_51: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "expr")) = expr; const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_51 _bp; } };
            },
...
// zbr:selfhost/AstBuilder.zbr:820
                return _zbr_ty_Stmt{ .print_ = blk_box_52: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "print_")) = _zbr_ty_StmtPrint.init(print_span, args, true); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_52 _bp; } };
            },
...
// zbr:selfhost/AstBuilder.zbr:831
                return _zbr_ty_Stmt{ .contract = blk_box_53: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "contract")) = _zbr_ty_StmtContract.init(req_span, _zbr_ty_ContractKind.precond, exprs); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_53 _bp; } };
            },
...
// zbr:selfhost/AstBuilder.zbr:838
                return _zbr_ty_Stmt{ .contract = blk_box_54: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Stmt, "contract")) = _zbr_ty_StmtContract.init(_zbr_fn_zspan(), _zbr_ty_ContractKind.postcond, exprs); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_54 _bp; } };
            },
            else => {
...
// zbr:selfhost/AstBuilder.zbr:992
                    return _zbr_ty_PNode{ .expr_call = blk_box_58: { const _bv: std.meta.Child(@FieldType(_zbr_ty_PNode, "expr_call")) = _zbr_ty_PCall.init(callee2, pc.args); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_58 _bp; } };
                }
...
// zbr:selfhost/AstBuilder.zbr:1001
                    return _zbr_ty_PNode{ .expr_member = blk_box_60: { const _bv: std.meta.Child(@FieldType(_zbr_ty_PNode, "expr_member")) = _zbr_ty_PMember.init(base2, pm.member, pm.line, pm.col); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_60 _bp; } };
                }
...
// zbr:selfhost/AstBuilder.zbr:1081
                return _zbr_ty_Expr{ .call = blk_box_63: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Expr, "call")) = _zbr_ty_ExprCall.init(_zbr_fn_spanOf(callee_expr), callee_expr, args); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_63 _bp; } };
            },
            .expr_index => |_ptr_pix| {
                const pix = _ptr_pix.*;
...
// zbr:selfhost/AstBuilder.zbr:1145
                        return _zbr_ty_Expr{ .call = blk_box_70: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Expr, "call")) = _zbr_ty_ExprCall.init(_zbr_fn_spanOf(lhs_expr), callee_expr, args); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_70 _bp; } };
                    },
                    else => {
...
// zbr:selfhost/AstBuilder.zbr:1192
                return _zbr_ty_Expr{ .except_ = blk_box_77: { const _bv: std.meta.Child(@FieldType(_zbr_ty_Expr, "except_")) = _zbr_ty_ExprExcept.init(_zbr_fn_spanOf(base_expr), base_expr, fields); const _bp = _zbr_rt._allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_77 _bp; } };
            },
