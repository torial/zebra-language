...
// zbr:selfhost/main.zbr:2906
                    if ((((rc == 0) and (!keep_temp)) and std.mem.eql(u8, output_dir, ""))) {
...
// zbr:selfhost/main.zbr:3005
                if ((((rc2 == 0) and (!keep_temp)) and std.mem.eql(u8, output_dir, ""))) {
