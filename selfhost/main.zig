...
// zbr:selfhost/main.zbr:2469
                    repl_argv.append(_zbr_rt._allocator, _intern("zig-out/bin/zebra-bootstrap.exe")) catch @panic("OOM");
...
// zbr:selfhost/main.zbr:2496
                        dbg_argv.append(_zbr_rt._allocator, _intern("zig-out/bin/zebra-bootstrap.exe")) catch @panic("OOM");
...
// zbr:selfhost/main.zbr:2520
                    bld_argv.append(_zbr_rt._allocator, _intern("zig-out/bin/zebra-bootstrap.exe")) catch @panic("OOM");
...
// zbr:selfhost/main.zbr:3063
            argv.append(_zbr_rt._allocator, _intern("zig-out/bin/zebra-bootstrap.exe")) catch @panic("OOM");
