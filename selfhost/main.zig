...
// zbr:selfhost/main.zbr:2857
    var dep: []const u8 = "        .zig_libui_ng = .{\n            .url  = \"git+https://github.com/torial/zig-libui-ng?ref=main#d6dcf282f4a921e06f69bc4a1795f9020bc79d8d\",\n            .hash = \"bindings_libui_ng-0.1.0-p2CY9aMvQgDn13B-AHHPBXNu_X1Dq0m-HxlPEzK7UuuE\",\n        },\n";
...
// zbr:selfhost/main.zbr:3619
            const known_flags: []const u8 = "--allow-implicit-try --build-file --check --check-full --cpu --emit-zig --gui-backend --help --keep-temp --dump-map --dump-transform --from-lldb --library-mode --list --list-targets --listen --module-path --no-runtime-module --only --out --output-dir --print --release --scaffold-only --selfhost-compile --shared --single-file --single-threaded --tag --target --turbo --version --warn-inference-guess --warn-non-exhaustive --zig-backend -c -h";
