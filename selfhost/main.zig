...
// zbr:selfhost/main.zbr:63
        self.c_sources = std.ArrayList([]const u8){};
// zbr:selfhost/main.zbr:64
        self.c_i_dirs = std.ArrayList([]const u8){};
...
// zbr:selfhost/main.zbr:172
        if ((blk: { std.fs.cwd().access(c_path, .{}) catch break :blk false; break :blk true; })) {
...
// zbr:selfhost/main.zbr:177
            if ((blk: { std.fs.cwd().access(h_path, .{}) catch break :blk false; break :blk true; })) {
...
// zbr:selfhost/main.zbr:350
                        merged_decls.append(_allocator, PNode{ .class_ = _box_1: { const _bp_1 = _allocator.create(Parser.PClass) catch @panic("OOM"); _bp_1.* = PClass.init(rcls_name, rcls.type_params, rcls.ifaces, rcls.mixins, new_members, std.ArrayList(PNode){}, rcls.is_reflectable); break :_box_1 _bp_1; } }) catch unreachable;
                    }
                },
                else => {
...
// zbr:selfhost/main.zbr:535
            mc.compileDep(path, true) catch |_tc_8| { _try_err_6 = _tc_8; break :_try_blk_6; };
