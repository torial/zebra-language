...
// zbr:selfhost/astbuilder_test.zbr:49
        const pm = try Parser.Parser.parse(src, "<test>");
...
// zbr:selfhost/astbuilder_test.zbr:429
    ...
    _try_blk_1: {
// zbr:selfhost/astbuilder_test.zbr:427
        const t = ASTBuilderTest.init();
// zbr:selfhost/astbuilder_test.zbr:428
        t.run() catch |_tc_2| { _try_err_1 = _tc_2; break :_try_blk_1; };
        break :_try_blk_1;
    }
    if (_try_err_1 != null) {
