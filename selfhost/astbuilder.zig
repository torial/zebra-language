...
// zbr:selfhost\astbuilder.zbr:26
    return Modifiers.init(false, false, false, false, false, false, false);
}

pub fn zstatic() Modifiers {
// zbr:selfhost\astbuilder.zbr:29
    return Modifiers.init(false, false, false, true, false, false, false);
}
...
// zbr:selfhost\astbuilder.zbr:221
            mods = Modifiers.init(false, false, false, false, false, false, true);
        }
...
// zbr:selfhost\astbuilder.zbr:259
        return Decl{ .struct_ = _box_6: { const _bp_6 = _allocator.create(ast.DeclStruct) catch @panic("OOM"); _bp_6.* = DeclStruct.init(zspan(), mods, s.name, ifaces, members, inv_exprs); break :_box_6 _bp_6; } };
    }
...
// zbr:selfhost\astbuilder.zbr:294
                    return Decl{ .var_ = _box_9: { const _bp_9 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_9.* = DeclVar.init(zspan(), fmods, f.name, type_ref, _box_a: { const _bp_a = blk2: { break :blk2 _allocator.create(@TypeOf(initval)) catch @panic("OOM"); }; _bp_a.* = initval; break :_box_a _bp_a; }, f.is_const); break :_box_9 _bp_9; } };
                }
// zbr:selfhost\astbuilder.zbr:295
                return Decl{ .var_ = _box_b: { const _bp_b = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_b.* = DeclVar.init(zspan(), fmods, f.name, type_ref, null, f.is_const); break :_box_b _bp_b; } };
            },
            .method_ => |m_ptr| {
                const m = m_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:309
        return Decl{ .enum_ = _box_c: { const _bp_c = _allocator.create(ast.DeclEnum) catch @panic("OOM"); _bp_c.* = DeclEnum.init(zspan(), zmods(), e.name, null, members); break :_box_c _bp_c; } };
    }
...
// zbr:selfhost\astbuilder.zbr:319
                params.append(_allocator, Param.init(zspan(), ParamMode.normal, p.name, ptype, _box_d: { const _bp_d = blk2: { break :blk2 _allocator.create(@TypeOf(defval)) catch @panic("OOM"); }; _bp_d.* = defval; break :_box_d _bp_d; })) catch unreachable;
            } else {
...
// zbr:selfhost\astbuilder.zbr:343
        const mods = Modifiers.init(false, false, false, m.is_static, false, false, false);
// zbr:selfhost\astbuilder.zbr:344
        return Decl{ .method = _box_e: { const _bp_e = _allocator.create(ast.DeclMethod) catch @panic("OOM"); _bp_e.* = DeclMethod.init(zspan(), mods, m.name, params, ret_type, stmts_list, false, m.throws_, req_exprs, ens_exprs); break :_box_e _bp_e; } };
    }
...
// zbr:selfhost\astbuilder.zbr:354
                params.append(_allocator, Param.init(zspan(), ParamMode.normal, p.name, ptype, _box_f: { const _bp_f = blk2: { break :blk2 _allocator.create(@TypeOf(defval)) catch @panic("OOM"); }; _bp_f.* = defval; break :_box_f _bp_f; })) catch unreachable;
            } else {
...
// zbr:selfhost\astbuilder.zbr:376
        return Decl{ .init = _box_10: { const _bp_10 = _allocator.create(ast.DeclInit) catch @panic("OOM"); _bp_10.* = DeclInit.init(zspan(), zmods(), params, stmts_list, req_exprs, ens_exprs); break :_box_10 _bp_10; } };
    }
...
// zbr:selfhost\astbuilder.zbr:393
                        const new_target: Expr = Expr{ .member = _box_11: { const _bp_11 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_11.* = ExprMember.init(zspan(), _box_12: { const _bp_12 = blk2: { break :blk2 _allocator.create(@TypeOf(target_expr)) catch @panic("OOM"); }; _bp_12.* = target_expr; break :_box_12 _bp_12; }, ei.name); break :_box_11 _bp_11; } };
// zbr:selfhost\astbuilder.zbr:394
                        const val_copy: Expr = sa.value.*;
// zbr:selfhost\astbuilder.zbr:395
                        return Stmt{ .assign = _box_13: { const _bp_13 = _allocator.create(ast.StmtAssign) catch @panic("OOM"); _bp_13.* = StmtAssign.init(zspan(), _box_14: { const _bp_14 = blk2: { break :blk2 _allocator.create(@TypeOf(new_target)) catch @panic("OOM"); }; _bp_14.* = new_target; break :_box_14 _bp_14; }, sa.op, _box_15: { const _bp_15 = blk2: { break :blk2 _allocator.create(@TypeOf(val_copy)) catch @panic("OOM"); }; _bp_15.* = val_copy; break :_box_15 _bp_15; }); break :_box_13 _bp_13; } };
                    },
                    else => {
...
// zbr:selfhost\astbuilder.zbr:415
                    return Stmt{ .return_ = _box_16: { const _bp_16 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_16.* = StmtReturn.init(Span.init(pret.line, 0, pret.line, 0), _box_17: { const _bp_17 = blk2: { break :blk2 _allocator.create(@TypeOf(rval)) catch @panic("OOM"); }; _bp_17.* = rval; break :_box_17 _bp_17; }); break :_box_16 _bp_16; } };
                }
// zbr:selfhost\astbuilder.zbr:416
                return Stmt{ .return_ = _box_18: { const _bp_18 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_18.* = StmtReturn.init(Span.init(pret.line, 0, pret.line, 0), null); break :_box_18 _bp_18; } };
            },
            .stmt_if => |pif_ptr| {
                const pif = pif_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:426
                var si = StmtIf.init(Span.init(pif.line, 0, pif.line, 0), _box_19: { const _bp_19 = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_19.* = cond_expr; break :_box_19 _bp_19; }, then_stmts, else_ifs, else_opt);
// zbr:selfhost\astbuilder.zbr:427
                si.is_capture = pif.is_capture;
// zbr:selfhost\astbuilder.zbr:428
                return Stmt{ .if_ = _box_1a: { const _bp_1a = _allocator.create(ast.StmtIf) catch @panic("OOM"); _bp_1a.* = si; break :_box_1a _bp_1a; } };
            },
            .stmt_while => |pw_ptr| {
                const pw = pw_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:433
                return Stmt{ .while_ = _box_1b: { const _bp_1b = _allocator.create(ast.StmtWhile) catch @panic("OOM"); _bp_1b.* = StmtWhile.init(Span.init(pw.line, 0, pw.line, 0), _box_1c: { const _bp_1c = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_1c.* = cond_expr; break :_box_1c _bp_1c; }, stmts); break :_box_1b _bp_1b; } };
            },
...
// zbr:selfhost\astbuilder.zbr:444
                return Stmt{ .for_in = _box_1d: { const _bp_1d = _allocator.create(ast.StmtForIn) catch @panic("OOM"); _bp_1d.* = StmtForIn.init(Span.init(pfor.line, 0, pfor.line, 0), vars, _box_1e: { const _bp_1e = blk2: { break :blk2 _allocator.create(@TypeOf(iter_expr)) catch @panic("OOM"); }; _bp_1e.* = iter_expr; break :_box_1e _bp_1e; }, stmts, else_stmts); break :_box_1d _bp_1d; } };
            },
...
// zbr:selfhost\astbuilder.zbr:455
                    return Stmt{ .for_num = _box_1f: { const _bp_1f = _allocator.create(ast.StmtForNum) catch @panic("OOM"); _bp_1f.* = StmtForNum.init(Span.init(pfn.line, 0, pfn.line, 0), pfn.var_name, _box_20: { const _bp_20 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_20.* = start_expr; break :_box_20 _bp_20; }, _box_21: { const _bp_21 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_21.* = stop_expr; break :_box_21 _bp_21; }, _box_22: { const _bp_22 = blk2: { break :blk2 _allocator.create(@TypeOf(step_expr)) catch @panic("OOM"); }; _bp_22.* = step_expr; break :_box_22 _bp_22; }, stmts, else_stmts); break :_box_1f _bp_1f; } };
                }
// zbr:selfhost\astbuilder.zbr:456
                return Stmt{ .for_num = _box_23: { const _bp_23 = _allocator.create(ast.StmtForNum) catch @panic("OOM"); _bp_23.* = StmtForNum.init(Span.init(pfn.line, 0, pfn.line, 0), pfn.var_name, _box_24: { const _bp_24 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_24.* = start_expr; break :_box_24 _bp_24; }, _box_25: { const _bp_25 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_25.* = stop_expr; break :_box_25 _bp_25; }, null, stmts, else_stmts); break :_box_23 _bp_23; } };
            },
            .stmt_var => |pv_ptr| {
                const pv = pv_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:462
                    return Stmt{ .var_ = _box_26: { const _bp_26 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_26.* = DeclVar.init(Span.init(pv.line, 0, pv.line, 0), zmods(), pv.name, type_ref, _box_27: { const _bp_27 = blk2: { break :blk2 _allocator.create(@TypeOf(initval)) catch @panic("OOM"); }; _bp_27.* = initval; break :_box_27 _bp_27; }, pv.is_const); break :_box_26 _bp_26; } };
                }
// zbr:selfhost\astbuilder.zbr:463
                return Stmt{ .var_ = _box_28: { const _bp_28 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_28.* = DeclVar.init(Span.init(pv.line, 0, pv.line, 0), zmods(), pv.name, type_ref, null, pv.is_const); break :_box_28 _bp_28; } };
            },
            .stmt_assign => |pa_ptr| {
                const pa = pa_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:469
                return Stmt{ .assign = _box_29: { const _bp_29 = _allocator.create(ast.StmtAssign) catch @panic("OOM"); _bp_29.* = StmtAssign.init(Span.init(pa.line, 0, pa.line, 0), _box_2a: { const _bp_2a = blk2: { break :blk2 _allocator.create(@TypeOf(target_expr)) catch @panic("OOM"); }; _bp_2a.* = target_expr; break :_box_2a _bp_2a; }, op, _box_2b: { const _bp_2b = blk2: { break :blk2 _allocator.create(@TypeOf(value_expr)) catch @panic("OOM"); }; _bp_2b.* = value_expr; break :_box_2b _bp_2b; }); break :_box_29 _bp_29; } };
            },
            .stmt_assert => |pas_ptr| {
                const pas = pas_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:475
                    return Stmt{ .assert_ = _box_2c: { const _bp_2c = _allocator.create(ast.StmtAssert) catch @panic("OOM"); _bp_2c.* = StmtAssert.init(Span.init(pas.line, 0, pas.line, 0), _box_2d: { const _bp_2d = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_2d.* = cond_expr; break :_box_2d _bp_2d; }, _box_2e: { const _bp_2e = blk2: { break :blk2 _allocator.create(@TypeOf(msg)) catch @panic("OOM"); }; _bp_2e.* = msg; break :_box_2e _bp_2e; }); break :_box_2c _bp_2c; } };
                }
// zbr:selfhost\astbuilder.zbr:476
                return Stmt{ .assert_ = _box_2f: { const _bp_2f = _allocator.create(ast.StmtAssert) catch @panic("OOM"); _bp_2f.* = StmtAssert.init(Span.init(pas.line, 0, pas.line, 0), _box_30: { const _bp_30 = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_30.* = cond_expr; break :_box_30 _bp_30; }, null); break :_box_2f _bp_2f; } };
            },
            .stmt_raise => |pr_ptr| {
                const pr = pr_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:482
                    return Stmt{ .raise_ = _box_31: { const _bp_31 = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_31.* = StmtRaise.init(Span.init(pr.line, 0, pr.line, 0), _box_32: { const _bp_32 = blk2: { break :blk2 _allocator.create(@TypeOf(msg)) catch @panic("OOM"); }; _bp_32.* = msg; break :_box_32 _bp_32; }, _box_33: { const _bp_33 = blk2: { break :blk2 _allocator.create(@TypeOf(det)) catch @panic("OOM"); }; _bp_33.* = det; break :_box_33 _bp_33; }); break :_box_31 _bp_31; } };
                }
...
// zbr:selfhost\astbuilder.zbr:485
                    return Stmt{ .raise_ = _box_34: { const _bp_34 = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_34.* = StmtRaise.init(Span.init(pr.line, 0, pr.line, 0), _box_35: { const _bp_35 = blk2: { break :blk2 _allocator.create(@TypeOf(msg)) catch @panic("OOM"); }; _bp_35.* = msg; break :_box_35 _bp_35; }, null); break :_box_34 _bp_34; } };
                }
// zbr:selfhost\astbuilder.zbr:486
                return Stmt{ .raise_ = _box_36: { const _bp_36 = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_36.* = StmtRaise.init(Span.init(pr.line, 0, pr.line, 0), null, null); break :_box_36 _bp_36; } };
            },
...
// zbr:selfhost\astbuilder.zbr:497
                return Stmt{ .try_catch = _box_37: { const _bp_37 = _allocator.create(ast.StmtTryCatch) catch @panic("OOM"); _bp_37.* = StmtTryCatch.init(Span.init(ptc.line, 0, ptc.line, 0), body_stmts, clauses); break :_box_37 _bp_37; } };
            },
            .stmt_branch => |pb_ptr| {
                const pb = pb_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:504
                return Stmt{ .arena_scope = _box_38: { const _bp_38 = _allocator.create(ast.StmtArenaScope) catch @panic("OOM"); _bp_38.* = StmtArenaScope.init(Span.init(pas.line, 0, pas.line, 0), stmts); break :_box_38 _bp_38; } };
            },
            .stmt_guard => |pg_ptr| {
                const pg = pg_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:509
                return Stmt{ .guard_ = _box_39: { const _bp_39 = _allocator.create(ast.StmtGuard) catch @panic("OOM"); _bp_39.* = StmtGuard.init(Span.init(pg.line, 0, pg.line, 0), _box_3a: { const _bp_3a = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_3a.* = cond_expr; break :_box_3a _bp_3a; }, else_stmts); break :_box_39 _bp_39; } };
            },
            .stmt_with => |pw_ptr| {
                const pw = pw_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:518
                return Stmt{ .with_ = _box_3b: { const _bp_3b = _allocator.create(ast.StmtWith) catch @panic("OOM"); _bp_3b.* = StmtWith.init(Span.init(pw.line, 0, pw.line, 0), _box_3c: { const _bp_3c = blk2: { break :blk2 _allocator.create(@TypeOf(target_expr)) catch @panic("OOM"); }; _bp_3c.* = target_expr; break :_box_3c _bp_3c; }, new_body); break :_box_3b _bp_3b; } };
            },
...
// zbr:selfhost\astbuilder.zbr:522
                return Stmt{ .destruct = _box_3d: { const _bp_3d = _allocator.create(ast.StmtDestruct) catch @panic("OOM"); _bp_3d.* = StmtDestruct.init(Span.init(pd.line, 0, pd.line, 0), pd.names, _box_3e: { const _bp_3e = blk2: { break :blk2 _allocator.create(@TypeOf(init_expr)) catch @panic("OOM"); }; _bp_3e.* = init_expr; break :_box_3e _bp_3e; }, pd.is_struct); break :_box_3d _bp_3d; } };
            },
            .stmt_expr => |inner_ptr| {
...
// zbr:selfhost\astbuilder.zbr:526
                return Stmt{ .expr = _box_3f: { const _bp_3f = _allocator.create(ast.Expr) catch @panic("OOM"); _bp_3f.* = expr; break :_box_3f _bp_3f; } };
            },
...
// zbr:selfhost\astbuilder.zbr:532
                return Stmt{ .print_ = _box_40: { const _bp_40 = _allocator.create(ast.StmtPrint) catch @panic("OOM"); _bp_40.* = StmtPrint.init(zspan(), args, true); break :_box_40 _bp_40; } };
            },
...
// zbr:selfhost\astbuilder.zbr:539
                return Stmt{ .contract = _box_41: { const _bp_41 = _allocator.create(ast.StmtContract) catch @panic("OOM"); _bp_41.* = StmtContract.init(zspan(), ContractKind.precond, exprs); break :_box_41 _bp_41; } };
            },
...
// zbr:selfhost\astbuilder.zbr:546
                return Stmt{ .contract = _box_42: { const _bp_42 = _allocator.create(ast.StmtContract) catch @panic("OOM"); _bp_42.* = StmtContract.init(zspan(), ContractKind.postcond, exprs); break :_box_42 _bp_42; } };
            },
            else => {
...
// zbr:selfhost\astbuilder.zbr:570
                        values.append(_allocator, Expr{ .binary = _box_43: { const _bp_43 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_43.* = ExprBinary.init(zspan(), BinaryOp.dotdot, _box_44: { const _bp_44 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_44.* = left_expr; break :_box_44 _bp_44; }, _box_45: { const _bp_45 = blk2: { break :blk2 _allocator.create(@TypeOf(right_expr)) catch @panic("OOM"); }; _bp_45.* = right_expr; break :_box_45 _bp_45; }); break :_box_43 _bp_43; } }) catch unreachable;
                    } else {
...
// zbr:selfhost\astbuilder.zbr:584
                        built_expr = Expr{ .member = _box_46: { const _bp_46 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_46.* = ExprMember.init(zspan(), _box_47: { const _bp_47 = blk2: { break :blk2 _allocator.create(@TypeOf(built_expr)) catch @panic("OOM"); }; _bp_47.* = built_expr; break :_box_47 _bp_47; }, parts.items[@as(usize, @intCast(i_pat))]); break :_box_46 _bp_46; } };
...
// zbr:selfhost\astbuilder.zbr:594
            if (_zebra_gt(@as(i64, @intCast(arm.guard_cond.items.len)), 0)) {
// zbr:selfhost\astbuilder.zbr:595
                const gexpr = try self.buildExpr(arm.guard_cond.items[@as(usize, @intCast(0))]);
// zbr:selfhost\astbuilder.zbr:596
                guard_exprs.append(_allocator, gexpr) catch unreachable;
            }
// zbr:selfhost\astbuilder.zbr:597
            var bo = BranchOn.init(zspan(), values, arm_stmts, binding_opt, guard_exprs);
...
// zbr:selfhost\astbuilder.zbr:609
        return Stmt{ .branch_ = _box_48: { const _bp_48 = _allocator.create(ast.StmtBranch) catch @panic("OOM"); _bp_48.* = StmtBranch.init(Span.init(pb.line, 0, pb.line, 0), _box_49: { const _bp_49 = blk2: { break :blk2 _allocator.create(@TypeOf(subject_expr)) catch @panic("OOM"); }; _bp_49.* = subject_expr; break :_box_49 _bp_49; }, cases, else_opt); break :_box_48 _bp_48; } };
    }
...
// zbr:selfhost\astbuilder.zbr:695
                    return Expr{ .member = _box_4a: { const _bp_4a = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_4a.* = ExprMember.init(zspan(), _box_4b: { const _bp_4b = blk2: { break :blk2 _allocator.create(@TypeOf(this_expr)) catch @panic("OOM"); }; _bp_4b.* = this_expr; break :_box_4b _bp_4b; }, pm.member); break :_box_4a _bp_4a; } };
                }
...
// zbr:selfhost\astbuilder.zbr:697
                return Expr{ .member = _box_4c: { const _bp_4c = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_4c.* = ExprMember.init(zspan(), _box_4d: { const _bp_4d = blk2: { break :blk2 _allocator.create(@TypeOf(base_expr)) catch @panic("OOM"); }; _bp_4d.* = base_expr; break :_box_4d _bp_4d; }, pm.member); break :_box_4c _bp_4c; } };
            },
            .expr_call => |pc_ptr| {
                const pc = pc_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:709
                return Expr{ .call = _box_4e: { const _bp_4e = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_4e.* = ExprCall.init(zspan(), callee_expr, args); break :_box_4e _bp_4e; } };
            },
            .expr_index => |pix_ptr| {
                const pix = pix_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:714
                return Expr{ .index = _box_4f: { const _bp_4f = _allocator.create(ast.ExprIndex) catch @panic("OOM"); _bp_4f.* = ExprIndex.init(zspan(), _box_50: { const _bp_50 = blk2: { break :blk2 _allocator.create(@TypeOf(obj_expr)) catch @panic("OOM"); }; _bp_50.* = obj_expr; break :_box_50 _bp_50; }, _box_51: { const _bp_51 = blk2: { break :blk2 _allocator.create(@TypeOf(idx_expr)) catch @panic("OOM"); }; _bp_51.* = idx_expr; break :_box_51 _bp_51; }); break :_box_4f _bp_4f; } };
            },
            .expr_slice => |psl_ptr| {
                const psl = psl_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:721
                return Expr{ .slice = _box_52: { const _bp_52 = _allocator.create(ast.ExprSlice) catch @panic("OOM"); _bp_52.* = ExprSlice.init(zspan(), _box_53: { const _bp_53 = blk2: { break :blk2 _allocator.create(@TypeOf(obj_expr)) catch @panic("OOM"); }; _bp_53.* = obj_expr; break :_box_53 _bp_53; }, _box_54: { const _bp_54 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_54.* = start_expr; break :_box_54 _bp_54; }, _box_55: { const _bp_55 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_55.* = stop_expr; break :_box_55 _bp_55; }); break :_box_52 _bp_52; } };
            },
            .expr_binary => |pb_ptr| {
                const pb = pb_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:731
                            return Expr{ .type_check = _box_56: { const _bp_56 = _allocator.create(ast.ExprTypeCheck) catch @panic("OOM"); _bp_56.* = ExprTypeCheck.init(zspan(), _box_57: { const _bp_57 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_57.* = left_expr; break :_box_57 _bp_57; }, ei.name); break :_box_56 _bp_56; } };
                        },
                        .member => |em_ptr| {
                            const em = em_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:736
                                var tc = ExprTypeCheck.init(zspan(), _box_58: { const _bp_58 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_58.* = left_expr; break :_box_58 _bp_58; }, obj_name.?);
// zbr:selfhost\astbuilder.zbr:737
                                tc.variant_name = em.member;
// zbr:selfhost\astbuilder.zbr:738
                                return Expr{ .type_check = _box_59: { const _bp_59 = _allocator.create(ast.ExprTypeCheck) catch @panic("OOM"); _bp_59.* = tc; break :_box_59 _bp_59; } };
                            } else {
...
// zbr:selfhost\astbuilder.zbr:744
                return Expr{ .binary = _box_5a: { const _bp_5a = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_5a.* = ExprBinary.init(zspan(), op, _box_5b: { const _bp_5b = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_5b.* = left_expr; break :_box_5b _bp_5b; }, _box_5c: { const _bp_5c = blk2: { break :blk2 _allocator.create(@TypeOf(right_expr)) catch @panic("OOM"); }; _bp_5c.* = right_expr; break :_box_5c _bp_5c; }); break :_box_5a _bp_5a; } };
            },
            .expr_orelse => |po_ptr| {
                const po = po_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:749
                return Expr{ .orelse_ = _box_5d: { const _bp_5d = _allocator.create(ast.ExprOrelse) catch @panic("OOM"); _bp_5d.* = ExprOrelse.init(zspan(), _box_5e: { const _bp_5e = blk2: { break :blk2 _allocator.create(@TypeOf(expr_val)) catch @panic("OOM"); }; _bp_5e.* = expr_val; break :_box_5e _bp_5e; }, _box_5f: { const _bp_5f = blk2: { break :blk2 _allocator.create(@TypeOf(fb_val)) catch @panic("OOM"); }; _bp_5f.* = fb_val; break :_box_5f _bp_5f; }); break :_box_5d _bp_5d; } };
            },
...
// zbr:selfhost\astbuilder.zbr:767
                        return Expr{ .call = _box_60: { const _bp_60 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_60.* = ExprCall.init(zspan(), callee_expr, args); break :_box_60 _bp_60; } };
                    },
                    else => {
...
// zbr:selfhost\astbuilder.zbr:776
                    return Expr{ .old_ = _box_61: { const _bp_61 = _allocator.create(ast.ExprOld) catch @panic("OOM"); _bp_61.* = ExprOld.init(zspan(), uid, _box_62: { const _bp_62 = blk2: { break :blk2 _allocator.create(@TypeOf(operand_expr)) catch @panic("OOM"); }; _bp_62.* = operand_expr; break :_box_62 _bp_62; }); break :_box_61 _bp_61; } };
                }
// zbr:selfhost\astbuilder.zbr:777
                const op = try self.toUnaryOp(pu.op);
// zbr:selfhost\astbuilder.zbr:778
                return Expr{ .unary = _box_63: { const _bp_63 = _allocator.create(ast.ExprUnary) catch @panic("OOM"); _bp_63.* = ExprUnary.init(zspan(), op, _box_64: { const _bp_64 = blk2: { break :blk2 _allocator.create(@TypeOf(operand_expr)) catch @panic("OOM"); }; _bp_64.* = operand_expr; break :_box_64 _bp_64; }); break :_box_63 _bp_63; } };
            },
            .expr_try => |inner_ptr| {
                const inner = inner_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:782
                return Expr{ .try_ = _box_65: { const _bp_65 = _allocator.create(ast.ExprTry) catch @panic("OOM"); _bp_65.* = ExprTry.init(zspan(), _box_66: { const _bp_66 = blk2: { break :blk2 _allocator.create(@TypeOf(inner_expr)) catch @panic("OOM"); }; _bp_66.* = inner_expr; break :_box_66 _bp_66; }); break :_box_65 _bp_65; } };
            },
            .expr_catch => |pc_ptr| {
                const pc = pc_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:790
                return Expr{ .catch_ = _box_67: { const _bp_67 = _allocator.create(ast.ExprCatch) catch @panic("OOM"); _bp_67.* = ExprCatch.init(zspan(), _box_68: { const _bp_68 = blk2: { break :blk2 _allocator.create(@TypeOf(expr_val)) catch @panic("OOM"); }; _bp_68.* = expr_val; break :_box_68 _bp_68; }, ev, _box_69: { const _bp_69 = blk2: { break :blk2 _allocator.create(@TypeOf(fb_val)) catch @panic("OOM"); }; _bp_69.* = fb_val; break :_box_69 _bp_69; }); break :_box_67 _bp_67; } };
            },
...
// zbr:selfhost\astbuilder.zbr:794
                return Expr{ .to_non_nil = _box_6a: { const _bp_6a = _allocator.create(ast.ExprToNonNil) catch @panic("OOM"); _bp_6a.* = ExprToNonNil.init(zspan(), _box_6b: { const _bp_6b = blk2: { break :blk2 _allocator.create(@TypeOf(inner_expr)) catch @panic("OOM"); }; _bp_6b.* = inner_expr; break :_box_6b _bp_6b; }); break :_box_6a _bp_6a; } };
            },
            .expr_except => |pex_ptr| {
                const pex = pex_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:802
                return Expr{ .except_ = _box_6c: { const _bp_6c = _allocator.create(ast.ExprExcept) catch @panic("OOM"); _bp_6c.* = ExprExcept.init(zspan(), base_expr, fields); break :_box_6c _bp_6c; } };
            },
...
// zbr:selfhost\astbuilder.zbr:814
                            parts.append(_allocator, StringPart{ .expr_ = _box_6d: { const _bp_6d = _allocator.create(ast.Expr) catch @panic("OOM"); _bp_6d.* = part_expr; break :_box_6d _bp_6d; } }) catch unreachable;
                        },
                    }
                }
// zbr:selfhost\astbuilder.zbr:815
                return Expr{ .string_interp = _box_6e: { const _bp_6e = _allocator.create(ast.ExprStringInterp) catch @panic("OOM"); _bp_6e.* = ExprStringInterp.init(zspan(), parts); break :_box_6e _bp_6e; } };
            },
            .expr_lambda => |pl| {
...
// zbr:selfhost\astbuilder.zbr:824
                return Expr{ .tuple_lit = _box_6f: { const _bp_6f = _allocator.create(ast.ExprTuple) catch @panic("OOM"); _bp_6f.* = ExprTuple.init(zspan(), elems); break :_box_6f _bp_6f; } };
            },
...
// zbr:selfhost\astbuilder.zbr:830
                return Expr{ .array_lit = _box_70: { const _bp_70 = _allocator.create(ast.ExprArrayLit) catch @panic("OOM"); _bp_70.* = ExprArrayLit.init(zspan(), elems); break :_box_70 _bp_70; } };
            },
...
// zbr:selfhost\astbuilder.zbr:839
                return Expr{ .list_lit = _box_71: { const _bp_71 = _allocator.create(ast.ExprListLit) catch @panic("OOM"); _bp_71.* = ExprListLit.init(zspan(), null, elems_l); break :_box_71 _bp_71; } };
            },
            else => {
...
// zbr:selfhost\astbuilder.zbr:858
                params.append(_allocator, Param.init(zspan(), ParamMode.normal, pp.name, tr, _box_72: { const _bp_72 = blk2: { break :blk2 _allocator.create(@TypeOf(defval)) catch @panic("OOM"); }; _bp_72.* = defval; break :_box_72 _bp_72; })) catch unreachable;
            } else {
...
// zbr:selfhost\astbuilder.zbr:879
            const dv = DeclVar.init(zspan(), zmods(), cv.name, cv_tr, _box_73: { const _bp_73 = blk2: { break :blk2 _allocator.create(@TypeOf(cv_init_expr)) catch @panic("OOM"); }; _bp_73.* = cv_init_expr; break :_box_73 _bp_73; }, (!cv.is_const));
// zbr:selfhost\astbuilder.zbr:880
            captures.append(_allocator, dv) catch unreachable;
        }
// zbr:selfhost\astbuilder.zbr:881
        return Expr{ .lambda = _box_74: { const _bp_74 = _allocator.create(ast.ExprLambda) catch @panic("OOM"); _bp_74.* = ExprLambda.init(zspan(), params, ret_type, lbody, captures); break :_box_74 _bp_74; } };
    }
...
// zbr:selfhost\astbuilder.zbr:954
        var _cp_it_75 = std.unicode.Utf8View.initUnchecked(s).iterator();
        while (_cp_it_75.nextCodepoint()) |gch| {
...
// zbr:selfhost\astbuilder.zbr:1017
            return TypeRef{ .ref_to = _box_76: { const _bp_76 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_76.* = inner; break :_box_76 _bp_76; } };
        }
...
// zbr:selfhost\astbuilder.zbr:1027
            return TypeRef{ .nilable = _box_77: { const _bp_77 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_77.* = inner; break :_box_77 _bp_77; } };
        }
