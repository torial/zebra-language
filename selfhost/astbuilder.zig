...
// zbr:selfhost\astbuilder.zbr:309
        return Decl{ .method = _box_e: { const _bp_e = _allocator.create(ast.DeclMethod) catch @panic("OOM"); _bp_e.* = DeclMethod.init(zspan(), mods, m.name, params, ret_type, stmts_list, false, m.throws_); break :_box_e _bp_e; } };
    }
...
// zbr:selfhost\astbuilder.zbr:323
        return Decl{ .init = _box_10: { const _bp_10 = _allocator.create(ast.DeclInit) catch @panic("OOM"); _bp_10.* = DeclInit.init(zspan(), zmods(), params, stmts_list); break :_box_10 _bp_10; } };
    }
...
// zbr:selfhost\astbuilder.zbr:497
                        values.append(_allocator, Expr{ .binary = _box_41: { const _bp_41 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_41.* = ExprBinary.init(zspan(), BinaryOp.dotdot, _box_42: { const _bp_42 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_42.* = left_expr; break :_box_42 _bp_42; }, _box_43: { const _bp_43 = blk2: { break :blk2 _allocator.create(@TypeOf(right_expr)) catch @panic("OOM"); }; _bp_43.* = right_expr; break :_box_43 _bp_43; }); break :_box_41 _bp_41; } }) catch unreachable;
                    } else {
...
// zbr:selfhost\astbuilder.zbr:511
                        built_expr = Expr{ .member = _box_44: { const _bp_44 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_44.* = ExprMember.init(zspan(), _box_45: { const _bp_45 = blk2: { break :blk2 _allocator.create(@TypeOf(built_expr)) catch @panic("OOM"); }; _bp_45.* = built_expr; break :_box_45 _bp_45; }, parts.items[@as(usize, @intCast(i_pat))]); break :_box_44 _bp_44; } };
...
// zbr:selfhost\astbuilder.zbr:524
            cases.append(_allocator, BranchOn.init(zspan(), values, arm_stmts, binding_opt, guard_exprs)) catch unreachable;
        }
...
// zbr:selfhost\astbuilder.zbr:528
        return Stmt{ .branch_ = _box_46: { const _bp_46 = _allocator.create(ast.StmtBranch) catch @panic("OOM"); _bp_46.* = StmtBranch.init(Span.init(pb.line, 0, pb.line, 0), _box_47: { const _bp_47 = blk2: { break :blk2 _allocator.create(@TypeOf(subject_expr)) catch @panic("OOM"); }; _bp_47.* = subject_expr; break :_box_47 _bp_47; }, cases, else_opt); break :_box_46 _bp_46; } };
    }
...
// zbr:selfhost\astbuilder.zbr:581
                    return Expr{ .member = _box_48: { const _bp_48 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_48.* = ExprMember.init(zspan(), _box_49: { const _bp_49 = blk2: { break :blk2 _allocator.create(@TypeOf(this_expr)) catch @panic("OOM"); }; _bp_49.* = this_expr; break :_box_49 _bp_49; }, pm.member); break :_box_48 _bp_48; } };
                }
...
// zbr:selfhost\astbuilder.zbr:583
                return Expr{ .member = _box_4a: { const _bp_4a = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_4a.* = ExprMember.init(zspan(), _box_4b: { const _bp_4b = blk2: { break :blk2 _allocator.create(@TypeOf(base_expr)) catch @panic("OOM"); }; _bp_4b.* = base_expr; break :_box_4b _bp_4b; }, pm.member); break :_box_4a _bp_4a; } };
            },
            .expr_call => |pc_ptr| {
                const pc = pc_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:595
                return Expr{ .call = _box_4c: { const _bp_4c = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_4c.* = ExprCall.init(zspan(), callee_expr, args); break :_box_4c _bp_4c; } };
            },
            .expr_index => |pix_ptr| {
                const pix = pix_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:600
                return Expr{ .index = _box_4d: { const _bp_4d = _allocator.create(ast.ExprIndex) catch @panic("OOM"); _bp_4d.* = ExprIndex.init(zspan(), _box_4e: { const _bp_4e = blk2: { break :blk2 _allocator.create(@TypeOf(obj_expr)) catch @panic("OOM"); }; _bp_4e.* = obj_expr; break :_box_4e _bp_4e; }, _box_4f: { const _bp_4f = blk2: { break :blk2 _allocator.create(@TypeOf(idx_expr)) catch @panic("OOM"); }; _bp_4f.* = idx_expr; break :_box_4f _bp_4f; }); break :_box_4d _bp_4d; } };
            },
            .expr_slice => |psl_ptr| {
                const psl = psl_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:607
                return Expr{ .slice = _box_50: { const _bp_50 = _allocator.create(ast.ExprSlice) catch @panic("OOM"); _bp_50.* = ExprSlice.init(zspan(), _box_51: { const _bp_51 = blk2: { break :blk2 _allocator.create(@TypeOf(obj_expr)) catch @panic("OOM"); }; _bp_51.* = obj_expr; break :_box_51 _bp_51; }, _box_52: { const _bp_52 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_52.* = start_expr; break :_box_52 _bp_52; }, _box_53: { const _bp_53 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_53.* = stop_expr; break :_box_53 _bp_53; }); break :_box_50 _bp_50; } };
            },
            .expr_binary => |pb_ptr| {
                const pb = pb_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:617
                            return Expr{ .type_check = _box_54: { const _bp_54 = _allocator.create(ast.ExprTypeCheck) catch @panic("OOM"); _bp_54.* = ExprTypeCheck.init(zspan(), _box_55: { const _bp_55 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_55.* = left_expr; break :_box_55 _bp_55; }, ei.name); break :_box_54 _bp_54; } };
                        },
                        .member => |em_ptr| {
                            const em = em_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:622
                                var tc = ExprTypeCheck.init(zspan(), _box_56: { const _bp_56 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_56.* = left_expr; break :_box_56 _bp_56; }, obj_name.?);
// zbr:selfhost\astbuilder.zbr:623
                                tc.variant_name = em.member;
// zbr:selfhost\astbuilder.zbr:624
                                return Expr{ .type_check = _box_57: { const _bp_57 = _allocator.create(ast.ExprTypeCheck) catch @panic("OOM"); _bp_57.* = tc; break :_box_57 _bp_57; } };
                            } else {
...
// zbr:selfhost\astbuilder.zbr:630
                return Expr{ .binary = _box_58: { const _bp_58 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_58.* = ExprBinary.init(zspan(), op, _box_59: { const _bp_59 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_59.* = left_expr; break :_box_59 _bp_59; }, _box_5a: { const _bp_5a = blk2: { break :blk2 _allocator.create(@TypeOf(right_expr)) catch @panic("OOM"); }; _bp_5a.* = right_expr; break :_box_5a _bp_5a; }); break :_box_58 _bp_58; } };
            },
            .expr_orelse => |po_ptr| {
                const po = po_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:635
                return Expr{ .orelse_ = _box_5b: { const _bp_5b = _allocator.create(ast.ExprOrelse) catch @panic("OOM"); _bp_5b.* = ExprOrelse.init(zspan(), _box_5c: { const _bp_5c = blk2: { break :blk2 _allocator.create(@TypeOf(expr_val)) catch @panic("OOM"); }; _bp_5c.* = expr_val; break :_box_5c _bp_5c; }, _box_5d: { const _bp_5d = blk2: { break :blk2 _allocator.create(@TypeOf(fb_val)) catch @panic("OOM"); }; _bp_5d.* = fb_val; break :_box_5d _bp_5d; }); break :_box_5b _bp_5b; } };
            },
...
// zbr:selfhost\astbuilder.zbr:653
                        return Expr{ .call = _box_5e: { const _bp_5e = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_5e.* = ExprCall.init(zspan(), callee_expr, args); break :_box_5e _bp_5e; } };
                    },
                    else => {
...
// zbr:selfhost\astbuilder.zbr:660
                return Expr{ .unary = _box_5f: { const _bp_5f = _allocator.create(ast.ExprUnary) catch @panic("OOM"); _bp_5f.* = ExprUnary.init(zspan(), op, _box_60: { const _bp_60 = blk2: { break :blk2 _allocator.create(@TypeOf(operand_expr)) catch @panic("OOM"); }; _bp_60.* = operand_expr; break :_box_60 _bp_60; }); break :_box_5f _bp_5f; } };
            },
            .expr_try => |inner_ptr| {
                const inner = inner_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:664
                return Expr{ .try_ = _box_61: { const _bp_61 = _allocator.create(ast.ExprTry) catch @panic("OOM"); _bp_61.* = ExprTry.init(zspan(), _box_62: { const _bp_62 = blk2: { break :blk2 _allocator.create(@TypeOf(inner_expr)) catch @panic("OOM"); }; _bp_62.* = inner_expr; break :_box_62 _bp_62; }); break :_box_61 _bp_61; } };
            },
...
// zbr:selfhost\astbuilder.zbr:668
                return Expr{ .to_non_nil = _box_63: { const _bp_63 = _allocator.create(ast.ExprToNonNil) catch @panic("OOM"); _bp_63.* = ExprToNonNil.init(zspan(), _box_64: { const _bp_64 = blk2: { break :blk2 _allocator.create(@TypeOf(inner_expr)) catch @panic("OOM"); }; _bp_64.* = inner_expr; break :_box_64 _bp_64; }); break :_box_63 _bp_63; } };
            },
            .expr_except => |pex_ptr| {
                const pex = pex_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:676
                return Expr{ .except_ = _box_65: { const _bp_65 = _allocator.create(ast.ExprExcept) catch @panic("OOM"); _bp_65.* = ExprExcept.init(zspan(), base_expr, fields); break :_box_65 _bp_65; } };
            },
...
// zbr:selfhost\astbuilder.zbr:688
                            parts.append(_allocator, StringPart{ .expr_ = _box_66: { const _bp_66 = _allocator.create(ast.Expr) catch @panic("OOM"); _bp_66.* = part_expr; break :_box_66 _bp_66; } }) catch unreachable;
                        },
                    }
                }
// zbr:selfhost\astbuilder.zbr:689
                return Expr{ .string_interp = _box_67: { const _bp_67 = _allocator.create(ast.ExprStringInterp) catch @panic("OOM"); _bp_67.* = ExprStringInterp.init(zspan(), parts); break :_box_67 _bp_67; } };
            },
            .expr_lambda => |pl| {
...
// zbr:selfhost\astbuilder.zbr:698
                return Expr{ .tuple_lit = _box_68: { const _bp_68 = _allocator.create(ast.ExprTuple) catch @panic("OOM"); _bp_68.* = ExprTuple.init(zspan(), elems); break :_box_68 _bp_68; } };
            },
            else => {
...
// zbr:selfhost\astbuilder.zbr:717
                params.append(_allocator, Param.init(zspan(), ParamMode.normal, pp.name, tr, _box_69: { const _bp_69 = blk2: { break :blk2 _allocator.create(@TypeOf(defval)) catch @panic("OOM"); }; _bp_69.* = defval; break :_box_69 _bp_69; })) catch unreachable;
            } else {
...
// zbr:selfhost\astbuilder.zbr:738
            const dv = DeclVar.init(zspan(), zmods(), cv.name, cv_tr, _box_6a: { const _bp_6a = blk2: { break :blk2 _allocator.create(@TypeOf(cv_init_expr)) catch @panic("OOM"); }; _bp_6a.* = cv_init_expr; break :_box_6a _bp_6a; }, (!cv.is_const));
// zbr:selfhost\astbuilder.zbr:739
            captures.append(_allocator, dv) catch unreachable;
        }
// zbr:selfhost\astbuilder.zbr:740
        return Expr{ .lambda = _box_6b: { const _bp_6b = _allocator.create(ast.ExprLambda) catch @panic("OOM"); _bp_6b.* = ExprLambda.init(zspan(), params, ret_type, lbody, captures); break :_box_6b _bp_6b; } };
    }
...
// zbr:selfhost\astbuilder.zbr:813
        var _cp_it_6c = std.unicode.Utf8View.initUnchecked(s).iterator();
        while (_cp_it_6c.nextCodepoint()) |gch| {
...
// zbr:selfhost\astbuilder.zbr:876
            return TypeRef{ .ref_to = _box_6d: { const _bp_6d = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_6d.* = inner; break :_box_6d _bp_6d; } };
        }
...
// zbr:selfhost\astbuilder.zbr:886
            return TypeRef{ .nilable = _box_6e: { const _bp_6e = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_6e.* = inner; break :_box_6e _bp_6e; } };
        }
