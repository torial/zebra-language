...
// zbr:selfhost/astbuilder.zbr:844
                return Expr{ .except_ = blk_box_65: { const _bv: std.meta.Child(@FieldType(Expr, "except_")) = ExprExcept.init(zspan(), base_expr, fields); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_65 _bp; } };
            },
...
// zbr:selfhost/astbuilder.zbr:855
                            ...
                            parts.append(_allocator, StringPart{ .expr_ = blk_box_66: { const _bv: std.meta.Child(@FieldType(StringPart, "expr_")) = part_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_66 _bp; } }) catch @panic("OOM");
                        },
                    }
                }
// zbr:selfhost/astbuilder.zbr:857
                return Expr{ .string_interp = blk_box_67: { const _bv: std.meta.Child(@FieldType(Expr, "string_interp")) = ExprStringInterp.init(zspan(), parts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_67 _bp; } };
            },
            .expr_lambda => |pl| {
...
// zbr:selfhost/astbuilder.zbr:866
                return Expr{ .tuple_lit = blk_box_68: { const _bv: std.meta.Child(@FieldType(Expr, "tuple_lit")) = ExprTuple.init(zspan(), elems); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_68 _bp; } };
            },
...
// zbr:selfhost/astbuilder.zbr:872
                return Expr{ .array_lit = blk_box_69: { const _bv: std.meta.Child(@FieldType(Expr, "array_lit")) = ExprArrayLit.init(zspan(), elems); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_69 _bp; } };
            },
...
// zbr:selfhost/astbuilder.zbr:881
                return Expr{ .list_lit = blk_box_70: { const _bv: std.meta.Child(@FieldType(Expr, "list_lit")) = ExprListLit.init(zspan(), null, elems_l); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_70 _bp; } };
            },
...
// zbr:selfhost/astbuilder.zbr:891
                return Expr{ .chained_cmp = blk_box_71: { const _bv: std.meta.Child(@FieldType(Expr, "chained_cmp")) = ExprChainedCmp.init(zspan(), ops_list, operands_list); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_71 _bp; } };
            },
            else => |_| {
...
// zbr:selfhost/astbuilder.zbr:933
        return Expr{ .lambda = blk_box_72: { const _bv: std.meta.Child(@FieldType(Expr, "lambda")) = ExprLambda.init(zspan(), params, ret_type, lbody, captures); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_72 _bp; } };
    }
...
// zbr:selfhost/astbuilder.zbr:1069
            return TypeRef{ .ref_to = blk_box_73: { const _bv: std.meta.Child(@FieldType(TypeRef, "ref_to")) = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_73 _bp; } };
        }
...
// zbr:selfhost/astbuilder.zbr:1079
            return TypeRef{ .nilable = blk_box_74: { const _bv: std.meta.Child(@FieldType(TypeRef, "nilable")) = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box_74 _bp; } };
        }
