...
pub const ASTBuilder = struct {
    ...
    pub fn buildStruct(self: *ASTBuilder, s: PClass) anyerror!Decl {
        ...
        return Decl{ .struct_ = blk_box: { const _bv = DeclStruct.init(zspan(), zmods(), s.name, ifaces, members); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn buildUnion(self: *ASTBuilder, u: PUnionDecl) anyerror!Decl {
        ...
        return Decl{ .union_ = blk_box: { const _bv = DeclUnion.init(zspan(), zmods(), u.name, variants); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn buildSig(self: *ASTBuilder, sg: PSig) anyerror!Decl {
        ...
        return Decl{ .sig_ = blk_box: { const _bv = DeclSig.init(zspan(), sg.name, params, ret_type); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn buildEnum(self: *ASTBuilder, e: PEnum) anyerror!Decl {
        ...
        return Decl{ .enum_ = blk_box: { const _bv = DeclEnum.init(zspan(), zmods(), e.name, null, members); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn buildMethod(self: *ASTBuilder, m: PMethod, is_member: bool) anyerror!Decl {
        ...
        return Decl{ .method = blk_box: { const _bv = DeclMethod.init(zspan(), mods, m.name, params, ret_type, stmts_list, false, m.throws_); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn buildInit(self: *ASTBuilder, pinit: PInit) anyerror!Decl {
        ...
        return Decl{ .init = blk_box: { const _bv = DeclInit.init(zspan(), zmods(), params, stmts_list); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn buildStmt(self: *ASTBuilder, pn: PNode) anyerror!Stmt {
        switch (pn) {
            ...
            .stmt_return => |_ptr_pret| {
                ...
                if ((@as(i64, @intCast(pret.value.items.len)) > 0)) {
                    const rval = try self.buildExpr(pret.value.items[@intCast(0)]);
                    return Stmt{ .return_ = blk_box: { const _bv = StmtReturn.init(zspan(), _bx0: { const _bv = rval; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                }
                return Stmt{ .return_ = blk_box: { const _bv = StmtReturn.init(zspan(), null); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_if => |_ptr_pif| {
                const pif = _ptr_pif.*;
                ...
                if ((@as(i64, @intCast(pif.else_stmts.items.len)) > 0)) {
                    else_opt = else_stmts_built;
                }
                return Stmt{ .if_ = blk_box: { const _bv = StmtIf.init(zspan(), _bx0: { const _bv = cond_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, then_stmts, else_ifs, else_opt); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_while => |_ptr_pw| {
                const pw = _ptr_pw.*;
                const cond_expr = try self.buildExpr(pw.cond.items[@intCast(0)]);
                const stmts = try self.buildStmts(pw.stmts);
                return Stmt{ .while_ = blk_box: { const _bv = StmtWhile.init(zspan(), _bx0: { const _bv = cond_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_for_in => |_ptr_pfor| {
                ...
                return Stmt{ .for_in = blk_box: { const _bv = StmtForIn.init(zspan(), vars, _bx0: { const _bv = iter_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_var => |_ptr_pv| {
                const pv = _ptr_pv.*;
                const type_ref = self.parseTypeRef(pv.type_name);
                if ((@as(i64, @intCast(pv.init_expr.items.len)) > 0)) {
                    const initval = try self.buildExpr(pv.init_expr.items[@intCast(0)]);
                    return Stmt{ .var_ = blk_box: { const _bv = DeclVar.init(zspan(), zmods(), pv.name, type_ref, _bx0: { const _bv = initval; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, pv.is_const); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                }
                return Stmt{ .var_ = blk_box: { const _bv = DeclVar.init(zspan(), zmods(), pv.name, type_ref, null, pv.is_const); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_assign => |_ptr_pa| {
                const pa = _ptr_pa.*;
                ...
                return Stmt{ .assign = blk_box: { const _bv = StmtAssign.init(zspan(), _bx0: { const _bv = target_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, op, _bx1: { const _bv = value_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx1 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_assert => |_ptr_pas| {
                const pas = _ptr_pas.*;
                const cond_expr = try self.buildExpr(pas.cond.items[@intCast(0)]);
                if ((@as(i64, @intCast(pas.message.items.len)) > 0)) {
                    const msg = try self.buildExpr(pas.message.items[@intCast(0)]);
                    return Stmt{ .assert_ = blk_box: { const _bv = StmtAssert.init(zspan(), _bx0: { const _bv = cond_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, _bx1: { const _bv = msg; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx1 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                }
                return Stmt{ .assert_ = blk_box: { const _bv = StmtAssert.init(zspan(), _bx0: { const _bv = cond_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, null); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_raise => |_ptr_pr| {
                const pr = _ptr_pr.*;
                ...
                return Stmt{ .raise_ = blk_box: { const _bv = StmtRaise.init(zspan(), null, null); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_try_catch => |_ptr_ptc| {
                ...
                return Stmt{ .try_catch = blk_box: { const _bv = StmtTryCatch.init(zspan(), body_stmts, clauses); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_branch => |_ptr_pb| {
                const pb = _ptr_pb.*;
            ...
            .stmt_expr => |_ptr_inner| {
                ...
                return Stmt{ .expr = blk_box: { const _bv = expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .stmt_print => |_ptr_inner| {
                ...
                return Stmt{ .print_ = blk_box: { const _bv = StmtPrint.init(zspan(), args, true); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            else => |_| {
    ...
    pub fn buildBranch(self: *ASTBuilder, pb: PBranch) anyerror!Stmt {
        ...
        return Stmt{ .branch_ = blk_box: { const _bv = StmtBranch.init(zspan(), _bx0: { const _bv = subject_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, cases, else_opt); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
        ...
        switch (pn) {
            ...
            .expr_member => |_ptr_pm| {
                ...
                if ((@as(i64, @intCast(pm.base.items.len)) == 0)) {
                    ...
                    return Expr{ .member = blk_box: { const _bv = ExprMember.init(zspan(), _bx0: { const _bv = this_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, pm.member); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                }
                const base_expr = try self.buildExpr(pm.base.items[@intCast(0)]);
                return Expr{ .member = blk_box: { const _bv = ExprMember.init(zspan(), _bx0: { const _bv = base_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, pm.member); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .expr_call => |_ptr_pc| {
                const pc = _ptr_pc.*;
            ...
            .expr_index => |_ptr_pix| {
                ...
                return Expr{ .index = blk_box: { const _bv = ExprIndex.init(zspan(), _bx0: { const _bv = obj_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }, _bx1: { const _bv = idx_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx1 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .expr_slice => |_ptr_psl| {
                const psl = _ptr_psl.*;
            ...
            .expr_unary => |_ptr_pu| {
                ...
                return Expr{ .unary = blk_box: { const _bv = ExprUnary.init(zspan(), op, _bx0: { const _bv = operand_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .expr_try => |_ptr_inner| {
                const inner = _ptr_inner.*;
                const inner_expr = try self.buildExpr(inner);
                return Expr{ .try_ = blk_box: { const _bv = ExprTry.init(zspan(), _bx0: { const _bv = inner_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .expr_to_bang => |_ptr_inner| {
                const inner = _ptr_inner.*;
                const inner_expr = try self.buildExpr(inner);
                return Expr{ .to_non_nil = blk_box: { const _bv = ExprToNonNil.init(zspan(), _bx0: { const _bv = inner_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :_bx0 _bp; }); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .expr_except => |_ptr_pex| {
                ...
                return Expr{ .except_ = blk_box: { const _bv = ExprExcept.init(zspan(), base_expr, fields); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
                ...
                for (psi.parts.items) |part| {
                    switch (part) {
                        .expr_str => |text| {
                            ...
                            parts.append(_allocator, StringPart{ .expr_ = blk_box: { const _bv = part_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } }) catch @panic("OOM");
                        },
                    }
                }
                return Expr{ .string_interp = blk_box: { const _bv = ExprStringInterp.init(zspan(), parts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
            },
            .expr_lambda => |pl| {
    ...
    pub fn buildLambdaExpr(self: *ASTBuilder, pl: PLambda) anyerror!Expr {
        ...
        if ((@as(i64, @intCast(pl.body_expr.items.len)) > 0)) {
        ...
        return Expr{ .lambda = blk_box: { const _bv = ExprLambda.init(zspan(), params, ret_type, lbody, captures); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseTypeRef(self: *ASTBuilder, s: []const u8) ?TypeRef {
        ...
        if (std.mem.startsWith(u8, s, "^")) {
            ...
            var rest_s: []const u8 = "";
            if ((@as(i64, @intCast(rest_parts.items.len)) > 1)) {
                rest_s = rest_parts.items[@intCast(1)];
            }
            const inner = self.parseTypeRefRequired(rest_s);
            return TypeRef{ .ref_to = blk_box: { const _bv = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
        if (std.mem.endsWith(u8, s, "?")) {
            ...
            return TypeRef{ .nilable = blk_box: { const _bv = inner; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
        if ((std.mem.indexOf(u8, s, "(") != null)) {
            ...
            var rest: []const u8 = "";
            if ((@as(i64, @intCast(name_parts.items.len)) > 1)) {
                rest = name_parts.items[@intCast(1)];
            }
            var arg_parts = std.ArrayList([]const u8){};
            {
                var _it_q = std.mem.splitSequence(u8, rest, ")");
                while (_it_q.next()) |q| {
                    arg_parts.append(_allocator, q) catch @panic("OOM");
                }
            }
            var args_str: []const u8 = "";
            if ((@as(i64, @intCast(arg_parts.items.len)) > 0)) {
                args_str = arg_parts.items[@intCast(0)];
            }
