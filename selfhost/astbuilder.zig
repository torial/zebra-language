...
// zbr:selfhost\astbuilder.zbr:507
                        built_expr = Expr{ .member = _box_45: { const _bp_45 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_45.* = ExprMember.init(zspan(), _box_46: { const _bp_46 = blk2: { break :blk2 _allocator.create(@TypeOf(built_expr)) catch @panic("OOM"); }; _bp_46.* = built_expr; break :_box_46 _bp_46; }, parts.items[@as(usize, @intCast(i_pat))]); break :_box_45 _bp_45; } };
