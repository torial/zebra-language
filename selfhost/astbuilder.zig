...
// zbr:selfhost\astbuilder.zbr:306
                    return Decl{ .var_ = _box_a: { const _bp_a = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_a.* = DeclVar.init(zspan(), fmods, f.name, type_ref, _box_b: { const _bp_b = blk2: { break :blk2 _allocator.create(@TypeOf(initval)) catch @panic("OOM"); }; _bp_b.* = initval; break :_box_b _bp_b; }, f.is_const); break :_box_a _bp_a; } };
                }
// zbr:selfhost\astbuilder.zbr:307
                return Decl{ .var_ = _box_c: { const _bp_c = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_c.* = DeclVar.init(zspan(), fmods, f.name, type_ref, null, f.is_const); break :_box_c _bp_c; } };
            },
            .method_ => |m_ptr| {
                const m = m_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:356
        return Decl{ .method = _box_f: { const _bp_f = _allocator.create(ast.DeclMethod) catch @panic("OOM"); _bp_f.* = DeclMethod.init(zspan(), mods, m.name, params, ret_type, stmts_list, false, m.throws_, req_exprs, ens_exprs); break :_box_f _bp_f; } };
    }
...
// zbr:selfhost\astbuilder.zbr:388
        return Decl{ .init = _box_11: { const _bp_11 = _allocator.create(ast.DeclInit) catch @panic("OOM"); _bp_11.* = DeclInit.init(zspan(), zmods(), params, stmts_list, req_exprs, ens_exprs); break :_box_11 _bp_11; } };
    }
...
// zbr:selfhost\astbuilder.zbr:427
                    return Stmt{ .return_ = _box_17: { const _bp_17 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_17.* = StmtReturn.init(Span.init(pret.line, 0, pret.line, 0), _box_18: { const _bp_18 = blk2: { break :blk2 _allocator.create(@TypeOf(rval)) catch @panic("OOM"); }; _bp_18.* = rval; break :_box_18 _bp_18; }); break :_box_17 _bp_17; } };
                }
// zbr:selfhost\astbuilder.zbr:428
                return Stmt{ .return_ = _box_19: { const _bp_19 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_19.* = StmtReturn.init(Span.init(pret.line, 0, pret.line, 0), null); break :_box_19 _bp_19; } };
            },
            .stmt_if => |pif_ptr| {
                const pif = pif_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:438
                var si = StmtIf.init(Span.init(pif.line, 0, pif.line, 0), _box_1a: { const _bp_1a = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_1a.* = cond_expr; break :_box_1a _bp_1a; }, then_stmts, else_ifs, else_opt);
// zbr:selfhost\astbuilder.zbr:439
                si.is_capture = pif.is_capture;
// zbr:selfhost\astbuilder.zbr:440
                return Stmt{ .if_ = _box_1b: { const _bp_1b = _allocator.create(ast.StmtIf) catch @panic("OOM"); _bp_1b.* = si; break :_box_1b _bp_1b; } };
            },
            .stmt_while => |pw_ptr| {
                const pw = pw_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:445
                return Stmt{ .while_ = _box_1c: { const _bp_1c = _allocator.create(ast.StmtWhile) catch @panic("OOM"); _bp_1c.* = StmtWhile.init(Span.init(pw.line, 0, pw.line, 0), _box_1d: { const _bp_1d = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_1d.* = cond_expr; break :_box_1d _bp_1d; }, stmts); break :_box_1c _bp_1c; } };
            },
...
// zbr:selfhost\astbuilder.zbr:458
                    return Stmt{ .for_in = _box_1e: { const _bp_1e = _allocator.create(ast.StmtForIn) catch @panic("OOM"); _bp_1e.* = StmtForIn.init(Span.init(pfor.line, 0, pfor.line, 0), vars, _box_1f: { const _bp_1f = blk2: { break :blk2 _allocator.create(@TypeOf(iter_expr)) catch @panic("OOM"); }; _bp_1f.* = iter_expr; break :_box_1f _bp_1f; }, _box_20: { const _bp_20 = blk2: { break :blk2 _allocator.create(@TypeOf(filter_expr)) catch @panic("OOM"); }; _bp_20.* = filter_expr; break :_box_20 _bp_20; }, stmts, else_stmts); break :_box_1e _bp_1e; } };
                }
// zbr:selfhost\astbuilder.zbr:459
                return Stmt{ .for_in = _box_21: { const _bp_21 = _allocator.create(ast.StmtForIn) catch @panic("OOM"); _bp_21.* = StmtForIn.init(Span.init(pfor.line, 0, pfor.line, 0), vars, _box_22: { const _bp_22 = blk2: { break :blk2 _allocator.create(@TypeOf(iter_expr)) catch @panic("OOM"); }; _bp_22.* = iter_expr; break :_box_22 _bp_22; }, null, stmts, else_stmts); break :_box_21 _bp_21; } };
            },
...
// zbr:selfhost\astbuilder.zbr:470
                    return Stmt{ .for_num = _box_23: { const _bp_23 = _allocator.create(ast.StmtForNum) catch @panic("OOM"); _bp_23.* = StmtForNum.init(Span.init(pfn.line, 0, pfn.line, 0), pfn.var_name, _box_24: { const _bp_24 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_24.* = start_expr; break :_box_24 _bp_24; }, _box_25: { const _bp_25 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_25.* = stop_expr; break :_box_25 _bp_25; }, _box_26: { const _bp_26 = blk2: { break :blk2 _allocator.create(@TypeOf(step_expr)) catch @panic("OOM"); }; _bp_26.* = step_expr; break :_box_26 _bp_26; }, stmts, else_stmts); break :_box_23 _bp_23; } };
                }
// zbr:selfhost\astbuilder.zbr:471
                return Stmt{ .for_num = _box_27: { const _bp_27 = _allocator.create(ast.StmtForNum) catch @panic("OOM"); _bp_27.* = StmtForNum.init(Span.init(pfn.line, 0, pfn.line, 0), pfn.var_name, _box_28: { const _bp_28 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_28.* = start_expr; break :_box_28 _bp_28; }, _box_29: { const _bp_29 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_29.* = stop_expr; break :_box_29 _bp_29; }, null, stmts, else_stmts); break :_box_27 _bp_27; } };
            },
            .stmt_var => |pv_ptr| {
                const pv = pv_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:477
                    return Stmt{ .var_ = _box_2a: { const _bp_2a = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_2a.* = DeclVar.init(Span.init(pv.line, 0, pv.line, 0), zmods(), pv.name, type_ref, _box_2b: { const _bp_2b = blk2: { break :blk2 _allocator.create(@TypeOf(initval)) catch @panic("OOM"); }; _bp_2b.* = initval; break :_box_2b _bp_2b; }, pv.is_const); break :_box_2a _bp_2a; } };
                }
// zbr:selfhost\astbuilder.zbr:478
                return Stmt{ .var_ = _box_2c: { const _bp_2c = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_2c.* = DeclVar.init(Span.init(pv.line, 0, pv.line, 0), zmods(), pv.name, type_ref, null, pv.is_const); break :_box_2c _bp_2c; } };
            },
            .stmt_assign => |pa_ptr| {
                const pa = pa_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:484
                return Stmt{ .assign = _box_2d: { const _bp_2d = _allocator.create(ast.StmtAssign) catch @panic("OOM"); _bp_2d.* = StmtAssign.init(Span.init(pa.line, 0, pa.line, 0), _box_2e: { const _bp_2e = blk2: { break :blk2 _allocator.create(@TypeOf(target_expr)) catch @panic("OOM"); }; _bp_2e.* = target_expr; break :_box_2e _bp_2e; }, op, _box_2f: { const _bp_2f = blk2: { break :blk2 _allocator.create(@TypeOf(value_expr)) catch @panic("OOM"); }; _bp_2f.* = value_expr; break :_box_2f _bp_2f; }); break :_box_2d _bp_2d; } };
            },
            .stmt_assert => |pas_ptr| {
                const pas = pas_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:490
                    return Stmt{ .assert_ = _box_30: { const _bp_30 = _allocator.create(ast.StmtAssert) catch @panic("OOM"); _bp_30.* = StmtAssert.init(Span.init(pas.line, 0, pas.line, 0), _box_31: { const _bp_31 = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_31.* = cond_expr; break :_box_31 _bp_31; }, _box_32: { const _bp_32 = blk2: { break :blk2 _allocator.create(@TypeOf(msg)) catch @panic("OOM"); }; _bp_32.* = msg; break :_box_32 _bp_32; }); break :_box_30 _bp_30; } };
                }
// zbr:selfhost\astbuilder.zbr:491
                return Stmt{ .assert_ = _box_33: { const _bp_33 = _allocator.create(ast.StmtAssert) catch @panic("OOM"); _bp_33.* = StmtAssert.init(Span.init(pas.line, 0, pas.line, 0), _box_34: { const _bp_34 = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_34.* = cond_expr; break :_box_34 _bp_34; }, null); break :_box_33 _bp_33; } };
            },
            .stmt_raise => |pr_ptr| {
                const pr = pr_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:497
                    return Stmt{ .raise_ = _box_35: { const _bp_35 = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_35.* = StmtRaise.init(Span.init(pr.line, 0, pr.line, 0), _box_36: { const _bp_36 = blk2: { break :blk2 _allocator.create(@TypeOf(msg)) catch @panic("OOM"); }; _bp_36.* = msg; break :_box_36 _bp_36; }, _box_37: { const _bp_37 = blk2: { break :blk2 _allocator.create(@TypeOf(det)) catch @panic("OOM"); }; _bp_37.* = det; break :_box_37 _bp_37; }); break :_box_35 _bp_35; } };
                }
...
// zbr:selfhost\astbuilder.zbr:500
                    return Stmt{ .raise_ = _box_38: { const _bp_38 = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_38.* = StmtRaise.init(Span.init(pr.line, 0, pr.line, 0), _box_39: { const _bp_39 = blk2: { break :blk2 _allocator.create(@TypeOf(msg)) catch @panic("OOM"); }; _bp_39.* = msg; break :_box_39 _bp_39; }, null); break :_box_38 _bp_38; } };
                }
// zbr:selfhost\astbuilder.zbr:501
                return Stmt{ .raise_ = _box_3a: { const _bp_3a = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_3a.* = StmtRaise.init(Span.init(pr.line, 0, pr.line, 0), null, null); break :_box_3a _bp_3a; } };
            },
...
// zbr:selfhost\astbuilder.zbr:512
                return Stmt{ .try_catch = _box_3b: { const _bp_3b = _allocator.create(ast.StmtTryCatch) catch @panic("OOM"); _bp_3b.* = StmtTryCatch.init(Span.init(ptc.line, 0, ptc.line, 0), body_stmts, clauses); break :_box_3b _bp_3b; } };
            },
            .stmt_branch => |pb_ptr| {
                const pb = pb_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:519
                return Stmt{ .arena_scope = _box_3c: { const _bp_3c = _allocator.create(ast.StmtArenaScope) catch @panic("OOM"); _bp_3c.* = StmtArenaScope.init(Span.init(pas.line, 0, pas.line, 0), stmts); break :_box_3c _bp_3c; } };
            },
            .stmt_guard => |pg_ptr| {
                const pg = pg_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:524
                return Stmt{ .guard_ = _box_3d: { const _bp_3d = _allocator.create(ast.StmtGuard) catch @panic("OOM"); _bp_3d.* = StmtGuard.init(Span.init(pg.line, 0, pg.line, 0), _box_3e: { const _bp_3e = blk2: { break :blk2 _allocator.create(@TypeOf(cond_expr)) catch @panic("OOM"); }; _bp_3e.* = cond_expr; break :_box_3e _bp_3e; }, else_stmts); break :_box_3d _bp_3d; } };
            },
            .stmt_with => |pw_ptr| {
                const pw = pw_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:533
                return Stmt{ .with_ = _box_3f: { const _bp_3f = _allocator.create(ast.StmtWith) catch @panic("OOM"); _bp_3f.* = StmtWith.init(Span.init(pw.line, 0, pw.line, 0), _box_40: { const _bp_40 = blk2: { break :blk2 _allocator.create(@TypeOf(target_expr)) catch @panic("OOM"); }; _bp_40.* = target_expr; break :_box_40 _bp_40; }, new_body); break :_box_3f _bp_3f; } };
            },
...
// zbr:selfhost\astbuilder.zbr:537
                return Stmt{ .destruct = _box_41: { const _bp_41 = _allocator.create(ast.StmtDestruct) catch @panic("OOM"); _bp_41.* = StmtDestruct.init(Span.init(pd.line, 0, pd.line, 0), pd.names, _box_42: { const _bp_42 = blk2: { break :blk2 _allocator.create(@TypeOf(init_expr)) catch @panic("OOM"); }; _bp_42.* = init_expr; break :_box_42 _bp_42; }, pd.is_struct); break :_box_41 _bp_41; } };
            },
            .stmt_expr => |inner_ptr| {
...
// zbr:selfhost\astbuilder.zbr:541
                return Stmt{ .expr = _box_43: { const _bp_43 = _allocator.create(ast.Expr) catch @panic("OOM"); _bp_43.* = expr; break :_box_43 _bp_43; } };
            },
...
// zbr:selfhost\astbuilder.zbr:547
                return Stmt{ .print_ = _box_44: { const _bp_44 = _allocator.create(ast.StmtPrint) catch @panic("OOM"); _bp_44.* = StmtPrint.init(zspan(), args, true); break :_box_44 _bp_44; } };
            },
...
// zbr:selfhost\astbuilder.zbr:554
                return Stmt{ .contract = _box_45: { const _bp_45 = _allocator.create(ast.StmtContract) catch @panic("OOM"); _bp_45.* = StmtContract.init(zspan(), ContractKind.precond, exprs); break :_box_45 _bp_45; } };
            },
...
// zbr:selfhost\astbuilder.zbr:561
                return Stmt{ .contract = _box_46: { const _bp_46 = _allocator.create(ast.StmtContract) catch @panic("OOM"); _bp_46.* = StmtContract.init(zspan(), ContractKind.postcond, exprs); break :_box_46 _bp_46; } };
            },
            else => {
...
// zbr:selfhost\astbuilder.zbr:585
                        values.append(_allocator, Expr{ .binary = _box_47: { const _bp_47 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_47.* = ExprBinary.init(zspan(), BinaryOp.dotdot, _box_48: { const _bp_48 = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_48.* = left_expr; break :_box_48 _bp_48; }, _box_49: { const _bp_49 = blk2: { break :blk2 _allocator.create(@TypeOf(right_expr)) catch @panic("OOM"); }; _bp_49.* = right_expr; break :_box_49 _bp_49; }); break :_box_47 _bp_47; } }) catch unreachable;
                    } else {
...
// zbr:selfhost\astbuilder.zbr:599
                        built_expr = Expr{ .member = _box_4a: { const _bp_4a = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_4a.* = ExprMember.init(zspan(), _box_4b: { const _bp_4b = blk2: { break :blk2 _allocator.create(@TypeOf(built_expr)) catch @panic("OOM"); }; _bp_4b.* = built_expr; break :_box_4b _bp_4b; }, parts.items[@as(usize, @intCast(i_pat))]); break :_box_4a _bp_4a; } };
...
// zbr:selfhost\astbuilder.zbr:624
        return Stmt{ .branch_ = _box_4c: { const _bp_4c = _allocator.create(ast.StmtBranch) catch @panic("OOM"); _bp_4c.* = StmtBranch.init(Span.init(pb.line, 0, pb.line, 0), _box_4d: { const _bp_4d = blk2: { break :blk2 _allocator.create(@TypeOf(subject_expr)) catch @panic("OOM"); }; _bp_4d.* = subject_expr; break :_box_4d _bp_4d; }, cases, else_opt); break :_box_4c _bp_4c; } };
    }
...
// zbr:selfhost\astbuilder.zbr:710
                    return Expr{ .member = _box_4e: { const _bp_4e = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_4e.* = ExprMember.init(zspan(), _box_4f: { const _bp_4f = blk2: { break :blk2 _allocator.create(@TypeOf(this_expr)) catch @panic("OOM"); }; _bp_4f.* = this_expr; break :_box_4f _bp_4f; }, pm.member); break :_box_4e _bp_4e; } };
                }
...
// zbr:selfhost\astbuilder.zbr:712
                return Expr{ .member = _box_50: { const _bp_50 = _allocator.create(ast.ExprMember) catch @panic("OOM"); _bp_50.* = ExprMember.init(zspan(), _box_51: { const _bp_51 = blk2: { break :blk2 _allocator.create(@TypeOf(base_expr)) catch @panic("OOM"); }; _bp_51.* = base_expr; break :_box_51 _bp_51; }, pm.member); break :_box_50 _bp_50; } };
            },
            .expr_call => |pc_ptr| {
                const pc = pc_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:724
                return Expr{ .call = _box_52: { const _bp_52 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_52.* = ExprCall.init(zspan(), callee_expr, args); break :_box_52 _bp_52; } };
            },
            .expr_index => |pix_ptr| {
                const pix = pix_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:729
                return Expr{ .index = _box_53: { const _bp_53 = _allocator.create(ast.ExprIndex) catch @panic("OOM"); _bp_53.* = ExprIndex.init(zspan(), _box_54: { const _bp_54 = blk2: { break :blk2 _allocator.create(@TypeOf(obj_expr)) catch @panic("OOM"); }; _bp_54.* = obj_expr; break :_box_54 _bp_54; }, _box_55: { const _bp_55 = blk2: { break :blk2 _allocator.create(@TypeOf(idx_expr)) catch @panic("OOM"); }; _bp_55.* = idx_expr; break :_box_55 _bp_55; }); break :_box_53 _bp_53; } };
            },
            .expr_slice => |psl_ptr| {
                const psl = psl_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:736
                return Expr{ .slice = _box_56: { const _bp_56 = _allocator.create(ast.ExprSlice) catch @panic("OOM"); _bp_56.* = ExprSlice.init(zspan(), _box_57: { const _bp_57 = blk2: { break :blk2 _allocator.create(@TypeOf(obj_expr)) catch @panic("OOM"); }; _bp_57.* = obj_expr; break :_box_57 _bp_57; }, _box_58: { const _bp_58 = blk2: { break :blk2 _allocator.create(@TypeOf(start_expr)) catch @panic("OOM"); }; _bp_58.* = start_expr; break :_box_58 _bp_58; }, _box_59: { const _bp_59 = blk2: { break :blk2 _allocator.create(@TypeOf(stop_expr)) catch @panic("OOM"); }; _bp_59.* = stop_expr; break :_box_59 _bp_59; }); break :_box_56 _bp_56; } };
            },
            .expr_binary => |pb_ptr| {
                const pb = pb_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:746
                            return Expr{ .type_check = _box_5a: { const _bp_5a = _allocator.create(ast.ExprTypeCheck) catch @panic("OOM"); _bp_5a.* = ExprTypeCheck.init(zspan(), _box_5b: { const _bp_5b = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_5b.* = left_expr; break :_box_5b _bp_5b; }, ei.name); break :_box_5a _bp_5a; } };
                        },
                        .member => |em_ptr| {
                            const em = em_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:751
                                var tc = ExprTypeCheck.init(zspan(), _box_5c: { const _bp_5c = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_5c.* = left_expr; break :_box_5c _bp_5c; }, obj_name.?);
// zbr:selfhost\astbuilder.zbr:752
                                tc.variant_name = em.member;
// zbr:selfhost\astbuilder.zbr:753
                                return Expr{ .type_check = _box_5d: { const _bp_5d = _allocator.create(ast.ExprTypeCheck) catch @panic("OOM"); _bp_5d.* = tc; break :_box_5d _bp_5d; } };
                            } else {
...
// zbr:selfhost\astbuilder.zbr:759
                return Expr{ .binary = _box_5e: { const _bp_5e = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_5e.* = ExprBinary.init(zspan(), op, _box_5f: { const _bp_5f = blk2: { break :blk2 _allocator.create(@TypeOf(left_expr)) catch @panic("OOM"); }; _bp_5f.* = left_expr; break :_box_5f _bp_5f; }, _box_60: { const _bp_60 = blk2: { break :blk2 _allocator.create(@TypeOf(right_expr)) catch @panic("OOM"); }; _bp_60.* = right_expr; break :_box_60 _bp_60; }); break :_box_5e _bp_5e; } };
            },
            .expr_orelse => |po_ptr| {
                const po = po_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:764
                return Expr{ .orelse_ = _box_61: { const _bp_61 = _allocator.create(ast.ExprOrelse) catch @panic("OOM"); _bp_61.* = ExprOrelse.init(zspan(), _box_62: { const _bp_62 = blk2: { break :blk2 _allocator.create(@TypeOf(expr_val)) catch @panic("OOM"); }; _bp_62.* = expr_val; break :_box_62 _bp_62; }, _box_63: { const _bp_63 = blk2: { break :blk2 _allocator.create(@TypeOf(fb_val)) catch @panic("OOM"); }; _bp_63.* = fb_val; break :_box_63 _bp_63; }); break :_box_61 _bp_61; } };
            },
...
// zbr:selfhost\astbuilder.zbr:782
                        return Expr{ .call = _box_64: { const _bp_64 = _allocator.create(ast.ExprCall) catch @panic("OOM"); _bp_64.* = ExprCall.init(zspan(), callee_expr, args); break :_box_64 _bp_64; } };
                    },
                    else => {
...
// zbr:selfhost\astbuilder.zbr:791
                    return Expr{ .old_ = _box_65: { const _bp_65 = _allocator.create(ast.ExprOld) catch @panic("OOM"); _bp_65.* = ExprOld.init(zspan(), uid, _box_66: { const _bp_66 = blk2: { break :blk2 _allocator.create(@TypeOf(operand_expr)) catch @panic("OOM"); }; _bp_66.* = operand_expr; break :_box_66 _bp_66; }); break :_box_65 _bp_65; } };
                }
// zbr:selfhost\astbuilder.zbr:792
                const op = try self.toUnaryOp(pu.op);
// zbr:selfhost\astbuilder.zbr:793
                return Expr{ .unary = _box_67: { const _bp_67 = _allocator.create(ast.ExprUnary) catch @panic("OOM"); _bp_67.* = ExprUnary.init(zspan(), op, _box_68: { const _bp_68 = blk2: { break :blk2 _allocator.create(@TypeOf(operand_expr)) catch @panic("OOM"); }; _bp_68.* = operand_expr; break :_box_68 _bp_68; }); break :_box_67 _bp_67; } };
            },
            .expr_try => |inner_ptr| {
                const inner = inner_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:797
                return Expr{ .try_ = _box_69: { const _bp_69 = _allocator.create(ast.ExprTry) catch @panic("OOM"); _bp_69.* = ExprTry.init(zspan(), _box_6a: { const _bp_6a = blk2: { break :blk2 _allocator.create(@TypeOf(inner_expr)) catch @panic("OOM"); }; _bp_6a.* = inner_expr; break :_box_6a _bp_6a; }); break :_box_69 _bp_69; } };
            },
            .expr_catch => |pc_ptr| {
                const pc = pc_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:805
                return Expr{ .catch_ = _box_6b: { const _bp_6b = _allocator.create(ast.ExprCatch) catch @panic("OOM"); _bp_6b.* = ExprCatch.init(zspan(), _box_6c: { const _bp_6c = blk2: { break :blk2 _allocator.create(@TypeOf(expr_val)) catch @panic("OOM"); }; _bp_6c.* = expr_val; break :_box_6c _bp_6c; }, ev, _box_6d: { const _bp_6d = blk2: { break :blk2 _allocator.create(@TypeOf(fb_val)) catch @panic("OOM"); }; _bp_6d.* = fb_val; break :_box_6d _bp_6d; }); break :_box_6b _bp_6b; } };
            },
...
// zbr:selfhost\astbuilder.zbr:809
                return Expr{ .to_non_nil = _box_6e: { const _bp_6e = _allocator.create(ast.ExprToNonNil) catch @panic("OOM"); _bp_6e.* = ExprToNonNil.init(zspan(), _box_6f: { const _bp_6f = blk2: { break :blk2 _allocator.create(@TypeOf(inner_expr)) catch @panic("OOM"); }; _bp_6f.* = inner_expr; break :_box_6f _bp_6f; }); break :_box_6e _bp_6e; } };
            },
            .expr_except => |pex_ptr| {
                const pex = pex_ptr.*;
...
// zbr:selfhost\astbuilder.zbr:817
                return Expr{ .except_ = _box_70: { const _bp_70 = _allocator.create(ast.ExprExcept) catch @panic("OOM"); _bp_70.* = ExprExcept.init(zspan(), base_expr, fields); break :_box_70 _bp_70; } };
            },
...
// zbr:selfhost\astbuilder.zbr:826
                            parts.append(_allocator, StringPart{ .format = fspec[@intCast(1)..@intCast(fspec.len)] }) catch unreachable;
                        },
                        else => {
// zbr:selfhost\astbuilder.zbr:828
                            const part_expr = try self.buildExpr(part);
// zbr:selfhost\astbuilder.zbr:829
                            parts.append(_allocator, StringPart{ .expr_ = _box_71: { const _bp_71 = _allocator.create(ast.Expr) catch @panic("OOM"); _bp_71.* = part_expr; break :_box_71 _bp_71; } }) catch unreachable;
                        },
                    }
                }
// zbr:selfhost\astbuilder.zbr:830
                return Expr{ .string_interp = _box_72: { const _bp_72 = _allocator.create(ast.ExprStringInterp) catch @panic("OOM"); _bp_72.* = ExprStringInterp.init(zspan(), parts); break :_box_72 _bp_72; } };
            },
            .expr_lambda => |pl| {
...
// zbr:selfhost\astbuilder.zbr:839
                return Expr{ .tuple_lit = _box_73: { const _bp_73 = _allocator.create(ast.ExprTuple) catch @panic("OOM"); _bp_73.* = ExprTuple.init(zspan(), elems); break :_box_73 _bp_73; } };
            },
...
// zbr:selfhost\astbuilder.zbr:845
                return Expr{ .array_lit = _box_74: { const _bp_74 = _allocator.create(ast.ExprArrayLit) catch @panic("OOM"); _bp_74.* = ExprArrayLit.init(zspan(), elems); break :_box_74 _bp_74; } };
            },
...
// zbr:selfhost\astbuilder.zbr:854
                return Expr{ .list_lit = _box_75: { const _bp_75 = _allocator.create(ast.ExprListLit) catch @panic("OOM"); _bp_75.* = ExprListLit.init(zspan(), null, elems_l); break :_box_75 _bp_75; } };
            },
...
// zbr:selfhost\astbuilder.zbr:864
                return Expr{ .chained_cmp = _box_76: { const _bp_76 = _allocator.create(ast.ExprChainedCmp) catch @panic("OOM"); _bp_76.* = ExprChainedCmp.init(zspan(), ops_list, operands_list); break :_box_76 _bp_76; } };
            },
            else => {
...
// zbr:selfhost\astbuilder.zbr:883
                params.append(_allocator, Param.init(zspan(), ParamMode.normal, pp.name, tr, _box_77: { const _bp_77 = blk2: { break :blk2 _allocator.create(@TypeOf(defval)) catch @panic("OOM"); }; _bp_77.* = defval; break :_box_77 _bp_77; })) catch unreachable;
            } else {
...
// zbr:selfhost\astbuilder.zbr:904
            const dv = DeclVar.init(zspan(), zmods(), cv.name, cv_tr, _box_78: { const _bp_78 = blk2: { break :blk2 _allocator.create(@TypeOf(cv_init_expr)) catch @panic("OOM"); }; _bp_78.* = cv_init_expr; break :_box_78 _bp_78; }, (!cv.is_const));
// zbr:selfhost\astbuilder.zbr:905
            captures.append(_allocator, dv) catch unreachable;
        }
// zbr:selfhost\astbuilder.zbr:906
        return Expr{ .lambda = _box_79: { const _bp_79 = _allocator.create(ast.ExprLambda) catch @panic("OOM"); _bp_79.* = ExprLambda.init(zspan(), params, ret_type, lbody, captures); break :_box_79 _bp_79; } };
    }
...
// zbr:selfhost\astbuilder.zbr:979
        var _cp_it_7a = std.unicode.Utf8View.initUnchecked(s).iterator();
        while (_cp_it_7a.nextCodepoint()) |gch| {
...
// zbr:selfhost\astbuilder.zbr:1042
            return TypeRef{ .ref_to = _box_7b: { const _bp_7b = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_7b.* = inner; break :_box_7b _bp_7b; } };
        }
...
// zbr:selfhost\astbuilder.zbr:1052
            return TypeRef{ .nilable = _box_7c: { const _bp_7c = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_7c.* = inner; break :_box_7c _bp_7c; } };
        }
