...
pub const Parser = struct {
    ...
    pub fn parseModule(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .module_ = blk_box: { const _bv = PModule.init(decls); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseUseDecl(self: *Parser) anyerror!PNode {
        ...
        self.skipEol();
        return PNode{ .use_ = blk_box: { const _bv = PUse.init(path, exposed); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseEnumDecl(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .enum_ = blk_box: { const _bv = PEnum.init(name, variants); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseUnionDecl(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .union_decl = blk_box: { const _bv = PUnionDecl.init(name, variants); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseSigDecl(self: *Parser) anyerror!PNode {
        ...
        if (has_params) {
            while ((!self.textIs(")"))) {
                if (self.textIs(",")) {
                    ...
                    params.append(_allocator, PParam.init(pname, ptype)) catch @panic("OOM");
                }
            }
            try self.expectText(")");
        }
        ...
        self.skipEol();
        return PNode{ .sig_ = blk_box: { const _bv = PSig.init(name, params, return_type); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseDeclInit(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .init_ = blk_box: { const _bv = PInit.init(params, stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseMethodDecl(self: *Parser, is_shared: bool) anyerror!PNode {
        ...
        return PNode{ .method_ = blk_box: { const _bv = PMethod.init(name, is_shared, throws_, params, return_type, stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseReturnStmt(self: *Parser) anyerror!PNode {
        ...
        self.skipEol();
        return PNode{ .stmt_return = blk_box: { const _bv = PReturn.init(value); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseIfStmt(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .stmt_if = blk_box: { const _bv = PIf.init(cond_list, then_stmts, else_stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseForInStmt(self: *Parser) anyerror!PNode {
        ...
        iter_list.append(_allocator, iter_expr) catch @panic("OOM");
        return PNode{ .stmt_for_in = blk_box: { const _bv = PForIn.init(var_names, iter_list, stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
        ...
        if (self.textIs("=")) {
            ...
            if ((self.textIs("def") and std.mem.eql(u8, self.peekAt(1).text, "("))) {
                ...
                if (self.textIs("=")) {
                    ...
                    return PNode{ .stmt_var = blk_box: { const _bv = PVar.init(name, is_const, type_name, init_expr); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                }
                self.skipEol();
                if ((!self.isIndent())) {
    ...
    pub fn parseAssertStmt(self: *Parser) anyerror!PNode {
        ...
        self.skipEol();
        return PNode{ .stmt_assert = blk_box: { const _bv = PAssert.init(cond_list, msg_list); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseTryCatch(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .stmt_try_catch = blk_box: { const _bv = PTryCatch.init(body_stmts, catch_binding, catch_stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseBranchStmt(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .stmt_branch = blk_box: { const _bv = PBranch.init(subj_list, arms, else_stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseExprOrAssignStmt(self: *Parser) anyerror!PNode {
        ...
        if (!std.mem.eql(u8, op, "")) {
            ...
            return PNode{ .stmt_assign = blk_box: { const _bv = PAssign.init(op, tgt, val); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
        self.skipEol();
        return PNode{ .stmt_expr = blk_box: { const _bv = target_expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseAnd(self: *Parser) anyerror!PNode {
        ...
        while (self.textIs("and")) {
            ...
            var r = std.ArrayList(PNode){};
            r.append(_allocator, right) catch @panic("OOM");
            left = PNode{ .expr_binary = blk_box: { const _bv = PBinary.init("and", l, r); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
        return left;
    }
    ...
    pub fn parseNot(self: *Parser) anyerror!PNode {
        if (self.textIs("not")) {
            ...
            return PNode{ .expr_unary = blk_box: { const _bv = PUnary.init("not", ops); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
    ...
    pub fn parseComparison(self: *Parser) anyerror!PNode {
        ...
        if (!std.mem.eql(u8, op, "")) {
            ...
            var r = std.ArrayList(PNode){};
            r.append(_allocator, right) catch @panic("OOM");
            return PNode{ .expr_binary = blk_box: { const _bv = PBinary.init(op, l, r); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
        return left;
    }
    ...
    pub fn parseAddSub(self: *Parser) anyerror!PNode {
        ...
        while ((self.textIs("+") or self.textIs("-"))) {
            ...
            var r = std.ArrayList(PNode){};
            r.append(_allocator, right) catch @panic("OOM");
            left = PNode{ .expr_binary = blk_box: { const _bv = PBinary.init(op, l, r); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
        }
        return left;
    }
    ...
    pub fn parsePostfix(self: *Parser) anyerror!PNode {
        ...
        while (going) {
            if (self.textIs(".")) {
                ...
                if (self.textIs("?")) {
                    self.advance();
                    expr = PNode{ .expr_try = blk_box: { const _bv = expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                } else {
                    if (self.textIs("to")) {
                        self.advance();
                        try self.expectText("!");
                        expr = PNode{ .expr_to_bang = blk_box: { const _bv = expr; const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                    } else {
                        if (self.textIs("except")) {
                            ...
                            expr = PNode{ .expr_except = blk_box: { const _bv = PExcept.init(base_list, fields); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                        } else {
                            if (self.textIs("[")) {
                                self.advance();
                                ...
                                if (self.textIs("..")) {
                                    ...
                                    expr = PNode{ .expr_slice = blk_box: { const _bv = PSlice.init(obj, start_list, stop_list); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                                } else {
                                    try self.expectText("]");
                                    var obj = std.ArrayList(PNode){};
                                    obj.append(_allocator, expr) catch @panic("OOM");
                                    ...
                                    expr = PNode{ .expr_index = blk_box: { const _bv = PIndex.init(obj, idx_list); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
                                }
                            } else {
                                if (self.textIs("(")) {
                                    self.advance();
    ...
    pub fn parseCaptureBlock(self: *Parser) anyerror!std.ArrayList(PCaptureVar) {
        ...
        while (((!self.isDedent()) and (!self.isEof()))) {
            ...
            self.skipEol();
            caps.append(_allocator, PCaptureVar.init(cap_name, cap_type, init_name, is_const)) catch @panic("OOM");
        }
        if (self.isDedent()) {
            self.advance();
        }
    ...
    pub fn parseStringInterp(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .expr_string_interp = blk_box: { const _bv = PStringInterp.init(parts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
