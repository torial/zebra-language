...
// zbr:selfhost\Parser.zbr:1124
        return PNode{ .field_ = _box_c: { const _bp_c = _allocator.create(PField) catch @panic("OOM"); _bp_c.* = PField.init(name, type_name, is_const, is_shared, init_expr); break :_box_c _bp_c; } };
    }
