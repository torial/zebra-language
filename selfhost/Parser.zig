...
// zbr:selfhost\Parser.zbr:1254
        return PNode{ .class_ = _box_4: { const _bp_4 = _allocator.create(PClass) catch @panic("OOM"); _bp_4.* = PClass.init(name, type_params, ifaces, mixins, members, invs, is_reflectable, false, false, false); break :_box_4 _bp_4; } };
    }
...
// zbr:selfhost\Parser.zbr:1296
        return PNode{ .struct_ = _box_6: { const _bp_6 = _allocator.create(PClass) catch @panic("OOM"); _bp_6.* = PClass.init(name, type_params, ifaces, std.ArrayList([]const u8).empty, members, invs, is_reflectable, is_derive_debug, is_derive_eq, is_derive_hash); break :_box_6 _bp_6; } };
    }
...
// zbr:selfhost\Parser.zbr:1320
        return PNode{ .interface_ = _box_7: { const _bp_7 = _allocator.create(PClass) catch @panic("OOM"); _bp_7.* = PClass.init(name, type_params, ifaces, std.ArrayList([]const u8).empty, members, std.ArrayList(PNode).empty, false, false, false, false); break :_box_7 _bp_7; } };
    }
...
// zbr:selfhost\Parser.zbr:1337
        return PNode{ .mixin_ = _box_8: { const _bp_8 = _allocator.create(PClass) catch @panic("OOM"); _bp_8.* = PClass.init(name, empty_str_list, empty_str_list, empty_str_list, members, std.ArrayList(PNode).empty, false, false, false, false); break :_box_8 _bp_8; } };
    }
...
// zbr:selfhost\Parser.zbr:1446
        return PNode{ .type_alias_ = _box_c: { const _bp_c = _allocator.create(PTypeAlias) catch @panic("OOM"); _bp_c.* = PTypeAlias.init(name, params, base_type, constraint); break :_box_c _bp_c; } };
    }
...
// zbr:selfhost\Parser.zbr:1535
        return PNode{ .field_ = _box_d: { const _bp_d = _allocator.create(PField) catch @panic("OOM"); _bp_d.* = PField.init(name, type_name, is_const, is_static, is_private, is_public, init_expr); break :_box_d _bp_d; } };
    }
...
// zbr:selfhost\Parser.zbr:1568
        return PNode{ .init_ = _box_e: { const _bp_e = _allocator.create(PInit) catch @panic("OOM"); _bp_e.* = PInit.init(params, stmts); break :_box_e _bp_e; } };
    }
...
// zbr:selfhost\Parser.zbr:1654
                wrapped.append(_allocator, PNode{ .stmt_try_catch = _box_f: { const _bp_f = _allocator.create(PTryCatch) catch @panic("OOM"); _bp_f.* = PTryCatch.init(stmts, catch_binding, catch_stmts, line); break :_box_f _bp_f; } }) catch unreachable;
// zbr:selfhost\Parser.zbr:1655
                stmts = wrapped;
            }
        }
// zbr:selfhost\Parser.zbr:1656
        return PNode{ .method_ = _box_10: { const _bp_10 = _allocator.create(PMethod) catch @panic("OOM"); _bp_10.* = PMethod.init(name, is_static, is_private, is_public, throws_, params, return_type, stmts, is_profile, is_once, tags, is_export, type_params); break :_box_10 _bp_10; } };
    }
...
// zbr:selfhost\Parser.zbr:1738
            return PNode{ .stmt_print = _box_11: { const _bp_11 = _allocator.create(PNode) catch @panic("OOM"); _bp_11.* = expr; break :_box_11 _bp_11; } };
        } else {
...
// zbr:selfhost\Parser.zbr:1749
        return PNode{ .stmt_return = _box_12: { const _bp_12 = _allocator.create(PReturn) catch @panic("OOM"); _bp_12.* = PReturn.init(value, line); break :_box_12 _bp_12; } };
    }
...
// zbr:selfhost\Parser.zbr:1776
            return PNode{ .stmt_if = _box_13: { const _bp_13 = _allocator.create(PIf) catch @panic("OOM"); _bp_13.* = pif; break :_box_13 _bp_13; } };
        } else {
...
// zbr:selfhost\Parser.zbr:1794
            return PNode{ .stmt_if = _box_14: { const _bp_14 = _allocator.create(PIf) catch @panic("OOM"); _bp_14.* = PIf.init(cond_list, then_stmts, else_stmts, line); break :_box_14 _bp_14; } };
        }
    }
...
// zbr:selfhost\Parser.zbr:1810
        return PNode{ .stmt_if = _box_16: { const _bp_16 = _allocator.create(PIf) catch @panic("OOM"); _bp_16.* = PIf.init(cond_list, then_stmts, empty_else, line); break :_box_16 _bp_16; } };
    }
...
// zbr:selfhost\Parser.zbr:1823
        return PNode{ .stmt_while = _box_18: { const _bp_18 = _allocator.create(PWhile) catch @panic("OOM"); _bp_18.* = PWhile.init(cond_list, stmts, line); break :_box_18 _bp_18; } };
    }
...
// zbr:selfhost\Parser.zbr:1845
            if_cond_list.append(_allocator, PNode{ .expr_unary = _box_19: { const _bp_19 = _allocator.create(PUnary) catch @panic("OOM"); _bp_19.* = PUnary.init("not", filter_operand); break :_box_19 _bp_19; } }) catch unreachable;
...
// zbr:selfhost\Parser.zbr:1850
            wrapped.append(_allocator, PNode{ .stmt_var = _box_1a: { const _bp_1a = _allocator.create(PVar) catch @panic("OOM"); _bp_1a.* = PVar.init(bind_name, false, "", init_list, line); break :_box_1a _bp_1a; } }) catch unreachable;
// zbr:selfhost\Parser.zbr:1851
            wrapped.append(_allocator, PNode{ .stmt_if = _box_1b: { const _bp_1b = _allocator.create(PIf) catch @panic("OOM"); _bp_1b.* = PIf.init(if_cond_list, break_list, empty_else, line); break :_box_1b _bp_1b; } }) catch unreachable;
...
// zbr:selfhost\Parser.zbr:1856
            return PNode{ .stmt_while = _box_1c: { const _bp_1c = _allocator.create(PWhile) catch @panic("OOM"); _bp_1c.* = PWhile.init(true_cond, wrapped, line); break :_box_1c _bp_1c; } };
        }
...
// zbr:selfhost\Parser.zbr:1862
        return PNode{ .stmt_while = _box_1d: { const _bp_1d = _allocator.create(PWhile) catch @panic("OOM"); _bp_1d.* = PWhile.init(cond_list, stmts, line); break :_box_1d _bp_1d; } };
    }
...
// zbr:selfhost\Parser.zbr:1888
        return PNode{ .stmt_allocate = _box_1e: { const _bp_1e = _allocator.create(PAllocate) catch @panic("OOM"); _bp_1e.* = PAllocate.init(source_list, stmts, false, line); break :_box_1e _bp_1e; } };
    }
...
// zbr:selfhost\Parser.zbr:1898
        return PNode{ .stmt_with = _box_1f: { const _bp_1f = _allocator.create(PWith) catch @panic("OOM"); _bp_1f.* = PWith.init(target_list, stmts, line); break :_box_1f _bp_1f; } };
    }
...
// zbr:selfhost\Parser.zbr:1908
        return PNode{ .stmt_in = _box_20: { const _bp_20 = _allocator.create(PInScope) catch @panic("OOM"); _bp_20.* = PInScope.init(expr_list, stmts, line); break :_box_20 _bp_20; } };
    }
...
// zbr:selfhost\Parser.zbr:1926
        return PNode{ .stmt_guard = _box_21: { const _bp_21 = _allocator.create(PGuard) catch @panic("OOM"); _bp_21.* = PGuard.init(cond_list, else_stmts, line); break :_box_21 _bp_21; } };
    }
...
// zbr:selfhost\Parser.zbr:1957
            return PNode{ .stmt_for_num = _box_22: { const _bp_22 = _allocator.create(PForNum) catch @panic("OOM"); _bp_22.* = PForNum.init(var_names.items[@as(usize, @intCast(0))], start_list, stop_list, step_list, stmts, else_stmts, line); break :_box_22 _bp_22; } };
        }
...
// zbr:selfhost\Parser.zbr:1972
        return PNode{ .stmt_for_in = _box_23: { const _bp_23 = _allocator.create(PForIn) catch @panic("OOM"); _bp_23.* = PForIn.init(var_names, iter_list, filter_list, stmts, else_stmts, line); break :_box_23 _bp_23; } };
    }
...
// zbr:selfhost\Parser.zbr:1996
        return PNode{ .stmt_destruct = _box_24: { const _bp_24 = _allocator.create(PDestruct) catch @panic("OOM"); _bp_24.* = PDestruct.init(names, init_expr, is_struct, line); break :_box_24 _bp_24; } };
    }
...
// zbr:selfhost\Parser.zbr:2028
                    return PNode{ .stmt_var = _box_25: { const _bp_25 = _allocator.create(PVar) catch @panic("OOM"); _bp_25.* = PVar.init(name, is_const, type_name, init_expr, line); break :_box_25 _bp_25; } };
                }
...
// zbr:selfhost\Parser.zbr:2047
                return PNode{ .stmt_var = _box_26: { const _bp_26 = _allocator.create(PVar) catch @panic("OOM"); _bp_26.* = PVar.init(name, is_const, type_name, init_expr, line); break :_box_26 _bp_26; } };
            }
...
// zbr:selfhost\Parser.zbr:2063
        return PNode{ .stmt_assert = _box_28: { const _bp_28 = _allocator.create(PAssert) catch @panic("OOM"); _bp_28.* = PAssert.init(cond_list, msg_list, line); break :_box_28 _bp_28; } };
    }
...
// zbr:selfhost\Parser.zbr:2073
            return PNode{ .stmt_assert_eq = _box_29: { const _bp_29 = _allocator.create(PAssertCmp) catch @panic("OOM"); _bp_29.* = PAssertCmp.init(lhs, rhs, line); break :_box_29 _bp_29; } };
        }
// zbr:selfhost\Parser.zbr:2074
        return PNode{ .stmt_assert_ne = _box_2a: { const _bp_2a = _allocator.create(PAssertCmp) catch @panic("OOM"); _bp_2a.* = PAssertCmp.init(lhs, rhs, line); break :_box_2a _bp_2a; } };
    }
...
// zbr:selfhost\Parser.zbr:2082
            return PNode{ .stmt_assert_true = _box_2b: { const _bp_2b = _allocator.create(PAssertUnary) catch @panic("OOM"); _bp_2b.* = PAssertUnary.init(expr, line); break :_box_2b _bp_2b; } };
        }
// zbr:selfhost\Parser.zbr:2083
        return PNode{ .stmt_assert_false = _box_2c: { const _bp_2c = _allocator.create(PAssertUnary) catch @panic("OOM"); _bp_2c.* = PAssertUnary.init(expr, line); break :_box_2c _bp_2c; } };
    }
...
// zbr:selfhost\Parser.zbr:2095
        return PNode{ .stmt_raise = _box_2d: { const _bp_2d = _allocator.create(PRaise) catch @panic("OOM"); _bp_2d.* = PRaise.init(msg_list, line); break :_box_2d _bp_2d; } };
    }
...
// zbr:selfhost\Parser.zbr:2181
        return PNode{ .stmt_branch = _box_2e: { const _bp_2e = _allocator.create(PBranch) catch @panic("OOM"); _bp_2e.* = PBranch.init(subj_list, arms, else_stmts, line); break :_box_2e _bp_2e; } };
    }
...
// zbr:selfhost\Parser.zbr:2226
            return PNode{ .stmt_copy_out = _box_2f: { const _bp_2f = _allocator.create(PCopyOut) catch @panic("OOM"); _bp_2f.* = PCopyOut.init(tgt, val, line); break :_box_2f _bp_2f; } };
        }
...
// zbr:selfhost\Parser.zbr:2235
            return PNode{ .stmt_assign = _box_30: { const _bp_30 = _allocator.create(PAssign) catch @panic("OOM"); _bp_30.* = PAssign.init(op, tgt, val, line); break :_box_30 _bp_30; } };
        }
// zbr:selfhost\Parser.zbr:2236
        self.skipEol();
// zbr:selfhost\Parser.zbr:2237
        return PNode{ .stmt_expr = _box_31: { const _bp_31 = _allocator.create(PNode) catch @panic("OOM"); _bp_31.* = target_expr; break :_box_31 _bp_31; } };
    }
...
// zbr:selfhost\Parser.zbr:2255
            left = PNode{ .expr_pipeline = _box_32: { const _bp_32 = _allocator.create(PPipeline) catch @panic("OOM"); _bp_32.* = PPipeline.init(lhs_list, rhs_list); break :_box_32 _bp_32; } };
        }
...
// zbr:selfhost\Parser.zbr:2268
            left = PNode{ .expr_catch = _box_33: { const _bp_33 = _allocator.create(PCatch) catch @panic("OOM"); _bp_33.* = PCatch.init(base, binding, fb); break :_box_33 _bp_33; } };
        }
...
// zbr:selfhost\Parser.zbr:2282
                left = PNode{ .expr_orelse = _box_34: { const _bp_34 = _allocator.create(POrelse) catch @panic("OOM"); _bp_34.* = POrelse.init(l, r); break :_box_34 _bp_34; } };
            } else {
// zbr:selfhost\Parser.zbr:2284
                left = PNode{ .expr_binary = _box_35: { const _bp_35 = _allocator.create(PBinary) catch @panic("OOM"); _bp_35.* = PBinary.init("or", l, r); break :_box_35 _bp_35; } };
            }
        }
...
// zbr:selfhost\Parser.zbr:2296
            left = PNode{ .expr_binary = _box_36: { const _bp_36 = _allocator.create(PBinary) catch @panic("OOM"); _bp_36.* = PBinary.init("and", l, r); break :_box_36 _bp_36; } };
        }
...
// zbr:selfhost\Parser.zbr:2305
            return PNode{ .expr_unary = _box_37: { const _bp_37 = _allocator.create(PUnary) catch @panic("OOM"); _bp_37.* = PUnary.init("not", ops); break :_box_37 _bp_37; } };
        }
...
// zbr:selfhost\Parser.zbr:2337
            const tc_node = PNode{ .expr_binary = _box_38: { const _bp_38 = _allocator.create(PBinary) catch @panic("OOM"); _bp_38.* = PBinary.init("is", l, r); break :_box_38 _bp_38; } };
...
// zbr:selfhost\Parser.zbr:2361
            inner.append(_allocator, PNode{ .expr_binary = _box_3a: { const _bp_3a = _allocator.create(PBinary) catch @panic("OOM"); _bp_3a.* = PBinary.init("in", lc, rc); break :_box_3a _bp_3a; } }) catch unreachable;
...
// zbr:selfhost\Parser.zbr:2408
                    return PNode{ .expr_chained_cmp = _box_3c: { const _bp_3c = _allocator.create(PChainedCmp) catch @panic("OOM"); _bp_3c.* = PChainedCmp.init(chain_ops, chain_nodes); break :_box_3c _bp_3c; } };
                }
            }
...
// zbr:selfhost\Parser.zbr:2414
            return PNode{ .expr_binary = _box_3d: { const _bp_3d = _allocator.create(PBinary) catch @panic("OOM"); _bp_3d.* = PBinary.init(op, l, r); break :_box_3d _bp_3d; } };
        }
...
// zbr:selfhost\Parser.zbr:2427
            left = PNode{ .expr_binary = _box_3e: { const _bp_3e = _allocator.create(PBinary) catch @panic("OOM"); _bp_3e.* = PBinary.init(op, l, r); break :_box_3e _bp_3e; } };
        }
...
// zbr:selfhost\Parser.zbr:2440
            left = PNode{ .expr_binary = _box_3f: { const _bp_3f = _allocator.create(PBinary) catch @panic("OOM"); _bp_3f.* = PBinary.init(op, l, r); break :_box_3f _bp_3f; } };
        }
...
// zbr:selfhost\Parser.zbr:2449
            return PNode{ .expr_unary = _box_40: { const _bp_40 = _allocator.create(PUnary) catch @panic("OOM"); _bp_40.* = PUnary.init("-", ops); break :_box_40 _bp_40; } };
        }
...
// zbr:selfhost\Parser.zbr:2456
            return PNode{ .expr_unary = _box_41: { const _bp_41 = _allocator.create(PUnary) catch @panic("OOM"); _bp_41.* = PUnary.init("old", ops); break :_box_41 _bp_41; } };
        }
...
// zbr:selfhost\Parser.zbr:2473
                    callee.append(_allocator, PNode{ .expr_member = _box_42: { const _bp_42 = _allocator.create(PMember) catch @panic("OOM"); _bp_42.* = PMember.init(base, mname); break :_box_42 _bp_42; } }) catch unreachable;
// zbr:selfhost\Parser.zbr:2474
                    expr = PNode{ .expr_call = _box_43: { const _bp_43 = _allocator.create(PCall) catch @panic("OOM"); _bp_43.* = PCall.init(callee, args); break :_box_43 _bp_43; } };
...
// zbr:selfhost\Parser.zbr:2486
                    callee.append(_allocator, PNode{ .expr_member = _box_44: { const _bp_44 = _allocator.create(PMember) catch @panic("OOM"); _bp_44.* = PMember.init(base, "to"); break :_box_44 _bp_44; } }) catch unreachable;
...
// zbr:selfhost\Parser.zbr:2494
                    expr = PNode{ .expr_member = _box_46: { const _bp_46 = _allocator.create(PMember) catch @panic("OOM"); _bp_46.* = PMember.init(base, field); break :_box_46 _bp_46; } };
                } else {
...
// zbr:selfhost\Parser.zbr:2500
                    expr = PNode{ .expr_member = _box_47: { const _bp_47 = _allocator.create(PMember) catch @panic("OOM"); _bp_47.* = PMember.init(base, field); break :_box_47 _bp_47; } };
                }
            } else if (self.textIs("?.")) {
...
// zbr:selfhost\Parser.zbr:2511
                    expr = PNode{ .expr_opt_chain = _box_48: { const _bp_48 = _allocator.create(POptChain) catch @panic("OOM"); _bp_48.* = POptChain.init(base_list, mname, true, cargs); break :_box_48 _bp_48; } };
                } else {
...
// zbr:selfhost\Parser.zbr:2518
                    expr = PNode{ .expr_opt_chain = _box_49: { const _bp_49 = _allocator.create(POptChain) catch @panic("OOM"); _bp_49.* = POptChain.init(base_list, field, false, empty_args); break :_box_49 _bp_49; } };
                }
            } else if (self.textIs("?")) {
// zbr:selfhost\Parser.zbr:2520
                self.advance();
// zbr:selfhost\Parser.zbr:2521
                expr = PNode{ .expr_try = _box_4a: { const _bp_4a = _allocator.create(PNode) catch @panic("OOM"); _bp_4a.* = expr; break :_box_4a _bp_4a; } };
            } else if (self.textIs("!")) {
// zbr:selfhost\Parser.zbr:2524
                self.advance();
// zbr:selfhost\Parser.zbr:2525
                expr = PNode{ .expr_to_bang = _box_4b: { const _bp_4b = _allocator.create(PNode) catch @panic("OOM"); _bp_4b.* = expr; break :_box_4b _bp_4b; } };
...
// zbr:selfhost\Parser.zbr:2530
                expr = PNode{ .expr_to_bang = _box_4c: { const _bp_4c = _allocator.create(PNode) catch @panic("OOM"); _bp_4c.* = expr; break :_box_4c _bp_4c; } };
...
// zbr:selfhost\Parser.zbr:2553
                expr = PNode{ .expr_except = _box_4d: { const _bp_4d = _allocator.create(PExcept) catch @panic("OOM"); _bp_4d.* = PExcept.init(base_list, fields); break :_box_4d _bp_4d; } };
            } else if (self.textIs("[")) {
...
// zbr:selfhost\Parser.zbr:2569
                    expr = PNode{ .expr_slice = _box_4e: { const _bp_4e = _allocator.create(PSlice) catch @panic("OOM"); _bp_4e.* = PSlice.init(obj, start_list, stop_list); break :_box_4e _bp_4e; } };
                } else {
...
// zbr:selfhost\Parser.zbr:2576
                    expr = PNode{ .expr_index = _box_4f: { const _bp_4f = _allocator.create(PIndex) catch @panic("OOM"); _bp_4f.* = PIndex.init(obj, idx_list); break :_box_4f _bp_4f; } };
                }
            } else if (self.textIs("(")) {
...
// zbr:selfhost\Parser.zbr:2583
                expr = PNode{ .expr_call = _box_50: { const _bp_50 = _allocator.create(PCall) catch @panic("OOM"); _bp_50.* = PCall.init(callee, args); break :_box_50 _bp_50; } };
            } else {
...
// zbr:selfhost\Parser.zbr:2646
            return PNode{ .expr_array_lit = _box_51: { const _bp_51 = _allocator.create(PArrayLit) catch @panic("OOM"); _bp_51.* = PArrayLit.init(elems); break :_box_51 _bp_51; } };
        } else if (self.textIs("[")) {
...
// zbr:selfhost\Parser.zbr:2661
            return PNode{ .expr_list_lit = _box_52: { const _bp_52 = _allocator.create(PArrayLit) catch @panic("OOM"); _bp_52.* = PArrayLit.init(elems); break :_box_52 _bp_52; } };
        } else if (self.textIs("(")) {
...
// zbr:selfhost\Parser.zbr:2673
                return PNode{ .expr_tuple_lit = _box_53: { const _bp_53 = _allocator.create(PTupleLit) catch @panic("OOM"); _bp_53.* = PTupleLit.init(elems); break :_box_53 _bp_53; } };
            }
...
// zbr:selfhost\Parser.zbr:2684
            callee.append(_allocator, PNode{ .expr_id = _box_54: { const _bp_54 = _allocator.create(PExprId) catch @panic("OOM"); _bp_54.* = PExprId.init(name, id_line, id_col); break :_box_54 _bp_54; } }) catch unreachable;
// zbr:selfhost\Parser.zbr:2685
            return PNode{ .expr_call = _box_55: { const _bp_55 = _allocator.create(PCall) catch @panic("OOM"); _bp_55.* = PCall.init(callee, args); break :_box_55 _bp_55; } };
        } else if (self.textIs(".")) {
...
// zbr:selfhost\Parser.zbr:2695
                callee.append(_allocator, PNode{ .expr_member = _box_56: { const _bp_56 = _allocator.create(PMember) catch @panic("OOM"); _bp_56.* = PMember.init(base, mname); break :_box_56 _bp_56; } }) catch unreachable;
...
// zbr:selfhost\Parser.zbr:2700
                return PNode{ .expr_member = _box_58: { const _bp_58 = _allocator.create(PMember) catch @panic("OOM"); _bp_58.* = PMember.init(base, field); break :_box_58 _bp_58; } };
            }
        } else if (self.isId()) {
...
// zbr:selfhost\Parser.zbr:2713
            return PNode{ .expr_id = _box_5a: { const _bp_5a = _allocator.create(PExprId) catch @panic("OOM"); _bp_5a.* = PExprId.init(name, id_line, id_col); break :_box_5a _bp_5a; } };
