...
// zbr:selfhost\Parser.zbr:1250
        return PNode{ .stmt_return = _box_f: { const _bp_f = _allocator.create(PReturn) catch @panic("OOM"); _bp_f.* = PReturn.init(value); break :_box_f _bp_f; } };
    }
...
// zbr:selfhost\Parser.zbr:1301
            wrapped.append(_allocator, PNode{ .stmt_var = _box_12: { const _bp_12 = _allocator.create(PVar) catch @panic("OOM"); _bp_12.* = PVar.init(bind_name, false, "", init_list); break :_box_12 _bp_12; } }) catch unreachable;
// zbr:selfhost\Parser.zbr:1302
            wrapped.append(_allocator, PNode{ .stmt_if = _box_13: { const _bp_13 = _allocator.create(PIf) catch @panic("OOM"); _bp_13.* = PIf.init(if_cond_list, break_list, empty_else); break :_box_13 _bp_13; } }) catch unreachable;
...
// zbr:selfhost\Parser.zbr:1307
            return PNode{ .stmt_while = _box_14: { const _bp_14 = _allocator.create(PWhile) catch @panic("OOM"); _bp_14.* = PWhile.init(true_cond, wrapped); break :_box_14 _bp_14; } };
        }
...
// zbr:selfhost\Parser.zbr:1313
        return PNode{ .stmt_while = _box_15: { const _bp_15 = _allocator.create(PWhile) catch @panic("OOM"); _bp_15.* = PWhile.init(cond_list, stmts); break :_box_15 _bp_15; } };
    }
...
// zbr:selfhost\Parser.zbr:1319
        return PNode{ .stmt_arena_scope = _box_16: { const _bp_16 = _allocator.create(PArenaScope) catch @panic("OOM"); _bp_16.* = PArenaScope.init(stmts); break :_box_16 _bp_16; } };
    }
...
// zbr:selfhost\Parser.zbr:1328
        return PNode{ .stmt_with = _box_17: { const _bp_17 = _allocator.create(PWith) catch @panic("OOM"); _bp_17.* = PWith.init(target_list, stmts); break :_box_17 _bp_17; } };
    }
...
// zbr:selfhost\Parser.zbr:1345
        return PNode{ .stmt_guard = _box_18: { const _bp_18 = _allocator.create(PGuard) catch @panic("OOM"); _bp_18.* = PGuard.init(cond_list, else_stmts); break :_box_18 _bp_18; } };
    }
...
// zbr:selfhost\Parser.zbr:1370
            return PNode{ .stmt_for_num = _box_19: { const _bp_19 = _allocator.create(PForNum) catch @panic("OOM"); _bp_19.* = PForNum.init(var_names.items[@as(usize, @intCast(0))], start_list, stop_list, step_list, stmts); break :_box_19 _bp_19; } };
        }
