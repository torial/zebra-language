...
pub const Parser = struct {
    ...
    pub fn peek(self: *Parser) *Token.Token {
        if ((self.pos < @as(i64, @intCast(self.tokens.items.len)))) {
    ...
    pub fn peekAt(self: *Parser, offset: i64) *Token.Token {
        ...
        if ((idx < @as(i64, @intCast(self.tokens.items.len)))) {
    ...
    pub fn parsePropertyDecl(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .property_ = blk_box: { const _bv: std.meta.Child(@FieldType(PNode, "property_")) = PProperty.init(name, type_name, stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseDeclField(self: *Parser, is_const: bool) anyerror!PNode {
        ...
        self.skipEol();
        return PNode{ .field_ = blk_box: { const _bv: std.meta.Child(@FieldType(PNode, "field_")) = PField.init(name, type_name, is_const, init_expr); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
    ...
    pub fn parseIfStmt(self: *Parser) anyerror!PNode {
        ...
        return PNode{ .stmt_if = blk_box: { const _bv: std.meta.Child(@FieldType(PNode, "stmt_if")) = PIf.init(cond_list, then_stmts, else_stmts); const _bp = _allocator.create(@TypeOf(_bv)) catch @panic("OOM"); _bp.* = _bv; break :blk_box _bp; } };
    }
