...
// zbr:selfhost\cg_helpers.zbr:816
    switch (expr) {
        .call => |c_ptr| {
            const c = c_ptr.*;
...
// zbr:selfhost\cg_helpers.zbr:903
            ...
            .with_ => |w_ptr| {
                const w = w_ptr.*;
// zbr:selfhost\cg_helpers.zbr:905
                if (w.target.* == .ident) {
