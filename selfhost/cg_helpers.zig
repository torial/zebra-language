...
pub fn nameUsedInExpr(_p_name: []const u8, _p_expr: Expr) bool {
    ...
    var expr = _p_expr;
    while (true) {
// zbr:selfhost\cg_helpers.zbr:358
        switch (expr) {
            .ident => |id| {
// zbr:selfhost\cg_helpers.zbr:360
