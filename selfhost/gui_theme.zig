...
pub const GuiTheme = struct {
    ptr:    *anyopaque,
    vtable: *const VTable,

    pub const VTable = struct {
        apply: *const fn (ptr: *anyopaque, dpi: f64) void,
    };

    pub fn apply(self: @This(), dpi: f64) void {
        return self.vtable.apply(self.ptr, dpi);
    }

    pub fn check(comptime T: type) void {
        comptime {
            if (!@hasDecl(T, "apply")) @compileError("type " ++ @typeName(T) ++ " does not implement GuiTheme.apply");
        }
    }
};

pub const SpaceNavyTheme = struct {
    _type_tag: u64 = _ttag_SpaceNavyTheme,
    pub fn apply(self: *SpaceNavyTheme, dpi: f64) void {
        _ = self;
// zbr:selfhost/gui_theme.zbr:6
        _gui_active_backend.setColorsDarkFn();
// zbr:selfhost/gui_theme.zbr:7
        _gui_active_backend.setStyleFloatFn("frame_rounding", @as(f32, @floatCast(7.0)));
// zbr:selfhost/gui_theme.zbr:8
        _gui_active_backend.setStyleFloatFn("child_rounding", @as(f32, @floatCast(8.0)));
// zbr:selfhost/gui_theme.zbr:9
        _gui_active_backend.setStyleFloatFn("popup_rounding", @as(f32, @floatCast(10.0)));
// zbr:selfhost/gui_theme.zbr:10
        _gui_active_backend.setStyleFloatFn("scrollbar_rounding", @as(f32, @floatCast(6.0)));
// zbr:selfhost/gui_theme.zbr:11
        _gui_active_backend.setStyleFloatFn("grab_rounding", @as(f32, @floatCast(5.0)));
// zbr:selfhost/gui_theme.zbr:12
        _gui_active_backend.setStyleFloatFn("tab_rounding", @as(f32, @floatCast(6.0)));
// zbr:selfhost/gui_theme.zbr:13
        _gui_active_backend.setStyleFloatFn("window_rounding", @as(f32, @floatCast(0.0)));
// zbr:selfhost/gui_theme.zbr:14
        _gui_active_backend.setVec2Fn("frame_padding", @as(f32, @floatCast(10.0)), @as(f32, @floatCast(6.0)));
// zbr:selfhost/gui_theme.zbr:15
        _gui_active_backend.setVec2Fn("item_spacing", @as(f32, @floatCast(8.0)), @as(f32, @floatCast(6.0)));
// zbr:selfhost/gui_theme.zbr:16
        _gui_active_backend.setVec2Fn("window_padding", @as(f32, @floatCast(12.0)), @as(f32, @floatCast(12.0)));
// zbr:selfhost/gui_theme.zbr:17
        _gui_active_backend.setStyleFloatFn("scrollbar_size", @as(f32, @floatCast(10.0)));
// zbr:selfhost/gui_theme.zbr:18
        _gui_active_backend.setStyleFloatFn("grab_min_size", @as(f32, @floatCast(10.0)));
// zbr:selfhost/gui_theme.zbr:19
        _gui_active_backend.setStyleFloatFn("window_border_size", @as(f32, @floatCast(0.0)));
// zbr:selfhost/gui_theme.zbr:20
        _gui_active_backend.setStyleFloatFn("frame_border_size", @as(f32, @floatCast(1.0)));
// zbr:selfhost/gui_theme.zbr:21
        _gui_active_backend.setStyleFloatFn("child_border_size", @as(f32, @floatCast(1.0)));
// zbr:selfhost/gui_theme.zbr:22
        _gui_active_backend.setStyleFloatFn("popup_border_size", @as(f32, @floatCast(1.0)));
// zbr:selfhost/gui_theme.zbr:23
        _gui_active_backend.setColorFn("text", @as(f32, @floatCast(0.910)), @as(f32, @floatCast(0.929)), @as(f32, @floatCast(0.961)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:24
        _gui_active_backend.setColorFn("text_disabled", @as(f32, @floatCast(0.353)), @as(f32, @floatCast(0.396)), @as(f32, @floatCast(0.502)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:25
        _gui_active_backend.setColorFn("window_bg", @as(f32, @floatCast(0.102)), @as(f32, @floatCast(0.125)), @as(f32, @floatCast(0.208)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:26
        _gui_active_backend.setColorFn("child_bg", @as(f32, @floatCast(0.125)), @as(f32, @floatCast(0.157)), @as(f32, @floatCast(0.251)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:27
        _gui_active_backend.setColorFn("popup_bg", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.149)), @as(f32, @floatCast(0.239)), @as(f32, @floatCast(0.97)));
// zbr:selfhost/gui_theme.zbr:28
        _gui_active_backend.setColorFn("border", @as(f32, @floatCast(0.165)), @as(f32, @floatCast(0.208)), @as(f32, @floatCast(0.376)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:29
        _gui_active_backend.setColorFn("border_shadow", @as(f32, @floatCast(0.000)), @as(f32, @floatCast(0.000)), @as(f32, @floatCast(0.000)), @as(f32, @floatCast(0.00)));
// zbr:selfhost/gui_theme.zbr:30
        _gui_active_backend.setColorFn("frame_bg", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.157)), @as(f32, @floatCast(0.271)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:31
        _gui_active_backend.setColorFn("frame_bg_hovered", @as(f32, @floatCast(0.161)), @as(f32, @floatCast(0.216)), @as(f32, @floatCast(0.380)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:32
        _gui_active_backend.setColorFn("frame_bg_active", @as(f32, @floatCast(0.196)), @as(f32, @floatCast(0.267)), @as(f32, @floatCast(0.451)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:33
        _gui_active_backend.setColorFn("title_bg", @as(f32, @floatCast(0.078)), @as(f32, @floatCast(0.094)), @as(f32, @floatCast(0.161)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:34
        _gui_active_backend.setColorFn("title_bg_active", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:35
        _gui_active_backend.setColorFn("title_bg_collapsed", @as(f32, @floatCast(0.078)), @as(f32, @floatCast(0.094)), @as(f32, @floatCast(0.161)), @as(f32, @floatCast(0.75)));
// zbr:selfhost/gui_theme.zbr:36
        _gui_active_backend.setColorFn("menu_bar_bg", @as(f32, @floatCast(0.090)), @as(f32, @floatCast(0.110)), @as(f32, @floatCast(0.184)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:37
        _gui_active_backend.setColorFn("scrollbar_bg", @as(f32, @floatCast(0.102)), @as(f32, @floatCast(0.125)), @as(f32, @floatCast(0.208)), @as(f32, @floatCast(0.50)));
// zbr:selfhost/gui_theme.zbr:38
        _gui_active_backend.setColorFn("scrollbar_grab", @as(f32, @floatCast(0.227)), @as(f32, @floatCast(0.314)), @as(f32, @floatCast(0.565)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:39
        _gui_active_backend.setColorFn("scrollbar_grab_hovered", @as(f32, @floatCast(0.278)), @as(f32, @floatCast(0.388)), @as(f32, @floatCast(0.659)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:40
        _gui_active_backend.setColorFn("scrollbar_grab_active", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:41
        _gui_active_backend.setColorFn("check_mark", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:42
        _gui_active_backend.setColorFn("slider_grab", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:43
        _gui_active_backend.setColorFn("slider_grab_active", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:44
        _gui_active_backend.setColorFn("button", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.90)));
// zbr:selfhost/gui_theme.zbr:45
        _gui_active_backend.setColorFn("button_hovered", @as(f32, @floatCast(0.141)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.800)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:46
        _gui_active_backend.setColorFn("button_active", @as(f32, @floatCast(0.082)), @as(f32, @floatCast(0.345)), @as(f32, @floatCast(0.639)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:47
        _gui_active_backend.setColorFn("header", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.38)));
// zbr:selfhost/gui_theme.zbr:48
        _gui_active_backend.setColorFn("header_hovered", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.58)));
// zbr:selfhost/gui_theme.zbr:49
        _gui_active_backend.setColorFn("header_active", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.80)));
// zbr:selfhost/gui_theme.zbr:50
        _gui_active_backend.setColorFn("separator", @as(f32, @floatCast(0.145)), @as(f32, @floatCast(0.188)), @as(f32, @floatCast(0.314)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:51
        _gui_active_backend.setColorFn("separator_hovered", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(0.78)));
// zbr:selfhost/gui_theme.zbr:52
        _gui_active_backend.setColorFn("separator_active", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:53
        _gui_active_backend.setColorFn("resize_grip", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.25)));
// zbr:selfhost/gui_theme.zbr:54
        _gui_active_backend.setColorFn("resize_grip_hovered", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(0.55)));
// zbr:selfhost/gui_theme.zbr:55
        _gui_active_backend.setColorFn("resize_grip_active", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(0.90)));
// zbr:selfhost/gui_theme.zbr:56
        _gui_active_backend.setColorFn("tab", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.157)), @as(f32, @floatCast(0.251)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:57
        _gui_active_backend.setColorFn("tab_hovered", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.80)));
// zbr:selfhost/gui_theme.zbr:58
        _gui_active_backend.setColorFn("tab_selected", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:59
        _gui_active_backend.setColorFn("tab_dimmed", @as(f32, @floatCast(0.098)), @as(f32, @floatCast(0.122)), @as(f32, @floatCast(0.200)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:60
        _gui_active_backend.setColorFn("tab_dimmed_selected", @as(f32, @floatCast(0.137)), @as(f32, @floatCast(0.188)), @as(f32, @floatCast(0.337)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:61
        _gui_active_backend.setColorFn("table_header_bg", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.157)), @as(f32, @floatCast(0.271)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:62
        _gui_active_backend.setColorFn("table_border_strong", @as(f32, @floatCast(0.188)), @as(f32, @floatCast(0.251)), @as(f32, @floatCast(0.427)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:63
        _gui_active_backend.setColorFn("table_border_light", @as(f32, @floatCast(0.145)), @as(f32, @floatCast(0.196)), @as(f32, @floatCast(0.337)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:64
        _gui_active_backend.setColorFn("table_row_bg", @as(f32, @floatCast(0.000)), @as(f32, @floatCast(0.000)), @as(f32, @floatCast(0.000)), @as(f32, @floatCast(0.00)));
// zbr:selfhost/gui_theme.zbr:65
        _gui_active_backend.setColorFn("table_row_bg_alt", @as(f32, @floatCast(0.157)), @as(f32, @floatCast(0.196)), @as(f32, @floatCast(0.318)), @as(f32, @floatCast(0.35)));
// zbr:selfhost/gui_theme.zbr:66
        _gui_active_backend.setColorFn("text_selected_bg", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.431)), @as(f32, @floatCast(0.784)), @as(f32, @floatCast(0.45)));
// zbr:selfhost/gui_theme.zbr:67
        _gui_active_backend.setColorFn("nav_cursor", @as(f32, @floatCast(0.118)), @as(f32, @floatCast(0.471)), @as(f32, @floatCast(0.796)), @as(f32, @floatCast(1.00)));
// zbr:selfhost/gui_theme.zbr:68
        _gui_active_backend.setColorFn("nav_windowing_highlight", @as(f32, @floatCast(1.000)), @as(f32, @floatCast(1.000)), @as(f32, @floatCast(1.000)), @as(f32, @floatCast(0.70)));
// zbr:selfhost/gui_theme.zbr:69
        _gui_active_backend.setColorFn("nav_windowing_dim_bg", @as(f32, @floatCast(0.078)), @as(f32, @floatCast(0.098)), @as(f32, @floatCast(0.165)), @as(f32, @floatCast(0.70)));
// zbr:selfhost/gui_theme.zbr:70
        _gui_active_backend.setColorFn("modal_window_dim_bg", @as(f32, @floatCast(0.063)), @as(f32, @floatCast(0.078)), @as(f32, @floatCast(0.133)), @as(f32, @floatCast(0.65)));
// zbr:selfhost/gui_theme.zbr:71
        _gui_active_backend.scaleAllSizesFn(@as(f32, @floatCast(dpi)));
    }

    pub fn init() *SpaceNavyTheme {
        const self = _allocator.create(SpaceNavyTheme) catch @panic("OOM");
        self.* = .{};
        self._type_tag = _ttag_SpaceNavyTheme;
        return self;
    }
...
const _ttag_SpaceNavyTheme: u64 = 2850062598;
const _reflect_SpaceNavyTheme_name: []const u8 = "SpaceNavyTheme";
const _reflect_SpaceNavyTheme_fields: []const []const u8 = &.{};
const _reflect_SpaceNavyTheme_field_types: []const []const u8 = &.{};

fn _shim_SpaceNavyTheme_GuiTheme_apply(ptr: *anyopaque, dpi: f64) void { return SpaceNavyTheme.apply(@alignCast(@ptrCast(ptr)), dpi); }
const _vtable_SpaceNavyTheme_GuiTheme = GuiTheme.VTable{ .apply = &_shim_SpaceNavyTheme_GuiTheme_apply, };
