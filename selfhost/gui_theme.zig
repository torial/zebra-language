...
const _ttag_SpaceNavyTheme: u64 = _zbr_hash("SpaceNavyTheme");
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_SpaceNavyTheme) return _reflect_SpaceNavyTheme_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_SpaceNavyTheme) return .{ .items = _reflect_SpaceNavyTheme_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_SpaceNavyTheme) return .{ .items = _reflect_SpaceNavyTheme_field_types };
    return .{ .items = &.{} };
}
