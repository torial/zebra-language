...
pub fn generateModuleWith(m: Module, file: []const u8, extra_class_names: std.ArrayList([]const u8), deps_mt: *ModuleTypes) []const u8 {
    ...
    if ((@as(i64, @intCast(reflect_classes.items.len)) > 0)) {
        ...
        var ri2: i64 = 0;
        while ((ri2 < @as(i64, @intCast(reflect_classes.items.len)))) {
...
pub fn generateFullWithDeps(m: Module, file: []const u8, preamble_path: []const u8, extra_class_names: std.ArrayList([]const u8), deps_mt: *ModuleTypes, all_dep_modules: std.ArrayList([]const u8)) anyerror![]const u8 {
    ...
    if ((@as(i64, @intCast(all_dep_modules.items.len)) > 0)) {
...
pub const Generator = struct {
    ...
    pub fn genClass(self: *Generator, n: DeclClass) void {
        ...
        var ri: i64 = 0;
        while ((ri < @as(i64, @intCast(rf_names.items.len)))) {
            if ((ri > 0)) {
                self.w.emit(", ");
            }
            self.w.emit("\"");
        ...
        ri = 0;
        while ((ri < @as(i64, @intCast(rf_types.items.len)))) {
            if ((ri > 0)) {
                self.w.emit(", ");
            }
            self.w.emit("\"");
    ...
    pub fn genDocStringLit(self: *Generator, text: []const u8) void {
        ...
        if ((@as(i64, @intCast(dq_parts.items.len)) >= 2)) {
        ...
        if (std.mem.startsWith(u8, content, "\n")) {
            ...
            content = "";
            var nsi: i64 = 1;
            while ((nsi < @as(i64, @intCast(nl_split.items.len)))) {
                if ((nsi > 1)) {
        ...
        var qi: i64 = 1;
        while ((qi < @as(i64, @intCast(qparts.items.len)))) {
        ...
        var ni: i64 = 1;
        while ((ni < @as(i64, @intCast(nparts.items.len)))) {
