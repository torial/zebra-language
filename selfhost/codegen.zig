...
// zbr:selfhost/codegen.zbr:7575
            if (_zebra_ge(tid2, 0)) {
                bg.w.emit(_str_concat("_zbr_thunk_", (std.fmt.allocPrint(_allocator, "{}", .{tid2}) catch @panic("OOM")), _allocator));
            } else {
                bg.genExpr(a2.value);
            }
