...
// zbr:selfhost/Checker.zbr:303
                self.walkExpr(sy.value.*, file, false);
            },
            .raise_ => |_ptr_sr2| {
                const sr2 = _ptr_sr2.*;
